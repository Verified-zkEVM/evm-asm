...
These 34 opcodes have executable-spec / handler / host-bridge
semantics only; **no RV64 subroutine is proven to produce the EVM result**:

STOP, KECCAK256, BALANCE, CODESIZE, CODECOPY, EXTCODESIZE, EXTCODECOPY, RETURNDATASIZE, RETURNDATACOPY, EXTCODEHASH, BLOCKHASH, BLOBHASH, BLOBBASEFEE, SLOAD, SSTORE, JUMP, JUMPI, PC, GAS, JUMPDEST, TLOAD, TSTORE, MCOPY, LOG0..4, CREATE, CALL, CALLCODE, RETURN, DELEGATECALL, CREATE2, STATICCALL, REVERT, INVALID, SELFDESTRUCT.
