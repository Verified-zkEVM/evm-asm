...
| 3 | RLP-decode the (block, witness) input | 🟡 blocked | `rlp_item_span` has no machine triple (#11577), `rlp_item_size` covers short forms only — long string `0xb8`–`0xbf` and long list `0xf8`–`0xff` uncovered (`Correspondence.lean` `rlp_item_size`), nested-list decode bridges blocked on `DecodeChain` fuel-insensitivity (#11711; residual #11795) | 2026-08-10 @372162cc2 |
