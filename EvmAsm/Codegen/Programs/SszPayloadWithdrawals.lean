...
def extractPayloadAndWithdrawals_prog : Program :=
  [ .ADDI .x2 .x2 (-48 : BitVec 12),
    ...
    .LI .x5 (44 : Word),
    .BNE .x10 .x5 (brOff (GuestAddrs.extract_payload_and_withdrawals + 188) (GuestAddrs.extract_payload_and_withdrawals + 68)),
    .ADD .x20 .x7 .x10,
    ...
    .BLTU .x10 .x5 (brOff (GuestAddrs.extract_payload_and_withdrawals + 188) (GuestAddrs.extract_payload_and_withdrawals + 116)),
    .MV .x10 .x31,
    .LI .x5 (540 : Word),
