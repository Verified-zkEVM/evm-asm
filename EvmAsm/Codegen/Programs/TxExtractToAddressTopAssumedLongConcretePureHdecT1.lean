...
theorem extractAssumed_creation_longConcrete_pureHdec_t1
  ...
  exact extractAssumed_creation_longConcrete_pure_t1
...
set_option maxRecDepth 8000 in
theorem extractAssumed_creation_longConcrete_pureHdec_t1_fullCode
    (sp0 spC : Word) (s : ExtractSaved)
    (txBase lenW toBuf isCreationPtr : Word)
    (txBytes : List (BitVec 8))
    (items : List EL.RLP.RLPItem)
  ...
  cpsTripleWithin_extend_code extractLinked_mono
    (extractAssumed_creation_longConcrete_pureHdec_t1 sp0 spC s
...
#print axioms extractAssumed_creation_longConcrete_pureHdec_t1
#print axioms extractAssumed_creation_longConcrete_pureHdec_t1_fullCode
