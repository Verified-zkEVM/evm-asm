...
/-- a4gbr: ScratchZero Is foundation + Front Is chain through AuthCount + free26 Is ExitPack
    (hrolled0 FREE). Residual: hrunA Is (applied_is@srcOffA9=0) + domain inhabit. -/
