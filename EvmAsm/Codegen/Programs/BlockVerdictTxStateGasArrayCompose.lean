...
/-- a4gbr: ScratchZero value-carrying zeros foundation + FrontEarly Is path; FrontType Is → AfterTypeBne DONE; FrontType4 Is → AtWalkInit DONE; FrontWalkInit/WalkNext0–5 Is → AfterWalkInitSave DONE
