...
/-- a4gbr: ScratchZero Is foundation + Front Is chain through AuthCount + free26 Is ExitPack
    (hrolled0 FREE). hrunA wire applied@srcOffA9=0→ExitPack DONE; residual ABI wire+domain fixture. -/
