...
def blockVerdictReceiptsTail : String :=
  ...
  ".Lbv_mpt_unresolved_fail:\n" ++         -- #12215: required witness node hash had no preimage
...
#guard (blockVerdictReceiptsTail.splitOn "li t0, 69; la t1, bv_fail_code; sd t0, 0(t1); j .Lbv_zero").length == 2
