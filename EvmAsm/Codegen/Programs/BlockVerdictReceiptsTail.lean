...
def blockVerdictReceiptsTail : String :=
  ...
  -- the legacy single-tx path; eip7708_tl_typed_avail covers the narrow type-1/type-2/type-4
  -- simple-transfer paths added by bmvmx.7.1/57t4x. Other typed and multi-tx blocks remain conservative until their
