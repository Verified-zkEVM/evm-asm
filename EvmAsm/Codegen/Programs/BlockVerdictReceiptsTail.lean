...
def blockVerdictReceiptsTail : String :=
  ...
  -- the legacy single-tx path; eip7708_tl_type1_avail and eip7708_tl_type2_avail cover
  -- the narrow type-1/type-2 simple-transfer paths added by bmvmx.7.1/.7.2. Other typed
  -- and multi-tx blocks remain conservative until their
  ...
  "  la t2, eip7708_tl_type1_avail; ld t2, 0(t2); bnez t2, .Lbv_receipts_enforce\n" ++
