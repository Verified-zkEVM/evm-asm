/-
  Front short AfterSave → legacy 20B copy bare region (no contentDwords).
-/
...
theorem extractFrontAfterSaveCopy_then_epi_of_decode_short_legacy_region
  ...
  have hMid := extractLegacyAfterSaveCopy_then_epi_of_decode_region sp0 spC s
    txBase lenW
...
#print axioms extractFrontAfterSaveCopy_then_epi_of_decode_short_legacy_region
