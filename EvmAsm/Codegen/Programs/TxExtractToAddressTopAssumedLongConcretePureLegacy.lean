...
theorem extractAssumed_creation_longConcrete_pure_legacy
  ...
  have hhoff :=
    extractSuccess_creation_legacy_hoff_srcOff_long txBytes hsuccess hcreFlag htype0
      items hdecL hlong
  have hhover :=
    extractSuccess_creation_legacy_hover_srcOff_long txBytes txBase hsuccess hcreFlag htype0
  ...
  have hfields02 :=
    extractSuccess_creation_legacy_hnext_fields02_long txBytes hsuccess hcreFlag htype0
      items hdecL hlong
  have hendEq :
  ...
  have hcur :
    ...
    simpa [longWalkCursor, srcOff0, listOff] using
      longWalkCursor_eq_srcOff0 txBytes txBase listOff items hencInner hlong hbound
        hoff hoverC
  have hhnext :=
    extractSuccess_creation_legacy_hnext_hcre_srcOff_long txBytes txBase hsuccess
  ...
  exact extractAssumed_creation_under_honesty_of_decode_long_concrete_legacy
...
set_option maxRecDepth 8000 in
theorem extractAssumed_creation_longConcrete_pure_legacy_fullCode
    (sp0 spC : Word) (s : ExtractSaved)
    (txBase lenW toBuf isCreationPtr : Word)
    (txBytes : List (BitVec 8))
    (items : List EL.RLP.RLPItem)
  ...
  cpsTripleWithin_extend_code extractLinked_mono
    (extractAssumed_creation_longConcrete_pure_legacy sp0 spC s
...
#print axioms extractAssumed_creation_longConcrete_pure_legacy
#print axioms extractAssumed_creation_longConcrete_pure_legacy_fullCode
