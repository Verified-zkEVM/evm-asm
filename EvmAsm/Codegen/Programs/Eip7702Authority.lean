...
def eip7702AuthorizationRecoverAddress_prog : Program :=
  [ .ADDI .x2 .x2 (-56 : BitVec 12),
    ...
    .LI .x10 (10 : Word),
    .JAL .x0 (jalOff (GuestAddrs.eip7702_authorization_recover_address + 368) (GuestAddrs.eip7702_authorization_recover_address + 116)),
    .MV .x10 .x8,
    .MV .x11 .x9,
    ...
    .BEQ .x10 .x0 (12 : BitVec 13),
    .LI .x10 (20 : Word),
    .JAL .x0 (jalOff (GuestAddrs.eip7702_authorization_recover_address + 368) (GuestAddrs.eip7702_authorization_recover_address + 144)),
    .LD .x5 .x19 (8 : BitVec 12),
    .LI .x6 (1 : Word),
    .BLTU .x6 .x5 (brOff (GuestAddrs.eip7702_authorization_recover_address + 332) (GuestAddrs.eip7702_authorization_recover_address + 156)),
    .ADDI .x10 .x19 (16 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.u256_is_zero (GuestAddrs.eip7702_authorization_recover_address + 164)),
    .BNE .x10 .x0 (brOff (GuestAddrs.eip7702_authorization_recover_address + 340) (GuestAddrs.eip7702_authorization_recover_address + 168)),
    .ADDI .x10 .x19 (48 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.u256_is_zero (GuestAddrs.eip7702_authorization_recover_address + 176)),
    .BNE .x10 .x0 (brOff (GuestAddrs.eip7702_authorization_recover_address + 348) (GuestAddrs.eip7702_authorization_recover_address + 180)),
    .ADDI .x10 .x19 (16 : BitVec 12),
    ...
    .BEQ .x6 .x0 (brOff (GuestAddrs.eip7702_authorization_recover_address + 356) (GuestAddrs.eip7702_authorization_recover_address + 220)),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .BNE .x6 .x0 (brOff (GuestAddrs.eip7702_authorization_recover_address + 364) (GuestAddrs.eip7702_authorization_recover_address + 260)),
    .MV .x10 .x19,
    ...
    .BEQ .x10 .x0 (12 : BitVec 13),
    .LI .x10 (50 : Word),
    .JAL .x0 (jalOff (GuestAddrs.eip7702_authorization_recover_address + 368) (GuestAddrs.eip7702_authorization_recover_address + 284)),
