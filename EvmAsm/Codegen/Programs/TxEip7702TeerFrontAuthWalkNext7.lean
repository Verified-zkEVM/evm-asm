/-
  Teer front auth walk_next cycle 7 under applied prest.
  E → AfterAuthWalkNext7Save via FrontAuthWalkNext6 + Cycle7.
-/
...
/-- Cycle7 CycleOk with regOwn temps x5–7,x28–31. -/
theorem teerAuthWalkNext7CycleOk_ownTemps
    ...
    (hend : v22 = endPtr) :
    cpsTripleWithin nAuthWalkNextCycle AfterAuthWalkNext6Save AfterAuthWalkNext7Save
      teerLinkedEarly
  ...
  have hcore (t0 t1 t2 t3 t4 t5 t6 : Word) :
      cpsTripleWithin nAuthWalkNextCycle AfterAuthWalkNext6Save AfterAuthWalkNext7Save
        ...
        (fun h => ∃ next len : Word,
          (teerAuthWalkNextSkipBodyPost listBase endPtr next len bs srcOff
            LinkAuthWalkNext7) h) := by
    have h0 := teerAuthWalkNext7CycleOk listBase endPtr a2Old t0 t1 t2 t3 t4 t5 t6
...
/-- Rest of AfterAuthWalkNext6Save flat without trailing pure. -/
def teerAuthWalkNext6FlatRest
    (spC loadPtr lenW balPtr balLenW chainIdW
...
theorem teerAuthWalkNext6FlatRest_to_awn7Pre
    (spC loadPtr lenW balPtr balLenW chainIdW
      s7 s11 spVal regionBase endL cursorV endWV : Word)
    (bs balBytes : List (BitVec 8)) (s : TeerSaved)
    (innerVal nextP lenP : Word) :
    ∀ h,
      (teerAuthWalkNext6FlatRest spC loadPtr lenW balPtr balLenW chainIdW
          s7 s11 spVal regionBase endL cursorV endWV bs balBytes s
          innerVal nextP lenP) h →
      (teerAuthWalkNextSkipFocus regionBase bs
          LinkAuthWalkNext6 nextP endL nextP (0 : Word) lenP **
        teerAuthWalkNextSkipAmbient spC loadPtr lenW balPtr balLenW chainIdW
          s7 s11 spVal cursorV endWV balBytes s innerVal) h := by
  intro h hp
  unfold teerAuthWalkNext6FlatRest at hp
...
def teerAuthWalkNext7PostNested
    (spC loadPtr lenW balPtr balLenW chainIdW
      s7 s11 spVal regionBase endL cursorV endWV : Word)
    (bs balBytes : List (BitVec 8)) (s : TeerSaved)
    (innerVal : Word) (srcOffA7 : Nat) : Assertion :=
  fun h => ∃ next len : Word,
    (teerAuthWalkNextSkipBodyPost regionBase endL next len bs srcOffA7
        LinkAuthWalkNext7 **
      teerAuthWalkNextSkipAmbient spC loadPtr lenW balPtr balLenW chainIdW
        s7 s11 spVal cursorV endWV balBytes s innerVal) h

set_option maxRecDepth 8000 in
theorem teerAuthWalkNext7_applied_nested
...
(hsuccess : (teerTxTypeDispatch (txSlice bs off len)).1 = (0 : Word))
    ...
    cpsTripleWithin nFrontToAuthWalkNext7Save
      E AfterAuthWalkNext7Save teerLinkedEarly
      ((.x1 ↦ᵣ ret) ** (.x2 ↦ᵣ spVal) **
      ...
      (teerAuthWalkNext7PostNested spC loadPtr lenW balPtr balLenW chainIdW
        s7 s11 spVal regionBase endL cursorV endW bs balBytes s innerVal
        srcOffA7) := by
  intro s innerVal listLen endL endW cursorV
  have hwnP := teerAuthWalkNext6_applied ret spVal spC loadPtr lenW
  ...
  let Flat (p : Word × Word) : Assertion :=
    ...
    ⌜rlpItemDecode bs srcOffA6 (regionBase + BitVec.ofNat 64 srcOffA6)
      endL p.1 p.2⌝
  have hwnPE :
      cpsTripleWithin nFrontToAuthWalkNext6Save E AfterAuthWalkNext6Save
        teerLinkedEarly
        ((.x1 ↦ᵣ ret) ** (.x2 ↦ᵣ spVal) **
          stackFree spVal nTeerStackDwords **
          (.x8 ↦ᵣ s0) ** (.x9 ↦ᵣ s1) **
    ...
    refine ⟨(nextP, lenP), ?_⟩
    dsimp only [Flat, teerAuthWalkNext6FlatRest]
    xperm_hyp hq'
  have hstep (p : Word × Word) :
    ...
    have hswap :
      ...
      have hcurK : p.1 = regionBase + BitVec.ofNat 64 srcOffA7 :=
        hbridgeA6 p.1 p.2 (by simpa [endL, innerVal, listLen] using hpure)
      have hcy := teerAuthWalkNext7CycleOk_ownTemps regionBase endL bs srcOffA7
        LinkAuthWalkNext6 p.1 endL p.1 (0 : Word) p.2
        (by simpa using halign) hoffA7 hoverA7 hvalidA7
        hssA7 hlsA7 hllA7
        hdecA7 hinbA7 hcurK rfl
      ...
      have hcyF' :
          cpsTripleWithin nAuthWalkNextCycle AfterAuthWalkNext6Save
            AfterAuthWalkNext7Save teerLinkedEarly
            (teerAuthWalkNextSkipFocus regionBase bs
                LinkAuthWalkNext6 p.1 endL p.1 (0 : Word) p.2 **
              teerAuthWalkNextSkipAmbient spC loadPtr lenW balPtr balLenW chainIdW
                s7 s11 spVal cursorV endW balBytes s innerVal)
        ...
        refine cpsTripleWithin_weaken
          (fun _ hp => by
            ...
            xperm_hyp hp)
          (fun h hq => by
            unfold teerAuthWalkNext7PostNested
            obtain ⟨h1, h2, hd, hu, hEx, hA⟩ := hq
            obtain ⟨next, len1, hB⟩ := hEx
            exact ⟨next, len1, h1, h2, hd, hu, hB, hA⟩)
          hcyF
      exact cpsTripleWithin_weaken
        (teerAuthWalkNext6FlatRest_to_awn7Pre spC loadPtr lenW balPtr balLenW
  ...
  exact cpsTripleWithin_mono_nSteps
    (by decide :
      nFrontToAuthWalkNext6Save + nAuthWalkNextCycle ≤ nFrontToAuthWalkNext7Save)
    hseq

set_option maxRecDepth 8000 in
/-- Flatten nested → applied-style AfterAuthWalkNext7Save post. -/
theorem teerAuthWalkNext7_applied
    (ret spVal spC loadPtr lenW balPtr balLenW chainIdW baiW : Word)
    (s0 s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11 : Word)
    (regionBase : Word) (bs balBytes : List (BitVec 8)) (off len : Nat)
    (hspC : spC = spVal + signExtend12 (-160 : BitVec 12))
...
(hsuccess : (teerTxTypeDispatch (txSlice bs off len)).1 = (0 : Word))
      ...
      (fun h => ∃ next lenK : Word,
        ((.x2 ↦ᵣ spC) **
          ...
          ⌜rlpItemDecode bs srcOffA7 (regionBase + BitVec.ofNat 64 srcOffA7)
            endL next lenK⌝) h) := by
  intro s innerVal listLen endL endW cursorV
  have h0 := teerAuthWalkNext7_applied_nested ret spVal spC loadPtr lenW
    balPtr balLenW chainIdW baiW s0 s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11
    regionBase bs balBytes off len hspC hnez hptr hlenW hsuccess htype4
    halign hbound hover hvalid0 listOff ha0 hoffL hoverL hvalidL hlenL
    h_ge h_hi h_exact srcOff0 hcur0 hoff0 hover0 hvalid0I hss0 hls0 hll0 hdec0 hinb0
  ...
  exact cpsTripleWithin_weaken (fun _ hp => hp)
    (fun h hq => by
      unfold teerAuthWalkNext7PostNested teerAuthWalkNextSkipBodyPost
        teerAuthWalkNextSkipAmbient teerAuthWalkNext0Ambient at hq
      obtain ⟨next, lenK, hq'⟩ := hq
      refine ⟨next, lenK, ?_⟩
      xperm_hyp hq') h0

#print axioms teerAuthWalkNext7CycleOk_ownTemps
#print axioms teerAuthWalkNext7_applied_nested
#print axioms teerAuthWalkNext7_applied


def teerAuthWalkNext6FlatRestIs
    (spC loadPtr lenW balPtr balLenW chainIdW
      s7 s11 spVal regionBase endL cursorV endWV : Word)
    (bs balBytes : List (BitVec 8)) (s : TeerSaved)
    (innerVal nextP lenP : Word) : Assertion :=
...
theorem teerAuthWalkNext6FlatRestIs_to_awn7Pre
    (spC loadPtr lenW balPtr balLenW chainIdW
      s7 s11 spVal regionBase endL cursorV endWV : Word)
    (bs balBytes : List (BitVec 8)) (s : TeerSaved)
    (innerVal nextP lenP : Word) :
    ∀ h,
      (teerAuthWalkNext6FlatRestIs spC loadPtr lenW balPtr balLenW chainIdW
          s7 s11 spVal regionBase endL cursorV endWV bs balBytes s
          innerVal nextP lenP) h →
      (teerAuthWalkNextSkipFocus regionBase bs
          LinkAuthWalkNext6 nextP endL nextP (0 : Word) lenP **
        teerAuthWalkNextSkipAmbientIs spC loadPtr lenW balPtr balLenW chainIdW
          s7 s11 spVal cursorV endWV balBytes s innerVal) h := by
  intro h hp
  unfold teerAuthWalkNext6FlatRestIs at hp
  unfold teerAuthWalkNextSkipFocus teerAuthWalkNext0Focus teerAuthWalkNext0BodyCore
    teerAuthWalkNextSkipAmbientIs teerAuthWalkNext0AmbientIs
  xperm_hyp hp

def teerAuthWalkNext7PostNestedIs
    (spC loadPtr lenW balPtr balLenW chainIdW
      s7 s11 spVal regionBase endL cursorV endWV : Word)
    (bs balBytes : List (BitVec 8)) (s : TeerSaved)
    (innerVal : Word) (srcOffA7 : Nat) : Assertion :=
...
set_option maxRecDepth 8000 in
theorem teerAuthWalkNext7_applied_nested_is
    (ret spVal spC loadPtr lenW balPtr balLenW chainIdW baiW : Word)
    (s0 s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11 : Word)
    (regionBase : Word) (bs balBytes : List (BitVec 8)) (off len : Nat)
    (hspC : spC = spVal + signExtend12 (-160 : BitVec 12))
...
(hsuccess : (teerTxTypeDispatch (txSlice bs off len)).1 = (0 : Word))
    ...
    cpsTripleWithin nFrontToAuthWalkNext7Save
      ...
      ((.x1 ↦ᵣ ret) ** (.x2 ↦ᵣ spVal) **
        ...
        regOwn .x16 ** regOwn .x28 ** regOwn .x29 ** regOwn .x30 **
        regOwn .x31 ** (.x0 ↦ᵣ (0 : Word)))
      (teerAuthWalkNext7PostNestedIs spC loadPtr lenW balPtr balLenW chainIdW
        s7 s11 spVal regionBase endL cursorV endW bs balBytes s innerVal
        srcOffA7) := by
  intro s innerVal listLen endL endW cursorV
  have hwnP := teerAuthWalkNext6_applied_is ret spVal spC loadPtr lenW
    balPtr balLenW chainIdW baiW s0 s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11
    regionBase bs balBytes off len hspC hnez hptr hlenW hsuccess htype4
    halign hbound hover hvalid0 listOff ha0 hoffL hoverL hvalidL hlenL
    h_ge h_hi h_exact srcOff0 hcur0 hoff0 hover0 hvalid0I hss0 hls0 hll0 hdec0 hinb0
  ...
  have hwnPE :
    ...
    obtain ⟨nextP, lenP, hq'⟩ := hq
    refine ⟨(nextP, lenP), ?_⟩
    dsimp only [Flat, teerAuthWalkNext6FlatRestIs]
    xperm_hyp hq'
  have hstep (p : Word × Word) :
      cpsTripleWithin nAuthWalkNextCycle AfterAuthWalkNext6Save AfterAuthWalkNext7Save
        teerLinkedEarly (Flat p)
      ...
      have hcyF' :
        ...
        refine cpsTripleWithin_weaken
          (fun _ hp => by
            ...
            xperm_hyp hp)
          (fun h hq => by
            unfold teerAuthWalkNext7PostNestedIs
            obtain ⟨h1, h2, hd, hu, hEx, hA⟩ := hq
            obtain ⟨next, len1, hB⟩ := hEx
            exact ⟨next, len1, h1, h2, hd, hu, hB, hA⟩)
          hcyF
      exact cpsTripleWithin_weaken
        (teerAuthWalkNext6FlatRestIs_to_awn7Pre spC loadPtr lenW balPtr balLenW
          chainIdW s7 s11 spVal regionBase endL cursorV endW bs balBytes s
          innerVal p.1 p.2)
        (fun _ hq => hq) hcyF'
    exact cpsTripleWithin_weaken (fun _ hp => by xperm_hyp hp)
...
set_option maxRecDepth 8000 in
/-- Flatten nested → applied-style AfterAuthWalkNext7Save post. -/
theorem teerAuthWalkNext7_applied_is
    (ret spVal spC loadPtr lenW balPtr balLenW chainIdW baiW : Word)
    (s0 s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11 : Word)
    (regionBase : Word) (bs balBytes : List (BitVec 8)) (off len : Nat)
    (hspC : spC = spVal + signExtend12 (-160 : BitVec 12))
...
(hsuccess : (teerTxTypeDispatch (txSlice bs off len)).1 = (0 : Word))
      ...
      (fun h => ∃ next lenK : Word,
        ((.x2 ↦ᵣ spC) **
          ...
          ⌜rlpItemDecode bs srcOffA7 (regionBase + BitVec.ofNat 64 srcOffA7)
            endL next lenK⌝) h) := by
  intro s innerVal listLen endL endW cursorV
  have h0 := teerAuthWalkNext7_applied_nested_is ret spVal spC loadPtr lenW
    balPtr balLenW chainIdW baiW s0 s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11
    regionBase bs balBytes off len hspC hnez hptr hlenW hsuccess htype4
    halign hbound hover hvalid0 listOff ha0 hoffL hoverL hvalidL hlenL
    h_ge h_hi h_exact srcOff0 hcur0 hoff0 hover0 hvalid0I hss0 hls0 hll0 hdec0 hinb0
  ...
  exact cpsTripleWithin_weaken (fun _ hp => hp)
    (fun h hq => by
      unfold teerAuthWalkNext7PostNestedIs teerAuthWalkNextSkipBodyPost
...
#print axioms teerAuthWalkNext7CycleOk_ownTemps
#print axioms teerAuthWalkNext7_applied_nested_is
#print axioms teerAuthWalkNext7_applied


#print axioms teerAuthWalkNext7_applied_nested_is
#print axioms teerAuthWalkNext7_applied_is
