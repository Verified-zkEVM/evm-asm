...
def blockValidateWithdrawalsRootIndexed_prog : Program :=
  [ .ADDI .x2 .x2 (-48 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.block_validate_withdrawals_root_indexed + 176) (GuestAddrs.block_validate_withdrawals_root_indexed + 60)),
    .MV .x10 .x18,
    .MV .x11 .x19,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.block_validate_withdrawals_root_indexed + 184) (GuestAddrs.block_validate_withdrawals_root_indexed + 84)),
