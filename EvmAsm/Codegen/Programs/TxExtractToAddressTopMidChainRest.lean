/-
  Mid-chain extension: type234 wn1→wn5 steps + AfterSave→wn5 under midOwned.
-/
...
/-- AfterWalkNext1Bne → AfterWalkNext2Bne under midOwned. -/
theorem extractWalkNext1to2Ok_owned
  ...
  extractWalkNext2PrepCallOk_owned spC s txBase lenW typeW innerW endPtr
    next1 len1 toBuf isCreationPtr s7 txBytes srcOff1 srcOff2
    hnext hsalign hoff hover hvalid hss hls hll hok1

set_option maxRecDepth 8000 in
/-- AfterWalkNext2Bne → AfterWalkNext3Bne under midOwned. -/
theorem extractWalkNext2to3Ok_owned
    (spC : Word) (s : ExtractSaved)
    ...
    cpsTripleWithin (((1 + (1 + 1)) + (1 + 87)) + 1)
      ...
      (fun h => ∃ next3 len3 : Word,
        (wn3OkConcrete txBase lenW typeW innerW endPtr next3 len3
          txBytes srcOff3 **
          midOwned spC s toBuf isCreationPtr s7) h) :=
  extractWalkNext3PrepCallOk_owned spC s txBase lenW typeW innerW endPtr
    next2 len2 toBuf isCreationPtr s7 txBytes srcOff2 srcOff3
    hnext hsalign hoff hover hvalid hss hls hll hok1

set_option maxRecDepth 8000 in
/-- AfterWalkNext3Bne → AfterWalkNext4Bne under midOwned. -/
theorem extractWalkNext3to4Ok_owned
    (spC : Word) (s : ExtractSaved)
    ...
    cpsTripleWithin (((1 + (1 + 1)) + (1 + 87)) + 1)
      ...
      (fun h => ∃ next4 len4 : Word,
        (wn4OkConcrete txBase lenW typeW innerW endPtr next4 len4
          txBytes srcOff4 **
          midOwned spC s toBuf isCreationPtr s7) h) :=
  extractWalkNext4PrepCallOk_owned spC s txBase lenW typeW innerW endPtr
    next3 len3 toBuf isCreationPtr s7 txBytes srcOff3 srcOff4
    hnext hsalign hoff hover hvalid hss hls hll hok1

set_option maxRecDepth 8000 in
/-- AfterWalkNext4Bne → AfterWalkNext5Bne under midOwned. -/
theorem extractWalkNext4to5Ok_owned
    (spC : Word) (s : ExtractSaved)
    ...
    cpsTripleWithin (((1 + (1 + 1)) + (1 + 87)) + 1)
      ...
      (fun h => ∃ next5 len5 : Word,
        (wn5OkConcrete txBase lenW typeW innerW endPtr next5 len5
          txBytes srcOff5 **
          midOwned spC s toBuf isCreationPtr s7) h) :=
  extractWalkNext5PrepCallOk_owned spC s txBase lenW typeW innerW endPtr
    next4 len4 toBuf isCreationPtr s7 txBytes srcOff4 srcOff5
    hnext hsalign hoff hover hvalid hss hls hll hok1

set_option maxRecDepth 8000 in
/-- type234 AfterSave → AfterWalkNext5Bne under midOwned.
    Nested exists + pure cursor identities after each walk (honesty residual). -/
theorem extractType234ToWn5Ok_owned
    (spC : Word) (s : ExtractSaved)
  ...
  have h2 :
    ...
    exact extractWalkNext1to2Ok_owned spC s txBase lenW typeW innerW endPtr
      next1 len1 toBuf isCreationPtr s7 txBytes srcOff1 srcOff2
      (hnext2 next1 len1) hsalign hoff2 hover2 hvalid2 hss2 hls2 hll2 hok2
  -- leg 2→3
  have h3 :
      cpsTripleWithin (((1 + (1 + 1)) + (1 + 87)) + 1)
        AfterWalkNext2Bne AfterWalkNext3Bne extractLinkedCode
    ...
    exact extractWalkNext2to3Ok_owned spC s txBase lenW typeW innerW endPtr
      next2 len2 toBuf isCreationPtr s7 txBytes srcOff2 srcOff3
      (hnext3 next2 len2) hsalign hoff3 hover3 hvalid3 hss3 hls3 hll3 hok3
  -- leg 3→4
  have h4 :
      cpsTripleWithin (((1 + (1 + 1)) + (1 + 87)) + 1)
        AfterWalkNext3Bne AfterWalkNext4Bne extractLinkedCode
    ...
    exact extractWalkNext3to4Ok_owned spC s txBase lenW typeW innerW endPtr
      next3 len3 toBuf isCreationPtr s7 txBytes srcOff3 srcOff4
      (hnext4 next3 len3) hsalign hoff4 hover4 hvalid4 hss4 hls4 hll4 hok4
  -- leg 4→5
  have h5 :
      cpsTripleWithin (((1 + (1 + 1)) + (1 + 87)) + 1)
        AfterWalkNext4Bne AfterWalkNext5Bne extractLinkedCode
    ...
    exact extractWalkNext4to5Ok_owned spC s txBase lenW typeW innerW endPtr
      next4 len4 toBuf isCreationPtr s7 txBytes srcOff4 srcOff5
      (hnext5 next4 len4) hsalign hoff5 hover5 hvalid5 hss5 hls5 hll5 hok5
...
#print axioms extractWalkNext1to2Ok_owned
#print axioms extractWalkNext2to3Ok_owned
#print axioms extractWalkNext3to4Ok_owned
#print axioms extractWalkNext4to5Ok_owned
#print axioms extractType234ToWn5Ok_owned
