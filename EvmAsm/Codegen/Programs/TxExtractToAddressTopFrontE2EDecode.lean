/-
  Front E → AfterSave → type234 creation → ret of_decode (no universal hok).
-/
...
/-- E → ret type234 creation of_decode. Residuals: hdrop/hnext/hcre + hdec/hinb. -/
theorem extractFrontCreation_then_epi_of_decode
...
#print axioms extractFrontCreation_then_epi_of_decode
