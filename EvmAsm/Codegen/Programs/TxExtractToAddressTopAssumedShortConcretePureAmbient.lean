/-
  Wire pure honesty into ambient short concrete Assumed creation.
...
theorem extractAssumed_creation_shortConcrete_pure_ambient
  ...
  have hfields04 :=
    extractSuccess_creation_type234_hnext_fields04 slice hsuccess hcreFlag hge
      items hdecL hshort
  ...
  have hhnext :=
    extractSuccess_creation_type234_hnext_hcre_srcOff slice loadPtr hsuccess
  ...
  have hcre : ∀ (next5 len5 : Word),
    ...
    simpa [absOff5, srcOff5, listOff, endW, absListOff] using
      hcre_ambient_of_slice regionBase loadPtr bs off len listOff items 5 endW
  ...
  exact extractAssumed_creation_under_honesty_of_decode_short_concrete_ambient
...
set_option maxRecDepth 8000 in
theorem extractAssumed_creation_shortConcrete_pure_ambient_fullCode
    (sp0 spC : Word) (s : ExtractSaved)
    (regionBase loadPtr lenW toBuf isCreationPtr : Word)
    (bs : List (BitVec 8)) (off len : Nat)
    (items : List EL.RLP.RLPItem)
  ...
  cpsTripleWithin_extend_code extractLinked_mono
    (extractAssumed_creation_shortConcrete_pure_ambient sp0 spC s
...
#print axioms extractAssumed_creation_shortConcrete_pure_ambient
#print axioms extractAssumed_creation_shortConcrete_pure_ambient_fullCode
