/-
  Front short AfterSave → 20B copy of_decode with concrete endPtr (no ∀endPtr).
-/
...
theorem extractFrontAfterSaveCopy_then_epi_of_decode_short
    ...
    cpsTripleWithin
      ...
      (frontAfterSavePostShort spC s txBase lenW toBuf isCreationPtr txBytes **
  ...
  have hMid := extractType234AfterSaveCopy_then_epi_of_decode sp0 spC s
    txBase lenW
  ...
  exact cpsTripleWithin_weaken
    (fun h hp => by
      ...
      have hM := frontAfterSavePostShort_to_midJoinPre spC s txBase lenW
...
#print axioms extractFrontAfterSaveCopy_then_epi_of_decode_short
