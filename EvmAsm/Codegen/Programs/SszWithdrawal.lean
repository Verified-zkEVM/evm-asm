...
def bvSumWithdrawalsToAddress_prog : Program :=
  [ .ADDI .x2 .x2 (-48 : BitVec 12),
    ...
    .LI .x20 (0 : Word),
    .BEQ .x20 .x18 (brOff (GuestAddrs.bv_sum_withdrawals_to_address + 248) (GuestAddrs.bv_sum_withdrawals_to_address + 64)),
    .LI .x5 (44 : Word),
    .MUL .x5 .x20 .x5,
    .ADD .x6 .x9 .x5,
    ...
    .BNE .x30 .x31 (brOff (GuestAddrs.bv_sum_withdrawals_to_address + 240) (GuestAddrs.bv_sum_withdrawals_to_address + 104)),
    .ADDI .x7 .x7 (1 : BitVec 12),
    .ADDI .x28 .x28 (1 : BitVec 12),
    .ADDI .x29 .x29 (-1 : BitVec 12),
    .JAL .x0 (-28 : BitVec 21),
    ...
    .JAL .x0 (jalOff (GuestAddrs.bv_sum_withdrawals_to_address + 64) (GuestAddrs.bv_sum_withdrawals_to_address + 244)),
    .LI .x10 (0 : Word),
    .JAL .x0 (8 : BitVec 21),
    .LI .x10 (1 : Word),
    .LD .x1 .x2 (0 : BitVec 12),
