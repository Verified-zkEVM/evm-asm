/-
  Ambient dual: Front long AfterSave → legacy creation of_decode (typeW=0).
-/
...
theorem extractFrontAfterSaveCreation_then_epi_of_decode_long_legacy_ambient
  ...
  have hMid := extractLegacyAfterSaveCreation_then_epi_of_decode_ambient sp0 spC s
...
#print axioms extractFrontAfterSaveCreation_then_epi_of_decode_long_legacy_ambient
