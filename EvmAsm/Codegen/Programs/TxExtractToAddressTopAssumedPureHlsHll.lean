/-
  Assumed creation: discharge vacuous hls/hll under short-list encode.
-/
...
/-- Assumed creation shortListSrcOff with pure hoff/hover and vacuous hls/hll. -/
theorem extractAssumed_creation_shortListSrcOff_pureHlsHll
  ...
  -- Instantiate vacuous hls/hll at argument sites so `P` is the fit post.
  exact extractAssumed_creation_shortListSrcOff_pureOff
    ...
    (hls_vacuous_of_short_list_item txBytes
      ...
      hencInner hshort hn1
      (extractSuccess_creation_type234_hoff_srcOff txBytes hsuccess hcreFlag hge
        items hdecL hshort).2.1)
    (hll_vacuous_of_short_list_item txBytes
      (teerTxTypeDispatch txBytes).2.2.toNat items 1
      hencInner hshort hn1
      (extractSuccess_creation_type234_hoff_srcOff txBytes hsuccess hcreFlag hge
    ...
    (hls_vacuous_of_short_list_item txBytes
      ...
      hencInner hshort hn2
      (extractSuccess_creation_type234_hoff_srcOff txBytes hsuccess hcreFlag hge
        items hdecL hshort).2.2.1)
    (hll_vacuous_of_short_list_item txBytes
      (teerTxTypeDispatch txBytes).2.2.toNat items 2
      hencInner hshort hn2
      (extractSuccess_creation_type234_hoff_srcOff txBytes hsuccess hcreFlag hge
    ...
    (hls_vacuous_of_short_list_item txBytes
      ...
      hencInner hshort hn3
      (extractSuccess_creation_type234_hoff_srcOff txBytes hsuccess hcreFlag hge
        items hdecL hshort).2.2.2.1)
    (hll_vacuous_of_short_list_item txBytes
      (teerTxTypeDispatch txBytes).2.2.toNat items 3
      hencInner hshort hn3
      (extractSuccess_creation_type234_hoff_srcOff txBytes hsuccess hcreFlag hge
    ...
    (hls_vacuous_of_short_list_item txBytes
      ...
      hencInner hshort hn4
      (extractSuccess_creation_type234_hoff_srcOff txBytes hsuccess hcreFlag hge
        items hdecL hshort).2.2.2.2.1)
    (hll_vacuous_of_short_list_item txBytes
      (teerTxTypeDispatch txBytes).2.2.toNat items 4
      hencInner hshort hn4
      (extractSuccess_creation_type234_hoff_srcOff txBytes hsuccess hcreFlag hge
    ...
    (hls_vacuous_of_short_list_item txBytes
      ...
      hencInner hshort hn5
      (extractSuccess_creation_type234_hoff_srcOff txBytes hsuccess hcreFlag hge
        items hdecL hshort).2.2.2.2.2)
    (hll_vacuous_of_short_list_item txBytes
      (teerTxTypeDispatch txBytes).2.2.toNat items 5
      hencInner hshort hn5
      (extractSuccess_creation_type234_hoff_srcOff txBytes hsuccess hcreFlag hge
...
theorem extractAssumed_creation_shortListSrcOff_pureHlsHll_fullCode
    (sp0 spC : Word) (s : ExtractSaved)
    (txBase lenW toBuf isCreationPtr : Word)
    (txBytes : List (BitVec 8))
    (items : List EL.RLP.RLPItem)
  ...
  exact cpsTripleWithin_extend_code extractLinked_mono
    (extractAssumed_creation_shortListSrcOff_pureHlsHll
      sp0 spC s txBase lenW toBuf isCreationPtr txBytes items
      hspC hret htalign htover htvalid hlen hsuccess hcreFlag hge hdecL hshort
      halign hover hvalidTx0 hoff hinover hinvalid hlistLen_ne h_ge h_hi h_exact
      hcur hne0 hne1
      hvalid0 hss0 hdec0 hinb0
      hvalid1 hss1 hdec1 hinb1
      hvalid2 hss2 hdec2 hinb2
      hvalid3 hss3 hdec3 hinb3
      hvalid4 hss4 hdec4 hinb4
      hvalid5 hss5 hdec5 hinb5)

#print axioms extractAssumed_creation_shortListSrcOff_pureHlsHll
#print axioms extractAssumed_creation_shortListSrcOff_pureHlsHll_fullCode
