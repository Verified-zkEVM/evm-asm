/-
  Ambient dual: E → ret t1 short creation of_decode.
-/
...
/-- Front short ambient + t1 AfterSave→creation steps. -/
def nFrontCreationStepsShortT1Ambient : Nat :=
...
theorem extractFrontCreation_then_epi_of_decode_short_concrete_t1_ambient
    ...
    cpsTripleWithin nFrontCreationStepsShortT1Ambient
  ...
  have hC := extractFrontAfterSaveCreation_then_epi_of_decode_short_t1_ambient sp0 spC s
...
#print axioms extractFrontCreation_then_epi_of_decode_short_concrete_t1_ambient
