/-
  Front E → AfterSave short concrete → legacy 20B copy → ret bare region.
-/
...
/-- Short-path E2E legacy copy steps: walk_init 15; 4 walks. -/
def nFrontCopyStepsShortLegacyRegion : Nat :=
...
theorem extractFrontCopy_then_epi_of_decode_short_concrete_legacy_region
    ...
    cpsTripleWithin nFrontCopyStepsShortLegacyRegion
  ...
  have hC := extractFrontAfterSaveCopy_then_epi_of_decode_short_legacy_region sp0 spC s
...
#print axioms extractFrontCopy_then_epi_of_decode_short_concrete_legacy_region
