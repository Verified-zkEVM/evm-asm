...
def blskFpPowQ14_prog : Program :=
  [ .ADDI .x2 .x2 (-48 : BitVec 12),
    ...
    .LI .x18 (0 : Word),
    .LI .x5 (48 : Word),
    .BGEU .x18 .x5 (brOff (GuestAddrs.blsk_fp_pow_q14 + 172) (GuestAddrs.blsk_fp_pow_q14 + 68)),
    ...
    .LI .x20 (128 : Word),
    .BEQ .x20 .x0 (brOff (GuestAddrs.blsk_fp_pow_q14 + 164) (GuestAddrs.blsk_fp_pow_q14 + 92)),
    ...
    .JAL .x0 (jalOff (GuestAddrs.blsk_fp_pow_q14 + 92) (GuestAddrs.blsk_fp_pow_q14 + 160)),
    .ADDI .x18 .x18 (1 : BitVec 12),
    .JAL .x0 (jalOff (GuestAddrs.blsk_fp_pow_q14 + 64) (GuestAddrs.blsk_fp_pow_q14 + 168)),
