...
def mptBranchChild_prog : Program :=
  [ .ADDI .x2 .x2 (-48 : BitVec 12),
    ...
    .MV .x19 .x13,
    .LI .x5 (16 : Word),
    .BGEU .x18 .x5 (brOff (GuestAddrs.mpt_branch_child + 260) (GuestAddrs.mpt_branch_child + 44)),
    .MV .x10 .x8,
    .MV .x11 .x9,
    .MV .x12 .x18,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_branch_child + 260) (GuestAddrs.mpt_branch_child + 80)),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .BEQ .x6 .x0 (brOff (GuestAddrs.mpt_branch_child + 164) (GuestAddrs.mpt_branch_child + 96)),
    .LI .x5 (32 : Word),
    .BNE .x6 .x5 (brOff (GuestAddrs.mpt_branch_child + 188) (GuestAddrs.mpt_branch_child + 104)),
    ...
    .LI .x10 (0 : Word),
    .JAL .x0 (jalOff (GuestAddrs.mpt_branch_child + 280) (GuestAddrs.mpt_branch_child + 160)),
    .SD .x19 .x0 (0 : BitVec 12),
    .SD .x19 .x0 (8 : BitVec 12),
    .SD .x19 .x0 (16 : BitVec 12),
    .SD .x19 .x0 (24 : BitVec 12),
    .LI .x10 (1 : Word),
    .JAL .x0 (jalOff (GuestAddrs.mpt_branch_child + 280) (GuestAddrs.mpt_branch_child + 184)),
    .SD .x19 .x0 (0 : BitVec 12),
    .SD .x19 .x0 (8 : BitVec 12),
    .SD .x19 .x0 (16 : BitVec 12),
    .SD .x19 .x0 (24 : BitVec 12),
...
def hpDecodeNibbles_prog : Program :=
  [ .ADDI .x2 .x2 (-48 : BitVec 12),
    ...
    .MV .x19 .x13,
    .MV .x20 .x14,
    .BEQ .x9 .x0 (brOff (GuestAddrs.hp_decode_nibbles + 168) (GuestAddrs.hp_decode_nibbles + 48)),
...
/-! ## mpt_walk -- PR-K24 end-to-end MPT lookup
    ...
    Calling convention:
      ...
      a0 (output) : walk status — see `MptStatusVocab.Walk`
                    (0 found / 1 absent / 2 parse / 3 unresolved HashedNode)
...
def mptWalk_prog : Program :=
  [ .ADDI .x2 .x2 (-80 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_walk + 1212) (GuestAddrs.mpt_walk + 408)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_walk + 1212) (GuestAddrs.mpt_walk + 844)),
...
/-- Lossy probe wrapper: `mpt_walk`, then remap Walk.unresolved(3) → Walk.absent(1).
    ...
    `mpt_walk` and reject on unresolved. See `MptStatusVocab.probeRemap`. -/
def mptWalkProbeFunction : String :=
  "mpt_walk_probe:\n" ++
  "  addi sp, sp, -16\n" ++
  "  sd ra, 0(sp)\n" ++
  "  jal ra, mpt_walk\n" ++
  "  # STATUS_VOCAB: probe-remap — unresolved HashedNode → clean absent\n" ++
  "  li t0, 3\n" ++
  "  bne a0, t0, .Lmwp_ret\n" ++
  "  li a0, 1\n" ++
  ".Lmwp_ret:\n" ++
...
#guard mptWalkProbeFunction.startsWith "mpt_walk_probe:\n"
#guard (mptWalkProbeFunction.splitOn "STATUS_VOCAB: probe-remap").length == 2
...
/-- `zisk_mpt_walk`: probe BuildUnit. Reads
    ...
    Output layout:
      bytes   0.. 8 : status — see `MptStatusVocab.Walk`
