...
def rlpEncodeU64_prog : Program :=
  [ .BEQ .x10 .x0 (32 : BitVec 13),
    ...
    .LI .x5 (1 : Word),
    .LI .x6 (256 : Word),
    .BLTU .x10 .x6 (brOff (GuestAddrs.rlp_encode_u64 + 144) (GuestAddrs.rlp_encode_u64 + 64)),
    .LI .x5 (2 : Word),
    .SLLI .x6 .x6 (8 : BitVec 6),
    .BLTU .x10 .x6 (brOff (GuestAddrs.rlp_encode_u64 + 144) (GuestAddrs.rlp_encode_u64 + 76)),
    .LI .x5 (3 : Word),
    .SLLI .x6 .x6 (8 : BitVec 6),
