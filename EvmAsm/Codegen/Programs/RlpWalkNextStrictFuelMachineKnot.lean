...
theorem validate_knot_body_under_shared_framed
    ...
    (hbodySub : ∀ a i,
      ...
      wholeCode a = some i)
    (hshared : SharedWalkNextToKnotGoal bytes base floor fuel cursorOff endOff
      sp raVal P nShared)
  ...
  have hshared' :
    ...
    simpa [SharedWalkNextToKnotGoal, bodyP, cursor, endPtr, ambient] using
      hshared
...
#print axioms validate_knot_body_under_shared_framed
