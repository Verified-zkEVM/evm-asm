/-
  Decode-gated PrepCallOk for type234 wn1..4 (honest drop-fail via Outcome).
-/
...
theorem extractWalkNext1Call_type234_a2_outcome
...
set_option maxRecDepth 8000 in
theorem extractWalkNext1Call_owned_a2_outcome
  ...
  have h := extractWalkNext1Call_type234_a2_outcome txBase lenW typeW innerW endPtr a2Old
...
set_option maxRecDepth 8000 in
theorem extractWalkNext1PrepCall_owned_outcome
    (spC : Word) (s : ExtractSaved)
    ...
    cpsTripleWithin ((1 + (1 + 1)) + (1 + 87))
      ...
      (wn1Stable txBase lenW typeW innerW endPtr
        ...
        wn1Common txBase txBytes **
        wn0Outcome txBase endPtr txBytes srcOff1 **
        midOwned spC s toBuf isCreationPtr s7) := by
  ...
  have hPrep2 :
    ...
    refine cpsTripleWithin_weaken (fun _ hp => hp) (fun _ hq => by
      ...
      xperm_hyp hq) hPrep
  have hCall := extractWalkNext1Call_owned_a2_outcome spC s txBase lenW typeW innerW
    endPtr len toBuf isCreationPtr s7 txBytes srcOff1
    hsalign hoff hover hvalid hss hls hll
  exact cpsTripleWithin_seq_same_cr hPrep2 hCall


set_option maxRecDepth 8000 in
theorem extractWalkNext1PrepCallOk_owned_of_decode
    (spC : Word) (s : ExtractSaved)
    (txBase lenW typeW innerW endPtr next len toBuf isCreationPtr s7 : Word)
    (txBytes : List (BitVec 8)) (srcOff0 srcOff1 : Nat)
    (hnext : next = txBase + BitVec.ofNat 64 srcOff1)
    ...
    (hdec : ∃ next1 len1 : Word,
      rlpItemDecode txBytes srcOff1 (txBase + BitVec.ofNat 64 srcOff1)
        endPtr next1 len1)
    (hinb : BitVec.ult (txBase + BitVec.ofNat 64 srcOff1) endPtr = true) :
  ...
  have hPC := extractWalkNext1PrepCall_owned_outcome spC s txBase lenW typeW innerW
    endPtr next len toBuf isCreationPtr s7 txBytes srcOff0 srcOff1
  ...
  have hPC2 :
    ...
    refine cpsTripleWithin_weaken (fun _ hp => hp) (fun h hq => by
      ...
      have hOk := wn0Outcome_drop_fail_of_decode txBase endPtr txBytes srcOff1
        hdec hinb h5 hOut
...
set_option maxRecDepth 8000 in
theorem extractWalkNext2Call_type234_a2_outcome
    (txBase lenW typeW innerW endPtr a2Old : Word)
    (txBytes : List (BitVec 8)) (srcOff : Nat)
    (hsalign : txBase.toNat % 8 = 0)
    (hoff : srcOff < txBytes.length)
...
set_option maxRecDepth 8000 in
theorem extractWalkNext2Call_owned_a2_outcome
    (spC : Word) (s : ExtractSaved)
    (txBase lenW typeW innerW endPtr a2Old toBuf isCreationPtr s7 : Word)
    (txBytes : List (BitVec 8)) (srcOff : Nat)
    (hsalign : txBase.toNat % 8 = 0)
    ...
    cpsTripleWithin (1 + 87) WalkNext2JalPc LinkWalkNext2 extractLinkedCode
      ...
      (wn2Stable txBase lenW typeW innerW endPtr
        ...
        wn0Outcome txBase endPtr txBytes srcOff **
        midOwned spC s toBuf isCreationPtr s7) := by
  have h := extractWalkNext2Call_type234_a2_outcome txBase lenW typeW innerW endPtr a2Old
    txBytes srcOff hsalign hoff hover hvalid hss hls hll
  have hF := cpsTripleWithin_frameR
    (midOwned spC s toBuf isCreationPtr s7) (midOwned_pcFree _ _ _ _ _) h
  exact cpsTripleWithin_weaken (fun _ hp => by xperm_hyp hp)
...
set_option maxRecDepth 8000 in
theorem extractWalkNext2PrepCall_owned_outcome
    (spC : Word) (s : ExtractSaved)
    (txBase lenW typeW innerW endPtr next len toBuf isCreationPtr s7 : Word)
    ...
    cpsTripleWithin ((1 + (1 + 1)) + (1 + 87))
      ...
      (wn2Stable txBase lenW typeW innerW endPtr
        ...
        wn2Common txBase txBytes **
        wn0Outcome txBase endPtr txBytes srcOff2 **
        midOwned spC s toBuf isCreationPtr s7) := by
  ...
  have hPrep2 :
    ...
    refine cpsTripleWithin_weaken (fun _ hp => hp) (fun _ hq => by
      simp only [hnext] at hq
      xperm_hyp hq) hPrep
  have hCall := extractWalkNext2Call_owned_a2_outcome spC s txBase lenW typeW innerW
    endPtr len toBuf isCreationPtr s7 txBytes srcOff2
    hsalign hoff hover hvalid hss hls hll
  exact cpsTripleWithin_seq_same_cr hPrep2 hCall


set_option maxRecDepth 8000 in
theorem extractWalkNext2PrepCallOk_owned_of_decode
    (spC : Word) (s : ExtractSaved)
    (txBase lenW typeW innerW endPtr next len toBuf isCreationPtr s7 : Word)
    (txBytes : List (BitVec 8)) (srcOff1 srcOff2 : Nat)
    (hnext : next = txBase + BitVec.ofNat 64 srcOff2)
    ...
    (hll : ¬ BitVec.ult ((txBytes[srcOff2]'hoff).zeroExtend 64) (0xf8 : Word) = true →
        ...
        ∀ k, k < ((txBytes[srcOff2]'hoff).zeroExtend 64 - (0xf7 : Word)).toNat →
          isValidByteAccess (txBase + BitVec.ofNat 64 (srcOff2 + 1 + k)) = true)
    (hdec : ∃ next2 len2 : Word,
      rlpItemDecode txBytes srcOff2 (txBase + BitVec.ofNat 64 srcOff2)
        endPtr next2 len2)
    (hinb : BitVec.ult (txBase + BitVec.ofNat 64 srcOff2) endPtr = true) :
    cpsTripleWithin (((1 + (1 + 1)) + (1 + 87)) + 1)
      ...
      (fun h => ∃ next2 len2 : Word,
        (wn2OkConcrete txBase lenW typeW innerW endPtr next2 len2
          txBytes srcOff2 **
          midOwned spC s toBuf isCreationPtr s7) h) := by
  have hPC := extractWalkNext2PrepCall_owned_outcome spC s txBase lenW typeW innerW
    endPtr next len toBuf isCreationPtr s7 txBytes srcOff1 srcOff2
    hnext hsalign hoff hover hvalid hss hls hll
  have hPC2 :
      cpsTripleWithin ((1 + (1 + 1)) + (1 + 87))
        AfterWalkNext1Bne LinkWalkNext2 extractLinkedCode
    ...
    refine cpsTripleWithin_weaken (fun _ hp => hp) (fun h hq => by
      ...
      obtain ⟨h3, h4, hd2, hu2, hC, hCD⟩ := hBCD
      obtain ⟨h5, h6, hd3, hu3, hOut, hM⟩ := hCD
      have hOk := wn0Outcome_drop_fail_of_decode txBase endPtr txBytes srcOff2
        hdec hinb h5 hOut
      exact ⟨h1, h2, hd1, hu1, hS, h3, h4, hd2, hu2, hC,
        h5, h6, hd3, hu3, hOk, hM⟩) hPC
...
set_option maxRecDepth 8000 in
theorem extractWalkNext3Call_type234_a2_outcome
    (txBase lenW typeW innerW endPtr a2Old : Word)
    (txBytes : List (BitVec 8)) (srcOff : Nat)
    (hsalign : txBase.toNat % 8 = 0)
    (hoff : srcOff < txBytes.length)
...
set_option maxRecDepth 8000 in
theorem extractWalkNext3Call_owned_a2_outcome
    (spC : Word) (s : ExtractSaved)
    (txBase lenW typeW innerW endPtr a2Old toBuf isCreationPtr s7 : Word)
    (txBytes : List (BitVec 8)) (srcOff : Nat)
    (hsalign : txBase.toNat % 8 = 0)
    ...
    cpsTripleWithin (1 + 87) WalkNext3JalPc LinkWalkNext3 extractLinkedCode
      ...
      (wn3Stable txBase lenW typeW innerW endPtr
        ...
        wn0Outcome txBase endPtr txBytes srcOff **
        midOwned spC s toBuf isCreationPtr s7) := by
  have h := extractWalkNext3Call_type234_a2_outcome txBase lenW typeW innerW endPtr a2Old
    txBytes srcOff hsalign hoff hover hvalid hss hls hll
  have hF := cpsTripleWithin_frameR
    (midOwned spC s toBuf isCreationPtr s7) (midOwned_pcFree _ _ _ _ _) h
  exact cpsTripleWithin_weaken (fun _ hp => by xperm_hyp hp)
...
set_option maxRecDepth 8000 in
theorem extractWalkNext3PrepCall_owned_outcome
    (spC : Word) (s : ExtractSaved)
    (txBase lenW typeW innerW endPtr next len toBuf isCreationPtr s7 : Word)
    ...
    cpsTripleWithin ((1 + (1 + 1)) + (1 + 87))
      ...
      (wn3Stable txBase lenW typeW innerW endPtr
        ...
        wn3Common txBase txBytes **
        wn0Outcome txBase endPtr txBytes srcOff3 **
        midOwned spC s toBuf isCreationPtr s7) := by
  ...
  have hPrep2 :
    ...
    refine cpsTripleWithin_weaken (fun _ hp => hp) (fun _ hq => by
      simp only [hnext] at hq
      xperm_hyp hq) hPrep
  have hCall := extractWalkNext3Call_owned_a2_outcome spC s txBase lenW typeW innerW
    endPtr len toBuf isCreationPtr s7 txBytes srcOff3
    hsalign hoff hover hvalid hss hls hll
  exact cpsTripleWithin_seq_same_cr hPrep2 hCall


set_option maxRecDepth 8000 in
theorem extractWalkNext3PrepCallOk_owned_of_decode
    (spC : Word) (s : ExtractSaved)
    (txBase lenW typeW innerW endPtr next len toBuf isCreationPtr s7 : Word)
    (txBytes : List (BitVec 8)) (srcOff2 srcOff3 : Nat)
    (hnext : next = txBase + BitVec.ofNat 64 srcOff3)
    ...
    (hll : ¬ BitVec.ult ((txBytes[srcOff3]'hoff).zeroExtend 64) (0xf8 : Word) = true →
        ...
        ∀ k, k < ((txBytes[srcOff3]'hoff).zeroExtend 64 - (0xf7 : Word)).toNat →
          isValidByteAccess (txBase + BitVec.ofNat 64 (srcOff3 + 1 + k)) = true)
    (hdec : ∃ next3 len3 : Word,
      rlpItemDecode txBytes srcOff3 (txBase + BitVec.ofNat 64 srcOff3)
        endPtr next3 len3)
    (hinb : BitVec.ult (txBase + BitVec.ofNat 64 srcOff3) endPtr = true) :
    cpsTripleWithin (((1 + (1 + 1)) + (1 + 87)) + 1)
      ...
      (fun h => ∃ next3 len3 : Word,
        (wn3OkConcrete txBase lenW typeW innerW endPtr next3 len3
          txBytes srcOff3 **
          midOwned spC s toBuf isCreationPtr s7) h) := by
  have hPC := extractWalkNext3PrepCall_owned_outcome spC s txBase lenW typeW innerW
    endPtr next len toBuf isCreationPtr s7 txBytes srcOff2 srcOff3
    hnext hsalign hoff hover hvalid hss hls hll
  have hPC2 :
      cpsTripleWithin ((1 + (1 + 1)) + (1 + 87))
        AfterWalkNext2Bne LinkWalkNext3 extractLinkedCode
    ...
    refine cpsTripleWithin_weaken (fun _ hp => hp) (fun h hq => by
      ...
      obtain ⟨h3, h4, hd2, hu2, hC, hCD⟩ := hBCD
      obtain ⟨h5, h6, hd3, hu3, hOut, hM⟩ := hCD
      have hOk := wn0Outcome_drop_fail_of_decode txBase endPtr txBytes srcOff3
        hdec hinb h5 hOut
      exact ⟨h1, h2, hd1, hu1, hS, h3, h4, hd2, hu2, hC,
        h5, h6, hd3, hu3, hOk, hM⟩) hPC
...
set_option maxRecDepth 8000 in
theorem extractWalkNext4Call_type234_a2_outcome
    (txBase lenW typeW innerW endPtr a2Old : Word)
    (txBytes : List (BitVec 8)) (srcOff : Nat)
    (hsalign : txBase.toNat % 8 = 0)
    (hoff : srcOff < txBytes.length)
...
set_option maxRecDepth 8000 in
theorem extractWalkNext4Call_owned_a2_outcome
    (spC : Word) (s : ExtractSaved)
    (txBase lenW typeW innerW endPtr a2Old toBuf isCreationPtr s7 : Word)
    (txBytes : List (BitVec 8)) (srcOff : Nat)
    (hsalign : txBase.toNat % 8 = 0)
    ...
    cpsTripleWithin (1 + 87) WalkNext4JalPc LinkWalkNext4 extractLinkedCode
      ...
      (wn4Stable txBase lenW typeW innerW endPtr
        ...
        wn0Outcome txBase endPtr txBytes srcOff **
        midOwned spC s toBuf isCreationPtr s7) := by
  have h := extractWalkNext4Call_type234_a2_outcome txBase lenW typeW innerW endPtr a2Old
    txBytes srcOff hsalign hoff hover hvalid hss hls hll
  have hF := cpsTripleWithin_frameR
    (midOwned spC s toBuf isCreationPtr s7) (midOwned_pcFree _ _ _ _ _) h
  exact cpsTripleWithin_weaken (fun _ hp => by xperm_hyp hp)
...
set_option maxRecDepth 8000 in
theorem extractWalkNext4PrepCall_owned_outcome
    (spC : Word) (s : ExtractSaved)
    (txBase lenW typeW innerW endPtr next len toBuf isCreationPtr s7 : Word)
    ...
    cpsTripleWithin ((1 + (1 + 1)) + (1 + 87))
      ...
      (wn4Stable txBase lenW typeW innerW endPtr
        ...
        wn4Common txBase txBytes **
        wn0Outcome txBase endPtr txBytes srcOff4 **
        midOwned spC s toBuf isCreationPtr s7) := by
  ...
  have hPrep2 :
    ...
    refine cpsTripleWithin_weaken (fun _ hp => hp) (fun _ hq => by
      simp only [hnext] at hq
      xperm_hyp hq) hPrep
  have hCall := extractWalkNext4Call_owned_a2_outcome spC s txBase lenW typeW innerW
    endPtr len toBuf isCreationPtr s7 txBytes srcOff4
    hsalign hoff hover hvalid hss hls hll
  exact cpsTripleWithin_seq_same_cr hPrep2 hCall


set_option maxRecDepth 8000 in
theorem extractWalkNext4PrepCallOk_owned_of_decode
    (spC : Word) (s : ExtractSaved)
    (txBase lenW typeW innerW endPtr next len toBuf isCreationPtr s7 : Word)
    (txBytes : List (BitVec 8)) (srcOff3 srcOff4 : Nat)
    (hnext : next = txBase + BitVec.ofNat 64 srcOff4)
    ...
    (hll : ¬ BitVec.ult ((txBytes[srcOff4]'hoff).zeroExtend 64) (0xf8 : Word) = true →
        ...
        ∀ k, k < ((txBytes[srcOff4]'hoff).zeroExtend 64 - (0xf7 : Word)).toNat →
          isValidByteAccess (txBase + BitVec.ofNat 64 (srcOff4 + 1 + k)) = true)
    (hdec : ∃ next4 len4 : Word,
      rlpItemDecode txBytes srcOff4 (txBase + BitVec.ofNat 64 srcOff4)
        endPtr next4 len4)
    (hinb : BitVec.ult (txBase + BitVec.ofNat 64 srcOff4) endPtr = true) :
    cpsTripleWithin (((1 + (1 + 1)) + (1 + 87)) + 1)
      ...
      (fun h => ∃ next4 len4 : Word,
        (wn4OkConcrete txBase lenW typeW innerW endPtr next4 len4
          txBytes srcOff4 **
          midOwned spC s toBuf isCreationPtr s7) h) := by
  have hPC := extractWalkNext4PrepCall_owned_outcome spC s txBase lenW typeW innerW
    endPtr next len toBuf isCreationPtr s7 txBytes srcOff3 srcOff4
    hnext hsalign hoff hover hvalid hss hls hll
  have hPC2 :
      cpsTripleWithin ((1 + (1 + 1)) + (1 + 87))
        AfterWalkNext3Bne LinkWalkNext4 extractLinkedCode
    ...
    refine cpsTripleWithin_weaken (fun _ hp => hp) (fun h hq => by
      ...
      obtain ⟨h3, h4, hd2, hu2, hC, hCD⟩ := hBCD
      obtain ⟨h5, h6, hd3, hu3, hOut, hM⟩ := hCD
      have hOk := wn0Outcome_drop_fail_of_decode txBase endPtr txBytes srcOff4
        hdec hinb h5 hOut
      exact ⟨h1, h2, hd1, hu1, hS, h3, h4, hd2, hu2, hC,
        h5, h6, hd3, hu3, hOk, hM⟩) hPC
...
#print axioms extractWalkNext1PrepCallOk_owned_of_decode
#print axioms extractWalkNext2PrepCallOk_owned_of_decode
#print axioms extractWalkNext3PrepCallOk_owned_of_decode
#print axioms extractWalkNext4PrepCallOk_owned_of_decode
