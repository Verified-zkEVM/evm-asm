...
theorem arena_pair (v : Nat × Nat) :
    bytesRegion arenaB (pairBytes 4 v)
      = (bytesRegion (0xa3c055c8 : Word) (leBytes32 v.1)
        ** bytesRegion (0xa3c055e8 : Word) (leBytes32 v.2)) := by
  ...
  rw [bytesRegion_append _ _ _ ⟨4, by rw [length_leBytes32]⟩, length_leBytes32,
    show arenaB + BitVec.ofNat 64 32 = (0xa3c055e8 : Word) from by decide,
    show arenaB = (0xa3c055c8 : Word) from by decide]
