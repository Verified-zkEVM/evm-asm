/-
  Ambient dual: E → ret type234 short 20B copy bare region of_decode.
-/
...
/-- Ambient short E2E copy steps (walk_init 15; same as slice short copy region). -/
def nFrontCopyStepsShortRegionAmbient : Nat :=
...
theorem extractFrontCopy_then_epi_of_decode_short_concrete_region_ambient
    ...
    cpsTripleWithin nFrontCopyStepsShortRegionAmbient
  ...
  have hC := extractFrontAfterSaveCopy_then_epi_of_decode_short_region_ambient sp0 spC s
...
#print axioms extractFrontCopy_then_epi_of_decode_short_concrete_region_ambient
