/-
  Ambient typed-tx paths for multi-tx Option A (type 1..4).
  LBU via loadPtr=regionBase+off over full ambient bytesRegion.
-/
...
theorem txTypeDispatch_type1_ambient
    (raIn regionBase loadPtr typePtr innerPtr oldT oldI v5 v6 : Word)
    (bs : List (BitVec 8)) (off len : Nat) (rest : List (BitVec 8))
    (hret : (raIn &&& ~~~(1 : Word)) = raIn)
    (hptr : loadPtr = regionBase + BitVec.ofNat 64 off)
    (hslice : txSlice bs off len = (1 : BitVec 8) :: rest)
  ...
  have hlen_pos : 0 < len := by
    ...
    omega
  have hlen_ne : BitVec.ofNat 64 len ≠ (0 : Word) :=
  ...
  have hbyte : bs[off]'hoff = (1 : BitVec 8) := by
  ...
  have hlbu0' : cpsTripleWithin 1 (D + 4) (D + 8)
      ...
      ((.x10 ↦ᵣ loadPtr) ** (.x5 ↦ᵣ ((1 : BitVec 8).zeroExtend 64)) **
  ...
  have htk5F :=
    cpsTripleWithin_frameR
      ...
      (by pcf) htk5
  have hret1 :=
    type1OkRet_spec raIn regionBase typePtr innerPtr oldT oldI
      loadPtr (BitVec.ofNat 64 len)
      ((1 : BitVec 8).zeroExtend 64) (1 : Word) bs hret
...
set_option maxRecDepth 8000 in
theorem txTypeDispatch_type2_ambient
    (raIn regionBase loadPtr typePtr innerPtr oldT oldI v5 v6 : Word)
    (bs : List (BitVec 8)) (off len : Nat) (rest : List (BitVec 8))
    (hret : (raIn &&& ~~~(1 : Word)) = raIn)
    (hptr : loadPtr = regionBase + BitVec.ofNat 64 off)
    (hslice : txSlice bs off len = (2 : BitVec 8) :: rest)
    (halign : regionBase.toNat % 8 = 0)
    (hlen_bound : off + len ≤ bs.length)
    (hover : regionBase.toNat + bs.length < 2 ^ 64)
    (hvalid : isValidByteAccess (regionBase + BitVec.ofNat 64 off) = true) :
  ...
  have hlbu0 := type_dispatch_lbu_ambient .x5 .x10 regionBase loadPtr v5 (D + 4)
    bs off (by decide) hptr halign hoff hover_off hvalid
  have hbyte : bs[off]'hoff = (2 : BitVec 8) := by
    have h0 := txSlice_getElem_zero bs off len hlen_pos hlen_bound
    simpa [hslice, List.getElem_cons_zero] using h0.symm
  have hlbu0' : cpsTripleWithin 1 (D + 4) (D + 8)
      (CodeReq.singleton (D + 4) (.LBU .x5 .x10 (0 : BitVec 12)))
      ((.x10 ↦ᵣ loadPtr) ** (.x5 ↦ᵣ v5) ** bytesRegion regionBase bs)
      ((.x10 ↦ᵣ loadPtr) ** (.x5 ↦ᵣ ((2 : BitVec 8).zeroExtend 64)) **
        bytesRegion regionBase bs) := by
    have hpc : (D + 4) + 4 = D + 8 := by
      simp only [D, GuestAddrs.tx_type_dispatch]; decide
    rw [← hpc]
  ...
  have htk7F :=
    cpsTripleWithin_frameR
      ...
      (by pcf) htk7
  have hret2 :=
    type2OkRet_spec raIn regionBase typePtr innerPtr oldT oldI
      loadPtr (BitVec.ofNat 64 len)
      ((2 : BitVec 8).zeroExtend 64) (2 : Word) bs hret
  have c01 := cpsTripleWithin_seq_perm_same_cr (fun _ hp => by xperm_hyp hp) hnt0F hlbuF
  have c02 := cpsTripleWithin_seq_perm_same_cr (fun _ hp => by xperm_hyp hp) c01 hli192F
  have c03 := cpsTripleWithin_seq_perm_same_cr (fun _ hp => by xperm_hyp hp) c02 hnt3F
  have c04 := cpsTripleWithin_seq_perm_same_cr (fun _ hp => by xperm_hyp hp) c03 hli1F
...
set_option maxRecDepth 8000 in
theorem txTypeDispatch_type3_ambient
    (raIn regionBase loadPtr typePtr innerPtr oldT oldI v5 v6 : Word)
    (bs : List (BitVec 8)) (off len : Nat) (rest : List (BitVec 8))
    (hret : (raIn &&& ~~~(1 : Word)) = raIn)
    (hptr : loadPtr = regionBase + BitVec.ofNat 64 off)
    (hslice : txSlice bs off len = (3 : BitVec 8) :: rest)
    (halign : regionBase.toNat % 8 = 0)
    (hlen_bound : off + len ≤ bs.length)
    (hover : regionBase.toNat + bs.length < 2 ^ 64)
    (hvalid : isValidByteAccess (regionBase + BitVec.ofNat 64 off) = true) :
  ...
  have hlbu0 := type_dispatch_lbu_ambient .x5 .x10 regionBase loadPtr v5 (D + 4)
    bs off (by decide) hptr halign hoff hover_off hvalid
  have hbyte : bs[off]'hoff = (3 : BitVec 8) := by
    have h0 := txSlice_getElem_zero bs off len hlen_pos hlen_bound
    simpa [hslice, List.getElem_cons_zero] using h0.symm
  have hlbu0' : cpsTripleWithin 1 (D + 4) (D + 8)
      (CodeReq.singleton (D + 4) (.LBU .x5 .x10 (0 : BitVec 12)))
      ((.x10 ↦ᵣ loadPtr) ** (.x5 ↦ᵣ v5) ** bytesRegion regionBase bs)
      ((.x10 ↦ᵣ loadPtr) ** (.x5 ↦ᵣ ((3 : BitVec 8).zeroExtend 64)) **
        bytesRegion regionBase bs) := by
    have hpc : (D + 4) + 4 = D + 8 := by
      simp only [D, GuestAddrs.tx_type_dispatch]; decide
    rw [← hpc]
  ...
  have htk9F :=
    cpsTripleWithin_frameR
      ...
      (by pcf) htk9
  have hret3 :=
    type3OkRet_spec raIn regionBase typePtr innerPtr oldT oldI
      loadPtr (BitVec.ofNat 64 len)
      ((3 : BitVec 8).zeroExtend 64) (3 : Word) bs hret
  have c01 := cpsTripleWithin_seq_perm_same_cr (fun _ hp => by xperm_hyp hp) hnt0F hlbuF
  have c02 := cpsTripleWithin_seq_perm_same_cr (fun _ hp => by xperm_hyp hp) c01 hli192F
  have c03 := cpsTripleWithin_seq_perm_same_cr (fun _ hp => by xperm_hyp hp) c02 hnt3F
  have c04 := cpsTripleWithin_seq_perm_same_cr (fun _ hp => by xperm_hyp hp) c03 hli1F
...
set_option maxRecDepth 8000 in
theorem txTypeDispatch_type4_ambient
    (raIn regionBase loadPtr typePtr innerPtr oldT oldI v5 v6 : Word)
    (bs : List (BitVec 8)) (off len : Nat) (rest : List (BitVec 8))
    (hret : (raIn &&& ~~~(1 : Word)) = raIn)
    (hptr : loadPtr = regionBase + BitVec.ofNat 64 off)
    (hslice : txSlice bs off len = (4 : BitVec 8) :: rest)
    (halign : regionBase.toNat % 8 = 0)
    (hlen_bound : off + len ≤ bs.length)
    (hover : regionBase.toNat + bs.length < 2 ^ 64)
    (hvalid : isValidByteAccess (regionBase + BitVec.ofNat 64 off) = true) :
  ...
  have hlbu0 := type_dispatch_lbu_ambient .x5 .x10 regionBase loadPtr v5 (D + 4)
    bs off (by decide) hptr halign hoff hover_off hvalid
  have hbyte : bs[off]'hoff = (4 : BitVec 8) := by
    have h0 := txSlice_getElem_zero bs off len hlen_pos hlen_bound
    simpa [hslice, List.getElem_cons_zero] using h0.symm
  have hlbu0' : cpsTripleWithin 1 (D + 4) (D + 8)
      (CodeReq.singleton (D + 4) (.LBU .x5 .x10 (0 : BitVec 12)))
      ((.x10 ↦ᵣ loadPtr) ** (.x5 ↦ᵣ v5) ** bytesRegion regionBase bs)
      ((.x10 ↦ᵣ loadPtr) ** (.x5 ↦ᵣ ((4 : BitVec 8).zeroExtend 64)) **
        bytesRegion regionBase bs) := by
    have hpc : (D + 4) + 4 = D + 8 := by
      simp only [D, GuestAddrs.tx_type_dispatch]; decide
    rw [← hpc]
  ...
  have htk11F :=
    cpsTripleWithin_frameR
      ...
      (by pcf) htk11
  have hret4 :=
    type4OkRet_spec raIn regionBase typePtr innerPtr oldT oldI
      loadPtr (BitVec.ofNat 64 len)
      ((4 : BitVec 8).zeroExtend 64) (4 : Word) bs hret
  have c01 := cpsTripleWithin_seq_perm_same_cr (fun _ hp => by xperm_hyp hp) hnt0F hlbuF
  have c02 := cpsTripleWithin_seq_perm_same_cr (fun _ hp => by xperm_hyp hp) c01 hli192F
  have c03 := cpsTripleWithin_seq_perm_same_cr (fun _ hp => by xperm_hyp hp) c02 hnt3F
  have c04 := cpsTripleWithin_seq_perm_same_cr (fun _ hp => by xperm_hyp hp) c03 hli1F
...
#print axioms txTypeDispatch_type1_ambient
#print axioms txTypeDispatch_type2_ambient
#print axioms txTypeDispatch_type3_ambient
#print axioms txTypeDispatch_type4_ambient
