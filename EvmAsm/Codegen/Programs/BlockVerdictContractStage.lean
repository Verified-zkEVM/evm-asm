...
def stageRuntimePayloadCode_prog : Program :=
  [ .ADDI .x2 .x2 (-72 : BitVec 12),
    ...
    .LI .x10 (1 : Word),
    .JAL .x0 (jalOff (GuestAddrs.stage_runtime_payload_code + 924) (GuestAddrs.stage_runtime_payload_code + 80)),
    ...
    .ADDI .x30 .x30 (1 : BitVec 12),
    .JAL .x0 (-36 : BitVec 21),
    .LD .x28 .x18 (404 : BitVec 12),
    .SD .x21 .x28 (256 : BitVec 12),
    .LD .x28 .x18 (428 : BitVec 12),
    ...
    .ADDI .x30 .x30 (1 : BitVec 12),
    .JAL .x0 (-36 : BitVec 21),
    .LD .x28 .x18 (412 : BitVec 12),
    .SD .x21 .x28 (320 : BitVec 12),
    .ADDI .x28 .x18 (440 : BitVec 12),
    .LD .x29 .x28 (0 : BitVec 12),
    .SD .x21 .x29 (352 : BitVec 12),
    .LD .x29 .x28 (8 : BitVec 12),
    .SD .x21 .x29 (360 : BitVec 12),
    .LD .x29 .x28 (16 : BitVec 12),
    .SD .x21 .x29 (368 : BitVec 12),
    .LD .x29 .x28 (24 : BitVec 12),
    .SD .x21 .x29 (376 : BitVec 12),
    .AUIPC .x28 (laHi GuestAddrs.bv_chain_id (GuestAddrs.stage_runtime_payload_code + 724)),
    .ADDI .x28 .x28 (laLo GuestAddrs.bv_chain_id (GuestAddrs.stage_runtime_payload_code + 724)),
    .LD .x29 .x28 (0 : BitVec 12),
...
#guard stageRuntimePayloadCode_prog.length = 242
