...
def verifyPublicKeysMatchSenders_prog : Program :=
  [ .ADDI .x2 .x2 (-80 : BitVec 12),
    ...
    .LI .x5 (4 : Word),
    .BLTU .x9 .x5 (brOff (GuestAddrs.verify_public_keys_match_senders + 252) (GuestAddrs.verify_public_keys_match_senders + 68)),
    .MV .x10 .x8,
    .JAL .x1 (jalOff GuestAddrs.bgv_u32le (GuestAddrs.verify_public_keys_match_senders + 76)),
    .ANDI .x5 .x10 (3 : BitVec 12),
    .BNE .x5 .x0 (brOff (GuestAddrs.verify_public_keys_match_senders + 260) (GuestAddrs.verify_public_keys_match_senders + 84)),
    .SRLI .x18 .x10 (2 : BitVec 6),
    .BEQ .x18 .x0 (brOff (GuestAddrs.verify_public_keys_match_senders + 252) (GuestAddrs.verify_public_keys_match_senders + 92)),
    ...
    .LI .x21 (0 : Word),
    .BEQ .x21 .x18 (brOff (GuestAddrs.verify_public_keys_match_senders + 252) (GuestAddrs.verify_public_keys_match_senders + 124)),
    ...
    .BLTU .x22 .x5 (brOff (GuestAddrs.verify_public_keys_match_senders + 260) (GuestAddrs.verify_public_keys_match_senders + 180)),
    .BLTU .x23 .x22 (brOff (GuestAddrs.verify_public_keys_match_senders + 260) (GuestAddrs.verify_public_keys_match_senders + 184)),
    .BLTU .x9 .x23 (brOff (GuestAddrs.verify_public_keys_match_senders + 260) (GuestAddrs.verify_public_keys_match_senders + 188)),
    .ADD .x10 .x8 .x22,
    .SUB .x11 .x23 .x22,
    ...
    .JAL .x0 (jalOff (GuestAddrs.verify_public_keys_match_senders + 124) (GuestAddrs.verify_public_keys_match_senders + 248)),
    .LI .x10 (0 : Word),
    .JAL .x0 (8 : BitVec 21),
    .LI .x10 (90 : Word),
...
def blockVerdictChainIdGate_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .LD .x9 .x5 (0 : BitVec 12),
    .LI .x5 (4 : Word),
    .BLTU .x9 .x5 (brOff (GuestAddrs.block_verdict_chain_id_gate + 592) (GuestAddrs.block_verdict_chain_id_gate + 60)),
    .MV .x10 .x8,
    .JAL .x1 (jalOff GuestAddrs.bgv_u32le (GuestAddrs.block_verdict_chain_id_gate + 68)),
    .ANDI .x5 .x10 (3 : BitVec 12),
    .BNE .x5 .x0 (brOff (GuestAddrs.block_verdict_chain_id_gate + 592) (GuestAddrs.block_verdict_chain_id_gate + 76)),
    .SRLI .x18 .x10 (2 : BitVec 6),
    .BEQ .x18 .x0 (brOff (GuestAddrs.block_verdict_chain_id_gate + 592) (GuestAddrs.block_verdict_chain_id_gate + 84)),
    .LI .x19 (0 : Word),
    .BEQ .x19 .x18 (brOff (GuestAddrs.block_verdict_chain_id_gate + 592) (GuestAddrs.block_verdict_chain_id_gate + 92)),
    ...
    .MV .x21 .x9,
    .SLLI .x5 .x18 (2 : BitVec 6),
    .BLTU .x20 .x5 (brOff (GuestAddrs.block_verdict_chain_id_gate + 592) (GuestAddrs.block_verdict_chain_id_gate + 148)),
    .BLTU .x21 .x20 (brOff (GuestAddrs.block_verdict_chain_id_gate + 592) (GuestAddrs.block_verdict_chain_id_gate + 152)),
    .BLTU .x9 .x21 (brOff (GuestAddrs.block_verdict_chain_id_gate + 592) (GuestAddrs.block_verdict_chain_id_gate + 156)),
    .ADD .x10 .x8 .x20,
    .SUB .x11 .x21 .x20,
    .BEQ .x11 .x0 (brOff (GuestAddrs.block_verdict_chain_id_gate + 592) (GuestAddrs.block_verdict_chain_id_gate + 168)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.block_verdict_chain_id_gate + 592) (GuestAddrs.block_verdict_chain_id_gate + 192)),
    ...
    .BNE .x5 .x0 (brOff (GuestAddrs.block_verdict_chain_id_gate + 424) (GuestAddrs.block_verdict_chain_id_gate + 208)),
    .ADD .x10 .x8 .x20,
    .SUB .x11 .x21 .x20,
    .LI .x12 (6 : Word),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.block_verdict_chain_id_gate + 592) (GuestAddrs.block_verdict_chain_id_gate + 244)),
    ...
    .LI .x7 (16 : Word),
    .BLTU .x7 .x6 (brOff (GuestAddrs.block_verdict_chain_id_gate + 600) (GuestAddrs.block_verdict_chain_id_gate + 264)),
    ...
    .LI .x30 (27 : Word),
    .BEQ .x29 .x30 (brOff (GuestAddrs.block_verdict_chain_id_gate + 584) (GuestAddrs.block_verdict_chain_id_gate + 344)),
    .LI .x30 (28 : Word),
    .BEQ .x29 .x30 (brOff (GuestAddrs.block_verdict_chain_id_gate + 584) (GuestAddrs.block_verdict_chain_id_gate + 352)),
    ...
    .BEQ .x29 .x5 (brOff (GuestAddrs.block_verdict_chain_id_gate + 584) (GuestAddrs.block_verdict_chain_id_gate + 392)),
    .ADDI .x6 .x5 (1 : BitVec 12),
    .MV .x7 .x30,
    .BNE .x6 .x0 (8 : BitVec 13),
    .ADDI .x7 .x7 (1 : BitVec 12),
    .BNE .x28 .x7 (brOff (GuestAddrs.block_verdict_chain_id_gate + 600) (GuestAddrs.block_verdict_chain_id_gate + 412)),
    .BNE .x29 .x6 (brOff (GuestAddrs.block_verdict_chain_id_gate + 600) (GuestAddrs.block_verdict_chain_id_gate + 416)),
    .JAL .x0 (jalOff (GuestAddrs.block_verdict_chain_id_gate + 584) (GuestAddrs.block_verdict_chain_id_gate + 420)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.block_verdict_chain_id_gate + 592) (GuestAddrs.block_verdict_chain_id_gate + 476)),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .LI .x7 (8 : Word),
    .BLTU .x7 .x6 (brOff (GuestAddrs.block_verdict_chain_id_gate + 600) (GuestAddrs.block_verdict_chain_id_gate + 496)),
    ...
    .JAL .x0 (jalOff (GuestAddrs.block_verdict_chain_id_gate + 92) (GuestAddrs.block_verdict_chain_id_gate + 588)),
    .LI .x10 (0 : Word),
    .JAL .x0 (8 : BitVec 21),
    .LI .x10 (1 : Word),
    .LD .x1 .x2 (0 : BitVec 12),
