...
def secp256k1PointDouble_prog : Program :=
  [ .ADDI .x2 .x2 (-32 : BitVec 12),
    ...
    .LI .x10 (1 : Word),
    .JAL .x0 (jalOff (GuestAddrs.secp256k1_point_double + 148) (GuestAddrs.secp256k1_point_double + 56)),
    .MV .x10 .x8,
...
def secp256k1ScalarMul_prog : Program :=
  [ .ADDI .x2 .x2 (-72 : BitVec 12),
    ...
    .LI .x20 (0 : Word),
    .LI .x5 (32 : Word),
    .BGEU .x20 .x5 (brOff (GuestAddrs.secp256k1_scalar_mul + 220) (GuestAddrs.secp256k1_scalar_mul + 72)),
    .ADD .x5 .x8 .x20,
    .LBU .x21 .x5 (0 : BitVec 12),
    .LI .x22 (128 : Word),
    .BEQ .x22 .x0 (brOff (GuestAddrs.secp256k1_scalar_mul + 212) (GuestAddrs.secp256k1_scalar_mul + 88)),
    ...
    .AND .x5 .x21 .x22,
    .BEQ .x5 .x0 (brOff (GuestAddrs.secp256k1_scalar_mul + 204) (GuestAddrs.secp256k1_scalar_mul + 136)),
    ...
    .JAL .x0 (jalOff (GuestAddrs.secp256k1_scalar_mul + 88) (GuestAddrs.secp256k1_scalar_mul + 208)),
    .ADDI .x20 .x20 (1 : BitVec 12),
    .JAL .x0 (jalOff (GuestAddrs.secp256k1_scalar_mul + 68) (GuestAddrs.secp256k1_scalar_mul + 216)),
    .MV .x10 .x19,
    .LD .x1 .x2 (0 : BitVec 12),
    .LD .x8 .x2 (8 : BitVec 12),
    .LD .x9 .x2 (16 : BitVec 12),
