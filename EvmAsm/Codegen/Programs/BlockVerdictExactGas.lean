...
def blockVerdictExactGasCheck : String :=
  ...
  -- The gas-result arena's block increments are settlement-gas increments
  -- (`tx.gas - gas_left - state_gas_left`, floor-adjusted). For Amsterdam's
  -- final header check, `block_regular_gas_used` excludes the EIP-8037 state
  -- dimension. Derive the regular component for this exact comparison while
  -- leaving bvgr_receipt_gas_increments untouched; receipts still accumulate
  -- settlement gas and can exceed header.gas_used.
  ...
  "  bltu a0, a1, .Lbv_block_gas_used_over_fail\n" ++
  "  sub a0, a0, a1\n" ++
