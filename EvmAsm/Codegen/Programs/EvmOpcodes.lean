...
def extcodehashAtHeaderStateRoot_prog : Program :=
  [ .ADDI .x2 .x2 (-80 : BitVec 12),
    ...
    .LI .x10 (4 : Word),
    .JAL .x0 (jalOff (GuestAddrs.extcodehash_at_header_state_root + 312) (GuestAddrs.extcodehash_at_header_state_root + 104)),
    .MV .x10 .x18,
    .LI .x11 (20 : Word),
    ...
    .JAL .x0 (jalOff (GuestAddrs.extcodehash_at_header_state_root + 312) (GuestAddrs.extcodehash_at_header_state_root + 160)),
    .LI .x10 (0 : Word),
    .JAL .x0 (jalOff (GuestAddrs.extcodehash_at_header_state_root + 312) (GuestAddrs.extcodehash_at_header_state_root + 168)),
    .LD .x6 .x22 (0 : BitVec 12),
    .BNE .x6 .x0 (brOff (GuestAddrs.extcodehash_at_header_state_root + 276) (GuestAddrs.extcodehash_at_header_state_root + 176)),
    .LD .x6 .x22 (8 : BitVec 12),
    .BNE .x6 .x0 (brOff (GuestAddrs.extcodehash_at_header_state_root + 276) (GuestAddrs.extcodehash_at_header_state_root + 184)),
    .LD .x6 .x22 (16 : BitVec 12),
    .BNE .x6 .x0 (brOff (GuestAddrs.extcodehash_at_header_state_root + 276) (GuestAddrs.extcodehash_at_header_state_root + 192)),
    .LD .x6 .x22 (24 : BitVec 12),
    .BNE .x6 .x0 (brOff (GuestAddrs.extcodehash_at_header_state_root + 276) (GuestAddrs.extcodehash_at_header_state_root + 200)),
    .LD .x6 .x22 (32 : BitVec 12),
    .BNE .x6 .x0 (brOff (GuestAddrs.extcodehash_at_header_state_root + 276) (GuestAddrs.extcodehash_at_header_state_root + 208)),
