/-
  Front E → AfterSave → type234 20B copy → ret of_decode (no universal hok).
-/
...
/-- E → ret type234 20B copy of_decode. Residuals: hdrop/hnext/hlen20 + hdec/hinb. -/
theorem extractFrontCopy_then_epi_of_decode
  ...
  have hC := extractFrontAfterSaveCopy_then_epi_of_decode sp0 spC s
...
#print axioms extractFrontCopy_then_epi_of_decode
