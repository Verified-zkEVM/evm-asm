...
def chainValidateConsecutiveNumbers_prog : Program :=
  [ .ADDI .x2 .x2 (-56 : BitVec 12),
    ...
    .LI .x5 (2 : Word),
    .BLTU .x8 .x5 (brOff (ChainValidateOfflineAddrs.chain_validate_consecutive_numbers + 332) (ChainValidateOfflineAddrs.chain_validate_consecutive_numbers + 68)),
    ...
    .BNE .x10 .x0 (brOff (ChainValidateOfflineAddrs.chain_validate_consecutive_numbers + 312) (ChainValidateOfflineAddrs.chain_validate_consecutive_numbers + 96)),
    ...
    .ADD .x6 .x18 .x5,
    .LI .x7 (1 : Word),
    .BEQ .x7 .x8 (brOff (ChainValidateOfflineAddrs.chain_validate_consecutive_numbers + 332) (ChainValidateOfflineAddrs.chain_validate_consecutive_numbers + 124)),
    ...
    .BNE .x10 .x0 (brOff (ChainValidateOfflineAddrs.chain_validate_consecutive_numbers + 312) (ChainValidateOfflineAddrs.chain_validate_consecutive_numbers + 196)),
    ...
    .JAL .x0 (jalOff (ChainValidateOfflineAddrs.chain_validate_consecutive_numbers + 124) (ChainValidateOfflineAddrs.chain_validate_consecutive_numbers + 280)),
...
def chainValidateGasUsedUnderLimit_prog : Program :=
  [ .ADDI .x2 .x2 (-56 : BitVec 12),
    ...
    .SD .x20 .x0 (0 : BitVec 12),
    .LI .x21 (0 : Word),
    .BEQ .x21 .x8 (brOff (ChainValidateOfflineAddrs.chain_validate_gas_used_under_limit + 292) (ChainValidateOfflineAddrs.chain_validate_gas_used_under_limit + 68)),
    ...
    .BNE .x10 .x0 (brOff (ChainValidateOfflineAddrs.chain_validate_gas_used_under_limit + 284) (ChainValidateOfflineAddrs.chain_validate_gas_used_under_limit + 128)),
    ...
    .BNE .x10 .x0 (brOff (ChainValidateOfflineAddrs.chain_validate_gas_used_under_limit + 284) (ChainValidateOfflineAddrs.chain_validate_gas_used_under_limit + 188)),
    ...
    .JAL .x0 (jalOff (ChainValidateOfflineAddrs.chain_validate_gas_used_under_limit + 68) (ChainValidateOfflineAddrs.chain_validate_gas_used_under_limit + 264)),
    .SD .x19 .x0 (0 : BitVec 12),
...
def chainValidateExtraDataLength_prog : Program :=
  [ .ADDI .x2 .x2 (-56 : BitVec 12),
    ...
    .SD .x20 .x0 (0 : BitVec 12),
    .LI .x21 (0 : Word),
    .BEQ .x21 .x8 (brOff (ChainValidateOfflineAddrs.chain_validate_extra_data_length + 236) (ChainValidateOfflineAddrs.chain_validate_extra_data_length + 68)),
    ...
    .BNE .x10 .x0 (brOff (ChainValidateOfflineAddrs.chain_validate_extra_data_length + 224) (ChainValidateOfflineAddrs.chain_validate_extra_data_length + 136)),
    ...
    .ADD .x18 .x18 .x29,
    .ADDI .x21 .x21 (1 : BitVec 12),
    .JAL .x0 (jalOff (ChainValidateOfflineAddrs.chain_validate_extra_data_length + 68) (ChainValidateOfflineAddrs.chain_validate_extra_data_length + 204)),
    .SD .x19 .x0 (0 : BitVec 12),
    .SD .x20 .x21 (0 : BitVec 12),
    .LI .x10 (0 : Word),
    .JAL .x0 (20 : BitVec 21),
