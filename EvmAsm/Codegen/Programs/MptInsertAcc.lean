...
def mptInsertAcc_prog : Program :=
  [ .ADDI .x2 .x2 (-96 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_acc + 2696) (GuestAddrs.mpt_insert_acc + 128)),
    ...
    .LI .x7 (0 : Word),
    .BEQ .x6 .x7 (brOff (GuestAddrs.mpt_insert_acc + 2232) (GuestAddrs.mpt_insert_acc + 164)),
    .LI .x7 (1 : Word),
    .BEQ .x6 .x7 (brOff (GuestAddrs.mpt_insert_acc + 292) (GuestAddrs.mpt_insert_acc + 172)),
    .LI .x7 (2 : Word),
    .BEQ .x6 .x7 (brOff (GuestAddrs.mpt_insert_acc + 1120) (GuestAddrs.mpt_insert_acc + 180)),
    .LI .x10 (1 : Word),
    .JAL .x0 (jalOff (GuestAddrs.mpt_insert_acc + 2696) (GuestAddrs.mpt_insert_acc + 188)),
    .MV .x10 .x9,
    .MV .x11 .x18,
    .MV .x12 .x19,
    .MV .x13 .x20,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_acc + 2748) (GuestAddrs.mpt_insert_acc + 228)),
    ...
    .LI .x10 (0 : Word),
    .JAL .x0 (jalOff (GuestAddrs.mpt_insert_acc + 2696) (GuestAddrs.mpt_insert_acc + 288)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_acc + 2748) (GuestAddrs.mpt_insert_acc + 352)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_acc + 2748) (GuestAddrs.mpt_insert_acc + 524)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_acc + 2748) (GuestAddrs.mpt_insert_acc + 656)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_acc + 2748) (GuestAddrs.mpt_insert_acc + 788)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_acc + 2748) (GuestAddrs.mpt_insert_acc + 864)),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .BEQ .x6 .x0 (brOff (GuestAddrs.mpt_insert_acc + 1112) (GuestAddrs.mpt_insert_acc + 992)),
    ...
    .MV .x23 .x22,
    .JAL .x0 (jalOff (GuestAddrs.mpt_insert_acc + 2488) (GuestAddrs.mpt_insert_acc + 1116)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_acc + 2748) (GuestAddrs.mpt_insert_acc + 1172)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_acc + 2748) (GuestAddrs.mpt_insert_acc + 1232)),
    ...
    .LD .x5 .x5 (0 : BitVec 12),
    .BNE .x5 .x0 (brOff (GuestAddrs.mpt_insert_acc + 2748) (GuestAddrs.mpt_insert_acc + 1248)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_acc + 2748) (GuestAddrs.mpt_insert_acc + 1292)),
    ...
    .LI .x28 (32 : Word),
    .BNE .x7 .x28 (brOff (GuestAddrs.mpt_insert_acc + 1416) (GuestAddrs.mpt_insert_acc + 1340)),
    ...
    .SUB .x29 .x6 .x28,
    .ADDI .x29 .x29 (-1 : BitVec 12),
    .BEQ .x29 .x0 (brOff (GuestAddrs.mpt_insert_acc + 1704) (GuestAddrs.mpt_insert_acc + 1576)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_acc + 2748) (GuestAddrs.mpt_insert_acc + 1768)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_acc + 2748) (GuestAddrs.mpt_insert_acc + 1900)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_acc + 2748) (GuestAddrs.mpt_insert_acc + 1976)),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .BEQ .x6 .x0 (brOff (GuestAddrs.mpt_insert_acc + 2224) (GuestAddrs.mpt_insert_acc + 2104)),
    ...
    .MV .x23 .x22,
    .JAL .x0 (jalOff (GuestAddrs.mpt_insert_acc + 2488) (GuestAddrs.mpt_insert_acc + 2228)),
    .ADD .x10 .x9 .x24,
    .ADDI .x10 .x10 (1 : BitVec 12),
    .SUB .x11 .x18 .x24,
    .ADDI .x11 .x11 (-1 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_acc + 2748) (GuestAddrs.mpt_insert_acc + 2276)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_acc + 2748) (GuestAddrs.mpt_insert_acc + 2416)),
    ...
    .MV .x23 .x22,
    .BEQ .x23 .x0 (brOff (GuestAddrs.mpt_insert_acc + 2664) (GuestAddrs.mpt_insert_acc + 2488)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_acc + 2748) (GuestAddrs.mpt_insert_acc + 2592)),
    ...
    .JAL .x0 (jalOff (GuestAddrs.mpt_insert_acc + 2488) (GuestAddrs.mpt_insert_acc + 2660)),
