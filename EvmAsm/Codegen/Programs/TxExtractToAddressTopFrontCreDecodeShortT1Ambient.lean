/-
  Ambient dual: Front short AfterSave → t1 creation of_decode (typeW=1, 5 walks).
-/
...
theorem extractFrontAfterSaveCreation_then_epi_of_decode_short_t1_ambient
  ...
  have hMid := extractT1AfterSaveCreation_then_epi_of_decode_ambient sp0 spC s
...
#print axioms extractFrontAfterSaveCreation_then_epi_of_decode_short_t1_ambient
