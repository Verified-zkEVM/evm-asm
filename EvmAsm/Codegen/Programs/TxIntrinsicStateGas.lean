...
def eip7702AuthorityAsof_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .LI .x5 (2 : Word),
    .BEQ .x10 .x5 (brOff (GuestAddrs.eip7702_authority_asof + 976) (GuestAddrs.eip7702_authority_asof + 480)),
    .MV .x10 .x8,
    .ADDI .x11 .x2 (56 : BitVec 12),
    .LI .x12 (20 : Word),
    ...
    .LI .x5 (1 : Word),
    .BEQ .x10 .x5 (brOff (GuestAddrs.eip7702_authority_asof + 976) (GuestAddrs.eip7702_authority_asof + 620)),
    .LI .x10 (2 : Word),
    .LI .x11 (0 : Word),
    .LI .x12 (0 : Word),
