...
def balAllAccountsNonstorageConsistentFunction : String :=
  ...
  ".Lc3ns_found:\n" ++
  "  mv s6, t5; mv a0, s7; mv a1, s8; mv a2, s6\n" ++
  ...
  -- `bal_account_nonstorage_finals` is a call and may clobber t0. Reload the
  -- effect's component mask before deciding whether the nonce field is covered.
  ".Lc3ns_mask_nonce:\n  lbu t0, 20(s6)\n" ++
