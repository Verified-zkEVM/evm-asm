/-
  Ambient dual: E → AfterSave long → 20B copy of_decode (regionBase/loadPtr).
-/
...
theorem extractFrontCopy_then_epi_of_decode_long_concrete_region_ambient
  ...
  have hC := extractFrontAfterSaveCopy_then_epi_of_decode_long_region_ambient sp0 spC s
...
#print axioms extractFrontCopy_then_epi_of_decode_long_concrete_region_ambient
