...
def baapDeleteSingleLeafStorage_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .BNE .x12 .x0 (brOff (GuestAddrs.baap_delete_single_leaf_storage + 508) (GuestAddrs.baap_delete_single_leaf_storage + 64)),
    .MV .x21 .x11,
    .MV .x11 .x21,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.baap_delete_single_leaf_storage + 76)),
    .BNE .x11 .x0 (brOff (GuestAddrs.baap_delete_single_leaf_storage + 508) (GuestAddrs.baap_delete_single_leaf_storage + 80)),
    .MV .x11 .x21,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.baap_delete_single_leaf_storage + 88)),
    .BNE .x11 .x0 (brOff (GuestAddrs.baap_delete_single_leaf_storage + 508) (GuestAddrs.baap_delete_single_leaf_storage + 92)),
    .MV .x11 .x21,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.baap_delete_single_leaf_storage + 100)),
    .BNE .x11 .x0 (brOff (GuestAddrs.baap_delete_single_leaf_storage + 508) (GuestAddrs.baap_delete_single_leaf_storage + 104)),
    .LI .x7 (32 : Word),
    .BNE .x12 .x7 (brOff (GuestAddrs.baap_delete_single_leaf_storage + 508) (GuestAddrs.baap_delete_single_leaf_storage + 112)),
    .SUB .x6 .x10 .x12,
    ...
    .LI .x29 (32 : Word),
    .BEQ .x29 .x0 (brOff (GuestAddrs.baap_delete_single_leaf_storage + 480) (GuestAddrs.baap_delete_single_leaf_storage + 148)),
    ...
    .BEQ .x10 .x0 (brOff (GuestAddrs.baap_delete_single_leaf_storage + 508) (GuestAddrs.baap_delete_single_leaf_storage + 236)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.baap_delete_single_leaf_storage + 508) (GuestAddrs.baap_delete_single_leaf_storage + 284)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.baap_delete_single_leaf_storage + 508) (GuestAddrs.baap_delete_single_leaf_storage + 364)),
    ...
    .LI .x6 (64 : Word),
    .BNE .x5 .x6 (brOff (GuestAddrs.baap_delete_single_leaf_storage + 508) (GuestAddrs.baap_delete_single_leaf_storage + 384)),
    ...
    .BNE .x28 .x29 (brOff (GuestAddrs.baap_delete_single_leaf_storage + 508) (GuestAddrs.baap_delete_single_leaf_storage + 420)),
