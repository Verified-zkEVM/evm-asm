...
def headersKeccakArray_prog : Program :=
  [ .ADDI .x2 .x2 (-48 : BitVec 12),
    ...
    .MV .x9 .x11,
    .MV .x18 .x12,
    .BEQ .x9 .x0 (brOff (GuestAddrs.headers_keccak_array + 132) (GuestAddrs.headers_keccak_array + 40)),
    .LWU .x5 .x8 (0 : BitVec 12),
    .SRLI .x19 .x5 (2 : BitVec 6),
    .LI .x20 (0 : Word),
    .BEQ .x20 .x19 (brOff (GuestAddrs.headers_keccak_array + 136) (GuestAddrs.headers_keccak_array + 56)),
    .SLLI .x5 .x20 (2 : BitVec 6),
    .ADD .x6 .x8 .x5,
    .LWU .x7 .x6 (0 : BitVec 12),
    .ADD .x10 .x8 .x7,
    ...
    .ADDI .x20 .x20 (1 : BitVec 12),
    .JAL .x0 (jalOff (GuestAddrs.headers_keccak_array + 56) (GuestAddrs.headers_keccak_array + 128)),
    .LI .x19 (0 : Word),
    .MV .x10 .x19,
    .LD .x1 .x2 (0 : BitVec 12),
    .LD .x8 .x2 (8 : BitVec 12),
...
def headerValidateParentHash_prog : Program :=
  [ .ADDI .x2 .x2 (-32 : BitVec 12),
    ...
    .LI .x10 (1 : Word),
    .JAL .x0 (jalOff (GuestAddrs.header_validate_parent_hash + 148) (GuestAddrs.header_validate_parent_hash + 48)),
    .MV .x10 .x8,
    .MV .x11 .x9,
...
def headersValidateChain_prog : Program :=
  [ .ADDI .x2 .x2 (-48 : BitVec 12),
    ...
    .LI .x6 (256 : Word),
    .BLTU .x6 .x5 (brOff (GuestAddrs.headers_validate_chain + 264) (GuestAddrs.headers_validate_chain + 56)),
    .MV .x10 .x8,
    .MV .x11 .x9,
    ...
    .LI .x5 (2 : Word),
    .BLTU .x19 .x5 (brOff (GuestAddrs.headers_validate_chain + 256) (GuestAddrs.headers_validate_chain + 92)),
    .LI .x20 (1 : Word),
    .BEQ .x20 .x19 (brOff (GuestAddrs.headers_validate_chain + 256) (GuestAddrs.headers_validate_chain + 100)),
    .SLLI .x5 .x20 (2 : BitVec 6),
    .ADD .x6 .x8 .x5,
    .LWU .x7 .x6 (0 : BitVec 12),
    .ADD .x10 .x8 .x7,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.headers_validate_chain + 264) (GuestAddrs.headers_validate_chain + 168)),
    ...
    .ADDI .x20 .x20 (1 : BitVec 12),
    .JAL .x0 (jalOff (GuestAddrs.headers_validate_chain + 100) (GuestAddrs.headers_validate_chain + 252)),
    .LI .x10 (0 : Word),
    .JAL .x0 (8 : BitVec 21),
    .LI .x10 (1 : Word),
    .LD .x1 .x2 (0 : BitVec 12),
