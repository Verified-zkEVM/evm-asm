/-
  Front AfterSave → type234 20B copy → ret via midJoin bridge.
-/
...
/-- front AfterSave → type234 20B copy → ret. Honesty residuals from MidJoin. -/
theorem extractFrontAfterSaveCopy_then_epi
  ...
  have hEx :
    ...
    have hcore := extractType234AfterSaveCopy_then_epi sp0 spC s
      txBase lenW
      (teerTxTypeDispatch txBytes).2.1
      (teerTxTypeDispatch txBytes).2.2
      ...
      hoff0 hover0 hvalid0 hss0 hls0 hll0 (hok0 endPtr)
      hoff1 hover1 hvalid1 hss1 hls1 hll1 (hok1 endPtr)
      hoff2 hover2 hvalid2 hss2 hls2 hll2 (hok2 endPtr)
...
#print axioms extractFrontAfterSaveCopy_then_epi
