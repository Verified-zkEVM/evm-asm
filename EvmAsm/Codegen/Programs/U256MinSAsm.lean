...
private theorem pickA_spec (w : Word) (hcond : minSel as bs) :
  ...
  have hmv := liftCode (cr' := CodeReq.ofProg (GuestAddrs.u256_min : Word) u256Min_prog)
    (mv_spec_gen_within .x5 .x10 aPtr w ((GuestAddrs.u256_min + 44) : Word) (by decide))
    (by code_mem)
  rw [show ((GuestAddrs.u256_min + 44) : Word) + 4 = ((GuestAddrs.u256_min + 48) : Word) from by decide] at hmv
  have hjal := liftCode (cr' := CodeReq.ofProg (GuestAddrs.u256_min : Word) u256Min_prog)
    (jal_x0_spec_gen_within (8 : BitVec 21) ((GuestAddrs.u256_min + 48) : Word))
    (by code_mem)
  rw [show ((GuestAddrs.u256_min + 48) : Word) + signExtend21 (8 : BitVec 21) = ((GuestAddrs.u256_min + 56) : Word)
...
private theorem pickB_spec (w : Word) (hcond : ¬ minSel as bs) :
    cpsTripleWithin 1 ((GuestAddrs.u256_min + 52) : Word) ((GuestAddrs.u256_min + 56) : Word)
      (CodeReq.ofProg (GuestAddrs.u256_min : Word) u256Min_prog)
      (((.x5 : Reg) ↦ᵣ w) ** ((.x31 : Reg) ↦ᵣ (32 : Word)) ** ((.x10 : Reg) ↦ᵣ aPtr) **
      ((.x11 : Reg) ↦ᵣ bPtr) ** ((.x12 : Reg) ↦ᵣ outPtr) **
      ((.x1 : Reg) ↦ᵣ ret) **
      ...
      bytesRegion aPtr as ** bytesRegion bPtr bs ** bytesRegion outPtr os) := by
  have hmv := liftCode (cr' := CodeReq.ofProg (GuestAddrs.u256_min : Word) u256Min_prog)
    (mv_spec_gen_within .x5 .x11 bPtr w ((GuestAddrs.u256_min + 52) : Word) (by decide))
    (by code_mem)
  rw [show ((GuestAddrs.u256_min + 52) : Word) + 4 = ((GuestAddrs.u256_min + 56) : Word) from by decide] at hmv
  have hmvF := cpsTripleWithin_frameR
...
private theorem scanLoop_spec
    ...
    (M i : Nat) (hMi : i + M = 32)
    (hpref : ∀ j, j < i → as.getD j 0 = bs.getD j 0) :
    cpsTripleWithin (9 * M + 8) ((GuestAddrs.u256_min + 8) : Word) ((GuestAddrs.u256_min + 56) : Word)
      (CodeReq.ofProg (GuestAddrs.u256_min : Word) u256Min_prog)
  ...
  | zero =>
      ...
      have hbr := cpsBranchWithin_frameR
        ...
        (cpsBranchWithin_extend_code
          (cr' := CodeReq.ofProg (GuestAddrs.u256_min : Word) u256Min_prog)
          (h := beq_spec_gen_within .x5 .x31 (36 : BitVec 13)
            (BitVec.ofNat 64 32) (32 : Word) ((GuestAddrs.u256_min + 8) : Word))
          (hmono := by code_mem))
      rw [show ((GuestAddrs.u256_min + 8) : Word) + signExtend13 (36 : BitVec 13)
            = ((GuestAddrs.u256_min + 44) : Word) from by decide,
          show ((GuestAddrs.u256_min + 8) : Word) + 4 = ((GuestAddrs.u256_min + 12) : Word) from by decide] at hbr
  ...
  | succ n ih =>
      ...
      have hadd6 := liftCode (cr' := CR)
        (add_spec_gen_within .x6 .x10 .x5 aPtr (BitVec.ofNat 64 i) (vf .x6)
          ((GuestAddrs.u256_min + 12) : Word) (by decide))
        (by rw [hCR]; code_mem)
      rw [show ((GuestAddrs.u256_min + 12) : Word) + 4 = ((GuestAddrs.u256_min + 16) : Word) from by decide] at hadd6
      have hadd7 := liftCode (cr' := CR)
        (add_spec_gen_within .x7 .x11 .x5 bPtr (BitVec.ofNat 64 i) (vf .x7)
          ((GuestAddrs.u256_min + 16) : Word) (by decide))
        (by rw [hCR]; code_mem)
      rw [show ((GuestAddrs.u256_min + 16) : Word) + 4 = ((GuestAddrs.u256_min + 20) : Word) from by decide] at hadd7
      have hlbuA := liftCode (cr' := CR)
        (bytesRegion_lbu_within .x28 .x6 aPtr (vf .x28) ((GuestAddrs.u256_min + 20) : Word)
          as i (by decide) halignA hia (by omega) (hvalidA i hiN))
        (by rw [hCR]; code_mem)
      rw [show ((GuestAddrs.u256_min + 20) : Word) + 4 = ((GuestAddrs.u256_min + 24) : Word) from by decide] at hlbuA
      have hlbuB := liftCode (cr' := CR)
        (bytesRegion_lbu_within .x29 .x7 bPtr (vf .x29) ((GuestAddrs.u256_min + 24) : Word)
          bs i (by decide) halignB hib (by omega) (hvalidB i hiN))
        (by rw [hCR]; code_mem)
      rw [show ((GuestAddrs.u256_min + 24) : Word) + 4 = ((GuestAddrs.u256_min + 28) : Word) from by decide] at hlbuB
      ...
      have hbrHdr := cpsBranchWithin_frameR
        ...
        (cpsBranchWithin_extend_code (cr' := CR)
          (h := beq_spec_gen_within .x5 .x31 (36 : BitVec 13)
            (BitVec.ofNat 64 i) (32 : Word) ((GuestAddrs.u256_min + 8) : Word))
          (hmono := by rw [hCR]; code_mem))
      rw [show ((GuestAddrs.u256_min + 8) : Word) + signExtend13 (36 : BitVec 13)
            = ((GuestAddrs.u256_min + 44) : Word) from by decide,
          show ((GuestAddrs.u256_min + 8) : Word) + 4 = ((GuestAddrs.u256_min + 12) : Word) from by decide] at hbrHdr
      ...
      have hbr1 := cpsBranchWithin_frameR
        ...
        (cpsBranchWithin_extend_code (cr' := CR)
          (h := bltu_spec_gen_within .x28 .x29 (16 : BitVec 13) aByte bByte
            ((GuestAddrs.u256_min + 28) : Word))
          (hmono := by rw [hCR]; code_mem))
      rw [show ((GuestAddrs.u256_min + 28) : Word) + signExtend13 (16 : BitVec 13)
            = ((GuestAddrs.u256_min + 44) : Word) from by decide,
          show ((GuestAddrs.u256_min + 28) : Word) + 4 = ((GuestAddrs.u256_min + 32) : Word) from by decide] at hbr1
      ...
      have hbr2 := cpsBranchWithin_frameR
        ...
        (cpsBranchWithin_extend_code (cr' := CR)
          (h := bltu_spec_gen_within .x29 .x28 (20 : BitVec 13) bByte aByte
            ((GuestAddrs.u256_min + 32) : Word))
          (hmono := by rw [hCR]; code_mem))
      rw [show ((GuestAddrs.u256_min + 32) : Word) + signExtend13 (20 : BitVec 13)
            = ((GuestAddrs.u256_min + 52) : Word) from by decide,
          show ((GuestAddrs.u256_min + 32) : Word) + 4 = ((GuestAddrs.u256_min + 36) : Word) from by decide] at hbr2
      ...
      have haddi := liftCode (cr' := CR)
        (addi_spec_gen_same_within .x5 (BitVec.ofNat 64 i) (1 : BitVec 12)
          ((GuestAddrs.u256_min + 36) : Word) (by decide))
        (by rw [hCR]; code_mem)
      rw [show (BitVec.ofNat 64 i : Word) + signExtend12 (1 : BitVec 12)
          ...
          omega,
          show ((GuestAddrs.u256_min + 36) : Word) + 4 = ((GuestAddrs.u256_min + 40) : Word) from by decide] at haddi
      have hjal := liftCode (cr' := CR)
        (jal_x0_spec_gen_within (-32 : BitVec 21) ((GuestAddrs.u256_min + 40) : Word))
        (by rw [hCR]; code_mem)
      rw [show ((GuestAddrs.u256_min + 40) : Word) + signExtend21 (-32 : BitVec 21)
            = ((GuestAddrs.u256_min + 8) : Word) from by decide] at hjal
      -- ---- continue segment (both bytes equal): ADDI ; JAL ; IH ----
      have hcont : ¬ BitVec.ult aByte bByte → ¬ BitVec.ult bByte aByte →
          cpsTripleWithin (9 * n + 10) ((GuestAddrs.u256_min + 36) : Word)
            ((GuestAddrs.u256_min + 56) : Word) CR
      ...
      have hstation2 : ¬ BitVec.ult aByte bByte →
          cpsTripleWithin (1 + (9 * n + 10)) ((GuestAddrs.u256_min + 32) : Word)
            ((GuestAddrs.u256_min + 56) : Word) CR
            ((.x28 ↦ᵣ aByte) ** (.x29 ↦ᵣ bByte) **
          ((.x5 : Reg) ↦ᵣ BitVec.ofNat 64 i) **
          (.x6 ↦ᵣ (aPtr + BitVec.ofNat 64 i)) **
        ...
        exact cpsTripleWithin_weaken (fun _ hp => by xperm_hyp hp)
          (fun _ hq => hq) hst
      -- ---- station 1: BLTU x28 x29 → pick a ----
      have hstation1 : cpsTripleWithin (1 + (1 + (9 * n + 10))) ((GuestAddrs.u256_min + 28) : Word)
          ((GuestAddrs.u256_min + 56) : Word) CR
          ((.x28 ↦ᵣ aByte) ** (.x29 ↦ᵣ bByte) **
          ((.x5 : Reg) ↦ᵣ BitVec.ofNat 64 i) **
          (.x6 ↦ᵣ (aPtr + BitVec.ofNat 64 i)) **
        ...
        exact cpsTripleWithin_weaken (fun _ hp => by xperm_hyp hp)
          (fun _ hq => hq) hst
      -- ---- body ; station 1 ----
      have hbody : cpsTripleWithin (9 * n + 16) ((GuestAddrs.u256_min + 12) : Word)
          ((GuestAddrs.u256_min + 56) : Word) CR
          (((.x5 : Reg) ↦ᵣ BitVec.ofNat 64 i) **
...
theorem u256Min_spec (aPtr bPtr outPtr ret : Word) (as bs os : List (BitVec 8))
  ...
  have hcopy : cpsTripleWithin 8 ((GuestAddrs.u256_min + 56) : Word) ((GuestAddrs.u256_min + 88) : Word) CR
      ((((.x5 : Reg) ↦ᵣ (if minSel as bs then aPtr else bPtr)) **
        ((.x12 : Reg) ↦ᵣ outPtr) **
        bytesRegion aPtr as ** bytesRegion bPtr bs ** bytesRegion outPtr os)
        ** regOwn .x6)
    ...
    · rw [if_pos hc, if_pos hc]
      have h := cpsTripleWithin_extend_code
        (hmono := CodeReq.ofProg_mono_sub (GuestAddrs.u256_min : Word) ((GuestAddrs.u256_min + 56) : Word)
          u256Min_prog (dwordCopyProgFrom .x5 .x12 .x6 0 4) 14
          (by decide) (by decide) (by decide) (by decide))
        (selectedDwordCopy_spec .x5 .x12 .x6 (by decide) aPtr outPtr tv as os
          0 4 (by omega) (by omega) (by decide) ((GuestAddrs.u256_min + 56) : Word))
