...
/-- Front short ambient + t1 AfterSave→copy region steps. -/
def nFrontCopyStepsShortT1RegionAmbient : Nat :=
...
theorem extractFrontCopy_then_epi_of_decode_short_concrete_t1_region_ambient
    ...
    cpsTripleWithin nFrontCopyStepsShortT1RegionAmbient
  ...
  have hC := extractFrontAfterSaveCopy_then_epi_of_decode_short_t1_region_ambient sp0 spC s
...
#print axioms extractFrontCopy_then_epi_of_decode_short_concrete_t1_region_ambient
