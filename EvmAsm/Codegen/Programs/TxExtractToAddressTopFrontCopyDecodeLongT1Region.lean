/-
  Front long AfterSave → t1 20B copy bare region (no contentDwords).
-/
...
theorem extractFrontAfterSaveCopy_then_epi_of_decode_long_t1_region
  ...
  have hMid := extractT1AfterSaveCopy_then_epi_of_decode_region sp0 spC s
    txBase lenW
...
#print axioms extractFrontAfterSaveCopy_then_epi_of_decode_long_t1_region
