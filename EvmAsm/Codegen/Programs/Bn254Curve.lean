...
def bncPointDbl_prog : Program :=
  [ .ADDI .x2 .x2 (-32 : BitVec 12),
    ...
    .LI .x10 (1 : Word),
    .JAL .x0 (jalOff (GuestAddrs.bnc_point_dbl + 140) (GuestAddrs.bnc_point_dbl + 48)),
    .MV .x10 .x8,
...
def bncPointAdd_prog : Program :=
  [ .ADDI .x2 .x2 (-40 : BitVec 12),
    ...
    .JAL .x0 (jalOff (GuestAddrs.bnc_point_add + 288) (GuestAddrs.bnc_point_add + 64)),
    .MV .x10 .x9,
    ...
    .LI .x10 (0 : Word),
    .JAL .x0 (jalOff (GuestAddrs.bnc_point_add + 288) (GuestAddrs.bnc_point_add + 96)),
    .MV .x10 .x8,
    .MV .x11 .x9,
    ...
    .BEQ .x10 .x0 (brOff (GuestAddrs.bnc_point_add + 276) (GuestAddrs.bnc_point_add + 128)),
    .MV .x10 .x8,
    .MV .x11 .x18,
    .JAL .x1 (jalOff GuestAddrs.bnc_point_dbl (GuestAddrs.bnc_point_add + 140)),
    .JAL .x0 (jalOff (GuestAddrs.bnc_point_add + 288) (GuestAddrs.bnc_point_add + 144)),
    .MV .x10 .x8,
...
def bncScalarMul_prog : Program :=
  [ .ADDI .x2 .x2 (-72 : BitVec 12),
    ...
    .LI .x20 (0 : Word),
    .LI .x5 (32 : Word),
    .BGEU .x20 .x5 (brOff (GuestAddrs.bnc_scalar_mul + 228) (GuestAddrs.bnc_scalar_mul + 72)),
    .ADD .x5 .x8 .x20,
    .LBU .x21 .x5 (0 : BitVec 12),
    .LI .x22 (128 : Word),
    .BEQ .x22 .x0 (brOff (GuestAddrs.bnc_scalar_mul + 220) (GuestAddrs.bnc_scalar_mul + 88)),
    ...
    .AND .x5 .x21 .x22,
    .BEQ .x5 .x0 (brOff (GuestAddrs.bnc_scalar_mul + 212) (GuestAddrs.bnc_scalar_mul + 136)),
    ...
    .JAL .x0 (jalOff (GuestAddrs.bnc_scalar_mul + 88) (GuestAddrs.bnc_scalar_mul + 216)),
    .ADDI .x20 .x20 (1 : BitVec 12),
    .JAL .x0 (jalOff (GuestAddrs.bnc_scalar_mul + 68) (GuestAddrs.bnc_scalar_mul + 224)),
    .MV .x10 .x19,
    .LD .x1 .x2 (0 : BitVec 12),
    .LD .x8 .x2 (8 : BitVec 12),
    .LD .x9 .x2 (16 : BitVec 12),
