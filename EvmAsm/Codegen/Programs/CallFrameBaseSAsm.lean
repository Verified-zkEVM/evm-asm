...
-- Address anchors.
#guard GuestAddrs.frame_base = 0x800382d0
...
theorem fb_laHi_agree :
    laHi GuestAddrs.call_frame_arena (GuestAddrs.frame_base + 12)
      = EvmAsm.Rv64.laHi (0x800382dc : Word) (0xac4639a0 : Word) := by decide

theorem fb_laLo_agree :
    laLo GuestAddrs.call_frame_arena (GuestAddrs.frame_base + 12)
      = EvmAsm.Rv64.laLo (0x800382dc : Word) (0xac4639a0 : Word) := by decide
...
theorem fb_la_resolved :
  ...
  exact la_resolve (0x800382dc : Word) (0xac4639a0 : Word) (by decide)
...
theorem frameBase_spec (depth ret : Word)
    ...
    cpsTripleWithin 7 (0x800382d0 : Word) ret
      (CodeReq.ofProg (0x800382d0 : Word) frameBase_prog)
  ...
  have hblk := cpsTripleWithin_extend_code
    (hmono := CodeReq.ofProg_mono_sub (0x800382d0 : Word) (0x800382d0 : Word)
      frameBase_prog fbBlock 0 (by decide) (by decide) (by decide) (by decide))
    (blockAt_regs_spec fbBlock rf (0x800382d0 : Word)
      (by decide) (by decide) (by decide))
  rw [show (0x800382d0 : Word) + BitVec.ofNat 64 (4 * fbBlock.length)
        = (0x800382e8 : Word) from by decide] at hblk
  -- ---- the engine image as an explicit set-chain ----
  set rf' := (execBlockAt Region.empty RwRegion.empty.base (0x800382d0 : Word)
  ...
  set s4 := s3.set .x6 ((0x800382dc : Word)
    + (((laHi GuestAddrs.call_frame_arena (GuestAddrs.frame_base + 12)).zeroExtend 32
  ...
  rw [hpost] at hblk
  -- ---- the ret ----
  have hret := liftCode (cr' := CodeReq.ofProg (0x800382d0 : Word) frameBase_prog)
    (EvmAsm.Evm64.ret_spec_within' (0x800382e8 : Word) ret)
    (by code_mem)
  rw [halign] at hret
  -- ---- frames + chain ----
