/-
Parametric swapDiv core assembly for the outer-loop assembly (#12851):
mechanical copy of swapdiv_core with `AB`/`PB` buffer-base parameters,
consuming Body11Spec/Body12Spec pieces.
-/
...
import EvmAsm.Codegen.Programs.AmsterdamBlobGasPriceBody12Spec

namespace EvmAsm.Codegen.AmsterdamBlobGasPriceBody13Spec
...
open EvmAsm.Codegen.AmsterdamBlobGasPriceBody11Spec EvmAsm.Codegen.AmsterdamBlobGasPriceBody12Spec

set_option maxRecDepth 8000

theorem swapdivP_core (newSp excess outPtr iVal AB PB : Word) (vals : Reg → Word)
    ...
    cpsNBranchWithin 3894 (PriceK + 680) priceCode
      ((.x2 ↦ᵣ newSp) **
        ...
        FR)
      [(PriceK + 964, QOVFDIVP newSp excess outPtr iVal AB PB vals a0 a1 a2 a3 a4 a5 p0 p1 p2 p3 p4 p5
          s0 s1 s2 s3 s4 s5 v7 v28 v29 v30 v31 FR),
       (PriceK + 144, QBACKP newSp excess outPtr iVal AB PB vals a0 a1 a2 a3 a4 a5 p0 p1 p2 p3 p4 p5
          s0 s1 s2 s3 s4 s5 v7 v28 v29 v30 v31 FR)] := by
  -- Phase 1 (proven separately): swap + divisor mul/mulhu
  have hP1 := swapdivP_p1 newSp excess outPtr iVal AB PB vals a0 a1 a2 a3 a4 a5 p0 p1 p2 p3 p4 p5
  ...
  have hP3' := swapdivP_p3 newSp excess outPtr iVal AB PB vals a0 a1 a2 a3 a4 a5 p0 p1 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5 v7 v28 v29 v30 v31 FR hFR
  -- The 6-limb fold
  have hLF := swapdiv_limbfold (taylorDW * iVal) (PB) p5 p4 p3 p2 p1 p0 v7 v28 v29
    ((.x2 ↦ᵣ newSp) **
        (.x1 ↦ᵣ (vals .x1)) **
        (.x10 ↦ᵣ excess) **
        (.x11 ↦ᵣ outPtr) **
