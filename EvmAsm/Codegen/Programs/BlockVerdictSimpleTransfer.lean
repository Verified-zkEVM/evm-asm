...
private def sttc_bv_tx_count : Nat := 0xa5dbbea8
private def sttc_bv_public_keys_len : Nat := 0xa5dbbec8
private def sttc_bv_public_keys_ptr : Nat := 0xa5dbbec0
private def sttc_bv_tx_item_start : Nat := 0xa5dbbeb8
private def sttc_bv_tx_list_ptr : Nat := 0xa5dbbe98
private def sttc_bv_tx_list_len : Nat := 0xa5dbbea0
private def sttc_bv_exec_p : Nat := 0xa5dbbd68
private def sttc_sttc_nonce : Nat := 0xaa723ab0
private def sttc_sttc_base_fee_be : Nat := 0xaa723b80
private def sttc_tea_type : Nat := 0xaa723ab8
private def sttc_tea_inner_off : Nat := 0xaa723ac0
...
def simpleTransferTxContext_prog : Program :=
  [ .ADDI .x2 .x2 (-48 : BitVec 12),
    ...
    .AUIPC .x5 (laHi GuestAddrs.bv_tx_count 2147483776),
    .ADDI .x5 .x5 (laLo GuestAddrs.bv_tx_count 2147483776),
    .LD .x6 .x5 (0 : BitVec 12),
    .LI .x7 (1 : Word),
    .BEQ .x6 .x7 (16 : BitVec 13),
    .LI .x5 (1 : Word),
    .SD .x8 .x5 (0 : BitVec 12),
    .JAL .x0 (jalOff 2147484288 2147483804),
    .AUIPC .x5 (laHi GuestAddrs.bv_public_keys_len 2147483808),
    .ADDI .x5 .x5 (laLo GuestAddrs.bv_public_keys_len 2147483808),
    .LD .x6 .x5 (0 : BitVec 12),
    .LI .x7 (65 : Word),
    .BEQ .x6 .x7 (16 : BitVec 13),
    .LI .x5 (2 : Word),
    .SD .x8 .x5 (0 : BitVec 12),
    .JAL .x0 (jalOff 2147484288 2147483836),
    .AUIPC .x5 (laHi GuestAddrs.bv_tx_list_ptr 2147483840),
    .ADDI .x5 .x5 (laLo GuestAddrs.bv_tx_list_ptr 2147483840),
    .LD .x9 .x5 (0 : BitVec 12),
    .AUIPC .x5 (laHi GuestAddrs.bv_tx_list_len 2147483852),
    .ADDI .x5 .x5 (laLo GuestAddrs.bv_tx_list_len 2147483852),
    .LD .x18 .x5 (0 : BitVec 12),
    .AUIPC .x5 (laHi GuestAddrs.bv_tx_item_start 2147483864),
    .ADDI .x5 .x5 (laLo GuestAddrs.bv_tx_item_start 2147483864),
    .LD .x19 .x5 (0 : BitVec 12),
    .BLTU .x18 .x19 (brOff 2147484256 2147483876),
    .BEQ .x18 .x19 (brOff 2147484268 2147483880),
    .ADD .x9 .x9 .x19,
    .SUB .x18 .x18 .x19,
    .SD .x8 .x9 (8 : BitVec 12),
    .SD .x8 .x18 (16 : BitVec 12),
    .AUIPC .x5 (laHi GuestAddrs.bv_public_keys_ptr 2147483900),
    .ADDI .x5 .x5 (laLo GuestAddrs.bv_public_keys_ptr 2147483900),
    .LD .x6 .x5 (0 : BitVec 12),
    .ADDI .x6 .x6 (1 : BitVec 12),
    .SD .x8 .x6 (24 : BitVec 12),
    .AUIPC .x5 (laHi GuestAddrs.bv_exec_p 2147483920),
    .ADDI .x5 .x5 (laLo GuestAddrs.bv_exec_p 2147483920),
    .LD .x6 .x5 (0 : BitVec 12),
    .ADDI .x6 .x6 (440 : BitVec 12),
    .AUIPC .x7 (laHi GuestAddrs.sttc_base_fee_be 2147483936),
    .ADDI .x7 .x7 (laLo GuestAddrs.sttc_base_fee_be 2147483936),
    .LI .x28 (0 : Word),
    .LI .x29 (32 : Word),
    ...
    .MV .x10 .x9,
    .MV .x11 .x18,
    .AUIPC .x12 (laHi GuestAddrs.tea_type 2147484000),
    .ADDI .x12 .x12 (laLo GuestAddrs.tea_type 2147484000),
    .AUIPC .x13 (laHi GuestAddrs.tea_inner_off 2147484008),
    .ADDI .x13 .x13 (laLo GuestAddrs.tea_inner_off 2147484008),
    .JAL .x1 (jalOff GuestAddrs.tx_type_dispatch 2147484016),
    .BEQ .x10 .x0 (16 : BitVec 13),
    .LI .x5 (20 : Word),
    .SD .x8 .x5 (0 : BitVec 12),
    .JAL .x0 (jalOff 2147484288 2147484032),
    .AUIPC .x5 (laHi GuestAddrs.tea_type 2147484036),
    .ADDI .x5 .x5 (laLo GuestAddrs.tea_type 2147484036),
    .LD .x6 .x5 (0 : BitVec 12),
    .SD .x8 .x6 (160 : BitVec 12),
    .AUIPC .x5 (laHi GuestAddrs.tea_inner_off 2147484052),
    .ADDI .x5 .x5 (laLo GuestAddrs.tea_inner_off 2147484052),
    .LD .x28 .x5 (0 : BitVec 12),
    .SD .x8 .x28 (168 : BitVec 12),
    .BLTU .x18 .x28 (brOff 2147484280 2147484068),
    .ADD .x29 .x9 .x28,
    ...
    .MV .x10 .x9,
    .MV .x11 .x18,
    .AUIPC .x12 (laHi GuestAddrs.sttc_nonce 2147484096),
    .ADDI .x12 .x12 (laLo GuestAddrs.sttc_nonce 2147484096),
    .ADDI .x13 .x8 (40 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.tx_extract_nonce_and_gas 2147484108),
    .SD .x8 .x10 (128 : BitVec 12),
    .BEQ .x10 .x0 (16 : BitVec 13),
    .LI .x5 (20 : Word),
    .SD .x8 .x5 (0 : BitVec 12),
    .JAL .x0 (jalOff 2147484288 2147484128),
    .MV .x10 .x9,
    .MV .x11 .x18,
    .ADDI .x12 .x8 (72 : BitVec 12),
    .ADDI .x13 .x8 (48 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.tx_extract_to_address 2147484148),
    .SD .x8 .x10 (136 : BitVec 12),
    .BEQ .x10 .x0 (16 : BitVec 13),
    .LI .x5 (30 : Word),
    .SD .x8 .x5 (0 : BitVec 12),
    .JAL .x0 (jalOff 2147484288 2147484168),
    .MV .x10 .x9,
    .MV .x11 .x18,
    .ADDI .x12 .x8 (96 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.tx_extract_value 2147484184),
    .SD .x8 .x10 (144 : BitVec 12),
    .BEQ .x10 .x0 (16 : BitVec 13),
    .LI .x5 (40 : Word),
    .SD .x8 .x5 (0 : BitVec 12),
    .JAL .x0 (jalOff 2147484288 2147484204),
    .MV .x10 .x9,
    .MV .x11 .x18,
    .ADDI .x12 .x8 (56 : BitVec 12),
    .ADDI .x13 .x8 (64 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.tx_extract_data_section 2147484224),
