...
#guard GuestAddrs.bnq_eq = 0x80030B44
...
#guard (bnqEqBody 0 0 [] []).flatten 0x80030B44 = bnqEq_prog
...
theorem bnqEqBody_flatten_eq (ptr1 ptr2 : Word) (bs1 bs2 : List (BitVec 8)) :
    (bnqEqBody ptr1 ptr2 bs1 bs2).flatten (0x80030B44 : Word) = bnqEq_prog := rfl
...
theorem bnqEq_spec (ptr1 ptr2 ret : Word) (bs1 bs2 : List (BitVec 8))
    ...
    cpsTripleWithin (bnqEqBody ptr1 ptr2 bs1 bs2).steps
      (0x80030B44 : Word) ret
      (CodeReq.ofProg (0x80030B44 : Word) bnqEq_prog)
  ...
  rw [show (DualReadScan.scanBody .x5 .x6 .x7 .x10 .x11 ptr1 ptr2 bs1 bs2
      48).flatten (0x80030B44 : Word) = bnqEq_prog from rfl] at h
  exact h
