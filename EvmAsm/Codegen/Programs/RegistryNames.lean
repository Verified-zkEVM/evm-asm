...
def knownProgramNames : List String :=
  ...
  ["zisk_headers_keccak_chain",
   ...
   "zisk_mpt_bounded_open_child_frame",
   ...
   "zisk_secp256k1_field_inv_n",
   "zisk_secp256k1_curve_point_ops",
   "zisk_secp256k1_add_dbl_syscall_probe",
   "zisk_secp256k1_add_dbl_opcode_probe",
   "zisk_secp256k1_recover_r",
   "zisk_bn254_g1_add_real",
   "zisk_bn254_g1_mul_real",
   "zisk_bn254_fp2_ops",
   "zisk_bn254_fq12_ops",
   "zisk_bn254_pairing_real",
   "zisk_u256_add_be",
   "zisk_u256_lt_be",
   "zisk_u256_sub_be",
   "zisk_u256_eq",
   ...
   "zisk_map_account_apply_post_fields",
   "zisk_map_account_change_value",
