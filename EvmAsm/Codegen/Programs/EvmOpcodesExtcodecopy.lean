...
def extcodecopyAtHeaderStateRoot_prog : Program :=
  [ .ADDI .x2 .x2 (-96 : BitVec 12),
    ...
    .MV .x23 .x17,
    .LUI .x5 (16 : BitVec 20),
    .BLTU .x5 .x20 (brOff (GuestAddrs.extcodecopy_at_header_state_root + 428) (GuestAddrs.extcodecopy_at_header_state_root + 84)),
    .MV .x5 .x21,
    .MV .x6 .x20,
    ...
    .LI .x10 (4 : Word),
    .JAL .x0 (jalOff (GuestAddrs.extcodecopy_at_header_state_root + 432) (GuestAddrs.extcodecopy_at_header_state_root + 144)),
    .MV .x10 .x18,
    .LI .x11 (20 : Word),
    ...
    .JAL .x0 (jalOff (GuestAddrs.extcodecopy_at_header_state_root + 432) (GuestAddrs.extcodecopy_at_header_state_root + 200)),
    .LI .x10 (0 : Word),
    .JAL .x0 (jalOff (GuestAddrs.extcodecopy_at_header_state_root + 432) (GuestAddrs.extcodecopy_at_header_state_root + 208)),
    ...
    .LI .x10 (0 : Word),
    .JAL .x0 (jalOff (GuestAddrs.extcodecopy_at_header_state_root + 432) (GuestAddrs.extcodecopy_at_header_state_root + 272)),
    ...
    .BEQ .x10 .x0 (12 : BitVec 13),
    .LI .x10 (5 : Word),
    .JAL .x0 (jalOff (GuestAddrs.extcodecopy_at_header_state_root + 432) (GuestAddrs.extcodecopy_at_header_state_root + 336)),
