...
" ++
  ...
  ".Lmbde_child:\n  mv a0, s0; mv a1, s1; li a2, 1; addi a3, sp, 80; addi a4, sp, 88; jal ra, rlp_list_nth_item; bnez a0, .Lmbde_fail; ld t0, 88(sp); li t1, 32; bgtu t0, t1, .Lmbde_fail; ld t1, 80(sp); add t1, s0, t1; sd t1, 0(s5); sd t0, 0(s6); li a0, 0; j .Lmbde_ret\n" ++
  ".Lmbde_fail:\n  li a0, 1\n" ++
  ".Lmbde_ret:\n  ld ra, 0(sp); ld s0, 8(sp); ld s1, 16(sp); ld s2, 24(sp); ld s3, 32(sp); ld s4, 40(sp); ld s5, 48(sp); ld s6, 56(sp); ld s7, 64(sp); addi sp, sp, 96; ret\n"
...
" ++
  ...
  ".Lmbdl_value:\n  mv a0, s0; mv a1, s1; li a2, 1; addi a3, sp, 80; addi a4, sp, 88; jal ra, rlp_list_nth_item; bnez a0, .Lmbdl_fail; ld t0, 88(sp); la t1, bsr_builder_witness_value_max; ld t1, 0(t1); bgtu t0, t1, .Lmbdl_fail; ld t1, 80(sp); add t1, s0, t1; sd t1, 0(s5); sd t0, 0(s6); li a0, 0; j .Lmbdl_ret\n" ++
  ".Lmbdl_fail:\n  li a0, 1\n" ++
  ".Lmbdl_ret:\n  ld ra, 0(sp); ld s0, 8(sp); ld s1, 16(sp); ld s2, 24(sp); ld s3, 32(sp); ld s4, 40(sp); ld s5, 48(sp); ld s6, 56(sp); ld s7, 64(sp); addi sp, sp, 96; ret\n"
...
def mptBoundedSplitLeafGroupFunction : String :=
  ...
  "  addi sp, sp, -128\n" ++
  "  sd ra, 0(sp); sd s0, 8(sp); sd s1, 16(sp); sd s2, 24(sp); sd s3, 32(sp); sd s4, 40(sp); sd s5, 48(sp); sd s6, 56(sp); sd s7, 64(sp)\n" ++
  "  mv s0, a0; mv s1, a1; mv s2, a2; mv s3, a3; mv s4, a4; sd a5, 72(sp); sd a6, 80(sp); bgeu s2, s3, .Lmbslg_fail; li t0, " ++ toString bsrMptKeyNibbles ++ "; bgtu s4, t0, .Lmbslg_fail; sub t0, t0, s4; beqz t0, .Lmbslg_fail; mv a0, s0; mv a1, t0; jal ra, mpt_bounded_decode_frame_payload; bnez a0, .Lmbslg_fail; ld t0, " ++ toString bsrMptFrameExtensionPathLenOffset ++ "(s0); li t1, " ++ toString bsrMptKeyNibbles ++ "; sub t1, t1, s4; bne t0, t1, .Lmbslg_fail; addi t0, s2, 1; bne t0, s3, .Lmbslg_general; slli t0, s2, 5; slli t1, s2, 3; add t0, t0, t1; add t0, t0, s1; ld t1, 32(t0); li t2, 2; bne t1, t2, .Lmbslg_general; mv a0, t0; mv a1, s4; mv a2, s0; jal ra, mpt_bounded_frame_path_match; bnez a0, .Lmbslg_general; addi t0, s2, 1; slli t1, t0, 5; slli t2, t0, 3; add t1, t1, t2; add t1, t1, s1; ld t2, 32(t1); li t3, 1; bgtu t2, t3, .Lmbslg_fail; ld a0, 0(t1); add a0, a0, s4; li t2, " ++ toString bsrMptKeyNibbles ++ "; sub a1, t2, s4; ld a2, 16(t1); ld a3, 24(t1); la a4, bsr_builder_node; addi a5, sp, 112; la a6, bsr_builder_result_ref; la a7, bsr_builder_result_len; jal ra, mpt_bounded_encode_leaf_ref; bnez a0, .Lmbslg_fail; li a0, 0; j .Lmbslg_ret\n  .Lmbslg_general:\n  ld t0, " ++ toString bsrMptFrameExtensionPathLenOffset ++ "(s0); mv a0, s1; mv a1, s2; mv a2, s3; mv a3, s4; addi a4, s0, " ++ toString bsrMptFrameExtensionPathOffset ++ "; mv a5, t0; addi a6, sp, 120; jal ra, mpt_bounded_interval_old_prefix; bnez a0, .Lmbslg_fail; ld s5, 120(sp); ld t0, " ++ toString bsrMptFrameExtensionPathLenOffset ++ "(s0); bgeu s5, t0, .Lmbslg_fail\n" ++
  ...
  ".Lmbslg_clear:\n  sd zero, 96(sp); li t1, 16; beq t0, t1, .Lmbslg_old; slli t1, t0, 5; slli t2, t0, 3; add t1, t1, t2; add t1, s0, t1; sd zero, 0(t1); addi t0, t0, 1; j .Lmbslg_clear\n" ++
  ...
  ".Lmbslg_new:\n  add a3, s4, s5; mv a0, s1; mv a1, s2; mv a2, s3; mv a4, s0; jal ra, mpt_bounded_partition_frame; bnez a0, .Lmbslg_fail; slli t0, s7, 4; addi t1, s0, " ++ toString bsrMptFrameRangeTableOffset ++ "; add t1, t1, t0; ld t2, 0(t1); ld t3, 8(t1); beq t2, t3, .Lmbslg_slots; add t0, s4, s5; addi t0, t0, 1; li t1, " ++ toString bsrMptKeyNibbles ++ "; bgeu t0, t1, .Lmbslg_fail; li t1, " ++ toString bsrMptBuilderFrameBytes ++ "; mul t0, t0, t1; la t1, bsr_builder_frames; add t0, t0, t1; la t1, bsr_builder_node; sd t1, " ++ toString bsrMptFrameNodePtrOffset ++ "(t0); ld t1, 112(sp); sd t1, " ++ toString bsrMptFrameNodeLenOffset ++ "(t0); li t1, 2; sd t1, " ++ toString bsrMptFrameNodeKindOffset ++ "(t0); mv a0, t0; mv a1, s1; mv a2, t2; mv a3, t3; add a4, s4, s5; addi a4, a4, 1; ld a5, 72(sp); ld a6, 80(sp); jal ra, mpt_bounded_rebuild_subtree; beqz a0, .Lmbslg_same_store; li t0, 2; bne a0, t0, .Lmbslg_fail; slli t0, s7, 5; slli t1, s7, 3; add t0, t0, t1; add t0, t0, s0; sd zero, 0(t0); j .Lmbslg_slots\n  .Lmbslg_same_store:\n  li t4, 1; sd t4, 96(sp); la t0, bsr_builder_result_len; ld t1, 0(t0); li t2, 32; bne t1, t2, .Lmbslg_same_unsnap; add a0, s4, s5; addi a0, a0, 1; la a1, bsr_builder_result_ref; mv a2, t1; jal ra, mpt_bounded_snapshot_constructed_child; bnez a0, .Lmbslg_fail\n  .Lmbslg_same_unsnap:\n  slli t0, s7, 5; slli t1, s7, 3; add t0, t0, t1; add t0, t0, s0; la t1, bsr_builder_result_len; ld t2, 0(t1); sd t2, 0(t0); addi t0, t0, 8; la t1, bsr_builder_result_ref\n  .Lmbslg_same_copy:\n  beqz t2, .Lmbslg_slots; lbu t3, 0(t1); sb t3, 0(t0); addi t1, t1, 1; addi t0, t0, 1; addi t2, t2, -1; j .Lmbslg_same_copy\n  .Lmbslg_slots:\n  li s6, 0\n" ++
  ".Lmbslg_slot:\n  li t0, 16; beq s6, t0, .Lmbslg_branch; slli t0, s6, 4; addi t1, s0, " ++ toString bsrMptFrameRangeTableOffset ++ "; add t1, t1, t0; ld t2, 0(t1); ld t3, 8(t1); beq t2, t3, .Lmbslg_next; beq s6, s7, .Lmbslg_next; mv a0, s1; mv a1, t2; mv a2, t3; addi a3, s4, 1; add a3, a3, s5; jal ra, mpt_bounded_build_missing_subtree; beqz a0, .Lmbslg_missing_result; li t0, 2; beq a0, t0, .Lmbslg_next; j .Lmbslg_fail\n  .Lmbslg_missing_result:\n  la t0, bsr_builder_result_len; ld t1, 0(t0); li t2, 32; bne t1, t2, .Lmbslg_missing_unsnapshotted; add a0, s4, s5; addi a0, a0, 1; la a1, bsr_builder_result_ref; mv a2, t1; jal ra, mpt_bounded_snapshot_constructed_child; bnez a0, .Lmbslg_fail\n  .Lmbslg_missing_unsnapshotted:\n  slli t0, s6, 5; slli t1, s6, 3; add t0, t0, t1; add t0, t0, s0; la t1, bsr_builder_result_len; ld t2, 0(t1); sd t2, 0(t0); addi t0, t0, 8; la t1, bsr_builder_result_ref\n" ++
  ".Lmbslg_copy_new:\n  beqz t2, .Lmbslg_next; lbu t3, 0(t1); sb t3, 0(t0); addi t1, t1, 1; addi t0, t0, 1; addi t2, t2, -1; j .Lmbslg_copy_new\n" ++
  ".Lmbslg_next:\n  addi s6, s6, 1; li t4, 16; bne s6, t4, .Lmbslg_next_go; ld t4, 96(sp); beqz t4, .Lmbslg_branch; li s7, 16; j .Lmbslg_branch\n  .Lmbslg_next_go:\n  j .Lmbslg_slot\n" ++
  ".Lmbslg_branch:\n  li t0, 0; li t1, 0\n  .Lmbslg_count:\n  li t2, 16; beq t1, t2, .Lmbslg_count_done; slli t2, t1, 5; slli t3, t1, 3; add t2, t2, t3; add t2, t2, s0; ld t2, 0(t2); beqz t2, .Lmbslg_count_next; mv a7, t1; addi t0, t0, 1\n  .Lmbslg_count_next:\n  addi t1, t1, 1; j .Lmbslg_count\n  .Lmbslg_count_done:\n  beqz t0, .Lmbslg_deleted; li t1, 1; bne t0, t1, .Lmbslg_encode_branch; sd a7, 104(sp); bne a7, s7, .Lmbslg_collapse; addi a0, s0, " ++ toString bsrMptFrameExtensionPathOffset ++ "; add a0, a0, s5; addi a0, a0, 1; li t0, " ++ toString bsrMptKeyNibbles ++ "; sub a1, t0, s4; sub a1, a1, s5; addi a1, a1, -1; ld a2, " ++ toString bsrMptFrameExtensionChildPtrOffset ++ "(s0); ld a3, " ++ toString bsrMptFrameExtensionChildLenOffset ++ "(s0); la a4, bsr_builder_node; addi a5, sp, 112; la a6, bsr_builder_result_ref; la a7, bsr_builder_result_len; jal ra, mpt_bounded_encode_leaf_ref; bnez a0, .Lmbslg_fail; slli t0, s7, 5; slli t1, s7, 3; add t0, t0, t1; add t0, t0, s0; la t1, bsr_builder_result_len; ld t2, 0(t1); sd t2, 0(t0); addi t0, t0, 8; la t1, bsr_builder_result_ref\n  .Lmbslg_refresh_copy:\n  beqz t2, .Lmbslg_refresh_done; lbu t3, 0(t1); sb t3, 0(t0); addi t1, t1, 1; addi t0, t0, 1; addi t2, t2, -1; j .Lmbslg_refresh_copy\n  .Lmbslg_refresh_done:\n  la t0, bsr_builder_result_len; ld t1, 0(t0); li t2, 32; bne t1, t2, .Lmbslg_collapse; add a0, s4, s5; addi a0, a0, 1; la a1, bsr_builder_result_ref; mv a2, t1; jal ra, mpt_bounded_snapshot_constructed_child; bnez a0, .Lmbslg_fail\n  .Lmbslg_collapse:\n  mv a0, s0; ld a1, 104(sp); add a2, s4, s5; ld a3, 72(sp); ld a4, 80(sp); addi a5, s0, " ++ toString bsrMptFrameExtensionPathOffset ++ "; mv a6, s5; jal ra, mpt_bounded_collapse_branch_leaf; bnez a0, .Lmbslg_fail; j .Lmbslg_ok\n  .Lmbslg_deleted:\n  li a0, 2; j .Lmbslg_ret\n  .Lmbslg_encode_branch:\n  mv a0, s0; la a1, bsr_builder_node; addi a2, sp, 112; jal ra, mpt_bounded_encode_branch; bnez a0, .Lmbslg_fail; la a0, bsr_builder_node; ld a1, 112(sp); la a2, bsr_builder_result_ref; la a3, bsr_builder_result_len; jal ra, mpt_bounded_node_ref; bnez a0, .Lmbslg_fail; beqz s5, .Lmbslg_ok; sd s5, " ++ toString bsrMptFrameExtensionPathLenOffset ++ "(s0); la t0, bsr_builder_result_ref; sd t0, " ++ toString bsrMptFrameExtensionChildPtrOffset ++ "(s0); la t0, bsr_builder_result_len; ld t0, 0(t0); sd t0, " ++ toString bsrMptFrameExtensionChildLenOffset ++ "(s0); mv a0, s0; la a1, bsr_builder_node; la a2, bsr_builder_result_ref; la a3, bsr_builder_result_len; jal ra, mpt_bounded_encode_extension; bnez a0, .Lmbslg_fail\n" ++
...
def mptBoundedSplitLeafFunction : String :=
  ...
  "  addi sp, sp, -128\n" ++
  "  sd ra, 0(sp); sd s0, 8(sp); sd s1, 16(sp); sd s2, 24(sp); sd s3, 32(sp); sd s4, 40(sp); sd s5, 48(sp); sd s6, 56(sp); sd s7, 64(sp)\n" ++
  "  mv s0, a0; mv s1, a1; mv s2, a2; ld s7, 32(s1); li t1, 2; beq s7, t1, .Lmbsl_mode_ok; li t1, 1; bne s7, t1, .Lmbsl_fail\n  .Lmbsl_mode_ok:\n  li t0, " ++ toString bsrMptKeyNibbles ++ "; bgtu s2, t0, .Lmbsl_fail; sub s3, t0, s2; beqz s3, .Lmbsl_fail; mv a0, s0; mv a1, s3; jal ra, mpt_bounded_decode_frame_payload; bnez a0, .Lmbsl_fail; ld t0, " ++ toString bsrMptFrameExtensionPathLenOffset ++ "(s0); bne t0, s3, .Lmbsl_fail; li t0, 2; beq s7, t0, .Lmbsl_delete_noop; li s6, 0; j .Lmbsl_match\n" ++
  ".Lmbsl_delete_noop:\n  addi a0, s0, " ++ toString bsrMptFrameExtensionPathOffset ++ "; mv a1, s3; ld a2, " ++ toString bsrMptFrameExtensionChildPtrOffset ++ "(s0); ld a3, " ++ toString bsrMptFrameExtensionChildLenOffset ++ "(s0); la a4, bsr_builder_node; addi a5, sp, 120; la a6, bsr_builder_result_ref; la a7, bsr_builder_result_len; jal ra, mpt_bounded_encode_leaf_ref; bnez a0, .Lmbsl_fail; li a0, 0; j .Lmbsl_ret\n" ++
  ".Lmbsl_match:\n" ++
...
def mptBoundedSplitExtensionGroupFunction : String :=
  ...
  ".Lmbseg_suffix_done:\n  ld t0,104(sp); sub t0,t0,s5; addi t0,t0,-1; sd t0," ++ toString bsrMptFrameExtensionPathLenOffset ++ "(s0); ld t1,72(sp); sd t1," ++ toString bsrMptFrameExtensionChildPtrOffset ++ "(s0); ld t1,80(sp); sd t1," ++ toString bsrMptFrameExtensionChildLenOffset ++ "(s0); mv a0,s0; la a1,bsr_builder_node; la a2,bsr_builder_result_ref; la a3,bsr_builder_result_len; jal ra,mpt_bounded_encode_extension; bnez a0,.Lmbseg_fail; li t0,1; sd t0,104(sp); j .Lmbseg_store_old\n" ++
  ".Lmbseg_direct:\n  sd zero,104(sp); la t0,bsr_builder_result_len; ld t1,72(sp); ld t2,80(sp); sd t2,0(t0); la t0,bsr_builder_result_ref\n  .Lmbseg_direct_copy:\n  beqz t2,.Lmbseg_store_old; lbu t3,0(t1); sb t3,0(t0); addi t1,t1,1; addi t0,t0,1; addi t2,t2,-1; j .Lmbseg_direct_copy\n" ++
  ".Lmbseg_store_old:\n  slli t0,s7,5; slli t1,s7,3; add t0,t0,t1; add t0,s0,t0; la t1,bsr_builder_result_len; ld t2,0(t1); sd t2,0(t0); addi t0,t0,8; la t1,bsr_builder_result_ref\n  .Lmbseg_copy_old:\n  beqz t2,.Lmbseg_old_saved; lbu t3,0(t1); sb t3,0(t0); addi t1,t1,1; addi t0,t0,1; addi t2,t2,-1; j .Lmbseg_copy_old\n  .Lmbseg_old_saved:\n  ld t0,104(sp); beqz t0,.Lmbseg_new; add a0,s4,s5; addi a0,a0,1; la a1,bsr_builder_result_ref; la a2,bsr_builder_result_len; ld a2,0(a2); jal ra,mpt_bounded_snapshot_constructed_child; bnez a0,.Lmbseg_fail\n" ++
  ".Lmbseg_new:\n  add a3,s4,s5; mv a0,s1; mv a1,s2; mv a2,s3; mv a4,s0; jal ra,mpt_bounded_partition_frame; bnez a0,.Lmbseg_fail; li s6,0\n  .Lmbseg_slot:\n  li t0,16; beq s6,t0,.Lmbseg_branch; slli t0,s6,4; addi t1,s0," ++ toString bsrMptFrameRangeTableOffset ++ "; add t1,t1,t0; ld t2,0(t1); ld t3,8(t1); beq t2,t3,.Lmbseg_next; beq s6,s7,.Lmbseg_same; mv a0,s1; mv a1,t2; mv a2,t3; addi a3,s4,1; add a3,a3,s5; jal ra,mpt_bounded_build_missing_subtree; beqz a0,.Lmbseg_missing_result; li t0,2; beq a0,t0,.Lmbseg_next; j .Lmbseg_fail\n  .Lmbseg_same:\n  sd t2,112(sp); sd t3,120(sp); add t0,s4,s5; addi t0,t0,1; li t1," ++ toString bsrMptBuilderFrameBytes ++ "; mul t0,t0,t1; la t1,bsr_builder_frames; add t0,t0,t1; sd t0,104(sp); slli t1,s7,5; slli t2,s7,3; add t1,t1,t2; add t1,t1,s0; addi a0,t1,8; ld a1,0(t1); ld a2,88(sp); ld a3,96(sp); ld a4,104(sp); jal ra,mpt_bounded_open_child_frame; beqz a0,.Lmbseg_same_opened; ld t0,104(sp); slli t1,s7,5; slli t2,s7,3; add t1,t1,t2; add t1,t1,s0; addi a0,t1,8; ld a1,0(t1); add a2,s4,s5; addi a2,a2,1; mv a3,t0; jal ra,mpt_bounded_open_constructed_child_frame; bnez a0,.Lmbseg_fail\n  .Lmbseg_same_opened:\n  ld a0,104(sp); mv a1,s1; ld a2,112(sp); ld a3,120(sp); add a4,s4,s5; addi a4,a4,1; ld a5,88(sp); ld a6,96(sp); jal ra,mpt_bounded_rebuild_subtree; beqz a0,.Lmbseg_same_result; li t0,2; bne a0,t0,.Lmbseg_fail; slli t0,s7,5; slli t1,s7,3; add t0,t0,t1; add t0,t0,s0; sd zero,0(t0); j .Lmbseg_next\n  .Lmbseg_same_result:\n  la t0,bsr_builder_result_len; ld t1,0(t0); li t2,32; bne t1,t2,.Lmbseg_missing_result; add a0,s4,s5; addi a0,a0,1; la a1,bsr_builder_result_ref; mv a2,t1; jal ra,mpt_bounded_snapshot_constructed_child; bnez a0,.Lmbseg_fail; j .Lmbseg_missing_result\n  .Lmbseg_missing_result:\n  slli t0,s6,5; slli t1,s6,3; add t0,t0,t1; add t0,s0,t0; la t1,bsr_builder_result_len; ld t2,0(t1); sd t2,0(t0); addi t0,t0,8; la t1,bsr_builder_result_ref\n  .Lmbseg_copy_new:\n  beqz t2,.Lmbseg_next; lbu t3,0(t1); sb t3,0(t0); addi t1,t1,1; addi t0,t0,1; addi t2,t2,-1; j .Lmbseg_copy_new\n  .Lmbseg_next:\n  addi s6,s6,1; j .Lmbseg_slot\n" ++
...
def mptBoundedCollapseBranchLeafFunction : String :=
  ...
  ".Lmbcbl_shift:\n" ++
  "  beqz s6, .Lmbcbl_prefix; addi t1, t1, -1; lbu t2, 0(t1); add t3, t1, t6; sb t2, 0(t3); addi s6, s6, -1; j .Lmbcbl_shift\n" ++
  ".Lmbcbl_prefix:\n" ++
  "  ld t1, 80(sp); ld t2, 88(sp)\n  .Lmbcbl_prefix_copy:\n  beqz t2, .Lmbcbl_prefix_nibble; lbu t3, 0(t1); sb t3, 0(t0); addi t0, t0, 1; addi t1, t1, 1; addi t2, t2, -1; j .Lmbcbl_prefix_copy\n  .Lmbcbl_prefix_nibble:\n  sb s1, 0(t0); sd t5, " ++ toString bsrMptFrameExtensionPathLenOffset ++ "(s5); mv t1, t5; ld t0, 64(sp); li t2, 2; bne t0, t2, .Lmbcbl_extension; addi a0, s5, " ++ toString bsrMptFrameExtensionPathOffset ++ "; mv a1, t1; ld a2, " ++ toString bsrMptFrameExtensionChildPtrOffset ++ "(s5); ld a3, " ++ toString bsrMptFrameExtensionChildLenOffset ++ "(s5); la a4, bsr_builder_node; addi a5, sp, 64; la a6, bsr_builder_result_ref; la a7, bsr_builder_result_len; jal ra, mpt_bounded_encode_leaf_ref; bnez a0, .Lmbcbl_fail; li a0, 0; j .Lmbcbl_ret\n" ++
...
def mptBoundedBuildMissingSubtreeFunction : String :=
  ...
  "  # A final delete below an absent branch is a no-op: propagate the empty\n" ++
  "  # subtree marker so the parent leaves this child slot unset.\n" ++
  ".Lmbms_one:\n  slli t0, s1, 5; slli t1, s1, 3; add t0, t0, t1; add t0, s0, t0; ld t1, 32(t0); li t2, 2; beq t1, t2, .Lmbms_deleted; li t2, 1; bne t1, t2, .Lmbms_fail; ld a0, 0(t0); add a0, a0, s3; li t1, " ++ toString bsrMptKeyNibbles ++ "; sub a1, t1, s3; ld a2, 16(t0); ld a3, 24(t0); la a4, bsr_builder_node; addi a5, sp, 72; la a6, bsr_builder_result_ref; la a7, bsr_builder_result_len; jal ra, mpt_bounded_encode_leaf_ref; bnez a0, .Lmbms_fail; li a0, 0; j .Lmbms_ret\n" ++
  ...
  ".Lmbms_child:\n  li t0, 16; beq s5, t0, .Lmbms_finish; slli t0, s5, 4; addi t1, s4, " ++ toString bsrMptFrameRangeTableOffset ++ "; add t1, t1, t0; ld t2, 0(t1); ld t3, 8(t1); beq t2, t3, .Lmbms_next; sd t2, 72(sp); sd t3, 80(sp); addi a0, s0, 0; mv a1, t2; mv a2, t3; addi a3, s3, 1; jal ra, mpt_bounded_build_missing_subtree; beqz a0, .Lmbms_child_store; li t0, 2; bne a0, t0, .Lmbms_ret; j .Lmbms_next\n  .Lmbms_child_store:\n  la t1, bsr_builder_result_len; ld t2, 0(t1); li t3, 32; bne t2, t3, .Lmbms_child_copy; addi a0, s3, 1; la a1, bsr_builder_result_ref; mv a2, t2; jal ra, mpt_bounded_snapshot_constructed_child; bnez a0, .Lmbms_fail\n  .Lmbms_child_copy:\n  slli t0, s5, 5; slli t1, s5, 3; add t0, t0, t1; add t0, s4, t0; la t1, bsr_builder_result_len; ld t2, 0(t1); sd t2, 0(t0); addi t0, t0, 8; la t1, bsr_builder_result_ref\n" ++
  ...
  ".Lmbms_finish:\n  beqz s6, .Lmbms_deleted; li t0, 2; bgeu s6, t0, .Lmbms_branch; li t0, 1; bne s6, t0, .Lmbms_fail; mv a0, s4; mv a1, s7; mv a2, s3; mv a3, zero; mv a4, zero; mv a5, zero; mv a6, zero; jal ra, mpt_bounded_collapse_branch_leaf; j .Lmbms_ret\n" ++
...
def mptBoundedRebuildSubtreeFunction : String :=
  ...
  ".Lmbrs_ext_group:\n  mv a0,s0; mv a1,s1; mv a2,s2; mv a3,s3; mv a4,s4; mv a5,s5; mv a6,s6; jal ra,mpt_bounded_split_extension_group; j .Lmbrs_ret\n" ++
  ...
  "  sd t2, 80(sp); sd t3, 88(sp); slli t0, s7, 5; slli t1, s7, 3; add t0, t0, t1; add t0, s0, t0; ld t4, 0(t0); beqz t4, .Lmbrs_missing; addi t5, t0, 8; addi t6, s4, 1; li a0, " ++ toString bsrMptBuilderFrameBytes ++ "; mul t6, t6, a0; la a0, bsr_builder_frames; add a4, a0, t6; sd a4, 72(sp); mv a0, t5; mv a1, t4; mv a2, s5; mv a3, s6; jal ra, mpt_bounded_open_child_frame; beqz a0, .Lmbrs_child_opened; slli t0, s7, 5; slli t1, s7, 3; add t0, t0, t1; add t0, t0, s0; addi a0, t0, 8; ld a1, 0(t0); addi a2, s4, 1; ld a3, 72(sp); jal ra, mpt_bounded_open_constructed_child_frame; bnez a0, .Lmbrs_fail\n  .Lmbrs_child_opened:\n" ++
  ...
  ".Lmbrs_missing:\n  mv a0, s1; ld a1, 80(sp); ld a2, 88(sp); addi a3, s4, 1; jal ra, mpt_bounded_build_missing_subtree; beqz a0, .Lmbrs_child_done; li t0, 2; bne a0, t0, .Lmbrs_ret; j .Lmbrs_next\n" ++
  ...
  ".Lmbrs_count_done:\n  li t1, 2; bgeu t0, t1, .Lmbrs_keep_branch; beqz t0, .Lmbrs_deleted; ld a1, 80(sp); mv a0, s0; mv a2, s4; mv a3, s5; mv a4, s6; mv a5, zero; mv a6, zero; jal ra, mpt_bounded_collapse_branch_leaf; j .Lmbrs_ret\n" ++
