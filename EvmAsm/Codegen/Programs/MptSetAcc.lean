...
def nodeDbLookup_prog : Program :=
  [ .AUIPC .x5 (laHi GuestAddrs.mset_db_count (GuestAddrs.node_db_lookup + 0)),
    ...
    .BEQ .x31 .x0 (brOff (GuestAddrs.node_db_lookup + 124) (GuestAddrs.node_db_lookup + 20)),
    .LD .x5 .x30 (0 : BitVec 12),
    .LD .x6 .x10 (0 : BitVec 12),
    .BNE .x5 .x6 (brOff (GuestAddrs.node_db_lookup + 96) (GuestAddrs.node_db_lookup + 32)),
    ...
    .JAL .x0 (jalOff (GuestAddrs.node_db_lookup + 20) (GuestAddrs.node_db_lookup + 120)),
    .LI .x10 (1 : Word),
    .JALR .x0 .x1 (0 : BitVec 12) ]
...
def mptNodeResolve_prog : Program :=
  [ .ADDI .x2 .x2 (-48 : BitVec 12),
    ...
    .BEQ .x10 .x0 (brOff (GuestAddrs.mpt_node_resolve + 416) (GuestAddrs.mpt_node_resolve + 64)),
    ...
    .ADD .x6 .x6 .x7,
    .LD .x7 .x6 (0 : BitVec 12),
    .BEQ .x7 .x0 (brOff (GuestAddrs.mpt_node_resolve + 216) (GuestAddrs.mpt_node_resolve + 116)),
    ...
    .BNE .x28 .x29 (brOff (GuestAddrs.mpt_node_resolve + 216) (GuestAddrs.mpt_node_resolve + 152)),
    ...
    .LI .x10 (0 : Word),
    .JAL .x0 (jalOff (GuestAddrs.mpt_node_resolve + 416) (GuestAddrs.mpt_node_resolve + 212)),
    .MV .x10 .x8,
    .MV .x11 .x9,
    .MV .x12 .x18,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_node_resolve + 416) (GuestAddrs.mpt_node_resolve + 248)),
...
def mptSetRecordWalkDb_prog : Program :=
  [ .ADDI .x2 .x2 (-96 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_set_record_walk_db + 968) (GuestAddrs.mpt_set_record_walk_db + 108)),
    ...
    .LI .x5 (1 : Word),
    .BEQ .x10 .x5 (brOff (GuestAddrs.mpt_set_record_walk_db + 400) (GuestAddrs.mpt_set_record_walk_db + 160)),
    .LI .x5 (2 : Word),
    .BEQ .x10 .x5 (brOff (GuestAddrs.mpt_set_record_walk_db + 760) (GuestAddrs.mpt_set_record_walk_db + 168)),
    .JAL .x0 (jalOff (GuestAddrs.mpt_set_record_walk_db + 976) (GuestAddrs.mpt_set_record_walk_db + 172)),
    .BEQ .x22 .x19 (brOff (GuestAddrs.mpt_set_record_walk_db + 376) (GuestAddrs.mpt_set_record_walk_db + 176)),
    .ADD .x5 .x18 .x22,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_set_record_walk_db + 976) (GuestAddrs.mpt_set_record_walk_db + 248)),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .BEQ .x6 .x0 (brOff (GuestAddrs.mpt_set_record_walk_db + 968) (GuestAddrs.mpt_set_record_walk_db + 264)),
    .LI .x7 (32 : Word),
    ...
    .ADD .x23 .x23 .x7,
    .MV .x24 .x6,
    .JAL .x0 (jalOff (GuestAddrs.mpt_set_record_walk_db + 140) (GuestAddrs.mpt_set_record_walk_db + 296)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_set_record_walk_db + 968) (GuestAddrs.mpt_set_record_walk_db + 344)),
    ...
    .LD .x24 .x5 (0 : BitVec 12),
    .JAL .x0 (jalOff (GuestAddrs.mpt_set_record_walk_db + 140) (GuestAddrs.mpt_set_record_walk_db + 372)),
    .SD .x21 .x25 (0 : BitVec 12),
    .SD .x21 .x22 (8 : BitVec 12),
    .SD .x21 .x23 (16 : BitVec 12),
    .SD .x21 .x24 (24 : BitVec 12),
    .LI .x10 (0 : Word),
    .JAL .x0 (jalOff (GuestAddrs.mpt_set_record_walk_db + 980) (GuestAddrs.mpt_set_record_walk_db + 396)),
    .MV .x10 .x23,
    .MV .x11 .x24,
    .LI .x12 (0 : Word),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_set_record_walk_db + 976) (GuestAddrs.mpt_set_record_walk_db + 432)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_set_record_walk_db + 976) (GuestAddrs.mpt_set_record_walk_db + 492)),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .BNE .x6 .x0 (brOff (GuestAddrs.mpt_set_record_walk_db + 976) (GuestAddrs.mpt_set_record_walk_db + 508)),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .ADD .x7 .x22 .x6,
    .BLTU .x19 .x7 (brOff (GuestAddrs.mpt_set_record_walk_db + 968) (GuestAddrs.mpt_set_record_walk_db + 528)),
    ...
    .BNE .x30 .x31 (brOff (GuestAddrs.mpt_set_record_walk_db + 968) (GuestAddrs.mpt_set_record_walk_db + 560)),
    .ADDI .x7 .x7 (1 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_set_record_walk_db + 976) (GuestAddrs.mpt_set_record_walk_db + 644)),
    ...
    .MV .x23 .x28,
    .MV .x24 .x6,
    .JAL .x0 (jalOff (GuestAddrs.mpt_set_record_walk_db + 140) (GuestAddrs.mpt_set_record_walk_db + 692)),
    .MV .x12 .x28,
    .MV .x10 .x8,
    .MV .x11 .x9,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_set_record_walk_db + 968) (GuestAddrs.mpt_set_record_walk_db + 728)),
    ...
    .LD .x24 .x5 (0 : BitVec 12),
    .JAL .x0 (jalOff (GuestAddrs.mpt_set_record_walk_db + 140) (GuestAddrs.mpt_set_record_walk_db + 756)),
    .MV .x10 .x23,
    .MV .x11 .x24,
    .LI .x12 (0 : Word),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_set_record_walk_db + 976) (GuestAddrs.mpt_set_record_walk_db + 792)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_set_record_walk_db + 976) (GuestAddrs.mpt_set_record_walk_db + 852)),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .LI .x7 (1 : Word),
    .BNE .x6 .x7 (brOff (GuestAddrs.mpt_set_record_walk_db + 976) (GuestAddrs.mpt_set_record_walk_db + 872)),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .SUB .x7 .x19 .x22,
    .BNE .x6 .x7 (brOff (GuestAddrs.mpt_set_record_walk_db + 968) (GuestAddrs.mpt_set_record_walk_db + 892)),
...
def mptSetAcc_prog : Program :=
  [ .ADDI .x2 .x2 (-96 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_set_acc + 424) (GuestAddrs.mpt_set_acc + 104)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_set_acc + 476) (GuestAddrs.mpt_set_acc + 160)),
    ...
    .MV .x23 .x22,
    .BEQ .x23 .x0 (brOff (GuestAddrs.mpt_set_acc + 400) (GuestAddrs.mpt_set_acc + 228)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_set_acc + 476) (GuestAddrs.mpt_set_acc + 332)),
    ...
    .JAL .x0 (jalOff (GuestAddrs.mpt_set_acc + 228) (GuestAddrs.mpt_set_acc + 396)),
...
def mptStateRoot_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .LI .x21 (0 : Word),
    .BEQ .x21 .x19 (brOff (GuestAddrs.mpt_state_root + 200) (GuestAddrs.mpt_state_root + 132)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_state_root + 280) (GuestAddrs.mpt_state_root + 188)),
    .ADDI .x21 .x21 (1 : BitVec 12),
    .JAL .x0 (jalOff (GuestAddrs.mpt_state_root + 132) (GuestAddrs.mpt_state_root + 196)),
