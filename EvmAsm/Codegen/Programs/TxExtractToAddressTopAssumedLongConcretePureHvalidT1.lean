...
theorem extractAssumed_creation_longConcrete_pureHvalid_t1
  ...
  have hv :=
    extractSuccess_creation_t1_hvalid_srcOff_long txBytes txBase hsuccess
      hcreFlag htype1 items hdecL hlong hge6 hvalidBuf
  have hll :=
    extractSuccess_long_hlover_hlvalid txBytes txBase hsuccess items hdecL hlong
      hover hvalidBuf
  exact extractAssumed_creation_longConcrete_pureHdec_t1
    ...
    hitem4 hv.2.2.2.2.2.2.2.2.1 hv.2.2.2.2.2.2.2.2.2
    hge6

set_option maxRecDepth 8000 in
theorem extractAssumed_creation_longConcrete_pureHvalid_t1_fullCode
    (sp0 spC : Word) (s : ExtractSaved)
    (txBase lenW toBuf isCreationPtr : Word)
    (txBytes : List (BitVec 8))
    (items : List EL.RLP.RLPItem)
...
#print axioms extractAssumed_creation_longConcrete_pureHvalid_t1
#print axioms extractAssumed_creation_longConcrete_pureHvalid_t1_fullCode
