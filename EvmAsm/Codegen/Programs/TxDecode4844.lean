...
def txEip4844Decode_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .BNE .x12 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 36)),
    .MV .x9 .x11,
    .MV .x19 .x10,
    .MV .x10 .x19,
    .MV .x11 .x9,
    ...
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 64)),
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    .JAL .x1 (jalOff GuestAddrs.rlp_content_to_u64_strict (GuestAddrs.tx_eip4844_decode + 76)),
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 80)),
    .SD .x18 .x10 (0 : BitVec 12),
    .MV .x10 .x19,
    .MV .x11 .x9,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.tx_eip4844_decode + 96)),
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 104)),
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    .JAL .x1 (jalOff GuestAddrs.rlp_content_to_u64_strict (GuestAddrs.tx_eip4844_decode + 116)),
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 120)),
    .SD .x18 .x10 (8 : BitVec 12),
    .MV .x10 .x19,
    .MV .x11 .x9,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.tx_eip4844_decode + 136)),
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 144)),
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    .ADDI .x12 .x18 (16 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.rlp_content_to_u256_be_strict (GuestAddrs.tx_eip4844_decode + 160)),
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 164)),
    .MV .x10 .x19,
    .MV .x11 .x9,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.tx_eip4844_decode + 176)),
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 184)),
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    .ADDI .x12 .x18 (48 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.rlp_content_to_u256_be_strict (GuestAddrs.tx_eip4844_decode + 200)),
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 204)),
    .MV .x10 .x19,
    .MV .x11 .x9,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.tx_eip4844_decode + 216)),
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 224)),
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    .JAL .x1 (jalOff GuestAddrs.rlp_content_to_u64_strict (GuestAddrs.tx_eip4844_decode + 236)),
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 240)),
    .SD .x18 .x10 (80 : BitVec 12),
    .MV .x10 .x19,
    .MV .x11 .x9,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.tx_eip4844_decode + 256)),
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 264)),
    .BEQ .x12 .x0 (56 : BitVec 13),
    .LI .x5 (20 : Word),
    .BNE .x12 .x5 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 276)),
    .SUB .x28 .x10 .x12,
    ...
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 360)),
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    .ADDI .x12 .x18 (112 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.rlp_content_to_u256_be_strict (GuestAddrs.tx_eip4844_decode + 376)),
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 380)),
    .MV .x10 .x19,
    .MV .x11 .x9,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.tx_eip4844_decode + 392)),
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 400)),
    .SUB .x28 .x10 .x12,
    .SUB .x6 .x28 .x8,
    ...
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 436)),
    .SUB .x28 .x10 .x12,
    .SUB .x6 .x28 .x8,
    ...
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 472)),
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    ...
    .JAL .x1 (jalOff GuestAddrs.rlp_content_to_u256_be_strict (GuestAddrs.tx_eip4844_decode + 492)),
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 496)),
    ...
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 616)),
    .SUB .x28 .x10 .x12,
    .SUB .x6 .x28 .x8,
    ...
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 652)),
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    .JAL .x1 (jalOff GuestAddrs.rlp_content_to_u64_strict (GuestAddrs.tx_eip4844_decode + 664)),
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 668)),
    .SD .x18 .x10 (176 : BitVec 12),
    .MV .x10 .x19,
    .MV .x11 .x9,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.tx_eip4844_decode + 684)),
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip4844_decode + 764) (GuestAddrs.tx_eip4844_decode + 692)),
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    .ADDI .x12 .x18 (184 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.rlp_content_to_u256_be_strict (GuestAddrs.tx_eip4844_decode + 708)),
    ...
    .JAL .x1 (jalOff GuestAddrs.rlp_content_to_u256_be_strict (GuestAddrs.tx_eip4844_decode + 748)),
...
def txEip4844Decode_relocs : RelocTable :=
  [ (8, .jal .x1 "rlp_walk_init"),
    ...
    (123, .jal .x1 "rlp_content_to_u256_be_strict"),
    (125, .la .x5 "tcbg_blob_fee_be"),
    (152, .jal .x1 "rlp_walk_next"),
    (161, .jal .x1 "rlp_walk_next"),
    (166, .jal .x1 "rlp_content_to_u64_strict"),
    (171, .jal .x1 "rlp_walk_next"),
    (177, .jal .x1 "rlp_content_to_u256_be_strict"),
    (181, .jal .x1 "rlp_walk_next"),
    (187, .jal .x1 "rlp_content_to_u256_be_strict") ]
