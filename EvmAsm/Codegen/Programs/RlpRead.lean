...
def rlpEncodeListPrefix_prog : Program :=
  [ .LI .x5 (56 : Word),
    ...
    .LI .x28 (1 : Word),
    .LI .x29 (256 : Word),
    .BLTU .x10 .x29 (brOff (GuestAddrs.rlp_encode_list_prefix + 120) (GuestAddrs.rlp_encode_list_prefix + 40)),
    .LI .x28 (2 : Word),
    .SLLI .x29 .x29 (8 : BitVec 6),
    .BLTU .x10 .x29 (brOff (GuestAddrs.rlp_encode_list_prefix + 120) (GuestAddrs.rlp_encode_list_prefix + 52)),
    .LI .x28 (3 : Word),
    .SLLI .x29 .x29 (8 : BitVec 6),
...
def rlpEncodeBytes_prog : Program :=
  [ .MV .x5 .x10,
    ...
    .JALR .x0 .x1 (0 : BitVec 12),
    .LI .x28 (56 : Word),
    .BGEU .x6 .x28 (brOff (GuestAddrs.rlp_encode_bytes + 120) (GuestAddrs.rlp_encode_bytes + 56)),
    ...
    .LI .x28 (1 : Word),
    .LI .x29 (256 : Word),
    .BLTU .x6 .x29 (brOff (GuestAddrs.rlp_encode_bytes + 208) (GuestAddrs.rlp_encode_bytes + 128)),
    .LI .x28 (2 : Word),
    .SLLI .x29 .x29 (8 : BitVec 6),
    .BLTU .x6 .x29 (brOff (GuestAddrs.rlp_encode_bytes + 208) (GuestAddrs.rlp_encode_bytes + 140)),
    .LI .x28 (3 : Word),
    .SLLI .x29 .x29 (8 : BitVec 6),
