...
def accountAddBalance_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.account_add_balance + 396) (GuestAddrs.account_add_balance + 80)),
    ...
    .LI .x7 (32 : Word),
    .BLTU .x7 .x6 (brOff (GuestAddrs.account_add_balance + 396) (GuestAddrs.account_add_balance + 124)),
...
def accountSetUintField_prog : Program :=
  [ .ADDI .x2 .x2 (-80 : BitVec 12),
    ...
    .MV .x22 .x16,
    .LI .x5 (32 : Word),
    .BLTU .x5 .x20 (brOff (GuestAddrs.account_set_uint_field + 152) (GuestAddrs.account_set_uint_field + 68)),
    .MV .x10 .x19,
    .MV .x11 .x20,
...
def selfdestructBalanceTransfer_prog : Program :=
  [ .ADDI .x2 .x2 (-80 : BitVec 12),
    ...
    .BNE .x20 .x0 (brOff (GuestAddrs.selfdestruct_balance_transfer + 240) (GuestAddrs.selfdestruct_balance_transfer + 80)),
    .MV .x10 .x8,
    .MV .x11 .x9,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.selfdestruct_balance_transfer + 384) (GuestAddrs.selfdestruct_balance_transfer + 104)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.selfdestruct_balance_transfer + 384) (GuestAddrs.selfdestruct_balance_transfer + 192)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.selfdestruct_balance_transfer + 384) (GuestAddrs.selfdestruct_balance_transfer + 228)),
    .LI .x10 (0 : Word),
    .JAL .x0 (jalOff (GuestAddrs.selfdestruct_balance_transfer + 388) (GuestAddrs.selfdestruct_balance_transfer + 236)),
    ...
    .LI .x10 (0 : Word),
    .JAL .x0 (jalOff (GuestAddrs.selfdestruct_balance_transfer + 388) (GuestAddrs.selfdestruct_balance_transfer + 288)),
