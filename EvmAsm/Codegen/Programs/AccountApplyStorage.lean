...
def accountApplyStorageSlot_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.account_apply_storage_slot + 252) (GuestAddrs.account_apply_storage_slot + 96)),
    ...
    .LI .x7 (32 : Word),
    .BNE .x6 .x7 (brOff (GuestAddrs.account_apply_storage_slot + 244) (GuestAddrs.account_apply_storage_slot + 116)),
    ...
    .BNE .x29 .x30 (brOff (GuestAddrs.account_apply_storage_slot + 244) (GuestAddrs.account_apply_storage_slot + 160)),
...
def accountApplyStorageSlotAcc_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.account_apply_storage_slot_acc + 768) (GuestAddrs.account_apply_storage_slot_acc + 96)),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .LI .x7 (32 : Word),
    .BNE .x6 .x7 (brOff (GuestAddrs.account_apply_storage_slot_acc + 760) (GuestAddrs.account_apply_storage_slot_acc + 116)),
    ...
    .ADDI .x28 .x28 (-1 : BitVec 12),
    .JAL .x0 (-28 : BitVec 21),
    .BEQ .x20 .x0 (brOff (GuestAddrs.account_apply_storage_slot_acc + 732) (GuestAddrs.account_apply_storage_slot_acc + 180)),
    .MV .x10 .x18,
    .MV .x11 .x19,
    .MV .x12 .x20,
    ...
    .JAL .x0 (jalOff (GuestAddrs.account_apply_storage_slot_acc + 544) (GuestAddrs.account_apply_storage_slot_acc + 208)),
    ...
    .BEQ .x5 .x0 (brOff (GuestAddrs.account_apply_storage_slot_acc + 760) (GuestAddrs.account_apply_storage_slot_acc + 224)),
    .BEQ .x20 .x0 (brOff (GuestAddrs.account_apply_storage_slot_acc + 584) (GuestAddrs.account_apply_storage_slot_acc + 228)),
    .MV .x10 .x19,
    .MV .x11 .x20,
    ...
    .BEQ .x10 .x0 (brOff (GuestAddrs.account_apply_storage_slot_acc + 544) (GuestAddrs.account_apply_storage_slot_acc + 420)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.account_apply_storage_slot_acc + 760) (GuestAddrs.account_apply_storage_slot_acc + 540)),
    .MV .x10 .x8,
    .MV .x11 .x9,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.account_apply_storage_slot_acc + 768) (GuestAddrs.account_apply_storage_slot_acc + 572)),
    .LI .x10 (0 : Word),
    .JAL .x0 (jalOff (GuestAddrs.account_apply_storage_slot_acc + 772) (GuestAddrs.account_apply_storage_slot_acc + 580)),
    .MV .x10 .x18,
    .LI .x11 (32 : Word),
    ...
    .BEQ .x10 .x0 (brOff (GuestAddrs.account_apply_storage_slot_acc + 544) (GuestAddrs.account_apply_storage_slot_acc + 724)),
    .JAL .x0 (32 : BitVec 21),
    .MV .x10 .x21,
    .MV .x11 .x8,
    .MV .x12 .x9,
