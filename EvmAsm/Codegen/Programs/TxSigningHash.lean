...
def rlpListTruncateToNFields_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .MV .x19 .x13,
    .MV .x20 .x14,
    .BEQ .x18 .x0 (brOff (GuestAddrs.rlp_list_truncate_to_n_fields + 260) (GuestAddrs.rlp_list_truncate_to_n_fields + 56)),
    .BEQ .x9 .x0 (brOff (GuestAddrs.rlp_list_truncate_to_n_fields + 284) (GuestAddrs.rlp_list_truncate_to_n_fields + 60)),
    .LBU .x5 .x8 (0 : BitVec 12),
    .LI .x6 (192 : Word),
    .BLTU .x5 .x6 (brOff (GuestAddrs.rlp_list_truncate_to_n_fields + 284) (GuestAddrs.rlp_list_truncate_to_n_fields + 72)),
    .LI .x6 (248 : Word),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.rlp_list_truncate_to_n_fields + 292) (GuestAddrs.rlp_list_truncate_to_n_fields + 136)),
...
def txSigningHash_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .BEQ .x9 .x0 (brOff (GuestAddrs.tx_signing_hash + 328) (GuestAddrs.tx_signing_hash + 68)),
    .LBU .x5 .x8 (0 : BitVec 12),
    .LI .x6 (192 : Word),
    .BLTU .x5 .x6 (brOff (GuestAddrs.tx_signing_hash + 328) (GuestAddrs.tx_signing_hash + 80)),
    .LI .x6 (248 : Word),
    .BLTU .x5 .x6 (16 : BitVec 13),
    .ADDI .x21 .x5 (-247 : BitVec 12),
    .ADDI .x21 .x21 (1 : BitVec 12),
    ...
    .LI .x21 (1 : Word),
    .LI .x22 (0 : Word),
    .BEQ .x18 .x0 (brOff (GuestAddrs.tx_signing_hash + 188) (GuestAddrs.tx_signing_hash + 112)),
    .ADDI .x5 .x18 (-1 : BitVec 12),
    .MV .x10 .x8,
    .MV .x11 .x9,
    .MV .x12 .x5,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_signing_hash + 328) (GuestAddrs.tx_signing_hash + 160)),
...
def txSigningHashLegacyEip155_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .MV .x18 .x12,
    .MV .x19 .x13,
    .BEQ .x9 .x0 (brOff (GuestAddrs.tx_signing_hash_legacy_eip155 + 436) (GuestAddrs.tx_signing_hash_legacy_eip155 + 52)),
    .LBU .x5 .x8 (0 : BitVec 12),
    .LI .x6 (192 : Word),
    .BLTU .x5 .x6 (brOff (GuestAddrs.tx_signing_hash_legacy_eip155 + 436) (GuestAddrs.tx_signing_hash_legacy_eip155 + 64)),
    .LI .x6 (248 : Word),
    .BLTU .x5 .x6 (16 : BitVec 13),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_signing_hash_legacy_eip155 + 436) (GuestAddrs.tx_signing_hash_legacy_eip155 + 124)),
