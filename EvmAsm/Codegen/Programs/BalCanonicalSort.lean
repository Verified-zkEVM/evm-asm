...
def balCanonicalSortHead_prog : Program :=
  [ .ADDI .x2 .x2 (-112 : BitVec 12),
    ...
    .BEQ .x15 .x0 (brOff (GuestAddrs.bal_canonical_sort + 508) (GuestAddrs.bal_canonical_sort + 84)),
    .BLTU .x15 .x11 (brOff (GuestAddrs.bal_canonical_sort + 508) (GuestAddrs.bal_canonical_sort + 88)),
    .MV .x8 .x10,
    .MV .x9 .x11,
    .MV .x24 .x12,
    .MV .x26 .x13,
    ...
    .JAL .x0 (-28 : BitVec 21),
    .BEQ .x25 .x0 (brOff (GuestAddrs.bal_canonical_sort + 76) (GuestAddrs.bal_canonical_sort + 148)),
    ...
    .LI .x19 (0 : Word),
    .LI .x5 (2 : Word),
    .BLTU .x9 .x5 (brOff (GuestAddrs.bal_canonical_sort + 524) (GuestAddrs.bal_canonical_sort + 172)),
    .SD .x18 .x0 (0 : BitVec 12),
    .SD .x18 .x9 (8 : BitVec 12),
    .SD .x18 .x0 (16 : BitVec 12),
    .SD .x18 .x0 (24 : BitVec 12),
    .LI .x19 (1 : Word),
    .BEQ .x19 .x0 (brOff (GuestAddrs.bal_canonical_sort + 524) (GuestAddrs.bal_canonical_sort + 196)),
    ...
    .MV .x6 .x23,
    .BEQ .x6 .x21 (brOff (GuestAddrs.bal_canonical_sort + 444) (GuestAddrs.bal_canonical_sort + 256)),
    .MUL .x5 .x6 .x24,
    .ADD .x5 .x8 .x5 ]
