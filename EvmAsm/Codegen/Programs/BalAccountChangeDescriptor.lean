...
def balAccountChangeDescriptor_prog : Program :=
  [ .ADDI .x2 .x2 (-96 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.bal_account_change_descriptor + 244) (GuestAddrs.bal_account_change_descriptor + 132)),
    .MV .x10 .x19,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.bal_account_change_descriptor + 244) (GuestAddrs.bal_account_change_descriptor + 164)),
