/-
  Front E → ret short concrete t1 creation of_decode (no ∀endPtr).
-/
...
/-- Front short + t1 AfterSave→creation steps. -/
def nFrontCreationStepsShortT1 : Nat :=
...
theorem extractFrontCreation_then_epi_of_decode_short_concrete_t1
    ...
    cpsTripleWithin nFrontCreationStepsShortT1
  ...
  have hC := extractFrontAfterSaveCreation_then_epi_of_decode_short_t1 sp0 spC s
...
#print axioms extractFrontCreation_then_epi_of_decode_short_concrete_t1
