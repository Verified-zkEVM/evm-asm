/-
  Wire pure honesty into ambient short concrete Assumed creation for t1 (type=1).
...
/-- Ambient short concrete Assumed creation with pure-discharged hcur/hnext/hcre/hinb/
    hoff/hover/hls/hll/hne and short walk guards. Residual: hvalid*/hvalid1_*/hdec*. -/
theorem extractAssumed_creation_shortConcrete_pure_t1_ambient
  ...
  have hhoff :=
    extractSuccess_creation_t1_hoff_srcOff slice hsuccess hcreFlag htype1
      items hdecL hshort
  ...
  have hhover :=
    extractSuccess_creation_t1_hover_srcOff slice loadPtr hsuccess hcreFlag htype1
      items hdecL hshort hover_sl
  have hlenItems :=
    extractSuccess_creation_t1_items_length slice hsuccess hcreFlag htype1
      items hdecL hshort
  ...
  have hfields03 :=
    extractSuccess_creation_t1_hnext_fields03 slice hsuccess hcreFlag htype1
  ...
  have hhnext :=
    extractSuccess_creation_t1_hnext_hcre_srcOff slice loadPtr hsuccess
  ...
  have hcre : ∀ (next4 len4 : Word),
    ...
    simpa [absOff4, srcOff4, listOff, endW, absListOff] using
      hcre_ambient_of_slice regionBase loadPtr bs off len listOff items 4 endW
        hptr hbound hencInner hshort hn4 hoff4_sl hspan4a hroom4
  ...
  have hss0 :=
    hss_ambient_of_short_list_field regionBase loadPtr bs off len listOff items 0
      hptr hbound hencInner hshort hn0 hoff0_sl hover (Or.inl hfields03.1)
      hvalid1_0 hoff0
  have hss1 :=
    hss_ambient_of_short_list_field regionBase loadPtr bs off len listOff items 1
      hptr hbound hencInner hshort hn1 hoff1_sl hover (Or.inl hfields03.2.1)
      hvalid1_1 hoff1
  have hss2 :=
    hss_ambient_of_short_list_field regionBase loadPtr bs off len listOff items 2
      hptr hbound hencInner hshort hn2 hoff2_sl hover (Or.inl hfields03.2.2.1)
      hvalid1_2 hoff2
  have hss3 :=
    hss_ambient_of_short_list_field regionBase loadPtr bs off len listOff items 3
      hptr hbound hencInner hshort hn3 hoff3_sl hover (Or.inl hfields03.2.2.2)
      hvalid1_3 hoff3
  have hls0 :
  ...
  have hss4 :=
    hss_ambient_of_short_list_field regionBase loadPtr bs off len listOff items 4
      hptr hbound hencInner hshort hn4 hoff4_sl hover (Or.inl (by omega))
      hvalid1_4 hoff4
  have hls4 :
  ...
  exact extractAssumed_creation_under_honesty_of_decode_short_concrete_t1_ambient
...
set_option maxRecDepth 8000 in
theorem extractAssumed_creation_shortConcrete_pure_t1_ambient_fullCode
    (sp0 spC : Word) (s : ExtractSaved)
    (regionBase loadPtr lenW toBuf isCreationPtr : Word)
    (bs : List (BitVec 8)) (off len : Nat)
    (items : List EL.RLP.RLPItem)
  ...
  cpsTripleWithin_extend_code extractLinked_mono
    (extractAssumed_creation_shortConcrete_pure_t1_ambient sp0 spC s
      regionBase loadPtr lenW toBuf isCreationPtr bs off len items
      hspC hret htalign htover htvalid hlen hptr hbound hsuccess hcreFlag htype1 hdecL hshort
...
#print axioms extractAssumed_creation_shortConcrete_pure_t1_ambient
#print axioms extractAssumed_creation_shortConcrete_pure_t1_ambient_fullCode
