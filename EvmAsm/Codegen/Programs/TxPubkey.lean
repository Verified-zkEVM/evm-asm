...
def txPubkeySignatureMaterial_prog : Program :=
  [ .ADDI .x2 .x2 (-80 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_pubkey_signature_material + 856) (GuestAddrs.tx_pubkey_signature_material + 152)),
    ...
    .BLTU .x9 .x21 (brOff (GuestAddrs.tx_pubkey_signature_material + 864) (GuestAddrs.tx_pubkey_signature_material + 188)),
    .ADD .x22 .x8 .x21,
    .SUB .x23 .x9 .x21,
    .BEQ .x20 .x0 (40 : BitVec 13),
    .LI .x5 (1 : Word),
    .BEQ .x20 .x5 (brOff (GuestAddrs.tx_pubkey_signature_material + 492) (GuestAddrs.tx_pubkey_signature_material + 208)),
    .LI .x5 (2 : Word),
    .BEQ .x20 .x5 (brOff (GuestAddrs.tx_pubkey_signature_material + 552) (GuestAddrs.tx_pubkey_signature_material + 216)),
    .LI .x5 (3 : Word),
    .BEQ .x20 .x5 (brOff (GuestAddrs.tx_pubkey_signature_material + 612) (GuestAddrs.tx_pubkey_signature_material + 224)),
    .LI .x5 (4 : Word),
    .BEQ .x20 .x5 (brOff (GuestAddrs.tx_pubkey_signature_material + 672) (GuestAddrs.tx_pubkey_signature_material + 232)),
    .JAL .x0 (jalOff (GuestAddrs.tx_pubkey_signature_material + 856) (GuestAddrs.tx_pubkey_signature_material + 236)),
    .MV .x10 .x8,
    .MV .x11 .x9,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_pubkey_signature_material + 872) (GuestAddrs.tx_pubkey_signature_material + 268)),
    ...
    .LI .x7 (28 : Word),
    .BEQ .x6 .x7 (brOff (GuestAddrs.tx_pubkey_signature_material + 368) (GuestAddrs.tx_pubkey_signature_material + 296)),
    .SLLI .x7 .x18 (1 : BitVec 6),
    .LI .x28 (35 : Word),
    .ADD .x28 .x28 .x7,
    .BEQ .x6 .x28 (brOff (GuestAddrs.tx_pubkey_signature_material + 412) (GuestAddrs.tx_pubkey_signature_material + 312)),
    .ADDI .x28 .x28 (1 : BitVec 12),
    .BEQ .x6 .x28 (brOff (GuestAddrs.tx_pubkey_signature_material + 452) (GuestAddrs.tx_pubkey_signature_material + 320)),
    .JAL .x0 (jalOff (GuestAddrs.tx_pubkey_signature_material + 888) (GuestAddrs.tx_pubkey_signature_material + 324)),
    .SD .x19 .x0 (8 : BitVec 12),
    .SD .x19 .x0 (120 : BitVec 12),
    .MV .x10 .x8,
    .MV .x11 .x9,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_pubkey_signature_material + 880) (GuestAddrs.tx_pubkey_signature_material + 360)),
    .JAL .x0 (jalOff (GuestAddrs.tx_pubkey_signature_material + 744) (GuestAddrs.tx_pubkey_signature_material + 364)),
    .LI .x5 (1 : Word),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_pubkey_signature_material + 880) (GuestAddrs.tx_pubkey_signature_material + 404)),
    .JAL .x0 (jalOff (GuestAddrs.tx_pubkey_signature_material + 744) (GuestAddrs.tx_pubkey_signature_material + 408)),
    .SD .x19 .x0 (8 : BitVec 12),
    .LI .x5 (1 : Word),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_pubkey_signature_material + 880) (GuestAddrs.tx_pubkey_signature_material + 444)),
    .JAL .x0 (jalOff (GuestAddrs.tx_pubkey_signature_material + 744) (GuestAddrs.tx_pubkey_signature_material + 448)),
    .LI .x5 (1 : Word),
    .SD .x19 .x5 (8 : BitVec 12),
    .SD .x19 .x5 (120 : BitVec 12),
    .MV .x10 .x8,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_pubkey_signature_material + 880) (GuestAddrs.tx_pubkey_signature_material + 484)),
    .JAL .x0 (jalOff (GuestAddrs.tx_pubkey_signature_material + 744) (GuestAddrs.tx_pubkey_signature_material + 488)),
    .MV .x10 .x22,
    .MV .x11 .x23,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_pubkey_signature_material + 872) (GuestAddrs.tx_pubkey_signature_material + 516)),
    .MV .x10 .x22,
    .MV .x11 .x23,
    .LI .x12 (8 : Word),
    .LI .x13 (1 : Word),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_pubkey_signature_material + 880) (GuestAddrs.tx_pubkey_signature_material + 544)),
    .JAL .x0 (jalOff (GuestAddrs.tx_pubkey_signature_material + 732) (GuestAddrs.tx_pubkey_signature_material + 548)),
    .MV .x10 .x22,
    .MV .x11 .x23,
    .ADDI .x12 .x19 (8 : BitVec 12),
    .ADDI .x13 .x19 (16 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_pubkey_signature_material + 872) (GuestAddrs.tx_pubkey_signature_material + 576)),
    .MV .x10 .x22,
    .MV .x11 .x23,
    .LI .x12 (9 : Word),
    .LI .x13 (2 : Word),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_pubkey_signature_material + 880) (GuestAddrs.tx_pubkey_signature_material + 604)),
    .JAL .x0 (jalOff (GuestAddrs.tx_pubkey_signature_material + 732) (GuestAddrs.tx_pubkey_signature_material + 608)),
    .MV .x10 .x22,
    .MV .x11 .x23,
    .ADDI .x12 .x19 (8 : BitVec 12),
    .ADDI .x13 .x19 (16 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_pubkey_signature_material + 872) (GuestAddrs.tx_pubkey_signature_material + 636)),
    .MV .x10 .x22,
    .MV .x11 .x23,
    .LI .x12 (11 : Word),
    .LI .x13 (3 : Word),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_pubkey_signature_material + 880) (GuestAddrs.tx_pubkey_signature_material + 664)),
    .JAL .x0 (jalOff (GuestAddrs.tx_pubkey_signature_material + 732) (GuestAddrs.tx_pubkey_signature_material + 668)),
    .MV .x10 .x22,
    .MV .x11 .x23,
    .ADDI .x12 .x19 (8 : BitVec 12),
    .ADDI .x13 .x19 (16 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_pubkey_signature_material + 872) (GuestAddrs.tx_pubkey_signature_material + 696)),
    .MV .x10 .x22,
    .MV .x11 .x23,
    .LI .x12 (10 : Word),
    .LI .x13 (4 : Word),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_pubkey_signature_material + 880) (GuestAddrs.tx_pubkey_signature_material + 724)),
    .JAL .x0 (4 : BitVec 21),
    .LD .x5 .x19 (8 : BitVec 12),
    .LI .x6 (1 : Word),
    .BLTU .x6 .x5 (brOff (GuestAddrs.tx_pubkey_signature_material + 896) (GuestAddrs.tx_pubkey_signature_material + 740)),
    .ADDI .x10 .x19 (16 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.u256_is_zero (GuestAddrs.tx_pubkey_signature_material + 748)),
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_pubkey_signature_material + 904) (GuestAddrs.tx_pubkey_signature_material + 752)),
    .ADDI .x10 .x19 (48 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.u256_is_zero (GuestAddrs.tx_pubkey_signature_material + 760)),
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_pubkey_signature_material + 912) (GuestAddrs.tx_pubkey_signature_material + 764)),
    .ADDI .x10 .x19 (16 : BitVec 12),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .BEQ .x6 .x0 (brOff (GuestAddrs.tx_pubkey_signature_material + 920) (GuestAddrs.tx_pubkey_signature_material + 804)),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .BNE .x6 .x0 (brOff (GuestAddrs.tx_pubkey_signature_material + 928) (GuestAddrs.tx_pubkey_signature_material + 844)),
    .LI .x10 (0 : Word),
    .JAL .x0 (jalOff (GuestAddrs.tx_pubkey_signature_material + 932) (GuestAddrs.tx_pubkey_signature_material + 852)),
    .LI .x10 (1 : Word),
    .JAL .x0 (jalOff (GuestAddrs.tx_pubkey_signature_material + 932) (GuestAddrs.tx_pubkey_signature_material + 860)),
    .LI .x10 (2 : Word),
    .JAL .x0 (jalOff (GuestAddrs.tx_pubkey_signature_material + 932) (GuestAddrs.tx_pubkey_signature_material + 868)),
    .LI .x10 (10 : Word),
    .JAL .x0 (56 : BitVec 21),
    .LI .x10 (20 : Word),
    .JAL .x0 (48 : BitVec 21),
...
def txPubkeyEcrecoverStageMaterial_prog : Program :=
  [ .ADDI .x2 .x2 (-32 : BitVec 12),
    ...
    .LI .x5 (1 : Word),
    .BLTU .x5 .x18 (brOff (GuestAddrs.tx_pubkey_ecrecover_stage_material + 148) (GuestAddrs.tx_pubkey_ecrecover_stage_material + 36)),
...
def secp256k1RecoverPubkeyStaged_prog : Program :=
  [ .ADDI .x2 .x2 (-24 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.secp256k1_recover_pubkey_staged + 284) (GuestAddrs.secp256k1_recover_pubkey_staged + 44)),
    .MV .x10 .x20,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.secp256k1_recover_pubkey_staged + 284) (GuestAddrs.secp256k1_recover_pubkey_staged + 80)),
...
def txPubkeyPublicKeyMatches_prog : Program :=
  [ .ADDI .x2 .x2 (-56 : BitVec 12),
    ...
    .LI .x6 (4 : Word),
    .BNE .x5 .x6 (brOff (GuestAddrs.tx_pubkey_public_key_matches + 152) (GuestAddrs.tx_pubkey_public_key_matches + 64)),
    .MV .x10 .x8,
    .MV .x11 .x9,
    .MV .x12 .x18,
    .MV .x13 .x20,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_pubkey_public_key_matches + 156) (GuestAddrs.tx_pubkey_public_key_matches + 92)),
