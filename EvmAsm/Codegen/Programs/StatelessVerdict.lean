...
def statelessVerdictFromSsz_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.stateless_verdict_from_ssz + 456) (GuestAddrs.stateless_verdict_from_ssz + 72)),
    .MV .x10 .x8,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.stateless_verdict_from_ssz + 456) (GuestAddrs.stateless_verdict_from_ssz + 144)),
    ...
    .LI .x21 (0 : Word),
    .BGE .x21 .x9 (brOff (GuestAddrs.stateless_verdict_from_ssz + 256) (GuestAddrs.stateless_verdict_from_ssz + 192)),
    .MV .x10 .x18,
    .MV .x11 .x20,
