...
def mptExtensionNodeEncode_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .BLTU .x20 .x5 (brOff (GuestAddrs.mpt_extension_node_encode + 452) (GuestAddrs.mpt_extension_node_encode + 64)),
    .BLTU .x21 .x5 (brOff (GuestAddrs.mpt_extension_node_encode + 452) (GuestAddrs.mpt_extension_node_encode + 68)),
    .ADDIW .x5 .x0 (3 : BitVec 12),
    .SLLI .x5 .x5 (30 : BitVec 6),
    .BGEU .x20 .x5 (brOff (GuestAddrs.mpt_extension_node_encode + 452) (GuestAddrs.mpt_extension_node_encode + 80)),
    .ADDIW .x5 .x0 (3 : BitVec 12),
    .SLLI .x5 .x5 (30 : BitVec 6),
    .ADDI .x5 .x5 (-8 : BitVec 12),
    .BLTU .x5 .x21 (brOff (GuestAddrs.mpt_extension_node_encode + 452) (GuestAddrs.mpt_extension_node_encode + 96)),
    .MV .x10 .x8,
    .MV .x11 .x9,
    .LI .x12 (0 : Word),
    ...
    .LD .x7 .x5 (0 : BitVec 12),
    .ADD .x31 .x20 .x6,
    .BLTU .x31 .x20 (brOff (GuestAddrs.mpt_extension_node_encode + 452) (GuestAddrs.mpt_extension_node_encode + 336)),
    .ADD .x31 .x31 .x7,
    .BLTU .x31 .x20 (brOff (GuestAddrs.mpt_extension_node_encode + 452) (GuestAddrs.mpt_extension_node_encode + 344)),
    .ADDIW .x5 .x0 (3 : BitVec 12),
    .SLLI .x5 .x5 (30 : BitVec 6),
    .BLTU .x5 .x31 (brOff (GuestAddrs.mpt_extension_node_encode + 452) (GuestAddrs.mpt_extension_node_encode + 356)),
    .ADD .x28 .x20 .x6,
...
def mptBranchPayloadTwoSlots_prog : Program :=
  [ .ADDI .x2 .x2 (-56 : BitVec 12),
    ...
    .MV .x21 .x15,
    .LI .x5 (17 : Word),
    .BGEU .x8 .x5 (brOff 2147483856 2147483708),
    .BGEU .x19 .x5 (brOff 2147483856 2147483712),
    .BEQ .x8 .x19 (brOff 2147483856 2147483716),
    .MV .x6 .x16,
    .LI .x7 (0 : Word),
    .LI .x5 (17 : Word),
    .BGE .x7 .x5 (brOff 2147483840 2147483732),
    .BEQ .x7 .x8 (24 : BitVec 13),
    .BEQ .x7 .x19 (56 : BitVec 13),
    .LI .x28 (128 : Word),
    .SB .x6 .x28 (0 : BitVec 12),
    .ADDI .x6 .x6 (1 : BitVec 12),
    .JAL .x0 (jalOff 2147483832 2147483756),
    .MV .x28 .x9,
    .MV .x29 .x18,
    .BEQ .x29 .x0 (brOff 2147483832 2147483768),
    .LBU .x30 .x28 (0 : BitVec 12),
    ...
    .JAL .x0 (-24 : BitVec 21),
    .ADDI .x7 .x7 (1 : BitVec 12),
    .JAL .x0 (jalOff 2147483728 2147483836),
    .SUB .x6 .x6 .x16,
