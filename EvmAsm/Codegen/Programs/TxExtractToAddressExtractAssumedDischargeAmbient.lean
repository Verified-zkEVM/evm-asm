/-
  ...
  content start + cover; long outer needs per-field short-encode; type234
  needs hge7 beyond to-field existence). Consumers keep
  `ExtractAssumedAmbient` as a named hyp until domain bridge lands.
-/
