...
def secp256k1RecoverR_prog : Program :=
  [ .ADDI .x2 .x2 (-48 : BitVec 12),
    ...
    .BEQ .x5 .x0 (brOff (GuestAddrs.secp256k1_recover_r + 120) (GuestAddrs.secp256k1_recover_r + 36)),
    .MV .x10 .x8,
    ...
    .LI .x10 (2 : Word),
    .JAL .x0 (jalOff (GuestAddrs.secp256k1_recover_r + 272) (GuestAddrs.secp256k1_recover_r + 68)),
    .MV .x10 .x18,
    ...
    .LI .x10 (2 : Word),
    .JAL .x0 (jalOff (GuestAddrs.secp256k1_recover_r + 272) (GuestAddrs.secp256k1_recover_r + 116)),
    .MV .x10 .x8,
    .MV .x11 .x18,
