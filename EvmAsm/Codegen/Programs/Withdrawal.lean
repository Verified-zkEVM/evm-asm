...
def withdrawalDecode_prog : Program :=
  [ .ADDI .x2 .x2 (-32 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.withdrawal_decode + 212) (GuestAddrs.withdrawal_decode + 52)),
    .MV .x10 .x8,
    .MV .x11 .x9,
    .LI .x12 (1 : Word),
    .ADDI .x13 .x18 (8 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.rlp_field_to_u64_strict (GuestAddrs.withdrawal_decode + 72)),
    .BNE .x10 .x0 (brOff (GuestAddrs.withdrawal_decode + 212) (GuestAddrs.withdrawal_decode + 76)),
    .MV .x10 .x8,
    .MV .x11 .x9,
    .LI .x12 (2 : Word),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.withdrawal_decode + 212) (GuestAddrs.withdrawal_decode + 112)),
    ...
    .LI .x7 (20 : Word),
    .BNE .x6 .x7 (brOff (GuestAddrs.withdrawal_decode + 212) (GuestAddrs.withdrawal_decode + 132)),
