/-
  Front E → AfterSave short concrete → t1 20B copy → ret bare region.
-/
...
def nFrontCopyStepsShortT1Region : Nat :=
...
theorem extractFrontCopy_then_epi_of_decode_short_concrete_t1_region
    ...
    cpsTripleWithin nFrontCopyStepsShortT1Region
  ...
  have hC := extractFrontAfterSaveCopy_then_epi_of_decode_short_t1_region sp0 spC s
...
#print axioms extractFrontCopy_then_epi_of_decode_short_concrete_t1_region
