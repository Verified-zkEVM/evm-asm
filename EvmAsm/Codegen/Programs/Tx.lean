...
def rlpFieldToU256Be_prog : Program :=
  [ .ADDI .x2 .x2 (-32 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (RlpFieldToU256BeOfflineAddrs.rlp_field_to_u256_be + 152) (RlpFieldToU256BeOfflineAddrs.rlp_field_to_u256_be + 60)),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .LI .x7 (32 : Word),
    .BLTU .x7 .x6 (brOff (RlpFieldToU256BeOfflineAddrs.rlp_field_to_u256_be + 144) (RlpFieldToU256BeOfflineAddrs.rlp_field_to_u256_be + 80)),
