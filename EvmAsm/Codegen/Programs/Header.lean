...
def headerValidatePostMerge_prog : Program :=
  [ .ADDI .x2 .x2 (-40 : BitVec 12),
    ...
    .LI .x5 (32 : Word),
    .BNE .x12 .x5 (356 : BitVec 13),
    .SUB .x6 .x10 .x12,
    .AUIPC .x5 (laHi GuestAddrs.empty_ommers_hash (GuestAddrs.header_validate_post_merge + 104)),
    .ADDI .x5 .x5 (laLo GuestAddrs.empty_ommers_hash (GuestAddrs.header_validate_post_merge + 104)),
    .LD .x7 .x5 (0 : BitVec 12),
    .LD .x28 .x6 (0 : BitVec 12),
    .BNE .x7 .x28 (332 : BitVec 13),
    .LD .x7 .x5 (8 : BitVec 12),
    .LD .x28 .x6 (8 : BitVec 12),
    .BNE .x7 .x28 (320 : BitVec 13),
    .LD .x7 .x5 (16 : BitVec 12),
    .LD .x28 .x6 (16 : BitVec 12),
    .BNE .x7 .x28 (308 : BitVec 13),
    .LD .x7 .x5 (24 : BitVec 12),
    .LD .x28 .x6 (24 : BitVec 12),
    .BNE .x7 .x28 (296 : BitVec 13),
    .MV .x18 .x10,
    .MV .x10 .x18,
    .MV .x11 .x19,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.header_validate_post_merge + 172)),
    .BNE .x11 .x0 (300 : BitVec 13),
    .MV .x18 .x10,
    .MV .x10 .x18,
    .MV .x11 .x19,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.header_validate_post_merge + 192)),
    .BNE .x11 .x0 (280 : BitVec 13),
    .MV .x18 .x10,
    .MV .x10 .x18,
    .MV .x11 .x19,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.header_validate_post_merge + 212)),
    .BNE .x11 .x0 (260 : BitVec 13),
    .MV .x18 .x10,
    .MV .x10 .x18,
    .MV .x11 .x19,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.header_validate_post_merge + 232)),
    .BNE .x11 .x0 (240 : BitVec 13),
    .MV .x18 .x10,
    .MV .x10 .x18,
    .MV .x11 .x19,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.header_validate_post_merge + 252)),
    .BNE .x11 .x0 (220 : BitVec 13),
    .MV .x18 .x10,
    .MV .x10 .x18,
    .MV .x11 .x19,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.header_validate_post_merge + 272)),
    .BNE .x11 .x0 (200 : BitVec 13),
    .BNE .x12 .x0 (180 : BitVec 13),
    .MV .x18 .x10,
    .MV .x10 .x18,
    .MV .x11 .x19,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.header_validate_post_merge + 296)),
    .BNE .x11 .x0 (176 : BitVec 13),
    .MV .x18 .x10,
    .MV .x10 .x18,
    .MV .x11 .x19,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.header_validate_post_merge + 316)),
    .BNE .x11 .x0 (156 : BitVec 13),
    .MV .x18 .x10,
    .MV .x10 .x18,
    .MV .x11 .x19,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.header_validate_post_merge + 336)),
    .BNE .x11 .x0 (136 : BitVec 13),
    .MV .x18 .x10,
    .MV .x10 .x18,
    .MV .x11 .x19,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.header_validate_post_merge + 356)),
    .BNE .x11 .x0 (116 : BitVec 13),
    .MV .x18 .x10,
    .MV .x10 .x18,
    .MV .x11 .x19,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.header_validate_post_merge + 376)),
    .BNE .x11 .x0 (96 : BitVec 13),
    .MV .x18 .x10,
    .MV .x10 .x18,
    .MV .x11 .x19,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.header_validate_post_merge + 396)),
    .BNE .x11 .x0 (76 : BitVec 13),
    .MV .x18 .x10,
    .MV .x10 .x18,
    .MV .x11 .x19,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.header_validate_post_merge + 416)),
    .BNE .x11 .x0 (56 : BitVec 13),
    .LI .x5 (8 : Word),
    .BNE .x12 .x5 (40 : BitVec 13),
    .SUB .x6 .x10 .x12,
...
def headerValidatePostMerge_relocs : RelocTable :=
  [ (10, .jal .x1 "rlp_walk_init"),
    ...
    (84, .jal .x1 "rlp_walk_next"),
    (89, .jal .x1 "rlp_walk_next"),
