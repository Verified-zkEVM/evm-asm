...
def p256BeToLe_prog : Program :=
  [ .LI .x5 (0 : Word),
    ...
    .ADDI .x5 .x5 (1 : BitVec 12),
    .LI .x6 (4 : Word),
    .BNE .x5 .x6 (brOff (GuestAddrs.p256_be_to_le + 4) (GuestAddrs.p256_be_to_le + 72)),
    .JALR .x0 .x1 (0 : BitVec 12) ]
...
def p256LeToBe_prog : Program :=
  [ .LI .x5 (0 : Word),
    ...
    .ADDI .x5 .x5 (1 : BitVec 12),
    .LI .x6 (4 : Word),
    .BNE .x5 .x6 (brOff (GuestAddrs.p256_le_to_be + 4) (GuestAddrs.p256_le_to_be + 68)),
    .JALR .x0 .x1 (0 : BitVec 12) ]
...
def p256Pow_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .LI .x19 (0 : Word),
    .LI .x5 (32 : Word),
    .BGEU .x19 .x5 (brOff (GuestAddrs.p256_pow + 188) (GuestAddrs.p256_pow + 84)),
    .ADD .x5 .x9 .x19,
    .LBU .x20 .x5 (0 : BitVec 12),
    .LI .x21 (128 : Word),
    .BEQ .x21 .x0 (brOff (GuestAddrs.p256_pow + 180) (GuestAddrs.p256_pow + 100)),
    ...
    .JAL .x0 (jalOff (GuestAddrs.p256_pow + 100) (GuestAddrs.p256_pow + 176)),
    .ADDI .x19 .x19 (1 : BitVec 12),
    .JAL .x0 (jalOff (GuestAddrs.p256_pow + 80) (GuestAddrs.p256_pow + 184)),
...
def p256PointDbl_prog : Program :=
  [ .ADDI .x2 .x2 (-32 : BitVec 12),
    ...
    .BEQ .x10 .x0 (brOff (GuestAddrs.p256_point_dbl + 100) (GuestAddrs.p256_point_dbl + 36)),
    .MV .x10 .x9,
    .LI .x5 (8 : Word),
    ...
    .LI .x10 (1 : Word),
    .JAL .x0 (jalOff (GuestAddrs.p256_point_dbl + 356) (GuestAddrs.p256_point_dbl + 96)),
    .MV .x10 .x8,
    .MV .x11 .x8,
...
def p256PointAdd_prog : Program :=
  [ .ADDI .x2 .x2 (-40 : BitVec 12),
    ...
    .BEQ .x10 .x0 (brOff (GuestAddrs.p256_point_add + 232) (GuestAddrs.p256_point_add + 60)),
    .MV .x10 .x8,
    .MV .x11 .x18,
    .JAL .x1 (jalOff GuestAddrs.p256_point_dbl (GuestAddrs.p256_point_add + 72)),
    .JAL .x0 (jalOff (GuestAddrs.p256_point_add + 260) (GuestAddrs.p256_point_add + 76)),
...
def p256ScalarMul_prog : Program :=
  [ .ADDI .x2 .x2 (-72 : BitVec 12),
    ...
    .LI .x20 (0 : Word),
    .LI .x5 (32 : Word),
    .BGEU .x20 .x5 (brOff (GuestAddrs.p256_scalar_mul + 220) (GuestAddrs.p256_scalar_mul + 84)),
    .ADD .x5 .x8 .x20,
    .LBU .x21 .x5 (0 : BitVec 12),
    .LI .x22 (128 : Word),
    .BEQ .x22 .x0 (brOff (GuestAddrs.p256_scalar_mul + 212) (GuestAddrs.p256_scalar_mul + 100)),
    ...
    .MV .x19 .x10,
    .AND .x5 .x21 .x22,
    .BEQ .x5 .x0 (brOff (GuestAddrs.p256_scalar_mul + 204) (GuestAddrs.p256_scalar_mul + 128)),
    ...
    .JAL .x0 (jalOff (GuestAddrs.p256_scalar_mul + 100) (GuestAddrs.p256_scalar_mul + 208)),
    .ADDI .x20 .x20 (1 : BitVec 12),
    .JAL .x0 (jalOff (GuestAddrs.p256_scalar_mul + 80) (GuestAddrs.p256_scalar_mul + 216)),
    .MV .x10 .x19,
    .LD .x1 .x2 (0 : BitVec 12),
    .LD .x8 .x2 (8 : BitVec 12),
    .LD .x9 .x2 (16 : BitVec 12),
