...
def chainValidateIncreasingTimestamps_prog : Program :=
  [ .ADDI .x2 .x2 (-56 : BitVec 12),
    ...
    .JAL .x1 (jalOff GuestAddrs.rlp_field_to_u64_strict (GuestAddrs.chain_validate_increasing_timestamps + 92)),
    ...
    .JAL .x1 (jalOff GuestAddrs.rlp_field_to_u64_strict (GuestAddrs.chain_validate_increasing_timestamps + 192)),
