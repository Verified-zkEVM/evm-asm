...
def mptInsertWalkDb_prog : Program :=
  [ .ADDI .x2 .x2 (-96 : BitVec 12),
    ...
    .LI .x30 (3 : Word),
    .JAL .x0 (jalOff (GuestAddrs.mpt_insert_walk_db + 1200) (GuestAddrs.mpt_insert_walk_db + 136)),
    .MV .x12 .x10,
    .MV .x10 .x8,
    .MV .x11 .x9,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_walk_db + 1232) (GuestAddrs.mpt_insert_walk_db + 172)),
    ...
    .LI .x5 (1 : Word),
    .BEQ .x10 .x5 (brOff (GuestAddrs.mpt_insert_walk_db + 524) (GuestAddrs.mpt_insert_walk_db + 224)),
    .LI .x5 (2 : Word),
    .BEQ .x10 .x5 (brOff (GuestAddrs.mpt_insert_walk_db + 952) (GuestAddrs.mpt_insert_walk_db + 232)),
    .JAL .x0 (jalOff (GuestAddrs.mpt_insert_walk_db + 1240) (GuestAddrs.mpt_insert_walk_db + 236)),
    .BEQ .x22 .x19 (brOff (GuestAddrs.mpt_insert_walk_db + 512) (GuestAddrs.mpt_insert_walk_db + 240)),
    .ADD .x5 .x18 .x22,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_walk_db + 1240) (GuestAddrs.mpt_insert_walk_db + 312)),
    ...
    .BEQ .x6 .x0 (brOff (GuestAddrs.mpt_insert_walk_db + 488) (GuestAddrs.mpt_insert_walk_db + 328)),
    .LI .x7 (32 : Word),
    ...
    .ADD .x23 .x23 .x7,
    .MV .x24 .x6,
    .JAL .x0 (jalOff (GuestAddrs.mpt_insert_walk_db + 204) (GuestAddrs.mpt_insert_walk_db + 360)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_walk_db + 1232) (GuestAddrs.mpt_insert_walk_db + 456)),
    ...
    .LD .x24 .x5 (0 : BitVec 12),
    .JAL .x0 (jalOff (GuestAddrs.mpt_insert_walk_db + 204) (GuestAddrs.mpt_insert_walk_db + 484)),
    .ADDI .x20 .x20 (-32 : BitVec 12),
    .ADDI .x25 .x25 (-1 : BitVec 12),
    .LI .x30 (0 : Word),
    .ADDI .x22 .x22 (-1 : BitVec 12),
    .LI .x31 (0 : Word),
    .JAL .x0 (jalOff (GuestAddrs.mpt_insert_walk_db + 1168) (GuestAddrs.mpt_insert_walk_db + 508)),
    .LI .x30 (5 : Word),
    .LI .x31 (0 : Word),
    .JAL .x0 (jalOff (GuestAddrs.mpt_insert_walk_db + 1168) (GuestAddrs.mpt_insert_walk_db + 520)),
    .MV .x10 .x23,
    .MV .x11 .x24,
    .LI .x12 (0 : Word),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_walk_db + 1240) (GuestAddrs.mpt_insert_walk_db + 556)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_walk_db + 1240) (GuestAddrs.mpt_insert_walk_db + 616)),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .BNE .x6 .x0 (brOff (GuestAddrs.mpt_insert_walk_db + 1240) (GuestAddrs.mpt_insert_walk_db + 632)),
    ...
    .JAL .x0 (-28 : BitVec 21),
    .BNE .x31 .x6 (brOff (GuestAddrs.mpt_insert_walk_db + 944) (GuestAddrs.mpt_insert_walk_db + 712)),
    .BLTU .x7 .x6 (brOff (GuestAddrs.mpt_insert_walk_db + 944) (GuestAddrs.mpt_insert_walk_db + 716)),
    .SD .x20 .x23 (0 : BitVec 12),
    .SD .x20 .x24 (8 : BitVec 12),
    .LI .x11 (1 : Word),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_walk_db + 1240) (GuestAddrs.mpt_insert_walk_db + 784)),
    ...
    .MV .x23 .x28,
    .MV .x24 .x6,
    .JAL .x0 (jalOff (GuestAddrs.mpt_insert_walk_db + 204) (GuestAddrs.mpt_insert_walk_db + 832)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_walk_db + 1232) (GuestAddrs.mpt_insert_walk_db + 912)),
    ...
    .LD .x24 .x5 (0 : BitVec 12),
    .JAL .x0 (jalOff (GuestAddrs.mpt_insert_walk_db + 204) (GuestAddrs.mpt_insert_walk_db + 940)),
    .LI .x30 (2 : Word),
    .JAL .x0 (jalOff (GuestAddrs.mpt_insert_walk_db + 1168) (GuestAddrs.mpt_insert_walk_db + 948)),
    .MV .x10 .x23,
    .MV .x11 .x24,
    .LI .x12 (0 : Word),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_walk_db + 1240) (GuestAddrs.mpt_insert_walk_db + 984)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_insert_walk_db + 1240) (GuestAddrs.mpt_insert_walk_db + 1044)),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .LI .x7 (1 : Word),
    .BNE .x6 .x7 (brOff (GuestAddrs.mpt_insert_walk_db + 1240) (GuestAddrs.mpt_insert_walk_db + 1064)),
