/-
  Ambient dual: Front short AfterSave → legacy creation of_decode (typeW=0).
-/
...
theorem extractFrontAfterSaveCreation_then_epi_of_decode_short_legacy_ambient
...
#print axioms extractFrontAfterSaveCreation_then_epi_of_decode_short_legacy_ambient
