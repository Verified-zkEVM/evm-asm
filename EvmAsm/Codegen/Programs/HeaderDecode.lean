...
def headerExtendedDecodeArityCheck_prog : Program :=
  [ .ADDI .x2 .x2 (-96 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.header_extended_decode_arity_check + 424) (GuestAddrs.header_extended_decode_arity_check + 60)),
    .LD .x20 .x2 (64 : BitVec 12),
    .MV .x10 .x8,
    .MV .x11 .x9,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_init (GuestAddrs.header_extended_decode_arity_check + 76)),
    .BNE .x12 .x0 (brOff (GuestAddrs.header_extended_decode_arity_check + 424) (GuestAddrs.header_extended_decode_arity_check + 80)),
    .MV .x18 .x10,
    .MV .x19 .x11,
    .LI .x5 (21 : Word),
    .BEQ .x20 .x5 (12 : BitVec 13),
    .LI .x5 (23 : Word),
    .BNE .x20 .x5 (brOff (GuestAddrs.header_extended_decode_arity_check + 424) (GuestAddrs.header_extended_decode_arity_check + 104)),
    .LI .x21 (0 : Word),
    .BEQ .x21 .x20 (brOff (GuestAddrs.header_extended_decode_arity_check + 416) (GuestAddrs.header_extended_decode_arity_check + 112)),
    .MV .x10 .x18,
    .MV .x11 .x19,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next_leaf (GuestAddrs.header_extended_decode_arity_check + 124)),
    .BNE .x11 .x0 (brOff (GuestAddrs.header_extended_decode_arity_check + 424) (GuestAddrs.header_extended_decode_arity_check + 128)),
    .SUB .x22 .x10 .x12,
    .MV .x18 .x10,
    .LI .x5 (0 : Word),
    ...
    .LI .x5 (11 : Word),
    .BEQ .x21 .x5 (brOff (GuestAddrs.header_extended_decode_arity_check + 368) (GuestAddrs.header_extended_decode_arity_check + 248)),
    .LI .x5 (17 : Word),
    .BEQ .x21 .x5 (brOff (GuestAddrs.header_extended_decode_arity_check + 368) (GuestAddrs.header_extended_decode_arity_check + 256)),
    .LI .x5 (18 : Word),
    .BEQ .x21 .x5 (brOff (GuestAddrs.header_extended_decode_arity_check + 368) (GuestAddrs.header_extended_decode_arity_check + 264)),
    .LI .x5 (22 : Word),
    .BEQ .x21 .x5 (brOff (GuestAddrs.header_extended_decode_arity_check + 368) (GuestAddrs.header_extended_decode_arity_check + 272)),
    .LI .x5 (7 : Word),
    .BEQ .x21 .x5 (brOff (GuestAddrs.header_extended_decode_arity_check + 368) (GuestAddrs.header_extended_decode_arity_check + 280)),
    .LI .x5 (8 : Word),
    .BEQ .x21 .x5 (brOff (GuestAddrs.header_extended_decode_arity_check + 368) (GuestAddrs.header_extended_decode_arity_check + 288)),
    .LI .x5 (9 : Word),
    .BEQ .x21 .x5 (brOff (GuestAddrs.header_extended_decode_arity_check + 368) (GuestAddrs.header_extended_decode_arity_check + 296)),
    .LI .x5 (10 : Word),
    .BEQ .x21 .x5 (brOff (GuestAddrs.header_extended_decode_arity_check + 368) (GuestAddrs.header_extended_decode_arity_check + 304)),
    .LI .x5 (15 : Word),
    .BEQ .x21 .x5 (brOff (GuestAddrs.header_extended_decode_arity_check + 388) (GuestAddrs.header_extended_decode_arity_check + 312)),
    .JAL .x0 (jalOff (GuestAddrs.header_extended_decode_arity_check + 408) (GuestAddrs.header_extended_decode_arity_check + 316)),
    .LI .x5 (32 : Word),
    .BNE .x12 .x5 (brOff (GuestAddrs.header_extended_decode_arity_check + 424) (GuestAddrs.header_extended_decode_arity_check + 324)),
    .JAL .x0 (jalOff (GuestAddrs.header_extended_decode_arity_check + 408) (GuestAddrs.header_extended_decode_arity_check + 328)),
    .LI .x5 (20 : Word),
    .BNE .x12 .x5 (brOff (GuestAddrs.header_extended_decode_arity_check + 424) (GuestAddrs.header_extended_decode_arity_check + 336)),
    .JAL .x0 (jalOff (GuestAddrs.header_extended_decode_arity_check + 408) (GuestAddrs.header_extended_decode_arity_check + 340)),
    .LI .x5 (256 : Word),
    .BNE .x12 .x5 (brOff (GuestAddrs.header_extended_decode_arity_check + 424) (GuestAddrs.header_extended_decode_arity_check + 348)),
    .JAL .x0 (56 : BitVec 21),
    .LI .x5 (8 : Word),
    .BNE .x12 .x5 (brOff (GuestAddrs.header_extended_decode_arity_check + 424) (GuestAddrs.header_extended_decode_arity_check + 360)),
    .JAL .x0 (44 : BitVec 21),
    .MV .x10 .x22,
    .MV .x11 .x12,
    .JAL .x1 (jalOff GuestAddrs.rlp_content_to_u64_strict (GuestAddrs.header_extended_decode_arity_check + 376)),
    .BNE .x11 .x0 (44 : BitVec 13),
    .JAL .x0 (24 : BitVec 21),
    .MV .x10 .x22,
    .MV .x11 .x12,
    .ADDI .x12 .x2 (64 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.rlp_content_to_u256_be_strict (GuestAddrs.header_extended_decode_arity_check + 400)),
    .BNE .x10 .x0 (20 : BitVec 13),
    .ADDI .x21 .x21 (1 : BitVec 12),
    .JAL .x0 (jalOff (GuestAddrs.header_extended_decode_arity_check + 112) (GuestAddrs.header_extended_decode_arity_check + 412)),
    .LI .x10 (0 : Word),
    .JAL .x0 (8 : BitVec 21),
    .LI .x10 (1 : Word),
...
def headerExtendedDecodeArityCheck_relocs : RelocTable :=
  [ (14, .jal .x1 "rlp_list_count_items"),
    ...
    (94, .jal .x1 "rlp_content_to_u64_strict"),
    (100, .jal .x1 "rlp_content_to_u256_be_strict") ]
...
#guard headerExtendedDecodeArityCheck_prog.length = 117
