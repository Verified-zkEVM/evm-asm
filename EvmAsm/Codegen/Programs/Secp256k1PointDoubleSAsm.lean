...
theorem pointDouble_spec (sp0 inPtr outPtr ret v8 v9 : Word)
  ...
  · -- ======================================================================
    ...
    have hbody : cpsTripleWithin
      ...
      rw [show (0x80020428 : Word) + 4 = (0x8002042C : Word) from by decide]
        at hbeq
      -- ---- mv a0, s1 ; call secf_zero32(out) ----
      have hm3 := liftCode (cr' := pdCr)
        (mv_spec_gen_within .x10 .x9 outPtr (1 : Word) (0x8002042C : Word)
          (by decide))
        (by code_mem)
      rw [show (0x8002042C : Word) + 4 = (0x80020430 : Word) from by decide]
        at hm3
      have hcall2 := callWithin_spec (0x80020430 : Word) (0x8001fb58 : Word)
        (0x80020428 : Word)
        (jalOff GuestAddrs.secf_zero32 (GuestAddrs.secp256k1_point_double + 40))
        ((secfZero32Fn 0 []).body.steps + 1)
        (by decide) (by code_mem) (by pcf)
        (secfZero32Flat_spec (0x80020434 : Word) outPtr oX hoXlen hrwwOut
          (by decide))
      rw [show (0x80020430 : Word) + 4 = (0x80020434 : Word) from by decide]
        at hcall2
      -- ---- addi a0, s1, 32 ; call secf_zero32(out+32) ----
      -- x10 comes back only owned — peel it for the addi
      have haddi2 : cpsTripleWithin 1 (0x80020434 : Word) (0x80020438 : Word)
          pdCr
        ...
        have h := liftCode (cr' := pdCr)
          (addi_spec_gen_within .x10 .x9 (vf .x10) outPtr (32 : BitVec 12)
            (0x80020434 : Word) (by decide))
          (by code_mem)
        rw [show (0x80020434 : Word) + 4 = (0x80020438 : Word) from by decide,
      ...
      have hcall3 := callWithin_spec (0x80020438 : Word) (0x8001fb58 : Word)
        (0x80020434 : Word)
        (jalOff GuestAddrs.secf_zero32 (GuestAddrs.secp256k1_point_double + 48))
        ((secfZero32Fn 0 []).body.steps + 1)
        (by decide) (by code_mem) (by pcf)
        (secfZero32Flat_spec (0x8002043C : Word) (outPtr + 32) oY hoYlen
          hrwwOut32 (by decide))
      rw [show (0x80020438 : Word) + 4 = (0x8002043C : Word) from by decide]
        at hcall3
      -- ---- li a0, 1 ; j (epilogue) ----
      have hli : cpsTripleWithin 1 (0x8002043C : Word) (0x80020440 : Word)
        ...
        refine cpsTripleWithin_weaken
          ...
          (fun _ hq => hq) ?_
        have h := liftCode (cr' := pdCr)
          (li_spec_gen_own_within .x10 (1 : Word) (0x8002043C : Word)
            (by decide))
          (by code_mem)
        rwa [show (0x8002043C : Word) + 4 = (0x80020440 : Word) from by decide]
          at h
      have hjmp := liftCode (cr' := pdCr)
        (jal_x0_spec_gen_within (92 : BitVec 21) (0x80020440 : Word))
        (by code_mem)
      rw [show (0x80020440 : Word) + signExtend21 (92 : BitVec 21)
          = (0x8002049C : Word) from by decide] at hjmp
      ...
      have haddi2F := cpsTripleWithin_frameR
        (((.x1 : Reg) ↦ᵣ (0x80020434 : Word)) ** ((.x0 : Reg) ↦ᵣ (0 : Word))
          ** (.x8 ↦ᵣ inPtr) ** regOwns a0Rest
          ** bytesRegion inPtr xBE ** bytesRegion (inPtr + 32) yBE
          ** bytesRegion outPtr (List.replicate 32 (0 : BitVec 8))
          ** bytesRegion (outPtr + 32) oY ** bytesRegion arenaB ws)
      ...
      have hliF := cpsTripleWithin_frameR
        (((.x1 : Reg) ↦ᵣ (0x8002043C : Word)) ** ((.x0 : Reg) ↦ᵣ (0 : Word))
      ...
      have hc6 := cpsTripleWithin_seq_perm_same_cr
        (fun h hp => by
          ...
          have hp1 : ((.x10 ↦ᵣ outPtr)
              ** (((.x1 : Reg) ↦ᵣ (0x80020428 : Word)) ** regOwns a0Rest
          ...
          have hp3 : (((.x1 : Reg) ↦ᵣ (0x80020428 : Word))
      ...
      · simp only [pdFrame, regsAt, frameSlotsSaved, pdVals, pdValsInf,
        ...
        have hfin : ((((.x1 : Reg) ↦ᵣ (0x8002043C : Word)) ** (.x8 ↦ᵣ inPtr)
            ** (.x9 ↦ᵣ outPtr)
            ...
            ** ((⌜beBytesToNat yBE = 0⌝ : Assertion)
              ** (((.x0 : Reg) ↦ᵣ (0 : Word)) ** ((.x10 : Reg) ↦ᵣ (1 : Word))
                ...
                ** bytesRegion (outPtr + 32) (List.replicate 32 (0 : BitVec 8))
                ** bytesRegion arenaB ws))) h := by
          have hq' : ((((.x1 : Reg) ↦ᵣ (0x8002043C : Word)) ** (.x8 ↦ᵣ inPtr)
              ** (.x9 ↦ᵣ outPtr)
              ** ((.x2 : Reg) ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12)))
              ** ((sp0 + signExtend12 (-32 : BitVec 12)
                    + signExtend12 (0 : BitVec 12)) ↦ₘ ret)
        ...
        have hout : ((((.x1 : Reg) ↦ᵣ (0x8002043C : Word)) ** (.x8 ↦ᵣ inPtr)
            ** (.x9 ↦ᵣ outPtr)
            ** ((.x2 : Reg) ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12)))
            ** ((sp0 + signExtend12 (-32 : BitVec 12)
                  + signExtend12 (0 : BitVec 12)) ↦ₘ ret)
