/-
  Teer front auth walk_next cycle 8 under applied prest.
  E → AfterAuthWalkNext8Save via FrontAuthWalkNext7 + Cycle8.
-/
...
/-- Cycle8 CycleOk with regOwn temps x5–7,x28–31. -/
theorem teerAuthWalkNext8CycleOk_ownTemps
    ...
    (hend : v22 = endPtr) :
    cpsTripleWithin nAuthWalkNextCycle AfterAuthWalkNext7Save AfterAuthWalkNext8Save
      teerLinkedEarly
  ...
  have hcore (t0 t1 t2 t3 t4 t5 t6 : Word) :
      cpsTripleWithin nAuthWalkNextCycle AfterAuthWalkNext7Save AfterAuthWalkNext8Save
        ...
        (fun h => ∃ next len : Word,
          (teerAuthWalkNextSkipBodyPost listBase endPtr next len bs srcOff
            LinkAuthWalkNext8) h) := by
    have h0 := teerAuthWalkNext8CycleOk listBase endPtr a2Old t0 t1 t2 t3 t4 t5 t6
...
/-- Rest of AfterAuthWalkNext7Save flat without trailing pure. -/
def teerAuthWalkNext7FlatRest
    (spC loadPtr lenW balPtr balLenW chainIdW
...
theorem teerAuthWalkNext7FlatRest_to_awn8Pre
    (spC loadPtr lenW balPtr balLenW chainIdW
      s7 s11 spVal regionBase endL cursorV endWV : Word)
    (bs balBytes : List (BitVec 8)) (s : TeerSaved)
    (innerVal nextP lenP : Word) :
    ∀ h,
      (teerAuthWalkNext7FlatRest spC loadPtr lenW balPtr balLenW chainIdW
          s7 s11 spVal regionBase endL cursorV endWV bs balBytes s
          innerVal nextP lenP) h →
      (teerAuthWalkNextSkipFocus regionBase bs
          LinkAuthWalkNext7 nextP endL nextP (0 : Word) lenP **
        teerAuthWalkNextSkipAmbient spC loadPtr lenW balPtr balLenW chainIdW
          s7 s11 spVal cursorV endWV balBytes s innerVal) h := by
  intro h hp
  unfold teerAuthWalkNext7FlatRest at hp
...
def teerAuthWalkNext8PostNested
    (spC loadPtr lenW balPtr balLenW chainIdW
      s7 s11 spVal regionBase endL cursorV endWV : Word)
    (bs balBytes : List (BitVec 8)) (s : TeerSaved)
    (innerVal : Word) (srcOffA8 : Nat) : Assertion :=
  fun h => ∃ next len : Word,
    (teerAuthWalkNextSkipBodyPost regionBase endL next len bs srcOffA8
        LinkAuthWalkNext8 **
      teerAuthWalkNextSkipAmbient spC loadPtr lenW balPtr balLenW chainIdW
        s7 s11 spVal cursorV endWV balBytes s innerVal) h

set_option maxRecDepth 8000 in
theorem teerAuthWalkNext8_applied_nested
...
(hsuccess : (teerTxTypeDispatch (txSlice bs off len)).1 = (0 : Word))
    ...
    cpsTripleWithin nFrontToAuthWalkNext8Save
      E AfterAuthWalkNext8Save teerLinkedEarly
      ((.x1 ↦ᵣ ret) ** (.x2 ↦ᵣ spVal) **
      ...
      (teerAuthWalkNext8PostNested spC loadPtr lenW balPtr balLenW chainIdW
        s7 s11 spVal regionBase endL cursorV endW bs balBytes s innerVal
        srcOffA8) := by
  intro s innerVal listLen endL endW cursorV
  have hwnP := teerAuthWalkNext7_applied ret spVal spC loadPtr lenW
  ...
  let Flat (p : Word × Word) : Assertion :=
    ...
    ⌜rlpItemDecode bs srcOffA7 (regionBase + BitVec.ofNat 64 srcOffA7)
      endL p.1 p.2⌝
  have hwnPE :
      cpsTripleWithin nFrontToAuthWalkNext7Save E AfterAuthWalkNext7Save
        teerLinkedEarly
        ((.x1 ↦ᵣ ret) ** (.x2 ↦ᵣ spVal) **
          stackFree spVal nTeerStackDwords **
          (.x8 ↦ᵣ s0) ** (.x9 ↦ᵣ s1) **
    ...
    refine ⟨(nextP, lenP), ?_⟩
    dsimp only [Flat, teerAuthWalkNext7FlatRest]
    xperm_hyp hq'
  have hstep (p : Word × Word) :
    ...
    have hswap :
      ...
      have hcurK : p.1 = regionBase + BitVec.ofNat 64 srcOffA8 :=
        hbridgeA7 p.1 p.2 (by simpa [endL, innerVal, listLen] using hpure)
      have hcy := teerAuthWalkNext8CycleOk_ownTemps regionBase endL bs srcOffA8
        LinkAuthWalkNext7 p.1 endL p.1 (0 : Word) p.2
        (by simpa using halign) hoffA8 hoverA8 hvalidA8
        hssA8 hlsA8 hllA8
        hdecA8 hinbA8 hcurK rfl
      ...
      have hcyF' :
          cpsTripleWithin nAuthWalkNextCycle AfterAuthWalkNext7Save
            AfterAuthWalkNext8Save teerLinkedEarly
            (teerAuthWalkNextSkipFocus regionBase bs
                LinkAuthWalkNext7 p.1 endL p.1 (0 : Word) p.2 **
              teerAuthWalkNextSkipAmbient spC loadPtr lenW balPtr balLenW chainIdW
                s7 s11 spVal cursorV endW balBytes s innerVal)
        ...
        refine cpsTripleWithin_weaken
          (fun _ hp => by
            ...
            xperm_hyp hp)
          (fun h hq => by
            unfold teerAuthWalkNext8PostNested
            obtain ⟨h1, h2, hd, hu, hEx, hA⟩ := hq
            obtain ⟨next, len1, hB⟩ := hEx
            exact ⟨next, len1, h1, h2, hd, hu, hB, hA⟩)
          hcyF
      exact cpsTripleWithin_weaken
        (teerAuthWalkNext7FlatRest_to_awn8Pre spC loadPtr lenW balPtr balLenW
  ...
  exact cpsTripleWithin_mono_nSteps
    (by decide :
      nFrontToAuthWalkNext7Save + nAuthWalkNextCycle ≤ nFrontToAuthWalkNext8Save)
    hseq

set_option maxRecDepth 8000 in
/-- Flatten nested → applied-style AfterAuthWalkNext8Save post. -/
theorem teerAuthWalkNext8_applied
    (ret spVal spC loadPtr lenW balPtr balLenW chainIdW baiW : Word)
    (s0 s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11 : Word)
    (regionBase : Word) (bs balBytes : List (BitVec 8)) (off len : Nat)
    (hspC : spC = spVal + signExtend12 (-160 : BitVec 12))
...
(hsuccess : (teerTxTypeDispatch (txSlice bs off len)).1 = (0 : Word))
      ...
      (fun h => ∃ next lenK : Word,
        ((.x2 ↦ᵣ spC) **
          ...
          ⌜rlpItemDecode bs srcOffA8 (regionBase + BitVec.ofNat 64 srcOffA8)
            endL next lenK⌝) h) := by
  intro s innerVal listLen endL endW cursorV
  have h0 := teerAuthWalkNext8_applied_nested ret spVal spC loadPtr lenW
    balPtr balLenW chainIdW baiW s0 s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11
    regionBase bs balBytes off len hspC hnez hptr hlenW hsuccess htype4
    halign hbound hover hvalid0 listOff ha0 hoffL hoverL hvalidL hlenL
    h_ge h_hi h_exact srcOff0 hcur0 hoff0 hover0 hvalid0I hss0 hls0 hll0 hdec0 hinb0
  ...
  exact cpsTripleWithin_weaken (fun _ hp => hp)
    (fun h hq => by
      unfold teerAuthWalkNext8PostNested teerAuthWalkNextSkipBodyPost
        teerAuthWalkNextSkipAmbient teerAuthWalkNext0Ambient at hq
      obtain ⟨next, lenK, hq'⟩ := hq
      refine ⟨next, lenK, ?_⟩
      xperm_hyp hq') h0

#print axioms teerAuthWalkNext8CycleOk_ownTemps
#print axioms teerAuthWalkNext8_applied_nested
#print axioms teerAuthWalkNext8_applied


def teerAuthWalkNext7FlatRestIs
    (spC loadPtr lenW balPtr balLenW chainIdW
      s7 s11 spVal regionBase endL cursorV endWV : Word)
    (bs balBytes : List (BitVec 8)) (s : TeerSaved)
    (innerVal nextP lenP : Word) : Assertion :=
...
theorem teerAuthWalkNext7FlatRestIs_to_awn8Pre
    (spC loadPtr lenW balPtr balLenW chainIdW
      s7 s11 spVal regionBase endL cursorV endWV : Word)
    (bs balBytes : List (BitVec 8)) (s : TeerSaved)
    (innerVal nextP lenP : Word) :
    ∀ h,
      (teerAuthWalkNext7FlatRestIs spC loadPtr lenW balPtr balLenW chainIdW
          s7 s11 spVal regionBase endL cursorV endWV bs balBytes s
          innerVal nextP lenP) h →
      (teerAuthWalkNextSkipFocus regionBase bs
          LinkAuthWalkNext7 nextP endL nextP (0 : Word) lenP **
        teerAuthWalkNextSkipAmbientIs spC loadPtr lenW balPtr balLenW chainIdW
          s7 s11 spVal cursorV endWV balBytes s innerVal) h := by
  intro h hp
  unfold teerAuthWalkNext7FlatRestIs at hp
  unfold teerAuthWalkNextSkipFocus teerAuthWalkNext0Focus teerAuthWalkNext0BodyCore
    teerAuthWalkNextSkipAmbientIs teerAuthWalkNext0AmbientIs
  xperm_hyp hp

def teerAuthWalkNext8PostNestedIs
    (spC loadPtr lenW balPtr balLenW chainIdW
      s7 s11 spVal regionBase endL cursorV endWV : Word)
    (bs balBytes : List (BitVec 8)) (s : TeerSaved)
    (innerVal : Word) (srcOffA8 : Nat) : Assertion :=
...
set_option maxRecDepth 8000 in
theorem teerAuthWalkNext8_applied_nested_is
    (ret spVal spC loadPtr lenW balPtr balLenW chainIdW baiW : Word)
    (s0 s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11 : Word)
    (regionBase : Word) (bs balBytes : List (BitVec 8)) (off len : Nat)
    (hspC : spC = spVal + signExtend12 (-160 : BitVec 12))
...
(hsuccess : (teerTxTypeDispatch (txSlice bs off len)).1 = (0 : Word))
    ...
    cpsTripleWithin nFrontToAuthWalkNext8Save
      ...
      ((.x1 ↦ᵣ ret) ** (.x2 ↦ᵣ spVal) **
        ...
        regOwn .x16 ** regOwn .x28 ** regOwn .x29 ** regOwn .x30 **
        regOwn .x31 ** (.x0 ↦ᵣ (0 : Word)))
      (teerAuthWalkNext8PostNestedIs spC loadPtr lenW balPtr balLenW chainIdW
        s7 s11 spVal regionBase endL cursorV endW bs balBytes s innerVal
        srcOffA8) := by
  intro s innerVal listLen endL endW cursorV
  have hwnP := teerAuthWalkNext7_applied_is ret spVal spC loadPtr lenW
    balPtr balLenW chainIdW baiW s0 s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11
    regionBase bs balBytes off len hspC hnez hptr hlenW hsuccess htype4
    halign hbound hover hvalid0 listOff ha0 hoffL hoverL hvalidL hlenL
    h_ge h_hi h_exact srcOff0 hcur0 hoff0 hover0 hvalid0I hss0 hls0 hll0 hdec0 hinb0
  ...
  have hwnPE :
    ...
    obtain ⟨nextP, lenP, hq'⟩ := hq
    refine ⟨(nextP, lenP), ?_⟩
    dsimp only [Flat, teerAuthWalkNext7FlatRestIs]
    xperm_hyp hq'
  have hstep (p : Word × Word) :
      cpsTripleWithin nAuthWalkNextCycle AfterAuthWalkNext7Save AfterAuthWalkNext8Save
        teerLinkedEarly (Flat p)
      ...
      have hcyF' :
        ...
        refine cpsTripleWithin_weaken
          (fun _ hp => by
            ...
            xperm_hyp hp)
          (fun h hq => by
            unfold teerAuthWalkNext8PostNestedIs
            obtain ⟨h1, h2, hd, hu, hEx, hA⟩ := hq
            obtain ⟨next, len1, hB⟩ := hEx
            exact ⟨next, len1, h1, h2, hd, hu, hB, hA⟩)
          hcyF
      exact cpsTripleWithin_weaken
        (teerAuthWalkNext7FlatRestIs_to_awn8Pre spC loadPtr lenW balPtr balLenW
          chainIdW s7 s11 spVal regionBase endL cursorV endW bs balBytes s
          innerVal p.1 p.2)
        (fun _ hq => hq) hcyF'
    exact cpsTripleWithin_weaken (fun _ hp => by xperm_hyp hp)
...
set_option maxRecDepth 8000 in
/-- Flatten nested → applied-style AfterAuthWalkNext8Save post. -/
theorem teerAuthWalkNext8_applied_is
    (ret spVal spC loadPtr lenW balPtr balLenW chainIdW baiW : Word)
    (s0 s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11 : Word)
    (regionBase : Word) (bs balBytes : List (BitVec 8)) (off len : Nat)
    (hspC : spC = spVal + signExtend12 (-160 : BitVec 12))
...
(hsuccess : (teerTxTypeDispatch (txSlice bs off len)).1 = (0 : Word))
      ...
      (fun h => ∃ next lenK : Word,
        ((.x2 ↦ᵣ spC) **
          ...
          ⌜rlpItemDecode bs srcOffA8 (regionBase + BitVec.ofNat 64 srcOffA8)
            endL next lenK⌝) h) := by
  intro s innerVal listLen endL endW cursorV
  have h0 := teerAuthWalkNext8_applied_nested_is ret spVal spC loadPtr lenW
    balPtr balLenW chainIdW baiW s0 s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11
    regionBase bs balBytes off len hspC hnez hptr hlenW hsuccess htype4
    halign hbound hover hvalid0 listOff ha0 hoffL hoverL hvalidL hlenL
    h_ge h_hi h_exact srcOff0 hcur0 hoff0 hover0 hvalid0I hss0 hls0 hll0 hdec0 hinb0
  ...
  exact cpsTripleWithin_weaken (fun _ hp => hp)
    (fun h hq => by
      unfold teerAuthWalkNext8PostNestedIs teerAuthWalkNextSkipBodyPost
...
#print axioms teerAuthWalkNext8CycleOk_ownTemps
#print axioms teerAuthWalkNext8_applied_nested_is
#print axioms teerAuthWalkNext8_applied


#print axioms teerAuthWalkNext8_applied_nested_is
#print axioms teerAuthWalkNext8_applied_is
