/-
  Ambient dual: Front short AfterSave → creation of_decode (split loadPtr/regionBase).
-/
...
theorem extractFrontAfterSaveCreation_then_epi_of_decode_short_ambient
...
#print axioms extractFrontAfterSaveCreation_then_epi_of_decode_short_ambient
