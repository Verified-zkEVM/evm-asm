...
def balAllAccountsNonstorageCovers_prog : Program :=
  [ .ADDI .x2 .x2 (-96 : BitVec 12),
    ...
    .BNE .x12 .x0 (brOff (GuestAddrs.bal_all_accounts_nonstorage_covers + 516) (GuestAddrs.bal_all_accounts_nonstorage_covers + 88)),
    .MV .x21 .x10,
    .MV .x24 .x11,
    ...
    .JAL .x0 (-16 : BitVec 21),
    .BEQ .x21 .x24 (brOff (GuestAddrs.bal_all_accounts_nonstorage_covers + 320) (GuestAddrs.bal_all_accounts_nonstorage_covers + 132)),
    .MV .x10 .x21,
    .MV .x11 .x24,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.bal_all_accounts_nonstorage_covers + 144)),
    .BNE .x11 .x0 (brOff (GuestAddrs.bal_all_accounts_nonstorage_covers + 516) (GuestAddrs.bal_all_accounts_nonstorage_covers + 148)),
    .MV .x21 .x10,
    .SUB .x25 .x10 .x12,
    .MV .x22 .x12,
    .MV .x10 .x25,
    ...
    .BNE .x12 .x0 (brOff (GuestAddrs.bal_all_accounts_nonstorage_covers + 516) (GuestAddrs.bal_all_accounts_nonstorage_covers + 176)),
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.bal_all_accounts_nonstorage_covers + 180)),
    .BNE .x11 .x0 (brOff (GuestAddrs.bal_all_accounts_nonstorage_covers + 516) (GuestAddrs.bal_all_accounts_nonstorage_covers + 184)),
    .LI .x7 (20 : Word),
    .BNE .x12 .x7 (brOff (GuestAddrs.bal_all_accounts_nonstorage_covers + 316) (GuestAddrs.bal_all_accounts_nonstorage_covers + 192)),
    .SUB .x23 .x10 .x12,
    .LI .x29 (0 : Word),
    .MV .x13 .x19,
    .BGEU .x29 .x13 (brOff (GuestAddrs.bal_all_accounts_nonstorage_covers + 316) (GuestAddrs.bal_all_accounts_nonstorage_covers + 208)),
    .ADD .x14 .x29 .x13,
    ...
    .JAL .x0 (jalOff (GuestAddrs.bal_all_accounts_nonstorage_covers + 208) (GuestAddrs.bal_all_accounts_nonstorage_covers + 284)),
    .MV .x13 .x14,
    .JAL .x0 (jalOff (GuestAddrs.bal_all_accounts_nonstorage_covers + 208) (GuestAddrs.bal_all_accounts_nonstorage_covers + 292)),
    ...
    .JAL .x0 (jalOff (GuestAddrs.bal_all_accounts_nonstorage_covers + 132) (GuestAddrs.bal_all_accounts_nonstorage_covers + 316)),
    .LI .x22 (0 : Word),
    .BEQ .x22 .x19 (brOff (GuestAddrs.bal_all_accounts_nonstorage_covers + 508) (GuestAddrs.bal_all_accounts_nonstorage_covers + 324)),
    ...
    .JAL .x0 (jalOff (GuestAddrs.bal_all_accounts_nonstorage_covers + 500) (GuestAddrs.bal_all_accounts_nonstorage_covers + 412)),
    .LI .x29 (0 : Word),
    ...
    .JAL .x0 (jalOff (GuestAddrs.bal_all_accounts_nonstorage_covers + 324) (GuestAddrs.bal_all_accounts_nonstorage_covers + 504)),
    .LI .x10 (0 : Word),
    .JAL .x0 (8 : BitVec 21),
    .LI .x10 (1 : Word),
