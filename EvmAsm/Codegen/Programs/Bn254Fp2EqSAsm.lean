...
#guard GuestAddrs.bnp_fp2_eq = 0x80030b84
...
#guard (bnpFp2EqBody 0 0 [] []).flatten GuestAddrs.bnp_fp2_eq = bnpFp2Eq_prog
...
theorem bnpFp2EqBody_flatten_eq (ptr1 ptr2 : Word) (bs1 bs2 : List (BitVec 8)) :
    (bnpFp2EqBody ptr1 ptr2 bs1 bs2).flatten (GuestAddrs.bnp_fp2_eq : Word) = bnpFp2Eq_prog := rfl
...
theorem bnpFp2Eq_spec (ptr1 ptr2 ret : Word) (bs1 bs2 : List (BitVec 8))
    ...
    cpsTripleWithin (bnpFp2EqBody ptr1 ptr2 bs1 bs2).steps
      (GuestAddrs.bnp_fp2_eq : Word) ret
      (CodeReq.ofProg (GuestAddrs.bnp_fp2_eq : Word) bnpFp2Eq_prog)
