...
#guard GuestAddrs.bnp_fp2_eq = 0x80030628
...
#guard (bnpFp2EqBody 0 0 [] []).flatten 0x80030628 = bnpFp2Eq_prog
...
theorem bnpFp2EqBody_flatten_eq (ptr1 ptr2 : Word) (bs1 bs2 : List (BitVec 8)) :
    (bnpFp2EqBody ptr1 ptr2 bs1 bs2).flatten (0x80030628 : Word) = bnpFp2Eq_prog := rfl
...
theorem bnpFp2Eq_spec (ptr1 ptr2 ret : Word) (bs1 bs2 : List (BitVec 8))
    ...
    cpsTripleWithin (bnpFp2EqBody ptr1 ptr2 bs1 bs2).steps
      (0x80030628 : Word) ret
      (CodeReq.ofProg (0x80030628 : Word) bnpFp2Eq_prog)
  ...
  rw [show (DualReadScan.scanBody .x5 .x6 .x7 .x10 .x11 ptr1 ptr2 bs1 bs2
      8).flatten (0x80030628 : Word) = bnpFp2Eq_prog from rfl] at h
  exact h
