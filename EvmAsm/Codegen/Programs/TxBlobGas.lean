...
def txEip4844ValidateBlobHashes_prog : Program :=
  [ .ADDI .x2 .x2 (-72 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_eip4844_validate_blob_hashes + 276) (GuestAddrs.tx_eip4844_validate_blob_hashes + 92)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_eip4844_validate_blob_hashes + 284) (GuestAddrs.tx_eip4844_validate_blob_hashes + 140)),
    ...
    .BEQ .x22 .x0 (brOff (GuestAddrs.tx_eip4844_validate_blob_hashes + 292) (GuestAddrs.tx_eip4844_validate_blob_hashes + 160)),
    .BLTU .x9 .x22 (brOff (GuestAddrs.tx_eip4844_validate_blob_hashes + 300) (GuestAddrs.tx_eip4844_validate_blob_hashes + 164)),
    .LI .x21 (0 : Word),
    .BEQ .x21 .x22 (brOff (GuestAddrs.tx_eip4844_validate_blob_hashes + 268) (GuestAddrs.tx_eip4844_validate_blob_hashes + 172)),
    .MV .x10 .x19,
    .MV .x11 .x20,
    .MV .x12 .x21,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_eip4844_validate_blob_hashes + 308) (GuestAddrs.tx_eip4844_validate_blob_hashes + 208)),
    ...
    .LI .x7 (32 : Word),
    .BNE .x6 .x7 (brOff (GuestAddrs.tx_eip4844_validate_blob_hashes + 308) (GuestAddrs.tx_eip4844_validate_blob_hashes + 228)),
    ...
    .JAL .x0 (jalOff (GuestAddrs.tx_eip4844_validate_blob_hashes + 172) (GuestAddrs.tx_eip4844_validate_blob_hashes + 264)),
    .LI .x10 (0 : Word),
    .JAL .x0 (48 : BitVec 21),
    .LI .x10 (1 : Word),
    .JAL .x0 (40 : BitVec 21),
...
def sszTxListVersionedHashesMatch_prog : Program :=
  [ .ADDI .x2 .x2 (-112 : BitVec 12),
    ...
    .BNE .x5 .x0 (brOff (GuestAddrs.ssz_tx_list_versioned_hashes_match + 600) (GuestAddrs.ssz_tx_list_versioned_hashes_match + 72)),
    ...
    .ADD .x5 .x8 .x10,
    .ADD .x22 .x8 .x21,
    .BLTU .x5 .x22 (brOff (GuestAddrs.ssz_tx_list_versioned_hashes_match + 600) (GuestAddrs.ssz_tx_list_versioned_hashes_match + 112)),
    .SUB .x23 .x5 .x22,
    .BEQ .x23 .x0 (brOff (GuestAddrs.ssz_tx_list_versioned_hashes_match + 588) (GuestAddrs.ssz_tx_list_versioned_hashes_match + 120)),
    .LI .x5 (4 : Word),
    .BLTU .x23 .x5 (brOff (GuestAddrs.ssz_tx_list_versioned_hashes_match + 600) (GuestAddrs.ssz_tx_list_versioned_hashes_match + 128)),
    .MV .x10 .x22,
    .JAL .x1 (jalOff GuestAddrs.bgv_u32le (GuestAddrs.ssz_tx_list_versioned_hashes_match + 136)),
    .ANDI .x5 .x10 (3 : BitVec 12),
    .BEQ .x10 .x0 (brOff (GuestAddrs.ssz_tx_list_versioned_hashes_match + 600) (GuestAddrs.ssz_tx_list_versioned_hashes_match + 144)),
    .BLTU .x23 .x10 (brOff (GuestAddrs.ssz_tx_list_versioned_hashes_match + 600) (GuestAddrs.ssz_tx_list_versioned_hashes_match + 148)),
    .SRLI .x24 .x10 (2 : BitVec 6),
    .LI .x25 (0 : Word),
    .BEQ .x25 .x24 (brOff (GuestAddrs.ssz_tx_list_versioned_hashes_match + 588) (GuestAddrs.ssz_tx_list_versioned_hashes_match + 160)),
    ...
    .BLTU .x26 .x5 (brOff (GuestAddrs.ssz_tx_list_versioned_hashes_match + 600) (GuestAddrs.ssz_tx_list_versioned_hashes_match + 188)),
    ...
    .JAL .x0 (8 : BitVec 21),
    .MV .x10 .x23,
    .BLTU .x10 .x26 (brOff (GuestAddrs.ssz_tx_list_versioned_hashes_match + 600) (GuestAddrs.ssz_tx_list_versioned_hashes_match + 224)),
    .SUB .x27 .x10 .x26,
    .ADD .x5 .x22 .x26,
    .MV .x10 .x5,
    .MV .x11 .x27,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.ssz_tx_list_versioned_hashes_match + 608) (GuestAddrs.ssz_tx_list_versioned_hashes_match + 264)),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .LI .x7 (3 : Word),
    .BNE .x6 .x7 (brOff (GuestAddrs.ssz_tx_list_versioned_hashes_match + 580) (GuestAddrs.ssz_tx_list_versioned_hashes_match + 284)),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .BLTU .x27 .x6 (brOff (GuestAddrs.ssz_tx_list_versioned_hashes_match + 608) (GuestAddrs.ssz_tx_list_versioned_hashes_match + 300)),
    .ADD .x5 .x22 .x26,
    .ADD .x26 .x5 .x6,
    .SUB .x27 .x27 .x6,
    .MV .x10 .x26,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.ssz_tx_list_versioned_hashes_match + 608) (GuestAddrs.ssz_tx_list_versioned_hashes_match + 336)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.ssz_tx_list_versioned_hashes_match + 616) (GuestAddrs.ssz_tx_list_versioned_hashes_match + 384)),
    ...
    .LI .x6 (0 : Word),
    .BEQ .x6 .x5 (brOff (GuestAddrs.ssz_tx_list_versioned_hashes_match + 580) (GuestAddrs.ssz_tx_list_versioned_hashes_match + 404)),
    .BGEU .x20 .x19 (brOff (GuestAddrs.ssz_tx_list_versioned_hashes_match + 624) (GuestAddrs.ssz_tx_list_versioned_hashes_match + 408)),
    .MV .x10 .x26,
    .MV .x11 .x27,
    .MV .x12 .x6,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.ssz_tx_list_versioned_hashes_match + 616) (GuestAddrs.ssz_tx_list_versioned_hashes_match + 456)),
    ...
    .LI .x29 (32 : Word),
    .BNE .x28 .x29 (brOff (GuestAddrs.ssz_tx_list_versioned_hashes_match + 616) (GuestAddrs.ssz_tx_list_versioned_hashes_match + 500)),
    ...
    .BNE .x31 .x15 (brOff (GuestAddrs.ssz_tx_list_versioned_hashes_match + 624) (GuestAddrs.ssz_tx_list_versioned_hashes_match + 556)),
    .ADDI .x30 .x30 (1 : BitVec 12),
    .JAL .x0 (-32 : BitVec 21),
    .ADDI .x20 .x20 (1 : BitVec 12),
    .ADDI .x6 .x6 (1 : BitVec 12),
    .JAL .x0 (jalOff (GuestAddrs.ssz_tx_list_versioned_hashes_match + 404) (GuestAddrs.ssz_tx_list_versioned_hashes_match + 576)),
    .ADDI .x25 .x25 (1 : BitVec 12),
    .JAL .x0 (jalOff (GuestAddrs.ssz_tx_list_versioned_hashes_match + 160) (GuestAddrs.ssz_tx_list_versioned_hashes_match + 584)),
