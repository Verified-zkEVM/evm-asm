...
def accountWritesUndoPush_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .AUIPC .x5 (laHi GuestAddrs.account_writes_undo_count (GuestAddrs.account_writes_undo_push + 32)),
    .ADDI .x5 .x5 (laLo GuestAddrs.account_writes_undo_count (GuestAddrs.account_writes_undo_push + 32)),
    .LD .x6 .x5 (0 : BitVec 12),
    .LUI .x7 (40 : BitVec 20),
    .BGEU .x6 .x7 (brOff (GuestAddrs.account_writes_undo_push + 224) (GuestAddrs.account_writes_undo_push + 48)),
    .LUI .x7 (95 : BitVec 20),
    .ADDIW .x7 .x7 (241 : BitVec 12),
    .SLLI .x7 .x7 (13 : BitVec 6),
    .SLLI .x28 .x6 (7 : BitVec 6),
    .ADD .x28 .x7 .x28,
    .SD .x28 .x15 (0 : BitVec 12),
    .SD .x28 .x16 (8 : BitVec 12),
    .BNE .x16 .x0 (brOff (GuestAddrs.account_writes_undo_push + 200) (GuestAddrs.account_writes_undo_push + 80)),
    .LUI .x7 (1 : BitVec 20),
    .ADDIW .x7 .x7 (2031 : BitVec 12),
    .SLLI .x7 .x7 (19 : BitVec 6),
    .SLLI .x29 .x15 (7 : BitVec 6),
    .ADD .x29 .x7 .x29,
    ...
    .SD .x28 .x7 (32 : BitVec 12),
    .LD .x7 .x29 (56 : BitVec 12),
    .SD .x28 .x7 (40 : BitVec 12),
    .LD .x7 .x29 (64 : BitVec 12),
    .SD .x28 .x7 (48 : BitVec 12),
    .LD .x7 .x29 (72 : BitVec 12),
    .SD .x28 .x7 (56 : BitVec 12),
    .LD .x7 .x29 (80 : BitVec 12),
    .SD .x28 .x7 (64 : BitVec 12),
    .LD .x7 .x29 (88 : BitVec 12),
    .SD .x28 .x7 (72 : BitVec 12),
    .LD .x7 .x29 (96 : BitVec 12),
    .SD .x28 .x7 (80 : BitVec 12),
    .LD .x7 .x29 (104 : BitVec 12),
    .SD .x28 .x7 (88 : BitVec 12),
    .LD .x7 .x29 (112 : BitVec 12),
    .SD .x28 .x7 (96 : BitVec 12),
    .LD .x7 .x29 (120 : BitVec 12),
    .SD .x28 .x7 (104 : BitVec 12),
    .ADDI .x6 .x6 (1 : BitVec 12),
    .AUIPC .x5 (laHi GuestAddrs.account_writes_undo_count (GuestAddrs.account_writes_undo_push + 204)),
    .ADDI .x5 .x5 (laLo GuestAddrs.account_writes_undo_count (GuestAddrs.account_writes_undo_push + 204)),
    .SD .x5 .x6 (0 : BitVec 12),
    .LI .x10 (0 : Word),
    .JAL .x0 (32 : BitVec 21),
    .LI .x10 (1 : Word),
    .AUIPC .x28 (laHi GuestAddrs.tx_account_writes_overflow (GuestAddrs.account_writes_undo_push + 228)),
    .ADDI .x28 .x28 (laLo GuestAddrs.tx_account_writes_overflow (GuestAddrs.account_writes_undo_push + 228)),
    .SD .x28 .x10 (0 : BitVec 12),
    .AUIPC .x28 (laHi GuestAddrs.account_writes_overflow (GuestAddrs.account_writes_undo_push + 240)),
    .ADDI .x28 .x28 (laLo GuestAddrs.account_writes_overflow (GuestAddrs.account_writes_undo_push + 240)),
    .SD .x28 .x10 (0 : BitVec 12),
...
/-- Reloc side-table for `accountWritesUndoPush_prog`: the `la`/cross-`jal` instruction indices
    kept SYMBOLIC in the emitted image text (`emitProgramR`), while the Program
    above carries the concrete guest-linked immediates for verification. -/
def accountWritesUndoPush_relocs : RelocTable :=
  [ (8, .la .x5 "account_writes_undo_count"),
    (51, .la .x5 "account_writes_undo_count"),
    (57, .la .x28 "tx_account_writes_overflow"),
    (60, .la .x28 "account_writes_overflow") ]

def accountWritesUndoPushFunction : String :=
  "account_writes_undo_push:\n" ++ emitProgramR accountWritesUndoPush_prog accountWritesUndoPush_relocs

/-- Kernel-checked drift guard: the emitted (image-agnostic, symbolic) Codegen
    string is exactly `accountWritesUndoPush_prog` rendered under its label with the `la`/`jal`
    relocs kept symbolic (bead evm-asm-4ch8f.9.3, mechanical conversion by
    `scripts/asm_to_program.py`). Guest binary byte-identity + guest-linked
    consistency of the concrete Program verified offline by assemble/link+cmp. -/
theorem accountWritesUndoPushFunction_eq_prog :
    accountWritesUndoPushFunction = "account_writes_undo_push:\n" ++ emitProgramR accountWritesUndoPush_prog accountWritesUndoPush_relocs := rfl

#guard accountWritesUndoPushFunction.startsWith "account_writes_undo_push:\n"
#guard accountWritesUndoPush_prog.length = 72
