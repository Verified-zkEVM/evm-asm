/-
  Ambient dual: E → ret legacy short creation of_decode.
-/
...
/-- Front short ambient + legacy AfterSave→creation steps. -/
def nFrontCreationStepsShortLegacyAmbient : Nat :=
...
theorem extractFrontCreation_then_epi_of_decode_short_concrete_legacy_ambient
    ...
    cpsTripleWithin nFrontCreationStepsShortLegacyAmbient
  ...
  have hC := extractFrontAfterSaveCreation_then_epi_of_decode_short_legacy_ambient sp0 spC s
...
#print axioms extractFrontCreation_then_epi_of_decode_short_concrete_legacy_ambient
