/-
  Front long AfterSave → legacy creation of_decode with concrete longWalkCursor/End.
-/
...
theorem extractFrontAfterSaveCreation_then_epi_of_decode_long_legacy
  ...
  have hMid := extractLegacyAfterSaveCreation_then_epi_of_decode sp0 spC s
    txBase lenW
  ...
  simp only [htype0, afterSaveFrameTy_zero_eq_afterSaveFrame] at hty
  exact hty

#print axioms extractFrontAfterSaveCreation_then_epi_of_decode_long_legacy
