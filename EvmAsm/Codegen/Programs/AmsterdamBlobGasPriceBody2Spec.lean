/-/
mul6 window for `amsterdam_blob_gas_price_u256` (#12851 body discharge):
instrs 108..169, `PriceK+432 .. PriceK+680`.

Lives in a second body file to stay under the per-file line cap;
the earlier windows (setup / or-chain / beqz / bgeu / add6) are in
`AmsterdamBlobGasPriceBodySpec.lean`.
-/
import EvmAsm.Codegen.Programs.AmsterdamBlobGasPriceBodySpec
import EvmAsm.Rv64.SyscallSpecs

namespace EvmAsm.Codegen.AmsterdamBlobGasPriceBody2Spec
...
/-! ## mul6 window (instrs 108..169, `PriceK+432 .. PriceK+680`) -/
...
@[reducible] private def mul6QOVF0 (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p0 p1 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5 : Word) : Assertion :=
  (((.x29 ↦ᵣ (if BitVec.ult ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0)) (rv64_mulhu a0 excess) then 1 else 0)) ** (.x0 ↦ᵣ (0 : Word)) ** ⌜(if BitVec.ult ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0)) (rv64_mulhu a0 excess) then 1 else 0) ≠ (0 : Word)⌝) **
    ...
    (.x18 ↦ᵣ iVal) ** (.x19 ↦ᵣ (newSp + signExtend12 64)) **
    (.x20 ↦ᵣ (newSp + signExtend12 112)) ** (.x21 ↦ᵣ outPtr) **
    ...
    (((newSp + signExtend12 64) + signExtend12 0) ↦ₘ a0) ** (((newSp + signExtend12 64) + signExtend12 8) ↦ₘ a1) **
    (((newSp + signExtend12 64) + signExtend12 16) ↦ₘ a2) ** (((newSp + signExtend12 64) + signExtend12 24) ↦ₘ a3) **
    (((newSp + signExtend12 64) + signExtend12 32) ↦ₘ a4) ** (((newSp + signExtend12 64) + signExtend12 40) ↦ₘ a5) **
    (((newSp + signExtend12 112) + signExtend12 0) ↦ₘ p0) ** (((newSp + signExtend12 112) + signExtend12 8) ↦ₘ p1) **
    (((newSp + signExtend12 112) + signExtend12 16) ↦ₘ p2) ** (((newSp + signExtend12 112) + signExtend12 24) ↦ₘ p3) **
    (((newSp + signExtend12 112) + signExtend12 32) ↦ₘ p4) ** (((newSp + signExtend12 112) + signExtend12 40) ↦ₘ p5) **
...
@[reducible] private def mul6QOVF1 (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p1 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5 : Word) : Assertion :=
  (((.x29 ↦ᵣ (if BitVec.ult ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0)) (rv64_mulhu a1 excess) then 1 else 0)) ** (.x0 ↦ᵣ (0 : Word)) ** ⌜(if BitVec.ult ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0)) (rv64_mulhu a1 excess) then 1 else 0) ≠ (0 : Word)⌝) **
    ...
    (((newSp + signExtend12 64) + signExtend12 16) ↦ₘ a2) ** (((newSp + signExtend12 64) + signExtend12 24) ↦ₘ a3) **
    (((newSp + signExtend12 64) + signExtend12 32) ↦ₘ a4) ** (((newSp + signExtend12 64) + signExtend12 40) ↦ₘ a5) **
    (((newSp + signExtend12 112) + signExtend12 0) ↦ₘ ((a0 * excess) + (0 : Word))) ** (((newSp + signExtend12 112) + signExtend12 8) ↦ₘ p1) **
    (((newSp + signExtend12 112) + signExtend12 16) ↦ₘ p2) ** (((newSp + signExtend12 112) + signExtend12 24) ↦ₘ p3) **
    (((newSp + signExtend12 112) + signExtend12 32) ↦ₘ p4) ** (((newSp + signExtend12 112) + signExtend12 40) ↦ₘ p5) **
    (((newSp + signExtend12 160) + signExtend12 0) ↦ₘ s0) ** (((newSp + signExtend12 160) + signExtend12 8) ↦ₘ s1) **
    (((newSp + signExtend12 160) + signExtend12 16) ↦ₘ s2) ** (((newSp + signExtend12 160) + signExtend12 24) ↦ₘ s3) **
...
@[reducible] private def mul6QOVF2 (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5 : Word) : Assertion :=
  (((.x29 ↦ᵣ (if BitVec.ult ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0)) (rv64_mulhu a2 excess) then 1 else 0)) ** (.x0 ↦ᵣ (0 : Word)) ** ⌜(if BitVec.ult ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0)) (rv64_mulhu a2 excess) then 1 else 0) ≠ (0 : Word)⌝) **
    ...
    (((newSp + signExtend12 64) + signExtend12 16) ↦ₘ a2) ** (((newSp + signExtend12 64) + signExtend12 24) ↦ₘ a3) **
    (((newSp + signExtend12 64) + signExtend12 32) ↦ₘ a4) ** (((newSp + signExtend12 64) + signExtend12 40) ↦ₘ a5) **
    (((newSp + signExtend12 112) + signExtend12 0) ↦ₘ ((a0 * excess) + (0 : Word))) ** (((newSp + signExtend12 112) + signExtend12 8) ↦ₘ ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0)))) **
    (((newSp + signExtend12 112) + signExtend12 16) ↦ₘ p2) ** (((newSp + signExtend12 112) + signExtend12 24) ↦ₘ p3) **
    (((newSp + signExtend12 112) + signExtend12 32) ↦ₘ p4) ** (((newSp + signExtend12 112) + signExtend12 40) ↦ₘ p5) **
    (((newSp + signExtend12 160) + signExtend12 0) ↦ₘ s0) ** (((newSp + signExtend12 160) + signExtend12 8) ↦ₘ s1) **
    (((newSp + signExtend12 160) + signExtend12 16) ↦ₘ s2) ** (((newSp + signExtend12 160) + signExtend12 24) ↦ₘ s3) **
...
@[reducible] private def mul6QOVF3 (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p3 p4 p5 s0 s1 s2 s3 s4 s5 : Word) : Assertion :=
  (((.x29 ↦ᵣ (if BitVec.ult ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0)) (rv64_mulhu a3 excess) then 1 else 0)) ** (.x0 ↦ᵣ (0 : Word)) ** ⌜(if BitVec.ult ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0)) (rv64_mulhu a3 excess) then 1 else 0) ≠ (0 : Word)⌝) **
    ...
    (((newSp + signExtend12 64) + signExtend12 32) ↦ₘ a4) ** (((newSp + signExtend12 64) + signExtend12 40) ↦ₘ a5) **
    (((newSp + signExtend12 112) + signExtend12 0) ↦ₘ ((a0 * excess) + (0 : Word))) ** (((newSp + signExtend12 112) + signExtend12 8) ↦ₘ ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0)))) **
    (((newSp + signExtend12 112) + signExtend12 16) ↦ₘ ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0)))) ** (((newSp + signExtend12 112) + signExtend12 24) ↦ₘ p3) **
    (((newSp + signExtend12 112) + signExtend12 32) ↦ₘ p4) ** (((newSp + signExtend12 112) + signExtend12 40) ↦ₘ p5) **
    (((newSp + signExtend12 160) + signExtend12 0) ↦ₘ s0) ** (((newSp + signExtend12 160) + signExtend12 8) ↦ₘ s1) **
    (((newSp + signExtend12 160) + signExtend12 16) ↦ₘ s2) ** (((newSp + signExtend12 160) + signExtend12 24) ↦ₘ s3) **
    (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5))

@[reducible] private def mul6QOVF4 (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p4 p5 s0 s1 s2 s3 s4 s5 : Word) : Assertion :=
  (((.x29 ↦ᵣ (if BitVec.ult ((rv64_mulhu a4 excess) + (if BitVec.ult ((a4 * excess) + ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0))) (a4 * excess) then 1 else 0)) (rv64_mulhu a4 excess) then 1 else 0)) ** (.x0 ↦ᵣ (0 : Word)) ** ⌜(if BitVec.ult ((rv64_mulhu a4 excess) + (if BitVec.ult ((a4 * excess) + ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0))) (a4 * excess) then 1 else 0)) (rv64_mulhu a4 excess) then 1 else 0) ≠ (0 : Word)⌝) **
    ...
    (((newSp + signExtend12 64) + signExtend12 32) ↦ₘ a4) ** (((newSp + signExtend12 64) + signExtend12 40) ↦ₘ a5) **
    (((newSp + signExtend12 112) + signExtend12 0) ↦ₘ ((a0 * excess) + (0 : Word))) ** (((newSp + signExtend12 112) + signExtend12 8) ↦ₘ ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0)))) **
    (((newSp + signExtend12 112) + signExtend12 16) ↦ₘ ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0)))) ** (((newSp + signExtend12 112) + signExtend12 24) ↦ₘ ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0)))) **
    (((newSp + signExtend12 112) + signExtend12 32) ↦ₘ p4) ** (((newSp + signExtend12 112) + signExtend12 40) ↦ₘ p5) **
    (((newSp + signExtend12 160) + signExtend12 0) ↦ₘ s0) ** (((newSp + signExtend12 160) + signExtend12 8) ↦ₘ s1) **
    (((newSp + signExtend12 160) + signExtend12 16) ↦ₘ s2) ** (((newSp + signExtend12 160) + signExtend12 24) ↦ₘ s3) **
    (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5))

@[reducible] private def mul6QOVF5 (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p5 s0 s1 s2 s3 s4 s5 : Word) : Assertion :=
  (((.x29 ↦ᵣ (if BitVec.ult ((rv64_mulhu a5 excess) + (if BitVec.ult ((a5 * excess) + ((rv64_mulhu a4 excess) + (if BitVec.ult ((a4 * excess) + ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0))) (a4 * excess) then 1 else 0))) (a5 * excess) then 1 else 0)) (rv64_mulhu a5 excess) then 1 else 0)) ** (.x0 ↦ᵣ (0 : Word)) ** ⌜(if BitVec.ult ((rv64_mulhu a5 excess) + (if BitVec.ult ((a5 * excess) + ((rv64_mulhu a4 excess) + (if BitVec.ult ((a4 * excess) + ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0))) (a4 * excess) then 1 else 0))) (a5 * excess) then 1 else 0)) (rv64_mulhu a5 excess) then 1 else 0) ≠ (0 : Word)⌝) **
    ...
    (((newSp + signExtend12 112) + signExtend12 0) ↦ₘ ((a0 * excess) + (0 : Word))) ** (((newSp + signExtend12 112) + signExtend12 8) ↦ₘ ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0)))) **
    (((newSp + signExtend12 112) + signExtend12 16) ↦ₘ ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0)))) ** (((newSp + signExtend12 112) + signExtend12 24) ↦ₘ ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0)))) **
    (((newSp + signExtend12 112) + signExtend12 32) ↦ₘ ((a4 * excess) + ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0)))) ** (((newSp + signExtend12 112) + signExtend12 40) ↦ₘ p5) **
    (((newSp + signExtend12 160) + signExtend12 0) ↦ₘ s0) ** (((newSp + signExtend12 160) + signExtend12 8) ↦ₘ s1) **
    (((newSp + signExtend12 160) + signExtend12 16) ↦ₘ s2) ** (((newSp + signExtend12 160) + signExtend12 24) ↦ₘ s3) **
    (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5))

@[reducible] private def mul6QOVFF (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 s0 s1 s2 s3 s4 s5 : Word) : Assertion :=
  (((.x31 ↦ᵣ ((rv64_mulhu a5 excess) + (if BitVec.ult ((a5 * excess) + ((rv64_mulhu a4 excess) + (if BitVec.ult ((a4 * excess) + ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0))) (a4 * excess) then 1 else 0))) (a5 * excess) then 1 else 0))) ** (.x0 ↦ᵣ (0 : Word)) ** ⌜((rv64_mulhu a5 excess) + (if BitVec.ult ((a5 * excess) + ((rv64_mulhu a4 excess) + (if BitVec.ult ((a4 * excess) + ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0))) (a4 * excess) then 1 else 0))) (a5 * excess) then 1 else 0)) ≠ (0 : Word)⌝) **
    ...
    (((newSp + signExtend12 112) + signExtend12 0) ↦ₘ ((a0 * excess) + (0 : Word))) ** (((newSp + signExtend12 112) + signExtend12 8) ↦ₘ ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0)))) **
    (((newSp + signExtend12 112) + signExtend12 16) ↦ₘ ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0)))) ** (((newSp + signExtend12 112) + signExtend12 24) ↦ₘ ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0)))) **
    (((newSp + signExtend12 112) + signExtend12 32) ↦ₘ ((a4 * excess) + ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0)))) ** (((newSp + signExtend12 112) + signExtend12 40) ↦ₘ ((a5 * excess) + ((rv64_mulhu a4 excess) + (if BitVec.ult ((a4 * excess) + ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0))) (a4 * excess) then 1 else 0)))) **
    (((newSp + signExtend12 160) + signExtend12 0) ↦ₘ s0) ** (((newSp + signExtend12 160) + signExtend12 8) ↦ₘ s1) **
    (((newSp + signExtend12 160) + signExtend12 16) ↦ₘ s2) ** (((newSp + signExtend12 160) + signExtend12 24) ↦ₘ s3) **
    (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5))

@[reducible] private def mul6QFALL (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 s0 s1 s2 s3 s4 s5 : Word) : Assertion :=
  (((.x31 ↦ᵣ ((rv64_mulhu a5 excess) + (if BitVec.ult ((a5 * excess) + ((rv64_mulhu a4 excess) + (if BitVec.ult ((a4 * excess) + ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0))) (a4 * excess) then 1 else 0))) (a5 * excess) then 1 else 0))) ** (.x0 ↦ᵣ (0 : Word)) ** ⌜((rv64_mulhu a5 excess) + (if BitVec.ult ((a5 * excess) + ((rv64_mulhu a4 excess) + (if BitVec.ult ((a4 * excess) + ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0))) (a4 * excess) then 1 else 0))) (a5 * excess) then 1 else 0)) = (0 : Word)⌝) **
    (.x2 ↦ᵣ newSp) ** (.x1 ↦ᵣ (vals .x1)) **
    (.x10 ↦ᵣ excess) ** (.x11 ↦ᵣ outPtr) **
    (.x8 ↦ᵣ excess) ** (.x9 ↦ᵣ taylorDW) **
...
@[reducible] private def mul6PRE (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p0 p1 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5 v5 v6 v7 v28 v29 v30 v31 : Word) : Assertion :=
  (.x2 ↦ᵣ newSp) ** (.x1 ↦ᵣ (vals .x1)) **
  (.x10 ↦ᵣ excess) ** (.x11 ↦ᵣ outPtr) **
  (.x8 ↦ᵣ excess) ** (.x9 ↦ᵣ taylorDW) **
  (.x18 ↦ᵣ iVal) ** (.x19 ↦ᵣ (newSp + signExtend12 64)) **
...
private theorem mul6_pre0 (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p0 p1 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5 v5 v6 v7 v28 v29 v30 v31 : Word) :
  ...
  have hldA0 := ld_spec_gen_within .x5 .x19 (newSp + signExtend12 64) v5 a0 (0 : BitVec 12) (PriceK + 436) (by decide)
...
private theorem mul6_pre1 (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p1 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5 : Word) :
    cpsTripleWithin 7 (PriceK + 476) (PriceK + 504) priceCode
      ...
      (      (((.x29 ↦ᵣ (if BitVec.ult ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0)) (rv64_mulhu a1 excess) then 1 else 0)) ** (.x0 ↦ᵣ (0 : Word))) **
        ...
        (((newSp + signExtend12 160) + signExtend12 16) ↦ₘ s2) ** (((newSp + signExtend12 160) + signExtend12 24) ↦ₘ s3) **
        (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5))) := by
  have hldA1 := ld_spec_gen_within .x5 .x19 (newSp + signExtend12 64) a0 a1 (8 : BitVec 12) (PriceK + 476) (by decide)
...
private theorem mul6_pre2 (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5 : Word) :
    cpsTripleWithin 7 (PriceK + 516) (PriceK + 544) priceCode
      ...
      (      (((.x29 ↦ᵣ (if BitVec.ult ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0)) (rv64_mulhu a2 excess) then 1 else 0)) ** (.x0 ↦ᵣ (0 : Word))) **
        ...
        (((newSp + signExtend12 160) + signExtend12 16) ↦ₘ s2) ** (((newSp + signExtend12 160) + signExtend12 24) ↦ₘ s3) **
        (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5))) := by
  have hldA2 := ld_spec_gen_within .x5 .x19 (newSp + signExtend12 64) a1 a2 (16 : BitVec 12) (PriceK + 516) (by decide)
...
private theorem mul6_pre3 (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p3 p4 p5 s0 s1 s2 s3 s4 s5 : Word) :
    cpsTripleWithin 7 (PriceK + 556) (PriceK + 584) priceCode
      ...
      (      (((.x29 ↦ᵣ (if BitVec.ult ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0)) (rv64_mulhu a3 excess) then 1 else 0)) ** (.x0 ↦ᵣ (0 : Word))) **
        ...
        (((newSp + signExtend12 160) + signExtend12 16) ↦ₘ s2) ** (((newSp + signExtend12 160) + signExtend12 24) ↦ₘ s3) **
        (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5))) := by
  have hldA3 := ld_spec_gen_within .x5 .x19 (newSp + signExtend12 64) a2 a3 (24 : BitVec 12) (PriceK + 556) (by decide)
...
private theorem mul6_pre4 (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p4 p5 s0 s1 s2 s3 s4 s5 : Word) :
    cpsTripleWithin 7 (PriceK + 596) (PriceK + 624) priceCode
      ...
      (      (((.x29 ↦ᵣ (if BitVec.ult ((rv64_mulhu a4 excess) + (if BitVec.ult ((a4 * excess) + ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0))) (a4 * excess) then 1 else 0)) (rv64_mulhu a4 excess) then 1 else 0)) ** (.x0 ↦ᵣ (0 : Word))) **
        ...
        (((newSp + signExtend12 160) + signExtend12 16) ↦ₘ s2) ** (((newSp + signExtend12 160) + signExtend12 24) ↦ₘ s3) **
        (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5))) := by
  have hldA4 := ld_spec_gen_within .x5 .x19 (newSp + signExtend12 64) a3 a4 (32 : BitVec 12) (PriceK + 596) (by decide)
...
private theorem mul6_pre5 (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p5 s0 s1 s2 s3 s4 s5 : Word) :
    cpsTripleWithin 7 (PriceK + 636) (PriceK + 664) priceCode
      ...
      (      (((.x29 ↦ᵣ (if BitVec.ult ((rv64_mulhu a5 excess) + (if BitVec.ult ((a5 * excess) + ((rv64_mulhu a4 excess) + (if BitVec.ult ((a4 * excess) + ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0))) (a4 * excess) then 1 else 0))) (a5 * excess) then 1 else 0)) (rv64_mulhu a5 excess) then 1 else 0)) ** (.x0 ↦ᵣ (0 : Word))) **
        ...
        (((newSp + signExtend12 160) + signExtend12 16) ↦ₘ s2) ** (((newSp + signExtend12 160) + signExtend12 24) ↦ₘ s3) **
        (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5))) := by
  have hldA5 := ld_spec_gen_within .x5 .x19 (newSp + signExtend12 64) a4 a5 (40 : BitVec 12) (PriceK + 636) (by decide)
...
private theorem mul6_tail0_core (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p0 p1 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5 : Word) :
    cpsTripleWithin 2 (PriceK + 468) (PriceK + 476) priceCode
      ...
      (((newSp + signExtend12 160) + signExtend12 16) ↦ₘ s2) ** (((newSp + signExtend12 160) + signExtend12 24) ↦ₘ s3) **
      (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5)) := by
  have hsd0 := sd_spec_gen_within .x20 .x28 (newSp + signExtend12 112) ((a0 * excess) + (0 : Word)) p0 (0 : BitVec 12) (PriceK + 468)
...
private theorem mul6_tail0 (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p0 p1 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5 : Word) :
    cpsTripleWithin 2 (PriceK + 468) (PriceK + 476) priceCode
      (      (((.x29 ↦ᵣ (if BitVec.ult ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0)) (rv64_mulhu a0 excess) then 1 else 0)) ** (.x0 ↦ᵣ (0 : Word)) ** ⌜(if BitVec.ult ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0)) (rv64_mulhu a0 excess) then 1 else 0) = (0 : Word)⌝) **
        (.x2 ↦ᵣ newSp) ** (.x1 ↦ᵣ (vals .x1)) **
        (.x10 ↦ᵣ excess) ** (.x11 ↦ᵣ outPtr) **
  ...
  refine cpsTripleWithin_weaken (pure_drop_mid) (fun _ hx => hx)
    (mul6_tail0_core newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p0 p1 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5)

private theorem mul6_tail1_core (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p1 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5 : Word) :
    cpsTripleWithin 2 (PriceK + 508) (PriceK + 516) priceCode
      ...
      (((newSp + signExtend12 160) + signExtend12 16) ↦ₘ s2) ** (((newSp + signExtend12 160) + signExtend12 24) ↦ₘ s3) **
      (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5)) := by
  have hsd1 := sd_spec_gen_within .x20 .x28 (newSp + signExtend12 112) ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) p1 (8 : BitVec 12) (PriceK + 508)
...
private theorem mul6_tail1 (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p1 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5 : Word) :
    cpsTripleWithin 2 (PriceK + 508) (PriceK + 516) priceCode
      (      (((.x29 ↦ᵣ (if BitVec.ult ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0)) (rv64_mulhu a1 excess) then 1 else 0)) ** (.x0 ↦ᵣ (0 : Word)) ** ⌜(if BitVec.ult ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0)) (rv64_mulhu a1 excess) then 1 else 0) = (0 : Word)⌝) **
        (.x2 ↦ᵣ newSp) ** (.x1 ↦ᵣ (vals .x1)) **
        (.x10 ↦ᵣ excess) ** (.x11 ↦ᵣ outPtr) **
      ...
      (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5)) := by
  refine cpsTripleWithin_weaken (pure_drop_mid) (fun _ hx => hx)
    (mul6_tail1_core newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p1 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5)

private theorem mul6_tail2_core (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5 : Word) :
    cpsTripleWithin 2 (PriceK + 548) (PriceK + 556) priceCode
      ...
      (((newSp + signExtend12 160) + signExtend12 16) ↦ₘ s2) ** (((newSp + signExtend12 160) + signExtend12 24) ↦ₘ s3) **
      (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5)) := by
  have hsd2 := sd_spec_gen_within .x20 .x28 (newSp + signExtend12 112) ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) p2 (16 : BitVec 12) (PriceK + 548)
...
private theorem mul6_tail2 (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5 : Word) :
    cpsTripleWithin 2 (PriceK + 548) (PriceK + 556) priceCode
      (      (((.x29 ↦ᵣ (if BitVec.ult ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0)) (rv64_mulhu a2 excess) then 1 else 0)) ** (.x0 ↦ᵣ (0 : Word)) ** ⌜(if BitVec.ult ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0)) (rv64_mulhu a2 excess) then 1 else 0) = (0 : Word)⌝) **
        (.x2 ↦ᵣ newSp) ** (.x1 ↦ᵣ (vals .x1)) **
        (.x10 ↦ᵣ excess) ** (.x11 ↦ᵣ outPtr) **
      ...
      (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5)) := by
  refine cpsTripleWithin_weaken (pure_drop_mid) (fun _ hx => hx)
    (mul6_tail2_core newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5)

private theorem mul6_tail3_core (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p3 p4 p5 s0 s1 s2 s3 s4 s5 : Word) :
    cpsTripleWithin 2 (PriceK + 588) (PriceK + 596) priceCode
      ...
      (((newSp + signExtend12 160) + signExtend12 16) ↦ₘ s2) ** (((newSp + signExtend12 160) + signExtend12 24) ↦ₘ s3) **
      (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5)) := by
  have hsd3 := sd_spec_gen_within .x20 .x28 (newSp + signExtend12 112) ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) p3 (24 : BitVec 12) (PriceK + 588)
...
private theorem mul6_tail3 (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p3 p4 p5 s0 s1 s2 s3 s4 s5 : Word) :
    cpsTripleWithin 2 (PriceK + 588) (PriceK + 596) priceCode
      (      (((.x29 ↦ᵣ (if BitVec.ult ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0)) (rv64_mulhu a3 excess) then 1 else 0)) ** (.x0 ↦ᵣ (0 : Word)) ** ⌜(if BitVec.ult ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0)) (rv64_mulhu a3 excess) then 1 else 0) = (0 : Word)⌝) **
        (.x2 ↦ᵣ newSp) ** (.x1 ↦ᵣ (vals .x1)) **
        (.x10 ↦ᵣ excess) ** (.x11 ↦ᵣ outPtr) **
      ...
      (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5)) := by
  refine cpsTripleWithin_weaken (pure_drop_mid) (fun _ hx => hx)
    (mul6_tail3_core newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p3 p4 p5 s0 s1 s2 s3 s4 s5)

private theorem mul6_tail4_core (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p4 p5 s0 s1 s2 s3 s4 s5 : Word) :
    cpsTripleWithin 2 (PriceK + 628) (PriceK + 636) priceCode
      ...
      (((newSp + signExtend12 160) + signExtend12 16) ↦ₘ s2) ** (((newSp + signExtend12 160) + signExtend12 24) ↦ₘ s3) **
      (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5)) := by
  have hsd4 := sd_spec_gen_within .x20 .x28 (newSp + signExtend12 112) ((a4 * excess) + ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0))) p4 (32 : BitVec 12) (PriceK + 628)
...
private theorem mul6_tail4 (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p4 p5 s0 s1 s2 s3 s4 s5 : Word) :
    cpsTripleWithin 2 (PriceK + 628) (PriceK + 636) priceCode
      (      (((.x29 ↦ᵣ (if BitVec.ult ((rv64_mulhu a4 excess) + (if BitVec.ult ((a4 * excess) + ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0))) (a4 * excess) then 1 else 0)) (rv64_mulhu a4 excess) then 1 else 0)) ** (.x0 ↦ᵣ (0 : Word)) ** ⌜(if BitVec.ult ((rv64_mulhu a4 excess) + (if BitVec.ult ((a4 * excess) + ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0))) (a4 * excess) then 1 else 0)) (rv64_mulhu a4 excess) then 1 else 0) = (0 : Word)⌝) **
        (.x2 ↦ᵣ newSp) ** (.x1 ↦ᵣ (vals .x1)) **
        (.x10 ↦ᵣ excess) ** (.x11 ↦ᵣ outPtr) **
      ...
      (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5)) := by
  refine cpsTripleWithin_weaken (pure_drop_mid) (fun _ hx => hx)
    (mul6_tail4_core newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p4 p5 s0 s1 s2 s3 s4 s5)

private theorem mul6_tail5_core (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p5 s0 s1 s2 s3 s4 s5 : Word) :
...
private theorem mul6_tail5 (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p5 s0 s1 s2 s3 s4 s5 : Word) :
    cpsTripleWithin 2 (PriceK + 668) (PriceK + 676) priceCode
      (      (((.x29 ↦ᵣ (if BitVec.ult ((rv64_mulhu a5 excess) + (if BitVec.ult ((a5 * excess) + ((rv64_mulhu a4 excess) + (if BitVec.ult ((a4 * excess) + ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0))) (a4 * excess) then 1 else 0))) (a5 * excess) then 1 else 0)) (rv64_mulhu a5 excess) then 1 else 0)) ** (.x0 ↦ᵣ (0 : Word)) ** ⌜(if BitVec.ult ((rv64_mulhu a5 excess) + (if BitVec.ult ((a5 * excess) + ((rv64_mulhu a4 excess) + (if BitVec.ult ((a4 * excess) + ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0))) (a4 * excess) then 1 else 0))) (a5 * excess) then 1 else 0)) (rv64_mulhu a5 excess) then 1 else 0) = (0 : Word)⌝) **
        (.x2 ↦ᵣ newSp) ** (.x1 ↦ᵣ (vals .x1)) **
        (.x10 ↦ᵣ excess) ** (.x11 ↦ᵣ outPtr) **
      ...
      (      (((.x31 ↦ᵣ ((rv64_mulhu a5 excess) + (if BitVec.ult ((a5 * excess) + ((rv64_mulhu a4 excess) + (if BitVec.ult ((a4 * excess) + ((rv64_mulhu a3 excess) + (if BitVec.ult ((a3 * excess) + ((rv64_mulhu a2 excess) + (if BitVec.ult ((a2 * excess) + ((rv64_mulhu a1 excess) + (if BitVec.ult ((a1 * excess) + ((rv64_mulhu a0 excess) + (if BitVec.ult ((a0 * excess) + (0 : Word)) (a0 * excess) then 1 else 0))) (a1 * excess) then 1 else 0))) (a2 * excess) then 1 else 0))) (a3 * excess) then 1 else 0))) (a4 * excess) then 1 else 0))) (a5 * excess) then 1 else 0))) ** (.x0 ↦ᵣ (0 : Word))) **
        ...
        (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5))) := by
  refine cpsTripleWithin_weaken (pure_drop_mid) (fun _ hx => hx)
    (mul6_tail5_core newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p5 s0 s1 s2 s3 s4 s5)

theorem mul6_core (newSp excess outPtr iVal : Word) (vals : Reg → Word) (a0 a1 a2 a3 a4 a5 p0 p1 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5 v5 v6 v7 v28 v29 v30 v31 : Word) :
    cpsNBranchWithin 62 (PriceK + 432) priceCode (mul6PRE newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p0 p1 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5 v5 v6 v7 v28 v29 v30 v31)
    [(PriceK + 964, mul6QOVF0 newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p0 p1 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5),
    (PriceK + 964, mul6QOVF1 newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p1 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5),
    (PriceK + 964, mul6QOVF2 newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5),
    (PriceK + 964, mul6QOVF3 newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p3 p4 p5 s0 s1 s2 s3 s4 s5),
    (PriceK + 964, mul6QOVF4 newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p4 p5 s0 s1 s2 s3 s4 s5),
    (PriceK + 964, mul6QOVF5 newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p5 s0 s1 s2 s3 s4 s5),
    (PriceK + 964, mul6QOVFF newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 s0 s1 s2 s3 s4 s5),
    (PriceK + 680, mul6QFALL newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 s0 s1 s2 s3 s4 s5)] := by
  -- limb 0
  have hpre0 := mul6_pre0 newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p0 p1 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5 v5 v6 v7 v28 v29 v30 v31
  ...
  have hbr0 := cpsBranchWithin_extend_code
    ...
    (cpsBranchWithin_frameR
      ...
      (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5))
      (by pcFree) hleaf0)
  have htail0 := mul6_tail0 newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p0 p1 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5
  ...
  -- limb 1
  have hpre1 := mul6_pre1 newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p1 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5
  ...
  have hbr1 := cpsBranchWithin_extend_code
    ...
    (cpsBranchWithin_frameR
      ...
      (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5))
      (by pcFree) hleaf1)
  have htail1 := mul6_tail1 newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p1 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5
  ...
  -- limb 2
  have hpre2 := mul6_pre2 newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5
  ...
  have hbr2 := cpsBranchWithin_extend_code
    ...
    (cpsBranchWithin_frameR
      ...
      (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5))
      (by pcFree) hleaf2)
  have htail2 := mul6_tail2 newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p2 p3 p4 p5 s0 s1 s2 s3 s4 s5
  ...
  -- limb 3
  have hpre3 := mul6_pre3 newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p3 p4 p5 s0 s1 s2 s3 s4 s5
  ...
  have hbr3 := cpsBranchWithin_extend_code
    ...
    (cpsBranchWithin_frameR
      ...
      (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5))
      (by pcFree) hleaf3)
  have htail3 := mul6_tail3 newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p3 p4 p5 s0 s1 s2 s3 s4 s5
  ...
  -- limb 4
  have hpre4 := mul6_pre4 newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p4 p5 s0 s1 s2 s3 s4 s5
  ...
  have hbr4 := cpsBranchWithin_extend_code
    ...
    (cpsBranchWithin_frameR
      ...
      (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5))
      (by pcFree) hleaf4)
  have htail4 := mul6_tail4 newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p4 p5 s0 s1 s2 s3 s4 s5
  ...
  -- limb 5
  have hpre5 := mul6_pre5 newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p5 s0 s1 s2 s3 s4 s5
  ...
  have hbr5 := cpsBranchWithin_extend_code
    ...
    (cpsBranchWithin_frameR
      ...
      (((newSp + signExtend12 160) + signExtend12 32) ↦ₘ s4) ** (((newSp + signExtend12 160) + signExtend12 40) ↦ₘ s5))
      (by pcFree) hleaf5)
  have htail5 := mul6_tail5 newSp excess outPtr iVal vals a0 a1 a2 a3 a4 a5 p5 s0 s1 s2 s3 s4 s5
