/-
  Discharge packaging hdec* for legacy short creation via short-list end pure.
-/
...
theorem extractAssumed_creation_shortConcrete_pureHdec_legacy
  ...
  exact extractAssumed_creation_shortConcrete_pure_legacy
...
set_option maxRecDepth 8000 in
theorem extractAssumed_creation_shortConcrete_pureHdec_legacy_fullCode
    (sp0 spC : Word) (s : ExtractSaved)
    (txBase lenW toBuf isCreationPtr : Word)
    (txBytes : List (BitVec 8))
    (items : List EL.RLP.RLPItem)
  ...
  cpsTripleWithin_extend_code extractLinked_mono
    (extractAssumed_creation_shortConcrete_pureHdec_legacy
      sp0 spC s txBase lenW toBuf isCreationPtr txBytes items
      hspC hret htalign htover htvalid hlen hsuccess hcreFlag htype0 hdecL hshort
      halign hover hvalidTx0 hinover hinvalid
      hvalid0 hvalid1_0 hvalid1 hvalid1_1 hvalid2 hvalid1_2 hvalid3 hvalid1_3
      hge5)

#print axioms extractAssumed_creation_shortConcrete_pureHdec_legacy
#print axioms extractAssumed_creation_shortConcrete_pureHdec_legacy_fullCode
