...
def eip1559CalcBaseFeePerGas_prog : Program :=
  [ .ADDI .x2 .x2 (-56 : BitVec 12),
    ...
    .BEQ .x11 .x18 (brOff (GuestAddrs.eip1559_calc_base_fee_per_gas + 236) (GuestAddrs.eip1559_calc_base_fee_per_gas + 40)),
    .LI .x20 (0 : Word),
    .BEQ .x18 .x0 (brOff (GuestAddrs.eip1559_calc_base_fee_per_gas + 276) (GuestAddrs.eip1559_calc_base_fee_per_gas + 48)),
    .BLTU .x18 .x11 (16 : BitVec 13),
    .BEQ .x11 .x0 (brOff (GuestAddrs.eip1559_calc_base_fee_per_gas + 160) (GuestAddrs.eip1559_calc_base_fee_per_gas + 56)),
    .SUB .x19 .x18 .x11,
    .JAL .x0 (12 : BitVec 21),
    .LI .x20 (1 : Word),
    .SUB .x19 .x11 .x18,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.eip1559_calc_base_fee_per_gas + 276) (GuestAddrs.eip1559_calc_base_fee_per_gas + 92)),
    .MV .x10 .x9,
    .MV .x11 .x18,
    .MV .x12 .x9,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.eip1559_calc_base_fee_per_gas + 276) (GuestAddrs.eip1559_calc_base_fee_per_gas + 196)),
    .LI .x10 (0 : Word),
    .JAL .x0 (jalOff (GuestAddrs.eip1559_calc_base_fee_per_gas + 280) (GuestAddrs.eip1559_calc_base_fee_per_gas + 204)),
    .MV .x10 .x8,
    .MV .x11 .x9,
    .MV .x12 .x9,
