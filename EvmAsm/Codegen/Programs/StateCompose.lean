...
def slotAtHeaderStateRoot_prog : Program :=
  [ .ADDI .x2 .x2 (-96 : BitVec 12),
    ...
    .LI .x10 (4 : Word),
    .JAL .x0 (jalOff (GuestAddrs.slot_at_header_state_root + 204) (GuestAddrs.slot_at_header_state_root + 108)),
    .MV .x10 .x18,
    .LI .x11 (20 : Word),
...
def extcodesizeAtHeaderStateRoot_prog : Program :=
  [ .ADDI .x2 .x2 (-80 : BitVec 12),
    ...
    .BEQ .x10 .x0 (12 : BitVec 13),
    .LI .x10 (4 : Word),
    .JAL .x0 (jalOff (GuestAddrs.extcodesize_at_header_state_root + 296) (GuestAddrs.extcodesize_at_header_state_root + 108)),
    .MV .x10 .x18,
    .LI .x11 (20 : Word),
    ...
    .JAL .x0 (jalOff (GuestAddrs.extcodesize_at_header_state_root + 296) (GuestAddrs.extcodesize_at_header_state_root + 164)),
    .LI .x10 (0 : Word),
    .JAL .x0 (jalOff (GuestAddrs.extcodesize_at_header_state_root + 296) (GuestAddrs.extcodesize_at_header_state_root + 172)),
