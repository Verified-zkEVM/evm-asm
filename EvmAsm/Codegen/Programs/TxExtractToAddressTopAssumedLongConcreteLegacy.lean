/-
  ExtractAssumed packaging under long concrete legacy creation of_decode.
-/
...
/-- Assumed creation long concrete legacy of_decode. -/
theorem extractAssumed_creation_under_honesty_of_decode_long_concrete_legacy
  ...
  have hShort := extractFrontCreation_then_epi_of_decode_long_concrete_legacy
...
set_option maxRecDepth 8000 in
theorem extractAssumed_creation_fullCode_of_decode_long_concrete_legacy
    (sp0 spC : Word) (s : ExtractSaved)
    (txBase lenW toBuf isCreationPtr : Word)
    (txBytes : List (BitVec 8))
    (srcOff0 srcOff1 srcOff2 srcOff3 : Nat)
  ...
  cpsTripleWithin_extend_code extractLinked_mono
    (extractAssumed_creation_under_honesty_of_decode_long_concrete_legacy
      sp0 spC s txBase lenW toBuf isCreationPtr txBytes
      srcOff0 srcOff1 srcOff2 srcOff3
      hoff
      hspC hret hcur htype0 hsalign
...
#print axioms extractAssumed_creation_under_honesty_of_decode_long_concrete_legacy
#print axioms extractAssumed_creation_fullCode_of_decode_long_concrete_legacy
