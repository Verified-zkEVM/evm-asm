/-
  Ambient dual: Front long E2E legacy creation of_decode (typeW=0).
-/
...
theorem extractFrontCreation_then_epi_of_decode_long_concrete_legacy_ambient
  ...
  have hC := extractFrontAfterSaveCreation_then_epi_of_decode_long_legacy_ambient sp0 spC s
...
#print axioms extractFrontCreation_then_epi_of_decode_long_concrete_legacy_ambient
