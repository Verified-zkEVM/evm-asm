...
def mptIndexedStreamLeafHash_prog : Program :=
  [ .ADDI .x2 .x2 (-176 : BitVec 12),
    ...
    .MV .x21 .x14,
    .LI .x5 (6 : Word),
    .BLTU .x5 .x18 (brOff (GuestAddrs.mpt_indexed_stream_leaf_hash + 372) (GuestAddrs.mpt_indexed_stream_leaf_hash + 72)),
    .LI .x5 (32 : Word),
    .BLTU .x20 .x5 (brOff (GuestAddrs.mpt_indexed_stream_leaf_hash + 372) (GuestAddrs.mpt_indexed_stream_leaf_hash + 80)),
    .MV .x10 .x9,
    .MV .x11 .x18,
    .LI .x12 (1 : Word),
    .ADDI .x13 .x2 (88 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.hp_encode_nibbles (GuestAddrs.mpt_indexed_stream_leaf_hash + 100)),
    .MV .x23 .x10,
    .ADDI .x10 .x2 (88 : BitVec 12),
    .MV .x11 .x23,
    .ADDI .x12 .x2 (96 : BitVec 12),
    .ADDI .x13 .x2 (144 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.rlp_encode_bytes (GuestAddrs.mpt_indexed_stream_leaf_hash + 124)),
    .LD .x23 .x2 (144 : BitVec 12),
    .LI .x5 (1 : Word),
    .BNE .x20 .x5 (24 : BitVec 13),
    .LBU .x6 .x19 (0 : BitVec 12),
    .LI .x7 (128 : Word),
    .BGEU .x6 .x7 (12 : BitVec 13),
    .LI .x24 (0 : Word),
    .JAL .x0 (24 : BitVec 21),
    .LI .x10 (128 : Word),
    .MV .x11 .x20,
    .ADDI .x12 .x2 (112 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.rlp_prefix_to_buffer (GuestAddrs.mpt_indexed_stream_leaf_hash + 172)),
    .MV .x24 .x10,
    .ADD .x5 .x23 .x24,
    .ADD .x11 .x5 .x20,
    .LI .x10 (192 : Word),
    .ADDI .x12 .x2 (128 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.rlp_prefix_to_buffer (GuestAddrs.mpt_indexed_stream_leaf_hash + 196)),
    .MV .x25 .x10,
    .AUIPC .x8 (laHi GuestAddrs.zk3_state (GuestAddrs.mpt_indexed_stream_leaf_hash + 204)),
    .ADDI .x8 .x8 (laLo GuestAddrs.zk3_state (GuestAddrs.mpt_indexed_stream_leaf_hash + 204)),
    .MV .x5 .x8,
    .LI .x6 (25 : Word),
    ...
    .LI .x22 (0 : Word),
    .ADDI .x10 .x2 (128 : BitVec 12),
    .MV .x11 .x25,
    .JAL .x1 (jalOff (GuestAddrs.mpt_indexed_stream_leaf_hash + 428) (GuestAddrs.mpt_indexed_stream_leaf_hash + 248)),
    .ADDI .x10 .x2 (96 : BitVec 12),
    .MV .x11 .x23,
    .JAL .x1 (jalOff (GuestAddrs.mpt_indexed_stream_leaf_hash + 428) (GuestAddrs.mpt_indexed_stream_leaf_hash + 260)),
    .BEQ .x24 .x0 (16 : BitVec 13),
    .ADDI .x10 .x2 (112 : BitVec 12),
    .MV .x11 .x24,
    .JAL .x1 (jalOff (GuestAddrs.mpt_indexed_stream_leaf_hash + 428) (GuestAddrs.mpt_indexed_stream_leaf_hash + 276)),
    .MV .x10 .x19,
    .MV .x11 .x20,
    .JAL .x1 (jalOff (GuestAddrs.mpt_indexed_stream_leaf_hash + 428) (GuestAddrs.mpt_indexed_stream_leaf_hash + 288)),
    .ADD .x5 .x8 .x22,
    ...
    .BEQ .x11 .x0 (brOff (GuestAddrs.mpt_indexed_stream_leaf_hash + 504) (GuestAddrs.mpt_indexed_stream_leaf_hash + 428)),
    ...
    .SD .x2 .x10 (160 : BitVec 12),
    .SD .x2 .x11 (168 : BitVec 12),
    .MV .x10 .x8,
    .CSRS (2048 : BitVec 12) .x10,
    .LD .x10 .x2 (160 : BitVec 12),
    .LD .x11 .x2 (168 : BitVec 12),
    .LI .x22 (0 : Word),
    .JAL .x0 (jalOff (GuestAddrs.mpt_indexed_stream_leaf_hash + 428) (GuestAddrs.mpt_indexed_stream_leaf_hash + 500)),
    .JALR .x0 .x1 (0 : BitVec 12) ]

/-- Reloc side-table for `mptIndexedStreamLeafHash_prog`: the `la`/cross-`jal` instruction indices
    kept SYMBOLIC in the emitted image text (`emitProgramR`), while the Program
    above carries the concrete guest-linked immediates for verification. -/
def mptIndexedStreamLeafHash_relocs : RelocTable :=
  [ (25, .jal .x1 "hp_encode_nibbles"),
    (31, .jal .x1 "rlp_encode_bytes"),
    (43, .jal .x1 "rlp_prefix_to_buffer"),
    (49, .jal .x1 "rlp_prefix_to_buffer"),
    (51, .la .x8 "zk3_state") ]

def mptIndexedStreamLeafHashFunction : String :=
  "mpt_indexed_stream_leaf_hash:\n" ++ emitProgramR mptIndexedStreamLeafHash_prog mptIndexedStreamLeafHash_relocs

/-- Kernel-checked drift guard: the emitted (image-agnostic, symbolic) Codegen
    string is exactly `mptIndexedStreamLeafHash_prog` rendered under its label with the `la`/`jal`
    relocs kept symbolic (bead evm-asm-4ch8f.9.3, mechanical conversion by
    `scripts/asm_to_program.py`). Guest binary byte-identity + guest-linked
    consistency of the concrete Program verified offline by assemble/link+cmp. -/
theorem mptIndexedStreamLeafHashFunction_eq_prog :
...
def mptIndexedLargeLeafHash_prog : Program :=
  [ .ADDI .x2 .x2 (-144 : BitVec 12),
    ...
    .MV .x21 .x14,
    .LI .x5 (56 : Word),
    .BLTU .x18 .x5 (brOff (GuestAddrs.mpt_indexed_large_leaf_hash + 332) (GuestAddrs.mpt_indexed_large_leaf_hash + 80)),
    .LI .x5 (1 : Word),
    .BLTU .x5 .x19 (brOff (GuestAddrs.mpt_indexed_large_leaf_hash + 332) (GuestAddrs.mpt_indexed_large_leaf_hash + 88)),
    .LI .x5 (15 : Word),
    .BLTU .x5 .x20 (brOff (GuestAddrs.mpt_indexed_large_leaf_hash + 332) (GuestAddrs.mpt_indexed_large_leaf_hash + 96)),
    ...
    .MV .x11 .x25,
    .JAL .x1 (jalOff (GuestAddrs.mpt_indexed_large_leaf_hash + 396) (GuestAddrs.mpt_indexed_large_leaf_hash + 212)),
    .ADDI .x10 .x2 (136 : BitVec 12),
    .LI .x11 (1 : Word),
    .JAL .x1 (jalOff (GuestAddrs.mpt_indexed_large_leaf_hash + 396) (GuestAddrs.mpt_indexed_large_leaf_hash + 224)),
    .ADDI .x10 .x2 (104 : BitVec 12),
    .MV .x11 .x23,
    .JAL .x1 (jalOff (GuestAddrs.mpt_indexed_large_leaf_hash + 396) (GuestAddrs.mpt_indexed_large_leaf_hash + 236)),
    .MV .x10 .x9,
    .MV .x11 .x18,
    .JAL .x1 (jalOff (GuestAddrs.mpt_indexed_large_leaf_hash + 396) (GuestAddrs.mpt_indexed_large_leaf_hash + 248)),
    .ADD .x5 .x8 .x22,
    .LBU .x6 .x5 (0 : BitVec 12),
    .XORI .x6 .x6 (1 : BitVec 12),
    .SB .x5 .x6 (0 : BitVec 12),
...
def mptIndexedTrieRootLarge_prog : Program :=
  [ .ADDI .x2 .x2 (-2016 : BitVec 12),
    ...
    .LI .x5 (2 : Word),
    .BLTU .x9 .x5 (brOff (GuestAddrs.mpt_indexed_trie_root_large + 364) (GuestAddrs.mpt_indexed_trie_root_large + 84)),
    .LI .x5 (129 : Word),
    .BGEU .x9 .x5 (brOff (GuestAddrs.mpt_indexed_trie_root_large + 364) (GuestAddrs.mpt_indexed_trie_root_large + 92)),
    .LI .x26 (0 : Word),
    ...
    .LI .x7 (56 : Word),
    .BLTU .x6 .x7 (brOff (GuestAddrs.mpt_indexed_trie_root_large + 364) (GuestAddrs.mpt_indexed_trie_root_large + 120)),
    .ADDI .x26 .x26 (1 : BitVec 12),
    .JAL .x0 (-28 : BitVec 21),
    .MV .x25 .x22,
    .LI .x19 (0 : Word),
    .LI .x5 (16 : Word),
    .BEQ .x19 .x5 (brOff (GuestAddrs.mpt_indexed_trie_root_large + 328) (GuestAddrs.mpt_indexed_trie_root_large + 144)),
    .LI .x20 (0 : Word),
    .LI .x21 (0 : Word),
    .LI .x26 (0 : Word),
    ...
    .ADDI .x26 .x26 (1 : BitVec 12),
    .JAL .x0 (-40 : BitVec 21),
    .BEQ .x20 .x0 (brOff (GuestAddrs.mpt_indexed_trie_root_large + 308) (GuestAddrs.mpt_indexed_trie_root_large + 204)),
    .LI .x5 (1 : Word),
    .BEQ .x20 .x5 (28 : BitVec 13),
    .JAL .x1 (jalOff (GuestAddrs.mpt_indexed_trie_root_large + 436) (GuestAddrs.mpt_indexed_trie_root_large + 216)),
    .ADDI .x11 .x2 (1968 : BitVec 12),
    .MV .x10 .x25,
    .JAL .x1 (jalOff (GuestAddrs.mpt_indexed_trie_root_large + 604) (GuestAddrs.mpt_indexed_trie_root_large + 228)),
    .MV .x25 .x10,
    .JAL .x0 (jalOff (GuestAddrs.mpt_indexed_trie_root_large + 320) (GuestAddrs.mpt_indexed_trie_root_large + 236)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_indexed_trie_root_large + 372) (GuestAddrs.mpt_indexed_trie_root_large + 284)),
    .MV .x10 .x25,
    .ADDI .x11 .x2 (1968 : BitVec 12),
    .JAL .x1 (jalOff (GuestAddrs.mpt_indexed_trie_root_large + 604) (GuestAddrs.mpt_indexed_trie_root_large + 296)),
    .MV .x25 .x10,
    .JAL .x0 (16 : BitVec 21),
    .LI .x5 (128 : Word),
    ...
    .JAL .x0 (jalOff (GuestAddrs.mpt_indexed_trie_root_large + 140) (GuestAddrs.mpt_indexed_trie_root_large + 324)),
    .LI .x5 (128 : Word),
    .SB .x25 .x5 (0 : BitVec 12),
    .ADDI .x25 .x25 (1 : BitVec 12),
    .SUB .x11 .x25 .x22,
    .MV .x10 .x22,
    .MV .x12 .x18,
    .JAL .x1 (jalOff (GuestAddrs.mpt_indexed_trie_root_large + 652) (GuestAddrs.mpt_indexed_trie_root_large + 352)),
    .LI .x10 (0 : Word),
    .JAL .x0 (16 : BitVec 21),
    .LI .x10 (2 : Word),
    .JAL .x0 (8 : BitVec 21),
    ...
    .LI .x20 (0 : Word),
    .LI .x5 (16 : Word),
    .BEQ .x20 .x5 (brOff (GuestAddrs.mpt_indexed_trie_root_large + 552) (GuestAddrs.mpt_indexed_trie_root_large + 456)),
    .SLLI .x26 .x19 (4 : BitVec 6),
    .ADD .x26 .x26 .x20,
    .BEQ .x26 .x0 (brOff (GuestAddrs.mpt_indexed_trie_root_large + 532) (GuestAddrs.mpt_indexed_trie_root_large + 468)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.mpt_indexed_trie_root_large + 592) (GuestAddrs.mpt_indexed_trie_root_large + 508)),
    .MV .x10 .x25,
    .ADDI .x11 .x2 (1968 : BitVec 12),
    .JAL .x1 (jalOff (GuestAddrs.mpt_indexed_trie_root_large + 604) (GuestAddrs.mpt_indexed_trie_root_large + 520)),
    .MV .x25 .x10,
    .JAL .x0 (16 : BitVec 21),
    .LI .x5 (128 : Word),
    .SB .x25 .x5 (0 : BitVec 12),
    .ADDI .x25 .x25 (1 : BitVec 12),
    .ADDI .x20 .x20 (1 : BitVec 12),
    .JAL .x0 (jalOff (GuestAddrs.mpt_indexed_trie_root_large + 452) (GuestAddrs.mpt_indexed_trie_root_large + 548)),
    .LI .x5 (128 : Word),
    .SB .x25 .x5 (0 : BitVec 12),
    .ADDI .x25 .x25 (1 : BitVec 12),
    .SUB .x11 .x25 .x23,
    ...
    .JAL .x1 (jalOff (GuestAddrs.mpt_indexed_trie_root_large + 652) (GuestAddrs.mpt_indexed_trie_root_large + 576)),
    .LD .x25 .x2 (128 : BitVec 12),
    .LD .x1 .x2 (152 : BitVec 12),
    .JALR .x0 .x1 (0 : BitVec 12),
    .LD .x25 .x2 (128 : BitVec 12),
    .LD .x1 .x2 (152 : BitVec 12),
    .JAL .x0 (jalOff (GuestAddrs.mpt_indexed_trie_root_large + 372) (GuestAddrs.mpt_indexed_trie_root_large + 600)),
    .LI .x5 (160 : Word),
...
def mptIndexedTrieRootSmall_prog : Program :=
  [ .ADDI .x2 .x2 (-56 : BitVec 12),
    ...
    .BGEU .x9 .x5 (brOff (GuestAddrs.mpt_indexed_trie_root_small + 468) (GuestAddrs.mpt_indexed_trie_root_small + 48)),
    .BEQ .x9 .x0 (brOff (GuestAddrs.mpt_indexed_trie_root_small + 380) (GuestAddrs.mpt_indexed_trie_root_small + 52)),
    .LI .x5 (1 : Word),
    .BEQ .x9 .x5 (brOff (GuestAddrs.mpt_indexed_trie_root_small + 360) (GuestAddrs.mpt_indexed_trie_root_small + 60)),
    .MV .x10 .x8,
    .MV .x11 .x9,
    .MV .x12 .x18,
    .JAL .x1 (jalOff GuestAddrs.mpt_indexed_trie_root_large (GuestAddrs.mpt_indexed_trie_root_small + 76)),
    .LI .x5 (2 : Word),
    .BNE .x10 .x5 (brOff (GuestAddrs.mpt_indexed_trie_root_small + 472) (GuestAddrs.mpt_indexed_trie_root_small + 84)),
    .LI .x19 (0 : Word),
    .BEQ .x19 .x9 (brOff (GuestAddrs.mpt_indexed_trie_root_small + 424) (GuestAddrs.mpt_indexed_trie_root_small + 92)),
    ...
    .ADD .x29 .x29 .x28,
    .BEQ .x19 .x0 (brOff (GuestAddrs.mpt_indexed_trie_root_small + 280) (GuestAddrs.mpt_indexed_trie_root_small + 128)),
    .LI .x5 (256 : Word),
    .BGEU .x19 .x5 (brOff (GuestAddrs.mpt_indexed_trie_root_small + 212) (GuestAddrs.mpt_indexed_trie_root_small + 136)),
    .LI .x5 (128 : Word),
    ...
    .LI .x5 (2 : Word),
    .JAL .x0 (jalOff (GuestAddrs.mpt_indexed_trie_root_small + 296) (GuestAddrs.mpt_indexed_trie_root_small + 168)),
    .LI .x30 (8 : Word),
    .SB .x29 .x30 (0 : BitVec 12),
    .LI .x30 (1 : Word),
    ...
    .LI .x5 (4 : Word),
    .JAL .x0 (jalOff (GuestAddrs.mpt_indexed_trie_root_small + 296) (GuestAddrs.mpt_indexed_trie_root_small + 208)),
    .LI .x30 (8 : Word),
    .SB .x29 .x30 (0 : BitVec 12),
    .LI .x30 (2 : Word),
    .SB .x29 .x30 (1 : BitVec 12),
    ...
    .ADDI .x19 .x19 (1 : BitVec 12),
    .JAL .x0 (jalOff (GuestAddrs.mpt_indexed_trie_root_small + 92) (GuestAddrs.mpt_indexed_trie_root_small + 356)),
    ...
    .JAL .x0 (jalOff (GuestAddrs.mpt_indexed_trie_root_small + 472) (GuestAddrs.mpt_indexed_trie_root_small + 376)),
