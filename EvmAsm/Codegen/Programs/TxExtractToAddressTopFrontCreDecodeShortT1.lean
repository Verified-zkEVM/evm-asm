/-
  Front short AfterSave → t1 creation of_decode with concrete endPtr (no ∀endPtr).
-/
...
theorem extractFrontAfterSaveCreation_then_epi_of_decode_short_t1
...
#print axioms extractFrontAfterSaveCreation_then_epi_of_decode_short_t1
