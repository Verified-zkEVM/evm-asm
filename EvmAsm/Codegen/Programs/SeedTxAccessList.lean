...
def txAccessListSpan_prog : Program :=
  [ .ADDI .x2 .x2 (-80 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_access_list_span + 364) (GuestAddrs.tx_access_list_span + 88)),
    ...
    .BEQ .x20 .x0 (brOff (GuestAddrs.tx_access_list_span + 356) (GuestAddrs.tx_access_list_span + 116)),
    .ADD .x21 .x8 .x6,
    .SUB .x22 .x9 .x6,
    .LI .x5 (1 : Word),
    .BEQ .x20 .x5 (32 : BitVec 13),
    .LI .x5 (2 : Word),
    .BEQ .x20 .x5 (brOff (GuestAddrs.tx_access_list_span + 208) (GuestAddrs.tx_access_list_span + 140)),
    .LI .x5 (3 : Word),
    .BEQ .x20 .x5 (brOff (GuestAddrs.tx_access_list_span + 252) (GuestAddrs.tx_access_list_span + 148)),
    .LI .x5 (4 : Word),
    .BEQ .x20 .x5 (brOff (GuestAddrs.tx_access_list_span + 296) (GuestAddrs.tx_access_list_span + 156)),
    .JAL .x0 (jalOff (GuestAddrs.tx_access_list_span + 364) (GuestAddrs.tx_access_list_span + 160)),
    .MV .x10 .x21,
    .MV .x11 .x22,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_access_list_span + 364) (GuestAddrs.tx_access_list_span + 184)),
    ...
    .JAL .x0 (jalOff (GuestAddrs.tx_access_list_span + 336) (GuestAddrs.tx_access_list_span + 204)),
    .MV .x10 .x21,
    .MV .x11 .x22,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_access_list_span + 364) (GuestAddrs.tx_access_list_span + 228)),
    ...
    .JAL .x0 (jalOff (GuestAddrs.tx_access_list_span + 336) (GuestAddrs.tx_access_list_span + 248)),
    .MV .x10 .x21,
    .MV .x11 .x22,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_access_list_span + 364) (GuestAddrs.tx_access_list_span + 272)),
