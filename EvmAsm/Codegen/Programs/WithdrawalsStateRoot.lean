...
def withdrawalsStateRoot_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .MV .x21 .x15,
    .LI .x22 (0 : Word),
    .BEQ .x22 .x20 (brOff (GuestAddrs.withdrawals_state_root + 320) (GuestAddrs.withdrawals_state_root + 64)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.withdrawals_state_root + 364) (GuestAddrs.withdrawals_state_root + 112)),
    .MV .x10 .x8,
    .MV .x11 .x9,
    .MV .x12 .x18,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.withdrawals_state_root + 356) (GuestAddrs.withdrawals_state_root + 168)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.withdrawals_state_root + 364) (GuestAddrs.withdrawals_state_root + 228)),
    ...
    .JAL .x0 (jalOff (GuestAddrs.withdrawals_state_root + 64) (GuestAddrs.withdrawals_state_root + 316)),
    .MV .x10 .x8,
    .MV .x11 .x9,
    .MV .x12 .x18,
