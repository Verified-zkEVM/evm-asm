/-
  Discharge packaging hdec* for t1 short creation via short-list end pure.
-/
...
theorem extractAssumed_creation_shortConcrete_pureHdec_t1
  ...
  exact extractAssumed_creation_shortConcrete_pure_t1
...
set_option maxRecDepth 8000 in
theorem extractAssumed_creation_shortConcrete_pureHdec_t1_fullCode
    (sp0 spC : Word) (s : ExtractSaved)
    (txBase lenW toBuf isCreationPtr : Word)
    (txBytes : List (BitVec 8))
    (items : List EL.RLP.RLPItem)
  ...
  cpsTripleWithin_extend_code extractLinked_mono
    (extractAssumed_creation_shortConcrete_pureHdec_t1
      sp0 spC s txBase lenW toBuf isCreationPtr txBytes items
      hspC hret htalign htover htvalid hlen hsuccess hcreFlag htype1 hdecL hshort
      halign hover hvalidTx0 hinover hinvalid
      hvalid0 hvalid1_0 hvalid1 hvalid1_1 hvalid2 hvalid1_2
      hvalid3 hvalid1_3 hvalid4 hvalid1_4
      hge6)

#print axioms extractAssumed_creation_shortConcrete_pureHdec_t1
#print axioms extractAssumed_creation_shortConcrete_pureHdec_t1_fullCode
