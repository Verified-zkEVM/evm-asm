...
/-! ## `bal_gas_valid_from_builder` (#11120)
    ...
    #11172: the former RLP-walker probe was retired; this builder path is the
    sole live gas-limit implementation. -/
...
/-! The former `bal_section_info` and `bal_gas_valid` probe wrappers were
    retired with their standalone probe units. The live builder path above
    remains the sole BAL gas implementation. -/
