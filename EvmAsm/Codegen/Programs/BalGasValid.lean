...
def balGasValid_prog : Program :=
  [ .ADDI .x2 .x2 (-112 : BitVec 12),
    ...
    .MV .x10 .x8,
    .MV .x11 .x9,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_init 2147483724),
    .BNE .x12 .x0 (brOff 2147484008 2147483728),
    .MV .x19 .x10,
    .MV .x21 .x11,
    .LI .x20 (0 : Word),
    .MV .x10 .x19,
    .MV .x11 .x21,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next 2147483752),
    .LI .x5 (2 : Word),
    .BEQ .x11 .x5 (brOff 2147483980 2147483760),
    .BNE .x11 .x0 (brOff 2147484008 2147483764),
    .MV .x19 .x10,
    .SUB .x22 .x10 .x12,
    .MV .x23 .x12,
    ...
    .MV .x10 .x22,
    .MV .x11 .x23,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_init 2147483792),
    .BNE .x12 .x0 (brOff 2147484008 2147483796),
    .MV .x24 .x10,
    .MV .x25 .x11,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next 2147483808),
    .BNE .x11 .x0 (brOff 2147484008 2147483812),
    .MV .x24 .x10,
    .MV .x10 .x24,
    .MV .x11 .x25,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next 2147483828),
    .BNE .x11 .x0 (brOff 2147484008 2147483832),
    .MV .x24 .x10,
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_init 2147483848),
    .BNE .x12 .x0 (brOff 2147484008 2147483852),
    .MV .x26 .x10,
    .MV .x27 .x11,
    .MV .x10 .x26,
    .MV .x11 .x27,
    ...
    .BNE .x11 .x0 (brOff 2147484008 2147483884),
    .MV .x26 .x10,
    .ADDI .x20 .x20 (1 : BitVec 12),
    .JAL .x0 (-32 : BitVec 21),
    .MV .x10 .x24,
    .MV .x11 .x25,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next 2147483908),
    .BNE .x11 .x0 (brOff 2147484008 2147483912),
    .MV .x24 .x10,
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_init 2147483928),
    .BNE .x12 .x0 (brOff 2147484008 2147483932),
    .MV .x26 .x10,
    .MV .x27 .x11,
    .MV .x10 .x26,
    .MV .x11 .x27,
    ...
    .LI .x5 (2 : Word),
    .BEQ .x11 .x5 (brOff 2147483744 2147483960),
...
def balSectionInfo_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .JAL .x1 (jalOff GuestAddrs.bgv_u32le 2147483708),
    .ADD .x5 .x18 .x10,
    .SD .x19 .x5 (0 : BitVec 12),
    .ADDI .x10 .x9 (4 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.bgv_u32le 2147483724),
    .ADD .x6 .x9 .x10,
    ...
    .MV .x10 .x5,
    .MV .x11 .x6,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_init 2147483752),
    .BNE .x12 .x0 (brOff 2147483820 2147483756),
    .MV .x9 .x10,
    .MV .x18 .x11,
    .LI .x8 (0 : Word),
    .MV .x10 .x9,
