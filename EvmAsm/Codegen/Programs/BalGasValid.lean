...
def balGasValid_prog : Program :=
  [ .ADDI .x2 .x2 (-112 : BitVec 12),
    ...
    .BNE .x12 .x0 (brOff (balGasValidPc + 360) (balGasValidPc + 80)),
    .MV .x19 .x10,
    .MV .x21 .x11,
    .LI .x20 (0 : Word),
    .MV .x10 .x19,
    ...
    .LI .x5 (2 : Word),
    .BEQ .x11 .x5 (brOff (balGasValidPc + 332) (balGasValidPc + 112)),
    .BNE .x11 .x0 (brOff (balGasValidPc + 360) (balGasValidPc + 116)),
    .MV .x19 .x10,
    .SUB .x22 .x10 .x12,
    .MV .x23 .x12,
    ...
    .BNE .x12 .x0 (brOff (balGasValidPc + 360) (balGasValidPc + 148)),
    .MV .x24 .x10,
    .MV .x25 .x11,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (balGasValidPc + 160)),
    .BNE .x11 .x0 (brOff (balGasValidPc + 360) (balGasValidPc + 164)),
    .MV .x24 .x10,
    .MV .x10 .x24,
    .MV .x11 .x25,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (balGasValidPc + 180)),
    .BNE .x11 .x0 (brOff (balGasValidPc + 360) (balGasValidPc + 184)),
    .MV .x24 .x10,
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_init (balGasValidPc + 200)),
    .BNE .x12 .x0 (brOff (balGasValidPc + 360) (balGasValidPc + 204)),
    .MV .x26 .x10,
    .MV .x27 .x11,
    .MV .x10 .x26,
    .MV .x11 .x27,
    ...
    .BNE .x11 .x0 (brOff (balGasValidPc + 360) (balGasValidPc + 236)),
    .MV .x26 .x10,
    .ADDI .x20 .x20 (1 : BitVec 12),
    .JAL .x0 (-32 : BitVec 21),
    .MV .x10 .x24,
    ...
    .BNE .x11 .x0 (brOff (balGasValidPc + 360) (balGasValidPc + 264)),
    .MV .x24 .x10,
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_init (balGasValidPc + 280)),
    .BNE .x12 .x0 (brOff (balGasValidPc + 360) (balGasValidPc + 284)),
    .MV .x26 .x10,
    .MV .x27 .x11,
    .MV .x10 .x26,
    .MV .x11 .x27,
    ...
    .LI .x5 (2 : Word),
    .BEQ .x11 .x5 (brOff (balGasValidPc + 96) (balGasValidPc + 312)),
...
def balSectionInfo_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .BNE .x12 .x0 (brOff (balSectionInfoPc + 172) (balSectionInfoPc + 108)),
    .MV .x9 .x10,
    .MV .x18 .x11,
    .LI .x8 (0 : Word),
    .MV .x10 .x9,
