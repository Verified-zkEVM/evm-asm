...
def lookupProgram : String → Option BuildUnit
  ...
  | "zisk_modexp_backend_real_probe" => some ziskModexpBackendRealProbeUnit
  ...
  | "zisk_witness_codes_lookup_by_hash_indexed" => some ziskWitnessCodesLookupByHashIndexedProbeUnit
  ...
  | "zisk_secp256k1_field_inv_n" => some ziskSecp256k1FieldInvNProbeUnit
  ...
  | "zisk_bls12_g1_add_real"    => some ziskBls12G1AddRealProbeUnit
