...
def balAccountPostFields_prog : Program :=
  [ .ADDI .x2 .x2 (-112 : BitVec 12),
    ...
    .BNE .x12 .x0 (brOff (GuestAddrs.bal_account_post_fields + 588) (GuestAddrs.bal_account_post_fields + 80)),
    ...
    .BNE .x11 .x0 (brOff (GuestAddrs.bal_account_post_fields + 588) (GuestAddrs.bal_account_post_fields + 104)),
    .SD .x2 .x10 (56 : BitVec 12),
    .LD .x10 .x2 (56 : BitVec 12),
    .LD .x11 .x2 (64 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.bal_account_post_fields + 120)),
    .BNE .x11 .x0 (brOff (GuestAddrs.bal_account_post_fields + 588) (GuestAddrs.bal_account_post_fields + 124)),
    .SD .x2 .x10 (56 : BitVec 12),
    .LD .x10 .x2 (56 : BitVec 12),
    .LD .x11 .x2 (64 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.bal_account_post_fields + 140)),
    .BNE .x11 .x0 (brOff (GuestAddrs.bal_account_post_fields + 588) (GuestAddrs.bal_account_post_fields + 144)),
    .SD .x2 .x10 (56 : BitVec 12),
    .LD .x10 .x2 (56 : BitVec 12),
    .LD .x11 .x2 (64 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.bal_account_post_fields + 160)),
    .BNE .x11 .x0 (brOff (GuestAddrs.bal_account_post_fields + 588) (GuestAddrs.bal_account_post_fields + 164)),
    .SD .x2 .x10 (56 : BitVec 12),
    .SUB .x5 .x10 .x12,
    .MV .x6 .x12,
    .MV .x10 .x5,
    ...
    .BNE .x12 .x0 (brOff (GuestAddrs.bal_account_post_fields + 588) (GuestAddrs.bal_account_post_fields + 192)),
    .BEQ .x10 .x11 (brOff (GuestAddrs.bal_account_post_fields + 368) (GuestAddrs.bal_account_post_fields + 196)),
    ...
    .BNE .x11 .x0 (brOff (GuestAddrs.bal_account_post_fields + 588) (GuestAddrs.bal_account_post_fields + 232)),
    .SD .x2 .x10 (72 : BitVec 12),
    .SUB .x5 .x10 .x12,
    ...
    .BNE .x12 .x0 (brOff (GuestAddrs.bal_account_post_fields + 588) (GuestAddrs.bal_account_post_fields + 268)),
    .SD .x2 .x10 (72 : BitVec 12),
    .SD .x2 .x11 (80 : BitVec 12),
    ...
    .BNE .x11 .x0 (brOff (GuestAddrs.bal_account_post_fields + 588) (GuestAddrs.bal_account_post_fields + 292)),
    .SD .x2 .x10 (72 : BitVec 12),
    .LD .x10 .x2 (72 : BitVec 12),
    .LD .x11 .x2 (80 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.bal_account_post_fields + 308)),
    .BNE .x11 .x0 (brOff (GuestAddrs.bal_account_post_fields + 588) (GuestAddrs.bal_account_post_fields + 312)),
    .SUB .x5 .x10 .x12,
    .MV .x7 .x12,
    .LI .x28 (32 : Word),
    .BLTU .x28 .x7 (brOff (GuestAddrs.bal_account_post_fields + 588) (GuestAddrs.bal_account_post_fields + 328)),
    ...
    .BNE .x11 .x0 (brOff (GuestAddrs.bal_account_post_fields + 588) (GuestAddrs.bal_account_post_fields + 380)),
    .SUB .x5 .x10 .x12,
    .MV .x6 .x12,
    .MV .x10 .x5,
    .MV .x11 .x6,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_init (GuestAddrs.bal_account_post_fields + 400)),
    .BNE .x12 .x0 (brOff (GuestAddrs.bal_account_post_fields + 588) (GuestAddrs.bal_account_post_fields + 404)),
    .BEQ .x10 .x11 (brOff (GuestAddrs.bal_account_post_fields + 580) (GuestAddrs.bal_account_post_fields + 408)),
    .SD .x2 .x10 (72 : BitVec 12),
    .SD .x2 .x11 (80 : BitVec 12),
    .LD .x5 .x2 (72 : BitVec 12),
    .LD .x6 .x2 (80 : BitVec 12),
    ...
    .BNE .x11 .x0 (brOff (GuestAddrs.bal_account_post_fields + 588) (GuestAddrs.bal_account_post_fields + 444)),
    .SD .x2 .x10 (72 : BitVec 12),
    .SUB .x5 .x10 .x12,
    .SD .x2 .x5 (88 : BitVec 12),
    .SD .x2 .x12 (96 : BitVec 12),
    ...
    .BNE .x12 .x0 (brOff (GuestAddrs.bal_account_post_fields + 588) (GuestAddrs.bal_account_post_fields + 480)),
    .SD .x2 .x10 (72 : BitVec 12),
    .SD .x2 .x11 (80 : BitVec 12),
    .LD .x10 .x2 (72 : BitVec 12),
    .LD .x11 .x2 (80 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.bal_account_post_fields + 500)),
    .BNE .x11 .x0 (brOff (GuestAddrs.bal_account_post_fields + 588) (GuestAddrs.bal_account_post_fields + 504)),
    .SD .x2 .x10 (72 : BitVec 12),
    .LD .x10 .x2 (72 : BitVec 12),
    .LD .x11 .x2 (80 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.bal_account_post_fields + 520)),
    .BNE .x11 .x0 (brOff (GuestAddrs.bal_account_post_fields + 588) (GuestAddrs.bal_account_post_fields + 524)),
    .SUB .x5 .x10 .x12,
    .MV .x7 .x12,
    .LI .x28 (32 : Word),
