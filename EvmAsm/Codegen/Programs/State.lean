...
/-! ## account_decode -- PR-K27 RLP splitter for Account records
    ...
    enforced:
      * nonce / balance : variable-length BE big-int; any bytes
                          beyond the u64/u256 width must be zero
...
def accountDecode_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .LI .x7 (8 : Word),
    .AUIPC .x5 (laHi GuestAddrs.ad_offset (GuestAddrs.account_decode + 108)),
    .ADDI .x5 .x5 (laLo GuestAddrs.ad_offset (GuestAddrs.account_decode + 108)),
    .LD .x28 .x5 (0 : BitVec 12),
    .ADD .x28 .x8 .x28,
    .BLTU .x7 .x6 (8 : BitVec 13),
    .JAL .x0 (36 : BitVec 21),
    .SUB .x31 .x6 .x7,
    .BEQ .x31 .x0 (24 : BitVec 13),
    .LBU .x29 .x28 (0 : BitVec 12),
    .BNE .x29 .x0 (432 : BitVec 13),
    ...
    .MV .x11 .x9,
    .LI .x12 (1 : Word),
    .AUIPC .x13 (laHi GuestAddrs.ad_offset (GuestAddrs.account_decode + 212)),
    .ADDI .x13 .x13 (laLo GuestAddrs.ad_offset (GuestAddrs.account_decode + 212)),
    .AUIPC .x14 (laHi GuestAddrs.ad_length (GuestAddrs.account_decode + 220)),
    .ADDI .x14 .x14 (laLo GuestAddrs.ad_length (GuestAddrs.account_decode + 220)),
    .JAL .x1 (jalOff GuestAddrs.rlp_list_nth_item (GuestAddrs.account_decode + 228)),
    .BNE .x10 .x0 (344 : BitVec 13),
    .AUIPC .x5 (laHi GuestAddrs.ad_length (GuestAddrs.account_decode + 236)),
    .ADDI .x5 .x5 (laLo GuestAddrs.ad_length (GuestAddrs.account_decode + 236)),
    .LD .x6 .x5 (0 : BitVec 12),
    .LI .x7 (32 : Word),
    .AUIPC .x5 (laHi GuestAddrs.ad_offset (GuestAddrs.account_decode + 252)),
    .ADDI .x5 .x5 (laLo GuestAddrs.ad_offset (GuestAddrs.account_decode + 252)),
    .LD .x28 .x5 (0 : BitVec 12),
    .ADD .x28 .x8 .x28,
    .BLTU .x7 .x6 (8 : BitVec 13),
    .JAL .x0 (36 : BitVec 21),
    ...
    .MV .x11 .x9,
    .LI .x12 (2 : Word),
    .AUIPC .x13 (laHi GuestAddrs.ad_offset (GuestAddrs.account_decode + 372)),
    .ADDI .x13 .x13 (laLo GuestAddrs.ad_offset (GuestAddrs.account_decode + 372)),
    .AUIPC .x14 (laHi GuestAddrs.ad_length (GuestAddrs.account_decode + 380)),
    .ADDI .x14 .x14 (laLo GuestAddrs.ad_length (GuestAddrs.account_decode + 380)),
    .JAL .x1 (jalOff GuestAddrs.rlp_list_nth_item (GuestAddrs.account_decode + 388)),
    .BNE .x10 .x0 (184 : BitVec 13),
    .AUIPC .x5 (laHi GuestAddrs.ad_length (GuestAddrs.account_decode + 396)),
    .ADDI .x5 .x5 (laLo GuestAddrs.ad_length (GuestAddrs.account_decode + 396)),
    .LD .x6 .x5 (0 : BitVec 12),
    .LI .x7 (32 : Word),
    .BNE .x6 .x7 (164 : BitVec 13),
    .AUIPC .x5 (laHi GuestAddrs.ad_offset (GuestAddrs.account_decode + 416)),
    .ADDI .x5 .x5 (laLo GuestAddrs.ad_offset (GuestAddrs.account_decode + 416)),
    .LD .x28 .x5 (0 : BitVec 12),
    .ADD .x28 .x8 .x28,
    .LBU .x29 .x28 (0 : BitVec 12),
    ...
    .MV .x11 .x9,
    .LI .x12 (3 : Word),
    .AUIPC .x13 (laHi GuestAddrs.ad_offset (GuestAddrs.account_decode + 476)),
    .ADDI .x13 .x13 (laLo GuestAddrs.ad_offset (GuestAddrs.account_decode + 476)),
    .AUIPC .x14 (laHi GuestAddrs.ad_length (GuestAddrs.account_decode + 484)),
    .ADDI .x14 .x14 (laLo GuestAddrs.ad_length (GuestAddrs.account_decode + 484)),
    .JAL .x1 (jalOff GuestAddrs.rlp_list_nth_item (GuestAddrs.account_decode + 492)),
    .BNE .x10 .x0 (80 : BitVec 13),
    .AUIPC .x5 (laHi GuestAddrs.ad_length (GuestAddrs.account_decode + 500)),
    .ADDI .x5 .x5 (laLo GuestAddrs.ad_length (GuestAddrs.account_decode + 500)),
    .LD .x6 .x5 (0 : BitVec 12),
    .LI .x7 (32 : Word),
    .BNE .x6 .x7 (60 : BitVec 13),
    .AUIPC .x5 (laHi GuestAddrs.ad_offset (GuestAddrs.account_decode + 520)),
    .ADDI .x5 .x5 (laLo GuestAddrs.ad_offset (GuestAddrs.account_decode + 520)),
    .LD .x28 .x5 (0 : BitVec 12),
    .ADD .x28 .x8 .x28,
    .LBU .x29 .x28 (0 : BitVec 12),
...
def accountDecode_relocs : RelocTable :=
  [ (17, .la .x13 "ad_offset"),
    ...
    (53, .la .x13 "ad_offset"),
    (55, .la .x14 "ad_length"),
    (57, .jal .x1 "rlp_list_nth_item"),
    (59, .la .x5 "ad_length"),
    (63, .la .x5 "ad_offset"),
    (93, .la .x13 "ad_offset"),
    (95, .la .x14 "ad_length"),
    (97, .jal .x1 "rlp_list_nth_item"),
    (99, .la .x5 "ad_length"),
    (104, .la .x5 "ad_offset"),
    (119, .la .x13 "ad_offset"),
    (121, .la .x14 "ad_length"),
    (123, .jal .x1 "rlp_list_nth_item"),
    (125, .la .x5 "ad_length"),
    (130, .la .x5 "ad_offset") ]
...
#guard accountDecode_prog.length = 154
