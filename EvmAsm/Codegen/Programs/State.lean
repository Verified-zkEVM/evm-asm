...
def slotDecodeU256_prog : Program :=
  [ .SD .x12 .x0 (0 : BitVec 12),
    ...
    .BEQ .x11 .x0 (brOff (GuestAddrs.slot_decode_u256 + 120) (GuestAddrs.slot_decode_u256 + 16)),
    .LBU .x5 .x10 (0 : BitVec 12),
    .LI .x6 (128 : Word),
    .BLTU .x5 .x6 (brOff (GuestAddrs.slot_decode_u256 + 108) (GuestAddrs.slot_decode_u256 + 28)),
    .BEQ .x5 .x6 (brOff (GuestAddrs.slot_decode_u256 + 112) (GuestAddrs.slot_decode_u256 + 32)),
    .LI .x6 (161 : Word),
    .BGEU .x5 .x6 (brOff (GuestAddrs.slot_decode_u256 + 120) (GuestAddrs.slot_decode_u256 + 40)),
    .LI .x6 (128 : Word),
    .SUB .x7 .x5 .x6,
    .ADDI .x28 .x11 (-1 : BitVec 12),
    .BLTU .x28 .x7 (brOff (GuestAddrs.slot_decode_u256 + 120) (GuestAddrs.slot_decode_u256 + 56)),
    .LI .x29 (32 : Word),
    .SUB .x29 .x29 .x7,
    .ADD .x30 .x12 .x29,
...
def slotAtIndex_prog : Program :=
  [ .ADDI .x2 .x2 (-32 : BitVec 12),
    ...
    .SD .x8 .x0 (24 : BitVec 12),
    .MV .x10 .x9,
    .JAL .x0 (jalOff (GuestAddrs.slot_at_index + 132) (GuestAddrs.slot_at_index + 68)),
