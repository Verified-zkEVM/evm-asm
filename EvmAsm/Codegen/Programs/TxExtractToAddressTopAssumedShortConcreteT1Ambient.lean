/-
  Ambient Assumed packaging under short concrete t1 of_decode E2E.
-/
...
theorem extractAssumed_creation_under_honesty_of_decode_short_concrete_t1_ambient
  ...
  have hShort := extractFrontCreation_then_epi_of_decode_short_concrete_t1_ambient
  ...
  have hle : nFrontCreationStepsShortT1Ambient ≤ nFrontCreationStepsShort := by
    simp only [nFrontCreationStepsShortT1Ambient, nFrontCreationStepsShort, nTypeSteps]
    omega
...
set_option maxRecDepth 8000 in
theorem extractAssumed_creation_fullCode_of_decode_short_concrete_t1_ambient
    (sp0 spC : Word) (s : ExtractSaved)
    (regionBase loadPtr lenW toBuf isCreationPtr : Word)
    (bs : List (BitVec 8)) (off len : Nat)
    (absOff0 absOff1 absOff2 absOff3 absOff4 : Nat)
  ...
  cpsTripleWithin_extend_code extractLinked_mono
    (extractAssumed_creation_under_honesty_of_decode_short_concrete_t1_ambient
      sp0 spC s regionBase loadPtr lenW toBuf isCreationPtr bs off len
      absOff0 absOff1 absOff2 absOff3 absOff4
      hspC hret hcur htype1 hsalign
    hoff0 hover0 hvalid0 hss0 hls0 hll0 hdec0 hinb0
...
#print axioms extractAssumed_creation_under_honesty_of_decode_short_concrete_t1_ambient
#print axioms extractAssumed_creation_fullCode_of_decode_short_concrete_t1_ambient
