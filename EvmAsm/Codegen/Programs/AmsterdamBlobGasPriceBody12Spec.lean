/-
Parametric swapDiv core (phase 3 + assembly) for the outer-loop assembly
(#12851): mechanical copy of the Body4P3/Body4Spec pieces with `AB`/`PB`
buffer-base parameters and renaming. Consumes Body11Spec's prologue/Q-posts.
-/
...
theorem swapdivP_p3 (newSp excess outPtr iVal AB PB : Word) (vals : Reg → Word)
    ...
    cpsTripleWithin 4 (PriceK + 704) (PriceK + 720) priceCode
      (((.x6 ↦ᵣ (rv64_mulhu taylorDW iVal)) ** ((.x0 ↦ᵣ (0 : Word)) ** ⌜(rv64_mulhu taylorDW iVal) = (0 : Word)⌝)) ** ((.x2 ↦ᵣ newSp) **
        ...
        FR))
            (((.x6 ↦ᵣ (0 : Word)) ** (.x7 ↦ᵣ v7) ** (.x0 ↦ᵣ (0 : Word)) ** (.x28 ↦ᵣ v28) ** (.x29 ↦ᵣ v29) ** (.x5 ↦ᵣ (taylorDW * iVal))) ** (.x30 ↦ᵣ ((PB) + signExtend12 (40 : BitVec 12))) ** (.x31 ↦ᵣ lcnt 0) ** (((PB) + signExtend12 (40 : BitVec 12)) ↦ₘ p5) ** (((PB) + signExtend12 (32 : BitVec 12)) ↦ₘ p4) ** (((PB) + signExtend12 (24 : BitVec 12)) ↦ₘ p3) ** (((PB) + signExtend12 (16 : BitVec 12)) ↦ₘ p2) ** (((PB) + signExtend12 (8 : BitVec 12)) ↦ₘ p1) ** (((PB) + signExtend12 (0 : BitVec 12)) ↦ₘ p0)** ((.x2 ↦ᵣ newSp) **
        (.x1 ↦ᵣ (vals .x1)) **
        (.x10 ↦ᵣ excess) **
        (.x11 ↦ᵣ outPtr) **
        (.x8 ↦ᵣ excess) **
  ...
  have hmvt := mv_spec_gen_within .x30 .x19 (PB) v30 (PriceK + 708) (by decide)
  have hmvtF : cpsTripleWithin 1 (PriceK + 708) (PriceK + 712) priceCode
      (((.x19 ↦ᵣ (PB)) ** (.x30 ↦ᵣ v30)) ** ((.x2 ↦ᵣ newSp) **
        (.x1 ↦ᵣ (vals .x1)) **
        (.x10 ↦ᵣ excess) **
        (.x11 ↦ᵣ outPtr) **
        (.x8 ↦ᵣ excess) **
  ...
  have haddi := addi_spec_gen_same_within .x30 (PB) (40 : BitVec 12) (PriceK + 712)
    (by decide)
  have haddiF : cpsTripleWithin 1 (PriceK + 712) (PriceK + 716) priceCode
      ((.x30 ↦ᵣ (PB)) ** ((.x2 ↦ᵣ newSp) **
        ...
        (.x19 ↦ᵣ (PB)) **
        FR))
      ((.x30 ↦ᵣ ((PB) + signExtend12 (40 : BitVec 12))) ** ((.x2 ↦ᵣ newSp) **
        (.x1 ↦ᵣ (vals .x1)) **
        (.x10 ↦ᵣ excess) **
        (.x11 ↦ᵣ outPtr) **
        (.x8 ↦ᵣ excess) **
  ...
  have hliF : cpsTripleWithin 1 (PriceK + 716) (PriceK + 720) priceCode
      ((.x31 ↦ᵣ v31) ** ((.x2 ↦ᵣ newSp) **
        ...
        (.x6 ↦ᵣ (0 : Word)) **
        (.x19 ↦ᵣ (PB)) **
        (.x30 ↦ᵣ ((PB) + signExtend12 (40 : BitVec 12))) **
        FR))
