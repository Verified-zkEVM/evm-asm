/-
  Front E → ret short concrete legacy creation of_decode (no ∀endPtr).
-/
...
def nFrontCreationStepsShortLegacy : Nat :=
...
theorem extractFrontCreation_then_epi_of_decode_short_concrete_legacy
    ...
    cpsTripleWithin nFrontCreationStepsShortLegacy
  ...
  have hC := extractFrontAfterSaveCreation_then_epi_of_decode_short_legacy sp0 spC s
...
#print axioms extractFrontCreation_then_epi_of_decode_short_concrete_legacy
