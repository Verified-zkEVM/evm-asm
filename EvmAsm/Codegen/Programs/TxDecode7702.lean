...
def txEip7702Decode_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .BNE .x12 .x0 (brOff (GuestAddrs.tx_eip7702_decode + 620) (GuestAddrs.tx_eip7702_decode + 36)),
    .MV .x9 .x11,
    .MV .x19 .x10,
    .MV .x10 .x19,
    .MV .x11 .x9,
    ...
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip7702_decode + 620) (GuestAddrs.tx_eip7702_decode + 64)),
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    .JAL .x1 (jalOff GuestAddrs.rlp_content_to_u64_strict (GuestAddrs.tx_eip7702_decode + 76)),
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip7702_decode + 620) (GuestAddrs.tx_eip7702_decode + 80)),
    .SD .x18 .x10 (0 : BitVec 12),
    .MV .x10 .x19,
    .MV .x11 .x9,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.tx_eip7702_decode + 96)),
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip7702_decode + 620) (GuestAddrs.tx_eip7702_decode + 104)),
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    .JAL .x1 (jalOff GuestAddrs.rlp_content_to_u64_strict (GuestAddrs.tx_eip7702_decode + 116)),
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip7702_decode + 620) (GuestAddrs.tx_eip7702_decode + 120)),
    .SD .x18 .x10 (8 : BitVec 12),
    .MV .x10 .x19,
    .MV .x11 .x9,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.tx_eip7702_decode + 136)),
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip7702_decode + 620) (GuestAddrs.tx_eip7702_decode + 144)),
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    .ADDI .x12 .x18 (16 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.rlp_content_to_u256_be_strict (GuestAddrs.tx_eip7702_decode + 160)),
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_eip7702_decode + 620) (GuestAddrs.tx_eip7702_decode + 164)),
    .MV .x10 .x19,
    .MV .x11 .x9,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.tx_eip7702_decode + 176)),
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip7702_decode + 620) (GuestAddrs.tx_eip7702_decode + 184)),
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    .ADDI .x12 .x18 (48 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.rlp_content_to_u256_be_strict (GuestAddrs.tx_eip7702_decode + 200)),
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_eip7702_decode + 620) (GuestAddrs.tx_eip7702_decode + 204)),
    .MV .x10 .x19,
    .MV .x11 .x9,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.tx_eip7702_decode + 216)),
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip7702_decode + 620) (GuestAddrs.tx_eip7702_decode + 224)),
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    .JAL .x1 (jalOff GuestAddrs.rlp_content_to_u64_strict (GuestAddrs.tx_eip7702_decode + 236)),
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip7702_decode + 620) (GuestAddrs.tx_eip7702_decode + 240)),
    .SD .x18 .x10 (80 : BitVec 12),
    .MV .x10 .x19,
    .MV .x11 .x9,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.tx_eip7702_decode + 256)),
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip7702_decode + 620) (GuestAddrs.tx_eip7702_decode + 264)),
    .BEQ .x12 .x0 (56 : BitVec 13),
    .LI .x5 (20 : Word),
    .BNE .x12 .x5 (brOff (GuestAddrs.tx_eip7702_decode + 620) (GuestAddrs.tx_eip7702_decode + 276)),
    .SUB .x28 .x10 .x12,
    ...
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip7702_decode + 620) (GuestAddrs.tx_eip7702_decode + 360)),
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    .ADDI .x12 .x18 (112 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.rlp_content_to_u256_be_strict (GuestAddrs.tx_eip7702_decode + 376)),
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_eip7702_decode + 620) (GuestAddrs.tx_eip7702_decode + 380)),
    .MV .x10 .x19,
    .MV .x11 .x9,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.tx_eip7702_decode + 392)),
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip7702_decode + 620) (GuestAddrs.tx_eip7702_decode + 400)),
    .SUB .x28 .x10 .x12,
    .SUB .x6 .x28 .x8,
    ...
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip7702_decode + 620) (GuestAddrs.tx_eip7702_decode + 436)),
    .SUB .x28 .x10 .x12,
    .SUB .x6 .x28 .x8,
    ...
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip7702_decode + 620) (GuestAddrs.tx_eip7702_decode + 472)),
    .SUB .x28 .x10 .x12,
    .SUB .x6 .x28 .x8,
    ...
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip7702_decode + 620) (GuestAddrs.tx_eip7702_decode + 508)),
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    .JAL .x1 (jalOff GuestAddrs.rlp_content_to_u64_strict (GuestAddrs.tx_eip7702_decode + 520)),
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip7702_decode + 620) (GuestAddrs.tx_eip7702_decode + 524)),
    .SD .x18 .x10 (168 : BitVec 12),
    .MV .x10 .x19,
    .MV .x11 .x9,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (GuestAddrs.tx_eip7702_decode + 540)),
    .MV .x19 .x10,
    .BNE .x11 .x0 (brOff (GuestAddrs.tx_eip7702_decode + 620) (GuestAddrs.tx_eip7702_decode + 548)),
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    .ADDI .x12 .x18 (176 : BitVec 12),
    .JAL .x1 (jalOff GuestAddrs.rlp_content_to_u256_be_strict (GuestAddrs.tx_eip7702_decode + 564)),
    ...
    .JAL .x1 (jalOff GuestAddrs.rlp_content_to_u256_be_strict (GuestAddrs.tx_eip7702_decode + 604)),
...
def txEip7702Decode_relocs : RelocTable :=
  [ (8, .jal .x1 "rlp_walk_init"),
    ...
    (130, .jal .x1 "rlp_content_to_u64_strict"),
    (135, .jal .x1 "rlp_walk_next"),
    (141, .jal .x1 "rlp_content_to_u256_be_strict"),
