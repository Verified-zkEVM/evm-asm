...
def knownProgramNamesTail : List String :=
  ...
  ["zisk_single_leaf_trie_root",
   ...
   "zisk_bal_account_record_array", "zisk_bal_account_access_outcome_descriptors", "zisk_bal_storage_access_outcome_descriptors", "zisk_tx_gas_sender_bal_lookup", "zisk_tx_gas_bal_post_verify", "zisk_block_verdict_gas_result_arena", "zisk_simple_transfer_tx_context", "zisk_multi_tx_nth_context", "zisk_stage_runtime_payload_code", "zisk_bytecode_is_self_contained", "zisk_stage_runtime_payload_code_storage", "zisk_stage_runtime_payload_code_calldata", "zisk_stage_runtime_payload", "zisk_simple_transfer_recipient_bal_verify", "zisk_simple_transfer_fee_recipient_bal_verify",
