...
def knownProgramNamesTail : List String :=
  ...
  ["zisk_single_leaf_trie_root",
   ...
   "zisk_call_depth_precompile_limit",
   "zisk_call_depth_eip4788_limit",
   "zisk_bal_account_record_array", "zisk_bal_account_access_outcome_descriptors", "zisk_bal_storage_access_outcome_descriptors", "zisk_tx_gas_sender_bal_lookup", "zisk_tx_gas_bal_post_verify", "zisk_block_verdict_gas_result_arena", "zisk_simple_transfer_tx_context", "zisk_multi_tx_nth_context", "zisk_stage_runtime_payload_code", "zisk_stage_runtime_payload_code_m29", "zisk_bytecode_is_self_contained", "zisk_bal_find_account_by_address", "zisk_stage_runtime_payload_code_storage", "zisk_stage_runtime_payload_code_calldata", "zisk_stage_creation_runtime_payload", "zisk_creation_runtime_windows", "zisk_bal_recipient_storage_keys", "zisk_stage_runtime_payload", "zisk_simple_transfer_recipient_bal_verify", "zisk_simple_transfer_fee_recipient_bal_verify", "zisk_bal_txs_independent", "zisk_frame_switch", "zisk_frame_base", "zisk_call_descend", "zisk_frame_return", "zisk_call_frame_descend", "zisk_call_depth_limit", "zisk_call_roundtrip", "zisk_create_roundtrip", "zisk_storage_multicontract", "zisk_call_balance_gate", "zisk_call_value_effect", "zisk_bal_storage_change_values", "zisk_bal_storage_matches_exec_log", "zisk_exec_log_append_storage_seed", "zisk_bal_recipient_field_empty", "zisk_bal_storage_covers_exec_log", "zisk_bal_addr_to_exec_log_key", "zisk_bal_all_accounts_storage_consistent", "zisk_sender_debit_from_gas", "zisk_multi_tx_running_sender_balance", "zisk_b3_coinbase_fee_credit_sum", "zisk_b3_recipient_credit_table", "zisk_bal_all_accounts_storage_consistent_skip_list", "zisk_bal_all_accounts_tuple_sequences_consistent_skip_list", "zisk_bal_storage_reads_in_exec_log", "zisk_create_descend", "zisk_extract_deposit_data", "zisk_parse_deposit_requests", "zisk_create2_descend", "zisk_call_extra_gas", "zisk_set_call_env", "zisk_bal_account_nonstorage_finals", "zisk_bal_account_nonstorage_consistent", "zisk_bal_all_accounts_nonstorage_consistent", "zisk_bal_all_accounts_nonstorage_covers", "zisk_bal_account_code_consistent", "zisk_tx_gas_bal_post_verify_runtime", "zisk_bal_slot_tuple_sequence", "zisk_exec_log_slot_tuples", "zisk_slot_tuple_sequences_match", "zisk_system_user_exec_log_slot_tuples", "zisk_create_code_effect_log", "zisk_bal_all_accounts_code_consistent", "zisk_create_deployed_code_valid", "zisk_account_tuple_sequences_consistent", "zisk_sender_post_nonce_consistent", "zisk_bal_all_accounts_code_covers", "zisk_bal_all_accounts_tuple_sequences_consistent", "zisk_create_initcode_size_valid", "zisk_create_creator_nonce_use", "zisk_nonstorage_effect_log", "zisk_nonstorage_effect_aggregate", "zisk_exec_log_latest_value", "zisk_mtx_committed_snapshot_append", "zisk_mtx_committed_snapshot_upsert", "zisk_mtx_committed_chunked_snapshot_upsert", "zisk_mtx_committed_latest_value", "zisk_mtx_committed_chunked_latest_value", "zisk_mtx_committed_block_verdict_threading", "zisk_sstore_regular_gas", "zisk_memory_expansion_gas", "zisk_dynamic_opcode_gas", "zisk_assemble_execution_requests", "zisk_log_full_data_capture", "zisk_materialize_log_records", "zisk_deposit_derivation_e2e", "zisk_stage_system_call_payload", "zisk_stage_system_call", "zisk_stage_predeploy_storage_preload", "zisk_derive_withdrawal_requests", "zisk_derive_consolidation_requests", "zisk_derive_requests_hash_e2e", "zisk_derive_block_system_requests", "zisk_sstore_clear_gas_probe", "zisk_log_records_encode_rlp", "zisk_ecrecover_precompile_probe", "zisk_capture_exec_state_gas", "zisk_dispatcher_tx_gas_settle", "zisk_capture_system_storage_exec_rows", "zisk_bal_serializer_measure", "zisk_bal_selftests", "zisk_bal_order_dump",
