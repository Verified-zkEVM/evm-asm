/-
  Ambient dual: Front long E2E t1 creation of_decode (typeW=1, fields 0..4).
-/
...
theorem extractFrontCreation_then_epi_of_decode_long_concrete_t1_ambient
  ...
  have hC := extractFrontAfterSaveCreation_then_epi_of_decode_long_t1_ambient sp0 spC s
...
#print axioms extractFrontCreation_then_epi_of_decode_long_concrete_t1_ambient
