...
abbrev vphlCompareBodyCode : CodeReq :=
...
theorem vphlCompareRound0Eq
    ...
    cpsTripleWithin 3 (vphlBase + 200) (vphlBase + 212) vphlCompareBodyCode
...
theorem vphlCompareRound0Ne
    ...
    cpsTripleWithin 3 (vphlBase + 200) (vphlBase + 264) vphlCompareBodyCode
      ((.x5 ↦ᵣ vphlClaimedAddr) ** (.x6 ↦ᵣ vphlComputedAddr) **
        (.x7 ↦ᵣ v7) ** (.x28 ↦ᵣ v28) **
        vphlClaimedOwn claimedBytes ** bytesRegion vphlComputedAddr computedBytes)
      ((.x5 ↦ᵣ vphlClaimedAddr) ** (.x6 ↦ᵣ vphlComputedAddr) **
...
theorem vphlCompareRound1Eq
    ...
    cpsTripleWithin 3 (vphlBase + 212) (vphlBase + 224) vphlCompareBodyCode
      ((.x5 ↦ᵣ vphlClaimedAddr) ** (.x6 ↦ᵣ vphlComputedAddr) **
        (.x7 ↦ᵣ v7) ** (.x28 ↦ᵣ v28) **
        vphlClaimedOwn claimedBytes ** bytesRegion vphlComputedAddr computedBytes)
      ((.x5 ↦ᵣ vphlClaimedAddr) ** (.x6 ↦ᵣ vphlComputedAddr) **
...
theorem vphlCompareRound1Ne
    ...
    cpsTripleWithin 3 (vphlBase + 212) (vphlBase + 264) vphlCompareBodyCode
      ((.x5 ↦ᵣ vphlClaimedAddr) ** (.x6 ↦ᵣ vphlComputedAddr) **
        (.x7 ↦ᵣ v7) ** (.x28 ↦ᵣ v28) **
        vphlClaimedOwn claimedBytes ** bytesRegion vphlComputedAddr computedBytes)
      ((.x5 ↦ᵣ vphlClaimedAddr) ** (.x6 ↦ᵣ vphlComputedAddr) **
...
theorem vphlCompareRound2Eq
    ...
    cpsTripleWithin 3 (vphlBase + 224) (vphlBase + 236) vphlCompareBodyCode
      ((.x5 ↦ᵣ vphlClaimedAddr) ** (.x6 ↦ᵣ vphlComputedAddr) **
        (.x7 ↦ᵣ v7) ** (.x28 ↦ᵣ v28) **
        vphlClaimedOwn claimedBytes ** bytesRegion vphlComputedAddr computedBytes)
      ((.x5 ↦ᵣ vphlClaimedAddr) ** (.x6 ↦ᵣ vphlComputedAddr) **
...
theorem vphlCompareRound2Ne
    ...
    cpsTripleWithin 3 (vphlBase + 224) (vphlBase + 264) vphlCompareBodyCode
      ((.x5 ↦ᵣ vphlClaimedAddr) ** (.x6 ↦ᵣ vphlComputedAddr) **
        (.x7 ↦ᵣ v7) ** (.x28 ↦ᵣ v28) **
        vphlClaimedOwn claimedBytes ** bytesRegion vphlComputedAddr computedBytes)
      ((.x5 ↦ᵣ vphlClaimedAddr) ** (.x6 ↦ᵣ vphlComputedAddr) **
...
theorem vphlCompareRound3Eq
    ...
    cpsTripleWithin 3 (vphlBase + 236) (vphlBase + 248) vphlCompareBodyCode
      ((.x5 ↦ᵣ vphlClaimedAddr) ** (.x6 ↦ᵣ vphlComputedAddr) **
        (.x7 ↦ᵣ v7) ** (.x28 ↦ᵣ v28) **
        vphlClaimedOwn claimedBytes ** bytesRegion vphlComputedAddr computedBytes)
      ((.x5 ↦ᵣ vphlClaimedAddr) ** (.x6 ↦ᵣ vphlComputedAddr) **
...
theorem vphlCompareRound3Ne
    ...
    cpsTripleWithin 3 (vphlBase + 236) (vphlBase + 264) vphlCompareBodyCode
      ((.x5 ↦ᵣ vphlClaimedAddr) ** (.x6 ↦ᵣ vphlComputedAddr) **
        (.x7 ↦ᵣ v7) ** (.x28 ↦ᵣ v28) **
        vphlClaimedOwn claimedBytes ** bytesRegion vphlComputedAddr computedBytes)
      ((.x5 ↦ᵣ vphlClaimedAddr) ** (.x6 ↦ᵣ vphlComputedAddr) **
...
theorem vphlCompareAllEq
    ...
    cpsTripleWithin 12 (vphlBase + 200) (vphlBase + 248) vphlCompareBodyCode
      ((.x5 ↦ᵣ vphlClaimedAddr) ** (.x6 ↦ᵣ vphlComputedAddr) **
        (.x7 ↦ᵣ v7) ** (.x28 ↦ᵣ v28) **
        vphlClaimedOwn claimedBytes ** bytesRegion vphlComputedAddr computedBytes)
      ((.x5 ↦ᵣ vphlClaimedAddr) ** (.x6 ↦ᵣ vphlComputedAddr) **
...
theorem vphlCompareMatchTail
    ...
    cpsTripleWithin 4 (vphlBase + 248) (vphlBase + 288) vphlCompareBodyCode
...
theorem vphlCompareMismatchTail
    (outPtr oldOut : Word) (G : Assertion) (hG : G.pcFree) :
    cpsTripleWithin 3 (vphlBase + 264) (vphlBase + 288) vphlCompareBodyCode
      ((.x20 ↦ᵣ outPtr) ** (.x5 ↦ᵣ vphlClaimedAddr) ** (.x10 ↦ᵣ (0 : Word)) **
        (outPtr ↦ₘ oldOut) ** G)
      ((.x20 ↦ᵣ outPtr) ** (.x5 ↦ᵣ vphlClaimedAddr) ** (.x10 ↦ᵣ (0 : Word)) **
