...
def txGasSenderBalLookup_prog : Program :=
  [ .ADDI .x2 .x2 (-112 : BitVec 12),
    ...
    .BEQ .x9 .x0 (brOff (GuestAddrs.tx_gas_sender_bal_lookup + 636) (GuestAddrs.tx_gas_sender_bal_lookup + 168)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_gas_sender_bal_lookup + 636) (GuestAddrs.tx_gas_sender_bal_lookup + 216)),
    .JAL .x0 (60 : BitVec 21),
    .BEQ .x5 .x0 (brOff (GuestAddrs.tx_gas_sender_bal_lookup + 636) (GuestAddrs.tx_gas_sender_bal_lookup + 224)),
    .LI .x6 (4 : Word),
    .BLTU .x6 .x5 (brOff (GuestAddrs.tx_gas_sender_bal_lookup + 636) (GuestAddrs.tx_gas_sender_bal_lookup + 232)),
    .LI .x6 (2 : Word),
    .BLTU .x9 .x6 (brOff (GuestAddrs.tx_gas_sender_bal_lookup + 636) (GuestAddrs.tx_gas_sender_bal_lookup + 240)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_gas_sender_bal_lookup + 636) (GuestAddrs.tx_gas_sender_bal_lookup + 276)),
    .MV .x10 .x18,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_gas_sender_bal_lookup + 644) (GuestAddrs.tx_gas_sender_bal_lookup + 312)),
    ...
    .LI .x25 (0 : Word),
    .BGEU .x25 .x24 (brOff (GuestAddrs.tx_gas_sender_bal_lookup + 652) (GuestAddrs.tx_gas_sender_bal_lookup + 332)),
    .MV .x10 .x19,
    .MV .x11 .x20,
    .MV .x12 .x25,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_gas_sender_bal_lookup + 644) (GuestAddrs.tx_gas_sender_bal_lookup + 368)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_gas_sender_bal_lookup + 644) (GuestAddrs.tx_gas_sender_bal_lookup + 432)),
    ...
    .LD .x5 .x5 (0 : BitVec 12),
    .LI .x6 (20 : Word),
    .BNE .x5 .x6 (brOff (GuestAddrs.tx_gas_sender_bal_lookup + 644) (GuestAddrs.tx_gas_sender_bal_lookup + 452)),
    ...
    .JAL .x0 (jalOff (GuestAddrs.tx_gas_sender_bal_lookup + 332) (GuestAddrs.tx_gas_sender_bal_lookup + 516)),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_gas_sender_bal_lookup + 660) (GuestAddrs.tx_gas_sender_bal_lookup + 556)),
    .SLLI .x5 .x25 (4 : BitVec 6),
    .SLLI .x6 .x25 (3 : BitVec 6),
    .ADD .x5 .x5 .x6,
    .ADD .x5 .x21 .x5,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.tx_gas_sender_bal_lookup + 660) (GuestAddrs.tx_gas_sender_bal_lookup + 592)),
    .MV .x10 .x26,
    .MV .x11 .x27,
