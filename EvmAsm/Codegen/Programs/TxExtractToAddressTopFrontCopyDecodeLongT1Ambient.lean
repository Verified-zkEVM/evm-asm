/-
  Ambient dual: Front long AfterSave → t1 20B copy of_decode (typeW=1, fields 0..4).
-/
...
theorem extractFrontAfterSaveCopy_then_epi_of_decode_long_t1_region_ambient
  ...
  have hMid := extractT1AfterSaveCopy_then_epi_of_decode_region_ambient sp0 spC s
...
#print axioms extractFrontAfterSaveCopy_then_epi_of_decode_long_t1_region_ambient
