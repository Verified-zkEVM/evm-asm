...
def receiptExtractLogsBloom_prog : Program :=
  [ .ADDI .x2 .x2 (-32 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.receipt_extract_logs_bloom + 148) (GuestAddrs.receipt_extract_logs_bloom + 64)),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .LI .x7 (256 : Word),
    .BNE .x6 .x7 (brOff (GuestAddrs.receipt_extract_logs_bloom + 156) (GuestAddrs.receipt_extract_logs_bloom + 84)),
...
def headerExtractLogsBloom_prog : Program :=
  [ .ADDI .x2 .x2 (-32 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.header_extract_logs_bloom + 148) (GuestAddrs.header_extract_logs_bloom + 64)),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .LI .x7 (256 : Word),
    .BNE .x6 .x7 (brOff (GuestAddrs.header_extract_logs_bloom + 156) (GuestAddrs.header_extract_logs_bloom + 84)),
