...
private theorem scalarBranchCase
  ...
  have hb1 := cpsBranchWithin_extend_code (cr' := wrapperCode)
    (CodeReq.ofProg_mem_at B (B + 84) rlpFieldToU64Strict_prog 21
...
theorem successMachineTail
  ...
  have hs := cpsTripleWithin_extend_code (cr' := wrapperCode)
    (CodeReq.ofProg_mem_at B (B + 88) rlpFieldToU64Strict_prog 22
  ...
  have hl := cpsTripleWithin_extend_code (cr' := wrapperCode)
    (CodeReq.ofProg_mem_at B (B + 92) rlpFieldToU64Strict_prog 23
  ...
  have hj := cpsTripleWithin_extend_code (cr' := wrapperCode)
    (CodeReq.ofProg_mem_at B (B + 96) rlpFieldToU64Strict_prog 24
...
theorem tooLongMachineTail
  ...
  have hl := cpsTripleWithin_extend_code (cr' := wrapperCode)
    (CodeReq.ofProg_mem_at B (B + 100) rlpFieldToU64Strict_prog 25
  ...
  have hb := cpsBranchWithin_extend_code (cr' := wrapperCode)
    (CodeReq.ofProg_mem_at B (B + 104) rlpFieldToU64Strict_prog 26
  ...
  have hr := cpsTripleWithin_extend_code (cr' := wrapperCode)
    (CodeReq.ofProg_mem_at B (B + 124) rlpFieldToU64Strict_prog 31
...
theorem noncanonicalMachineTail
  ...
  have hs := cpsTripleWithin_extend_code (cr' := wrapperCode)
    (CodeReq.ofProg_mem_at B (B + 108) rlpFieldToU64Strict_prog 27
  ...
  rw [show B + 112 + signExtend21 (16 : BitVec 21) = B + 128 from by decide]
    at hj0
  have hj := cpsTripleWithin_extend_code (cr' := wrapperCode)
    (CodeReq.ofProg_mem_at B (B + 112) rlpFieldToU64Strict_prog 28
