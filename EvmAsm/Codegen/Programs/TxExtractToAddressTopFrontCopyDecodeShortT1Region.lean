/-
  Front short AfterSave → t1 20B copy bare region (no contentDwords).
-/
...
theorem extractFrontAfterSaveCopy_then_epi_of_decode_short_t1_region
...
#print axioms extractFrontAfterSaveCopy_then_epi_of_decode_short_t1_region
