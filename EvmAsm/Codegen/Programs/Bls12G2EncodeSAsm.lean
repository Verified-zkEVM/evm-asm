...
#guard GuestAddrs.blsg2_encode = 0x800342e0
#guard GuestAddrs.blsg_le_to_be = 0x8002f648
...
/-- The verification `CodeReq`: the caller at its guest address plus the
    ...
    call). -/
def encCr : CodeReq :=
  (CodeReq.ofProg (GuestAddrs.blsg2_encode : Word) blsg2Encode_prog).union
...
theorem blsgLeToBeFlat_spec (ret srci dsti : Word) (inb ob : List (BitVec 8))
    ...
    cpsTripleWithin ((blsgLeToBeFn srci dsti inb ob).body.steps + 1)
      (GuestAddrs.blsg_le_to_be : Word) ret encCr
...
/-- One loop pass (`(GuestAddrs.blsg2_encode + 32) → (GuestAddrs.blsg2_encode + 64)`): compute the 48·i offset,
...
private theorem encStep_spec (i : Nat) (hi : i < 4) (v1 : Word)
    ...
    cpsTripleWithin ((blsgLeToBeFn 0 0 [] []).body.steps + 10)
      ((GuestAddrs.blsg2_encode + 32) : Word) ((GuestAddrs.blsg2_encode + 64) : Word) encCr
      ...
      ((.x18 ↦ᵣ BitVec.ofNat 64 (i + 1)) ** (.x5 ↦ᵣ BitVec.ofNat 64 4)
        ** (((.x1 : Reg) ↦ᵣ (BitVec.ofNat 64 GuestAddrs.blsg2_encode + 56)) ** (.x8 ↦ᵣ src) ** (.x9 ↦ᵣ dst)
          ** regOwn .x6 ** regOwn .x10 ** regOwn .x11 ** regOwns encRest
  ...
  have hs1 := slli_spec_gen_within .x5 .x18 (vf .x5) (BitVec.ofNat 64 i)
    (4 : BitVec 6) ((GuestAddrs.blsg2_encode + 32) : Word) (by decide)
  rw [show ((4 : BitVec 6)).toNat = 4 from rfl,
      ofNat_shl i 4 16 (by norm_num) (by omega),
      show ((GuestAddrs.blsg2_encode + 32) : Word) + 4 = ((GuestAddrs.blsg2_encode + 36) : Word) from by decide] at hs1
  have hs1C := liftCode (cr' := encCr) hs1 (by code_mem)
  have hs2 := slli_spec_gen_within .x6 .x18 (vf .x6) (BitVec.ofNat 64 i)
    (5 : BitVec 6) ((GuestAddrs.blsg2_encode + 36) : Word) (by decide)
  rw [show ((5 : BitVec 6)).toNat = 5 from rfl,
      ofNat_shl i 5 32 (by norm_num) (by omega),
      show ((GuestAddrs.blsg2_encode + 36) : Word) + 4 = ((GuestAddrs.blsg2_encode + 40) : Word) from by decide] at hs2
  have hs2C := liftCode (cr' := encCr) hs2 (by code_mem)
  have hs3 := add_spec_gen_rd_eq_rs1_within .x5 .x6 (BitVec.ofNat 64 (16 * i))
    (BitVec.ofNat 64 (32 * i)) ((GuestAddrs.blsg2_encode + 40) : Word) (by decide)
  rw [show BitVec.ofNat 64 (16 * i) + BitVec.ofNat 64 (32 * i)
        = BitVec.ofNat 64 (48 * i) from by
      apply BitVec.eq_of_toNat_eq
      simp only [BitVec.toNat_add, BitVec.toNat_ofNat]
      omega,
      show ((GuestAddrs.blsg2_encode + 40) : Word) + 4 = ((GuestAddrs.blsg2_encode + 44) : Word) from by decide] at hs3
  have hs3C := liftCode (cr' := encCr) hs3 (by code_mem)
  have hs4 := add_spec_gen_within .x10 .x8 .x5 src (BitVec.ofNat 64 (48 * i))
    (vf .x10) ((GuestAddrs.blsg2_encode + 44) : Word) (by decide)
  rw [show ((GuestAddrs.blsg2_encode + 44) : Word) + 4 = ((GuestAddrs.blsg2_encode + 48) : Word) from by decide] at hs4
  have hs4C := liftCode (cr' := encCr) hs4 (by code_mem)
  have hs5 := add_spec_gen_within .x11 .x9 .x5 dst (BitVec.ofNat 64 (48 * i))
    (vf .x11) ((GuestAddrs.blsg2_encode + 48) : Word) (by decide)
  rw [show ((GuestAddrs.blsg2_encode + 48) : Word) + 4 = ((GuestAddrs.blsg2_encode + 52) : Word) from by decide] at hs5
  have hs5C := liftCode (cr' := encCr) hs5 (by code_mem)
  -- ---- the cross-call ----
  have hcallee := blsgLeToBeFlat_spec (((GuestAddrs.blsg2_encode + 52) : Word) + 4)
    (src + BitVec.ofNat 64 (48 * i)) (dst + BitVec.ofNat 64 (48 * i)) inb ob
    hilen holen hwfR hwfW hso hdo hdisj (by decide)
  have hcall := callWithin_spec ((GuestAddrs.blsg2_encode + 52) : Word) (GuestAddrs.blsg_le_to_be : Word) v1
  ...
  rw [show ((GuestAddrs.blsg2_encode + 52) : Word) + 4 = (BitVec.ofNat 64 GuestAddrs.blsg2_encode + 56) from by decide] at hcall
  ...
  have ha := addi_spec_gen_same_within .x18 (BitVec.ofNat 64 i) (1 : BitVec 12)
    (BitVec.ofNat 64 GuestAddrs.blsg2_encode + 56) (by decide)
  rw [cnt_step_up i (by omega),
      show (BitVec.ofNat 64 GuestAddrs.blsg2_encode + 56) + 4 = ((GuestAddrs.blsg2_encode + 60) : Word) from by decide] at ha
  have haC := liftCode (cr' := encCr) ha (by code_mem)
  have hli := li_spec_gen_own_within .x5 (4 : Word) ((GuestAddrs.blsg2_encode + 60) : Word) (by decide)
  rw [show ((GuestAddrs.blsg2_encode + 60) : Word) + 4 = ((GuestAddrs.blsg2_encode + 64) : Word) from by decide,
  ...
  have hliF := cpsTripleWithin_frameR
    ((.x18 ↦ᵣ BitVec.ofNat 64 (i + 1)) ** ((.x1 : Reg) ↦ᵣ (BitVec.ofNat 64 GuestAddrs.blsg2_encode + 56))
      ** (.x8 ↦ᵣ src) ** (.x9 ↦ᵣ dst)
...
def encInv (ret src dst : Word)
  ...
  (if i = 0 then ((.x1 : Reg) ↦ᵣ ret) else ((.x1 : Reg) ↦ᵣ (BitVec.ofNat 64 GuestAddrs.blsg2_encode + 56)))
  ** (.x8 ↦ᵣ src) ** (.x9 ↦ᵣ dst)
  ** regOwn .x6 ** regOwn .x10 ** regOwn .x11 ** regOwns encRest
...
private theorem encLoopBody_spec
  ...
  · -- i = 0: chunk 0, entry `ra`.
    ...
    · norm_num [encInv] at hq ⊢
      xperm_hyp hq
  · -- i = 1: chunk 1, link `ra`.
    have h := hstep 1 (by omega) (BitVec.ofNat 64 GuestAddrs.blsg2_encode + 56) in1 o1 hi1 ho1
      (by omega) (by omega)
    ...
    · norm_num [encInv] at hq ⊢
      xperm_hyp hq
  · -- i = 2: chunk 2.
    have h := hstep 2 (by omega) (BitVec.ofNat 64 GuestAddrs.blsg2_encode + 56) in2 o2 hi2 ho2
      (by omega) (by omega)
    ...
    · norm_num [encInv] at hq ⊢
      xperm_hyp hq
  · -- i = 3: chunk 3.
    have h := hstep 3 (by omega) (BitVec.ofNat 64 GuestAddrs.blsg2_encode + 56) in3 o3 hi3 ho3
      (by omega) (by omega)
...
def encVals' (src dst : Word) : Reg → Word :=
  fun r => match r with
  | .x1 => (BitVec.ofNat 64 GuestAddrs.blsg2_encode + 56) | .x8 => src | .x9 => dst
...
theorem blsg2Encode_spec (sp0 ret src dst arb8 arb9 arb18 : Word)
    ...
    cpsTripleWithin
      (1 + encFrame.length
        ...
        + encFrame.length + 1 + 1)
      (GuestAddrs.blsg2_encode : Word) ret encCr
  ...
  have hm1 := mv_spec_gen_within .x8 .x10 src arb8 ((GuestAddrs.blsg2_encode + 20) : Word) (by decide)
  rw [show ((GuestAddrs.blsg2_encode + 20) : Word) + 4 = ((GuestAddrs.blsg2_encode + 24) : Word) from by decide] at hm1
  have hm1C := liftCode (cr' := encCr) hm1 (by code_mem)
  have hm2 := mv_spec_gen_within .x9 .x11 dst arb9 ((GuestAddrs.blsg2_encode + 24) : Word) (by decide)
  rw [show ((GuestAddrs.blsg2_encode + 24) : Word) + 4 = ((GuestAddrs.blsg2_encode + 28) : Word) from by decide] at hm2
  have hm2C := liftCode (cr' := encCr) hm2 (by code_mem)
  have hm3 := li_spec_gen_within .x18 arb18 (0 : Word) ((GuestAddrs.blsg2_encode + 28) : Word) (by decide)
  rw [show ((GuestAddrs.blsg2_encode + 28) : Word) + 4 = ((GuestAddrs.blsg2_encode + 32) : Word) from by decide,
      show (0 : Word) = BitVec.ofNat 64 0 from rfl] at hm3
  have hm3C := liftCode (cr' := encCr) hm3 (by code_mem)
  -- ---- the count-up loop ----
  have hloop := countupLoopBottom_spec encCr ((GuestAddrs.blsg2_encode + 32) : Word) ((GuestAddrs.blsg2_encode + 64) : Word)
  ...
  rw [show ((GuestAddrs.blsg2_encode + 64) : Word) + 4 = ((GuestAddrs.blsg2_encode + 68) : Word) from by decide] at hloop
  ...
  have hbody : cpsTripleWithin
      (3 + 4 * ((blsgLeToBeFn 0 0 [] []).body.steps + 10 + 1))
      ((GuestAddrs.blsg2_encode : Word) + BitVec.ofNat 64 (4 * (1 + encFrame.length)))
      ((GuestAddrs.blsg2_encode : Word)
      ...
      ((.x2 ↦ᵣ (sp0 + signExtend12 (-40 : BitVec 12)))
        ...
        ** (regOwn .x10 ** regOwn .x11
          ...
          ** bytesRegion (src + BitVec.ofNat 64 96) in2
          ** bytesRegion (src + BitVec.ofNat 64 144) in3)) := by
    have hentry : (GuestAddrs.blsg2_encode : Word) + BitVec.ofNat 64 (4 * (1 + encFrame.length))
        = ((GuestAddrs.blsg2_encode + 20) : Word) := by decide
    have hexit : (GuestAddrs.blsg2_encode : Word)
          + BitVec.ofNat 64 (4 * (1 + encFrame.length + encBody.length))
        = ((GuestAddrs.blsg2_encode + 68) : Word) := by decide
    rw [hentry, hexit]
    ...
    have hq1 : (((.x5 : Reg) ↦ᵣ (4#64 : Word))
        ** ((.x18 ↦ᵣ (4#64 : Word)) ** ((.x1 : Reg) ↦ᵣ (BitVec.ofNat 64 GuestAddrs.blsg2_encode + 56))
          ** (.x8 ↦ᵣ src) ** (.x9 ↦ᵣ dst)
          ** regOwn .x6 ** regOwn .x10 ** regOwn .x11 ** regOwns encRest
          ** bytesRegion dst (blsgLeToBeBytes in0)
