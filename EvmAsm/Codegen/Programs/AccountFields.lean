...
def accountIsEip161Empty_prog : Program :=
  [ .ADDI .x2 .x2 (-40 : BitVec 12),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.account_is_eip161_empty + 396) (GuestAddrs.account_is_eip161_empty + 68)),
    ...
    .LI .x7 (8 : Word),
    .BLTU .x7 .x6 (brOff (GuestAddrs.account_is_eip161_empty + 396) (GuestAddrs.account_is_eip161_empty + 88)),
    ...
    .JAL .x0 (-24 : BitVec 21),
    .BNE .x7 .x0 (brOff (GuestAddrs.account_is_eip161_empty + 384) (GuestAddrs.account_is_eip161_empty + 140)),
    .MV .x10 .x8,
    .MV .x11 .x9,
    .LI .x12 (1 : Word),
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.account_is_eip161_empty + 396) (GuestAddrs.account_is_eip161_empty + 176)),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .LI .x7 (32 : Word),
    .BLTU .x7 .x6 (brOff (GuestAddrs.account_is_eip161_empty + 396) (GuestAddrs.account_is_eip161_empty + 196)),
    ...
    .LBU .x29 .x28 (0 : BitVec 12),
    .BNE .x29 .x0 (brOff (GuestAddrs.account_is_eip161_empty + 384) (GuestAddrs.account_is_eip161_empty + 224)),
    .ADDI .x28 .x28 (1 : BitVec 12),
    .ADDI .x6 .x6 (-1 : BitVec 12),
    .JAL .x0 (-20 : BitVec 21),
    .MV .x10 .x8,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.account_is_eip161_empty + 396) (GuestAddrs.account_is_eip161_empty + 272)),
    ...
    .LD .x6 .x5 (0 : BitVec 12),
    .LI .x7 (32 : Word),
    .BNE .x6 .x7 (brOff (GuestAddrs.account_is_eip161_empty + 404) (GuestAddrs.account_is_eip161_empty + 292)),
