/-
  Front long AfterSave → legacy 20B copy bare region (no contentDwords).
-/
...
theorem extractFrontAfterSaveCopy_then_epi_of_decode_long_legacy_region
...
#print axioms extractFrontAfterSaveCopy_then_epi_of_decode_long_legacy_region
