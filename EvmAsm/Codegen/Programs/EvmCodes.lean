...
def hasCodeOrNonceAtHeaderStateRoot_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .LI .x10 (4 : Word),
    .JAL .x0 (jalOff (GuestAddrs.has_code_or_nonce_at_header_state_root + 308) (GuestAddrs.has_code_or_nonce_at_header_state_root + 92)),
    .MV .x10 .x18,
    .LI .x11 (20 : Word),
    ...
    .JAL .x0 (jalOff (GuestAddrs.has_code_or_nonce_at_header_state_root + 308) (GuestAddrs.has_code_or_nonce_at_header_state_root + 148)),
    .LI .x10 (0 : Word),
    .JAL .x0 (jalOff (GuestAddrs.has_code_or_nonce_at_header_state_root + 308) (GuestAddrs.has_code_or_nonce_at_header_state_root + 156)),
    .LD .x6 .x21 (0 : BitVec 12),
    .BNE .x6 .x0 (brOff (GuestAddrs.has_code_or_nonce_at_header_state_root + 288) (GuestAddrs.has_code_or_nonce_at_header_state_root + 164)),
    ...
    .BNE .x6 .x7 (brOff (GuestAddrs.has_code_or_nonce_at_header_state_root + 288) (GuestAddrs.has_code_or_nonce_at_header_state_root + 184)),
    .LD .x6 .x5 (8 : BitVec 12),
    .LD .x7 .x21 (48 : BitVec 12),
    .BNE .x6 .x7 (brOff (GuestAddrs.has_code_or_nonce_at_header_state_root + 288) (GuestAddrs.has_code_or_nonce_at_header_state_root + 196)),
    .LD .x6 .x5 (16 : BitVec 12),
    .LD .x7 .x21 (56 : BitVec 12),
    .BNE .x6 .x7 (brOff (GuestAddrs.has_code_or_nonce_at_header_state_root + 288) (GuestAddrs.has_code_or_nonce_at_header_state_root + 208)),
    .LD .x6 .x5 (24 : BitVec 12),
    .LD .x7 .x21 (64 : BitVec 12),
    .BNE .x6 .x7 (brOff (GuestAddrs.has_code_or_nonce_at_header_state_root + 288) (GuestAddrs.has_code_or_nonce_at_header_state_root + 220)),
