/-
  Ambient dual: Front E2E long concrete t1 20B copy (regionBase/loadPtr).
-/
...
theorem extractFrontCopy_then_epi_of_decode_long_concrete_t1_region_ambient
  ...
  have hC := extractFrontAfterSaveCopy_then_epi_of_decode_long_t1_region_ambient sp0 spC s
...
#print axioms extractFrontCopy_then_epi_of_decode_long_concrete_t1_region_ambient
