/-
  Teer front auth walk_next cycle 0 under applied prest.
  E → AfterAuthWalkNext0Save via WalkInit2 applied + Auth CycleOk0.
-/
...
private abbrev nAuthWalkNext0CyclePub : Nat := 2 + (1 + 87) + 1 + 1
private abbrev nFrontToAuthWalkNext0Save : Nat :=
  nFrontToWalkInit2Save + nAuthWalkNext0CyclePub
...
/-- Auth cycle0 prest core (x21/x22 cursors). -/
def teerAuthWalkNext0BodyCore
    (listBase : Word) (bs : List (BitVec 8))
    (old1 v21 v22 a0Old a1Old a2Old : Word) : Assertion :=
  (.x1 ↦ᵣ old1) ** (.x21 ↦ᵣ v21) ** (.x22 ↦ᵣ v22) **
    (.x10 ↦ᵣ a0Old) ** (.x11 ↦ᵣ a1Old) ** (.x12 ↦ᵣ a2Old) **
    (.x0 ↦ᵣ (0 : Word)) ** bytesRegion listBase bs

def teerAuthWalkNext0BodyPost
...
theorem teerAuthWalkNext0CycleOk_ownTemps
    ...
    (hend : v22 = endPtr) :
    cpsTripleWithin nAuthWalkNext0CyclePub AfterWalkInit2Save AfterAuthWalkNext0Save
      teerLinkedEarly
      (teerAuthWalkNext0BodyCore listBase bs old1 v21 v22 a0Old a1Old a2Old **
        regOwn .x5 ** regOwn .x6 ** regOwn .x7 **
        regOwn .x28 ** regOwn .x29 ** regOwn .x30 ** regOwn .x31)
      (fun h => ∃ next len : Word,
        (teerAuthWalkNext0BodyPost listBase endPtr next len bs srcOff) h) := by
  have hcore (t0 t1 t2 t3 t4 t5 t6 : Word) :
      cpsTripleWithin nAuthWalkNext0CyclePub AfterWalkInit2Save AfterAuthWalkNext0Save
        ...
        (fun h => ∃ next len : Word,
          (teerAuthWalkNext0BodyPost listBase endPtr next len bs srcOff) h) := by
    have h0 := teerAuthWalkNext0CycleOk listBase endPtr a2Old t0 t1 t2 t3 t4 t5 t6
    ...
    refine cpsTripleWithin_weaken (fun s hp => ?_) (fun h hq => by
      ...
      exact ⟨next, len, by
        unfold teerAuthWalkNext0BodyPost
        exact hq'⟩) h0
...
/-- Ambient: no focus x1/x10-12/x21-22/x0/temps/blob. Keeps x24/x25 value cursors. -/
def teerAuthWalkNext0Ambient
...
private theorem pcFree_teerAuthWalkNext0Ambient
    (spC loadPtr lenW balPtr balLenW chainIdW
      s7 s11 spVal cursorV endWV : Word)
    (balBytes : List (BitVec 8)) (s : TeerSaved)
    (innerVal : Word) :
    (teerAuthWalkNext0Ambient spC loadPtr lenW balPtr balLenW chainIdW
      s7 s11 spVal cursorV endWV balBytes s innerVal).pcFree := by
  unfold teerAuthWalkNext0Ambient; pcf

def teerAuthWalkNext0Focus
    (listBase : Word) (bs : List (BitVec 8))
    (old1 v21 v22 a0Old a1Old a2Old : Word) : Assertion :=
  teerAuthWalkNext0BodyCore listBase bs old1 v21 v22 a0Old a1Old a2Old **
    regOwn .x5 ** regOwn .x6 ** regOwn .x7 **
...
theorem teerAfterWalkInit2SaveFlat_to_awn0Pre
    (spC loadPtr lenW balPtr balLenW chainIdW
      s7 s11 spVal regionBase cursorV endWV : Word)
    (bs balBytes : List (BitVec 8)) (s : TeerSaved)
    (innerVal : Word) (listOff srcOffA : Nat)
    ...
    let endL := (regionBase + BitVec.ofNat 64 listOff) + (lenW - innerVal)
    ∀ h,
      ((.x2 ↦ᵣ spC) **
        (.x1 ↦ᵣ LinkWalkInit2) **
        (.x8 ↦ᵣ loadPtr) ** (.x9 ↦ᵣ lenW) **
      ...
      (teerAuthWalkNext0Focus regionBase bs
          LinkWalkInit2 cur endL cur endL (0 : Word) **
        teerAuthWalkNext0Ambient spC loadPtr lenW balPtr balLenW chainIdW
          s7 s11 spVal cursorV endWV balBytes s innerVal) h := by
  intro cur endL _ hp
  unfold teerAuthWalkNext0Focus teerAuthWalkNext0BodyCore teerAuthWalkNext0Ambient
  xperm_hyp hp

def teerAuthWalkNext0PostNested
    (spC loadPtr lenW balPtr balLenW chainIdW
      s7 s11 spVal regionBase endL cursorV endWV : Word)
    (bs balBytes : List (BitVec 8)) (s : TeerSaved)
    (innerVal : Word) (srcOffA : Nat) : Assertion :=
  fun h => ∃ next len : Word,
    (teerAuthWalkNext0BodyPost regionBase endL next len bs srcOffA **
      teerAuthWalkNext0Ambient spC loadPtr lenW balPtr balLenW chainIdW
        s7 s11 spVal cursorV endWV balBytes s innerVal) h


set_option maxRecDepth 8000 in
theorem teerAuthWalkNext0_applied_nested
  ...
  have hcy := teerAuthWalkNext0CycleOk_ownTemps regionBase endL bs srcOffA
    LinkWalkInit2 cur endL cur endL (0 : Word)
    (by simpa using halign) hoffA hoverA hvalidA hssA hlsA hllA hdecA hinbA
    hcurA rfl
  have hcyF := cpsTripleWithin_frameR
    (teerAuthWalkNext0Ambient spC loadPtr lenW balPtr balLenW chainIdW
      s7 s11 spVal cursorV endW balBytes s innerVal)
    (by exact pcFree_teerAuthWalkNext0Ambient _ _ _ _ _ _ _ _ _ _ _ _ _ _) hcy
  have hcyF' :
      cpsTripleWithin nAuthWalkNext0CyclePub AfterWalkInit2Save AfterAuthWalkNext0Save
        teerLinkedEarly
        (teerAuthWalkNext0Focus regionBase bs
    ...
    refine cpsTripleWithin_weaken
      (fun _ hp => by
        unfold teerAuthWalkNext0Focus at hp
        xperm_hyp hp)
      (fun h hq => by
        unfold teerAuthWalkNext0PostNested
        obtain ⟨h1, h2, hd, hu, hEx, hA⟩ := hq
        obtain ⟨next, len0, hB⟩ := hEx
        exact ⟨next, len0, h1, h2, hd, hu, hB, hA⟩)
      hcyF
  have hsc := teerAfterWalkInit2SaveFlat_to_awn0Pre spC loadPtr lenW balPtr
    balLenW chainIdW s7 s11 spVal regionBase cursorV endW bs balBytes s innerVal
    listOff srcOffA hcurA
  have hseq := cpsTripleWithin_seq_perm_same_cr hsc hwi2 hcyF'
  exact cpsTripleWithin_mono_nSteps
    (by decide : nFrontToWalkInit2Save + nAuthWalkNext0CyclePub ≤ nFrontToAuthWalkNext0Save)
    hseq

set_option maxRecDepth 8000 in
theorem teerAuthWalkNext0_applied
    (ret spVal spC loadPtr lenW balPtr balLenW chainIdW baiW : Word)
    (s0 s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11 : Word)
    (regionBase : Word) (bs balBytes : List (BitVec 8)) (off len : Nat)
    (hspC : spC = spVal + signExtend12 (-160 : BitVec 12))
      ...
      (fun h => ∃ next len0 : Word,
        ((.x2 ↦ᵣ spC) **
          ...
          ⌜rlpItemDecode bs srcOffA (regionBase + BitVec.ofNat 64 srcOffA)
            endL next len0⌝) h) := by
  intro s innerVal listLen endL endW cursorV
  have h0 := teerAuthWalkNext0_applied_nested ret spVal spC loadPtr lenW
    balPtr balLenW chainIdW baiW s0 s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11
    regionBase bs balBytes off len hspC hnez hptr hlenW hsuccess htype4
    halign hbound hover hvalid0 listOff ha0 hoffL hoverL hvalidL hlenL
    h_ge h_hi h_exact srcOff0 hcur0 hoff0 hover0 hvalid0I hss0 hls0 hll0 hdec0 hinb0
  ...
  exact cpsTripleWithin_weaken (fun _ hp => hp)
    (fun h hq => by
      unfold teerAuthWalkNext0PostNested teerAuthWalkNext0BodyPost
        teerAuthWalkNext0Ambient at hq
      obtain ⟨next, len0, hq'⟩ := hq
      refine ⟨next, len0, ?_⟩
      xperm_hyp hq') h0

#print axioms teerAuthWalkNext0CycleOk_ownTemps
#print axioms teerAuthWalkNext0_applied


def teerAuthWalkNext0AmbientIs
    (spC loadPtr lenW balPtr balLenW chainIdW
      s7 s11 spVal cursorV endWV : Word)
    (balBytes : List (BitVec 8)) (s : TeerSaved)
    (innerVal : Word) : Assertion :=
...
private theorem pcFree_teerAuthWalkNext0AmbientIs
    (spC loadPtr lenW balPtr balLenW chainIdW
      s7 s11 spVal cursorV endWV : Word)
    (balBytes : List (BitVec 8)) (s : TeerSaved)
    (innerVal : Word) :
    (teerAuthWalkNext0AmbientIs spC loadPtr lenW balPtr balLenW chainIdW
      s7 s11 spVal cursorV endWV balBytes s innerVal).pcFree := by
  unfold teerAuthWalkNext0AmbientIs; pcf

theorem teerAfterWalkInit2SaveFlatIs_to_awn0Pre
    (spC loadPtr lenW balPtr balLenW chainIdW
      s7 s11 spVal regionBase cursorV endWV : Word)
    (bs balBytes : List (BitVec 8)) (s : TeerSaved)
    (innerVal : Word) (listOff srcOffA : Nat)
    ...
    ∀ h,
      ((.x2 ↦ᵣ spC) **
        ...
        memOwn RecipientPtrAddr ** memOwn RecipientLenAddr **
        memOwn ValueNonzeroAddr **
        teerScratchZeroIs ** teerScratchRestWithoutVnzOwn) h →
      (teerAuthWalkNext0Focus regionBase bs
          LinkWalkInit2 cur endL cur endL (0 : Word) **
        teerAuthWalkNext0AmbientIs spC loadPtr lenW balPtr balLenW chainIdW
          s7 s11 spVal cursorV endWV balBytes s innerVal) h := by
  intro cur endL _ hp
  unfold teerAuthWalkNext0Focus teerAuthWalkNext0BodyCore teerAuthWalkNext0AmbientIs
  xperm_hyp hp

def teerAuthWalkNext0PostNestedIs
    (spC loadPtr lenW balPtr balLenW chainIdW
      s7 s11 spVal regionBase endL cursorV endWV : Word)
    (bs balBytes : List (BitVec 8)) (s : TeerSaved)
    (innerVal : Word) (srcOffA : Nat) : Assertion :=
...
set_option maxRecDepth 8000 in
theorem teerAuthWalkNext0_applied_nested_is
    (ret spVal spC loadPtr lenW balPtr balLenW chainIdW baiW : Word)
    (s0 s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11 : Word)
    (regionBase : Word) (bs balBytes : List (BitVec 8)) (off len : Nat)
    (hspC : spC = spVal + signExtend12 (-160 : BitVec 12))
    ...
    cpsTripleWithin nFrontToAuthWalkNext0Save
      ...
      ((.x1 ↦ᵣ ret) ** (.x2 ↦ᵣ spVal) **
        ...
        regOwn .x16 ** regOwn .x28 ** regOwn .x29 ** regOwn .x30 **
        regOwn .x31 ** (.x0 ↦ᵣ (0 : Word)))
      (teerAuthWalkNext0PostNestedIs spC loadPtr lenW balPtr balLenW chainIdW
        s7 s11 spVal regionBase endL cursorV endW bs balBytes s innerVal srcOffA) := by
  intro s innerVal listLen endL endW cursorV
  let cur := (regionBase + BitVec.ofNat 64 listOff) + signExtend12 (1 : BitVec 12)
  have hwi2 := teerWalkInit2_applied_is ret spVal spC loadPtr lenW
    balPtr balLenW chainIdW baiW s0 s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11
    regionBase bs balBytes off len hspC hnez hptr hlenW hsuccess htype4
    halign hbound hover hvalid0 listOff ha0 hoffL hoverL hvalidL hlenL
    h_ge h_hi h_exact srcOff0 hcur0 hoff0 hover0 hvalid0I hss0 hls0 hll0 hdec0 hinb0
  ...
  have hcyF := cpsTripleWithin_frameR
    (teerAuthWalkNext0AmbientIs spC loadPtr lenW balPtr balLenW chainIdW
      s7 s11 spVal cursorV endW balBytes s innerVal)
    (by exact pcFree_teerAuthWalkNext0AmbientIs _ _ _ _ _ _ _ _ _ _ _ _ _ _) hcy
  have hcyF' :
      cpsTripleWithin nAuthWalkNext0CyclePub AfterWalkInit2Save AfterAuthWalkNext0Save
        teerLinkedEarly
        (teerAuthWalkNext0Focus regionBase bs
    ...
    refine cpsTripleWithin_weaken
      (fun _ hp => by
        ...
        xperm_hyp hp)
      (fun h hq => by
        unfold teerAuthWalkNext0PostNestedIs
        obtain ⟨h1, h2, hd, hu, hEx, hA⟩ := hq
        obtain ⟨next, len0, hB⟩ := hEx
        exact ⟨next, len0, h1, h2, hd, hu, hB, hA⟩)
      hcyF
  have hsc := teerAfterWalkInit2SaveFlatIs_to_awn0Pre spC loadPtr lenW balPtr
    balLenW chainIdW s7 s11 spVal regionBase cursorV endW bs balBytes s innerVal
    listOff srcOffA hcurA
  have hseq := cpsTripleWithin_seq_perm_same_cr hsc hwi2 hcyF'
  exact cpsTripleWithin_mono_nSteps
...
set_option maxRecDepth 8000 in
theorem teerAuthWalkNext0_applied_is
    (ret spVal spC loadPtr lenW balPtr balLenW chainIdW baiW : Word)
    (s0 s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11 : Word)
    (regionBase : Word) (bs balBytes : List (BitVec 8)) (off len : Nat)
    (hspC : spC = spVal + signExtend12 (-160 : BitVec 12))
      ...
      (fun h => ∃ next len0 : Word,
        ((.x2 ↦ᵣ spC) **
          ...
          ⌜rlpItemDecode bs srcOffA (regionBase + BitVec.ofNat 64 srcOffA)
            endL next len0⌝) h) := by
  intro s innerVal listLen endL endW cursorV
  have h0 := teerAuthWalkNext0_applied_nested_is ret spVal spC loadPtr lenW
    balPtr balLenW chainIdW baiW s0 s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11
    regionBase bs balBytes off len hspC hnez hptr hlenW hsuccess htype4
    halign hbound hover hvalid0 listOff ha0 hoffL hoverL hvalidL hlenL
    h_ge h_hi h_exact srcOff0 hcur0 hoff0 hover0 hvalid0I hss0 hls0 hll0 hdec0 hinb0
  ...
  exact cpsTripleWithin_weaken (fun _ hp => hp)
    (fun h hq => by
      unfold teerAuthWalkNext0PostNestedIs teerAuthWalkNext0BodyPost
        teerAuthWalkNext0AmbientIs at hq
      obtain ⟨next, len0, hq'⟩ := hq
      refine ⟨next, len0, ?_⟩
      xperm_hyp hq') h0
...
#print axioms teerAuthWalkNext0_applied_nested_is
#print axioms teerAuthWalkNext0_applied_is
