...
theorem cvbgumCall (hbi lenBase spC iW : Word) (Li : Nat)
  ...
  have hjal := jal_link_spec_within
    (EvmAsm.Codegen.jalOff GuestAddrs.rlp_field_to_u64_strict
      (ChainValidateOfflineAddrs.chain_validate_blob_gas_used_under_max + 124)) (D + 124) oldX1
  rw [show (D + 124) + signExtend21 (jalOff GuestAddrs.rlp_field_to_u64_strict
      (ChainValidateOfflineAddrs.chain_validate_blob_gas_used_under_max + 124)) = EvmAsm.Codegen.RlpFieldToU64StrictSAsm.B from by
    change BitVec.ofNat 64 ChainValidateOfflineAddrs.chain_validate_blob_gas_used_under_max + BitVec.ofNat 64 124 + _ =
      BitVec.ofNat 64 GuestAddrs.rlp_field_to_u64_strict
    exact jalOff_correct_add GuestAddrs.rlp_field_to_u64_strict ChainValidateOfflineAddrs.chain_validate_blob_gas_used_under_max 124
    ...
    (cpsTripleWithin_extend_code (cr' := cvbgumCode)
      (CodeReq.ofProg_mem_at D (D + 124) cvbgumProg 31
        (.JAL .x1 (EvmAsm.Codegen.jalOff GuestAddrs.rlp_field_to_u64_strict
          (ChainValidateOfflineAddrs.chain_validate_blob_gas_used_under_max + 124))) (by bv_omega)
...
theorem cvbgumIterDispatch
    ...
    (htail : (∀ j, j < i + 1 → hdrUnderMax hdrBase bigBytes lengths j) →
      cpsTripleWithin nTail (D + 68) raIn fullCode
        ...
        (cvbgumPost sp0 spC calleeNewSp hdrBase lenBase validPtr firstBadPtr csaved
          bigBytes lengths)) :
  ...
  refine cpsTripleWithin_weaken (fun h hp => ?hstrip) (fun _ hq => hq)
    (EvmAsm.Codegen.RlpListNthItemSAsm.cpsTripleWithin_exists_assertion (fun status =>
      EvmAsm.Codegen.RlpListNthItemSAsm.cpsTripleWithin_exists_assertion (fun value =>
        (show cpsTripleWithin (25 + nTail) (D + 128) raIn fullCode
          ((.x1 ↦ᵣ LinkRA) **
    ...
    case body =>
      ...
      · -- SUCCESS arm: `bne` not taken → reload → value compare.
        ...
        have hbne := bne_spec_gen_within .x10 .x0 (88 : BitVec 13) (0 : Word) (0 : Word)
          (D + 128)
        have hbneC := cpsBranchWithin_extend_code cvbgum_mono
          (cpsBranchWithin_extend_code (cr' := cvbgumCode)
            (CodeReq.ofProg_mem_at D (D + 128) cvbgumProg 32 (.BNE .x10 .x0 (88 : BitVec 13))
              (by bv_omega) (by rw [cvbgum_length]; decide) rfl
              (by rw [cvbgum_length]; decide)) hbne)
        ...
        have hcont : cpsTripleWithin (24 + nTail) (D + 132) raIn fullCode
            (((.x10 ↦ᵣ (0 : Word)) ** (.x0 ↦ᵣ (0 : Word))) ** RframeOk)
            (cvbgumPost sp0 spC (spC + signExtend12 (-32 : BitVec 12)) hdrBase lenBase
              validPtr firstBadPtr csaved bigBytes lengths) := by
          rw [hRframeOk]
          refine cpsTripleWithin_weaken (fun h hp => by xperm_hyp hp) (fun _ hq => hq)
            (show cpsTripleWithin (24 + nTail) (D + 132) raIn fullCode
          ...
          have hreload := cpsTripleWithin_extend_code cvbgum_mono
            (cvbgumReload (hdrBaseAt hdrBase lengths i) (BitVec.ofNat 64 i) value v5
          ...
          have hbltu := bltu_spec_gen_within .x7 .x6 (28 : BitVec 13) MaxBlobGas value (D + 172)
          rw [show (D + 172) + signExtend13 (28 : BitVec 13) = D + 200 from by
            rw [show signExtend13 (28 : BitVec 13) = (28 : Word) from by decide]; bv_omega] at hbltu
          have hbltuC := cpsBranchWithin_extend_code cvbgum_mono
            (cpsBranchWithin_extend_code (cr' := cvbgumCode)
              (CodeReq.ofProg_mem_at D (D + 172) cvbgumProg 43 (.BLTU .x7 .x6 (28 : BitVec 13))
                (by bv_omega) (by rw [cvbgum_length]; decide) rfl
                (by rw [cvbgum_length]; decide)) hbltu)
          ...
          have h_t : cpsTripleWithin (13 + nTail) (D + 200) raIn fullCode
              (((.x7 ↦ᵣ MaxBlobGas) ** (.x6 ↦ᵣ value) ** ⌜BitVec.ult MaxBlobGas value⌝) ** Rstate2)
              (cvbgumPost sp0 spC (spC + signExtend12 (-32 : BitVec 12)) hdrBase lenBase
                validPtr firstBadPtr csaved bigBytes lengths) := by
            rw [hRstate2, hRreload]
            refine cpsTripleWithin_weaken (fun h hp => by xperm_hyp hp) (fun _ hq => hq)
              (cpsTripleWithin_pure_pre (P := BitVec.ult MaxBlobGas value)
                (H := (.x7 ↦ᵣ MaxBlobGas) ** (.x6 ↦ᵣ value) ** (.x5 ↦ᵣ Field) **
                ...
                (fun hult => ?_))
            have hviol := cpsTripleWithin_extend_code cvbgum_mono
              (retViolation sp0 spC raIn (BitVec.ofNat 64 i) validPtr firstBadPtr csaved
                ((.x7 ↦ᵣ MaxBlobGas) ** (.x6 ↦ᵣ value) ** (.x5 ↦ᵣ Field) **
                  (IterPtr ↦ₘ hdrBaseAt hdrBase lengths i) ** (IterI ↦ₘ BitVec.ofNat 64 i) **
            ...
            have hp1 : ((.x5 ↦ᵣ Field) ** (.x6 ↦ᵣ value) ** (.x7 ↦ᵣ MaxBlobGas) **
                (.x28 ↦ᵣ v28) ** (.x29 ↦ᵣ v29) ** (.x30 ↦ᵣ v30) ** (.x31 ↦ᵣ v31) **
            ...
            have hp2 := sepConj_mono (regIs_implies_regOwn .x5) (sepConj_mono
              ...
              (fun _ x => x))))))))))) h hp1
            xperm_hyp hp2
          have h_f : cpsTripleWithin (13 + nTail) (D + 176) raIn fullCode
              (((.x7 ↦ᵣ MaxBlobGas) ** (.x6 ↦ᵣ value) ** ⌜¬ BitVec.ult MaxBlobGas value⌝) ** Rstate2)
              (cvbgumPost sp0 spC (spC + signExtend12 (-32 : BitVec 12)) hdrBase lenBase
                validPtr firstBadPtr csaved bigBytes lengths) := by
            rw [hRstate2, hRreload]
            refine cpsTripleWithin_weaken (fun h hp => by xperm_hyp hp) (fun _ hq => hq)
              (cpsTripleWithin_pure_pre (P := ¬ BitVec.ult MaxBlobGas value)
                (H := (.x7 ↦ᵣ MaxBlobGas) ** (.x6 ↦ᵣ value) ** (.x5 ↦ᵣ Field) **
                  ...
                  (.x28 ↦ᵣ v28) ** (.x29 ↦ᵣ v29) ** (.x30 ↦ᵣ v30) ** (.x31 ↦ᵣ v31))
                (fun hnult => ?_))
            have hprefix' : ∀ j, j < i + 1 → hdrUnderMax hdrBase bigBytes lengths j := by
              intro j hj
              rcases (by omega : j < i ∨ j = i) with hlt | heq
              · exact hprefix j hlt
              · subst heq; exact ⟨value, hResult, hnult⟩
            have hadv := cpsTripleWithin_extend_code cvbgum_mono
              (cvbgumAdvance (hdrBaseAt hdrBase lengths i) lenBase (BitVec.ofNat 64 i)
                lengths[i]! v28 v29)
      ...
      · -- PARSE-FAIL arm: `bne` taken → status ≠ 0 exit.
        have hbne := bne_spec_gen_within .x10 .x0 (88 : BitVec 13) status (0 : Word) (D + 128)
        have hbneC := cpsBranchWithin_extend_code cvbgum_mono
          (cpsBranchWithin_extend_code (cr' := cvbgumCode)
            (CodeReq.ofProg_mem_at D (D + 128) cvbgumProg 32 (.BNE .x10 .x0 (88 : BitVec 13))
              (by bv_omega) (by rw [cvbgum_length]; decide) rfl
        ...
        rw [show (D + 128) + signExtend13 (88 : BitVec 13) = D + 216 from by
          rw [show signExtend13 (88 : BitVec 13) = (88 : Word) from by decide]; bv_omega] at htaken
        ...
        have hpfC := cpsTripleWithin_extend_code cvbgum_mono
        ...
        refine cpsTripleWithin_weaken (fun h hp => by xperm_hyp hp) (fun h hq => ?_)
          (cpsTripleWithin_mono_nSteps (show 1 + 11 ≤ 25 + nTail by omega) hcompose)
