/-
  Ambient dual: Front short AfterSave → t1 20B copy bare region of_decode (typeW=1, 5 walks).
-/
...
theorem extractFrontAfterSaveCopy_then_epi_of_decode_short_t1_region_ambient
...
#print axioms extractFrontAfterSaveCopy_then_epi_of_decode_short_t1_region_ambient
