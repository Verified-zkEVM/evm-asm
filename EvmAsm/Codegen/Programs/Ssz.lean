...
public import EvmAsm.Stateless.SSZ.HashTreeRoot.Program
...
meta import EvmAsm.Stateless.SSZ.HashTreeRoot.Program
...
def sszMerkleize_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .MV .x9 .x12,
    .MV .x22 .x13,
    .BEQ .x8 .x0 (brOff (GuestAddrs.ssz_merkleize + 324) (GuestAddrs.ssz_merkleize + 52)),
    .LI .x5 (1 : Word),
    .LI .x20 (0 : Word),
    ...
    .BEQ .x20 .x9 (brOff (GuestAddrs.ssz_merkleize + 280) (GuestAddrs.ssz_merkleize + 184)),
    ...
    .ADDI .x20 .x20 (1 : BitVec 12),
    .JAL .x0 (jalOff (GuestAddrs.ssz_merkleize + 184) (GuestAddrs.ssz_merkleize + 276)),
...
def sszHashTreeRootListBytelist_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .MV .x19 .x13,
    .MV .x20 .x14,
    .BEQ .x9 .x0 (brOff (GuestAddrs.ssz_hash_tree_root_list_bytelist + 452) (GuestAddrs.ssz_hash_tree_root_list_bytelist + 56)),
    ...
    .BNE .x30 .x0 (brOff (GuestAddrs.ssz_hash_tree_root_list_bytelist + 552) (GuestAddrs.ssz_hash_tree_root_list_bytelist + 104)),
    .SRLI .x21 .x5 (2 : BitVec 6),
    .BEQ .x21 .x0 (brOff (GuestAddrs.ssz_hash_tree_root_list_bytelist + 552) (GuestAddrs.ssz_hash_tree_root_list_bytelist + 112)),
    .LUI .x30 (1 : BitVec 20),
    .BLTU .x30 .x21 (brOff (GuestAddrs.ssz_hash_tree_root_list_bytelist + 552) (GuestAddrs.ssz_hash_tree_root_list_bytelist + 120)),
    .BLTU .x9 .x5 (brOff (GuestAddrs.ssz_hash_tree_root_list_bytelist + 552) (GuestAddrs.ssz_hash_tree_root_list_bytelist + 124)),
    .LI .x22 (0 : Word),
    .BEQ .x22 .x21 (brOff (GuestAddrs.ssz_hash_tree_root_list_bytelist + 336) (GuestAddrs.ssz_hash_tree_root_list_bytelist + 132)),
    ...
    .BLTU .x7 .x28 (brOff (GuestAddrs.ssz_hash_tree_root_list_bytelist + 552) (GuestAddrs.ssz_hash_tree_root_list_bytelist + 188)),
    .BLTU .x9 .x7 (brOff (GuestAddrs.ssz_hash_tree_root_list_bytelist + 552) (GuestAddrs.ssz_hash_tree_root_list_bytelist + 192)),
    .ADD .x10 .x8 .x7,
    .ADDI .x28 .x22 (1 : BitVec 12),
    .BEQ .x28 .x21 (brOff (GuestAddrs.ssz_hash_tree_root_list_bytelist + 272) (GuestAddrs.ssz_hash_tree_root_list_bytelist + 204)),
    ...
    .SLLI .x30 .x30 (24 : BitVec 6),
    .OR .x29 .x29 .x30,
    .BLTU .x29 .x7 (brOff (GuestAddrs.ssz_hash_tree_root_list_bytelist + 552) (GuestAddrs.ssz_hash_tree_root_list_bytelist + 256)),
    .BLTU .x9 .x29 (brOff (GuestAddrs.ssz_hash_tree_root_list_bytelist + 552) (GuestAddrs.ssz_hash_tree_root_list_bytelist + 260)),
    .ADD .x29 .x8 .x29,
    .JAL .x0 (8 : BitVec 21),
    .ADD .x29 .x8 .x9,
    .SUB .x11 .x29 .x10,
    .LI .x6 (32 : Word),
    .SLL .x6 .x6 .x18,
    .BLTU .x6 .x11 (brOff (GuestAddrs.ssz_hash_tree_root_list_bytelist + 552) (GuestAddrs.ssz_hash_tree_root_list_bytelist + 288)),
    .LUI .x5 (512 : BitVec 20),
    .BLTU .x5 .x11 (brOff (GuestAddrs.ssz_hash_tree_root_list_bytelist + 552) (GuestAddrs.ssz_hash_tree_root_list_bytelist + 296)),
    .MV .x12 .x18,
    ...
    .BNE .x10 .x0 (brOff (GuestAddrs.ssz_hash_tree_root_list_bytelist + 552) (GuestAddrs.ssz_hash_tree_root_list_bytelist + 324)),
    .ADDI .x22 .x22 (1 : BitVec 12),
    .JAL .x0 (jalOff (GuestAddrs.ssz_hash_tree_root_list_bytelist + 132) (GuestAddrs.ssz_hash_tree_root_list_bytelist + 332)),
    ...
    .JAL .x0 (jalOff (GuestAddrs.ssz_hash_tree_root_list_bytelist + 544) (GuestAddrs.ssz_hash_tree_root_list_bytelist + 448)),
