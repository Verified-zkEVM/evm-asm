/-
  Wire pure honesty into short concrete Assumed creation for legacy (type=0):
...
/-- Short concrete Assumed creation legacy; pure-discharged honesty.
    Residual: hvalid*/hvalid1_*/hdec*. -/
theorem extractAssumed_creation_shortConcrete_pure_legacy
  ...
  have hhoff :=
    extractSuccess_creation_legacy_hoff_srcOff txBytes hsuccess hcreFlag htype0
      items hdecL hshort
  have hhover :=
    extractSuccess_creation_legacy_hover_srcOff txBytes txBase hsuccess hcreFlag htype0
      items hdecL hshort hover
  have hlenItems :=
    extractSuccess_creation_legacy_items_length txBytes hsuccess hcreFlag htype0
      items hdecL hshort
  ...
  have hfields02 :=
    extractSuccess_creation_legacy_hnext_fields02 txBytes hsuccess hcreFlag htype0
  ...
  have hhnext :=
    extractSuccess_creation_legacy_hnext_hcre_srcOff txBytes txBase hsuccess
      hcreFlag htype0 items hdecL hshort
  ...
  exact extractAssumed_creation_under_honesty_of_decode_short_concrete_legacy
    ...
    hdec2 hinb2
    hhoff.2.2.2 hhover.2.2.2 hvalid3 hss3
    (hls_vacuous_of_short_list_item txBytes listOff items 3 hencInner hshort hn3 hhoff.2.2.2)
    (hll_vacuous_of_short_list_item txBytes listOff items 3 hencInner hshort hn3 hhoff.2.2.2)
    hdec3 hinb3
...
set_option maxRecDepth 8000 in
theorem extractAssumed_creation_shortConcrete_pure_legacy_fullCode
    (sp0 spC : Word) (s : ExtractSaved)
    (txBase lenW toBuf isCreationPtr : Word)
    (txBytes : List (BitVec 8))
    (items : List EL.RLP.RLPItem)
  ...
  cpsTripleWithin_extend_code extractLinked_mono
    (extractAssumed_creation_shortConcrete_pure_legacy
...
#print axioms extractAssumed_creation_shortConcrete_pure_legacy
#print axioms extractAssumed_creation_shortConcrete_pure_legacy_fullCode
