...
def addressComputeCreate2_prog : Program :=
  [ .ADDI .x2 .x2 (-48 : BitVec 12),
    ...
    .ADD .x7 .x9 .x5,
    .LBU .x28 .x7 (0 : BitVec 12),
    .ADDI .x7 .x18 (21 : BitVec 12),
    .ADD .x7 .x7 .x5,
    .SB .x7 .x28 (0 : BitVec 12),
    .ADDI .x5 .x5 (1 : BitVec 12),
    .JAL .x0 (-32 : BitVec 21),
    .AUIPC .x6 (laHi GuestAddrs.ac2_inner_digest (GuestAddrs.address_compute_create2 + 156)),
    .ADDI .x6 .x6 (laLo GuestAddrs.ac2_inner_digest (GuestAddrs.address_compute_create2 + 156)),
    .LI .x5 (0 : Word),
    .LI .x28 (32 : Word),
    .BEQ .x5 .x28 (32 : BitVec 13),
    .ADD .x7 .x6 .x5,
    .LBU .x28 .x7 (0 : BitVec 12),
    .ADDI .x7 .x18 (53 : BitVec 12),
    .ADD .x7 .x7 .x5,
    .SB .x7 .x28 (0 : BitVec 12),
    .ADDI .x5 .x5 (1 : BitVec 12),
    .JAL .x0 (-32 : BitVec 21),
    .MV .x10 .x18,
    .LI .x11 (85 : Word),
    .AUIPC .x12 (laHi GuestAddrs.ac2_outer_digest (GuestAddrs.address_compute_create2 + 212)),
    .ADDI .x12 .x12 (laLo GuestAddrs.ac2_outer_digest (GuestAddrs.address_compute_create2 + 212)),
    .JAL .x1 (jalOff GuestAddrs.zkvm_keccak256 (GuestAddrs.address_compute_create2 + 220)),
    .AUIPC .x5 (laHi GuestAddrs.ac2_outer_digest (GuestAddrs.address_compute_create2 + 224)),
    .ADDI .x5 .x5 (laLo GuestAddrs.ac2_outer_digest (GuestAddrs.address_compute_create2 + 224)),
    .LI .x6 (0 : Word),
    .LI .x7 (20 : Word),
    .BEQ .x6 .x7 (32 : BitVec 13),
    .ADDI .x28 .x5 (12 : BitVec 12),
...
def addressComputeCreate2_relocs : RelocTable :=
  [ (12, .la .x12 "ac2_inner_digest"),
    ...
    (39, .la .x6 "ac2_inner_digest"),
    (53, .la .x12 "ac2_outer_digest"),
    (55, .jal .x1 "zkvm_keccak256"),
    (56, .la .x5 "ac2_outer_digest") ]
...
def addressComputeCreate_prog : Program :=
  [ .ADDI .x2 .x2 (-32 : BitVec 12),
    ...
    .LI .x7 (1 : Word),
    .JAL .x0 (jalOff (GuestAddrs.address_compute_create + 280) (GuestAddrs.address_compute_create + 108)),
    .LI .x6 (128 : Word),
    .SB .x5 .x6 (22 : BitVec 12),
    .LI .x7 (1 : Word),
    .JAL .x0 (jalOff (GuestAddrs.address_compute_create + 280) (GuestAddrs.address_compute_create + 124)),
    .AUIPC .x28 (laHi GuestAddrs.ac_nonce_be (GuestAddrs.address_compute_create + 128)),
    .ADDI .x28 .x28 (laLo GuestAddrs.ac_nonce_be (GuestAddrs.address_compute_create + 128)),
    ...
    .MV .x10 .x5,
    .AUIPC .x12 (laHi GuestAddrs.ac_digest (GuestAddrs.address_compute_create + 300)),
    .ADDI .x12 .x12 (laLo GuestAddrs.ac_digest (GuestAddrs.address_compute_create + 300)),
    .JAL .x1 (jalOff GuestAddrs.zkvm_keccak256 (GuestAddrs.address_compute_create + 308)),
    .AUIPC .x5 (laHi GuestAddrs.ac_digest (GuestAddrs.address_compute_create + 312)),
    .ADDI .x5 .x5 (laLo GuestAddrs.ac_digest (GuestAddrs.address_compute_create + 312)),
    .LI .x6 (0 : Word),
    .LI .x7 (20 : Word),
    .BEQ .x6 .x7 (32 : BitVec 13),
    .ADDI .x28 .x5 (12 : BitVec 12),
...
def addressComputeCreate_relocs : RelocTable :=
  [ (8, .la .x5 "ac_buffer"),
    (32, .la .x28 "ac_nonce_be"),
    (75, .la .x12 "ac_digest"),
    (77, .jal .x1 "zkvm_keccak256"),
    (78, .la .x5 "ac_digest") ]
