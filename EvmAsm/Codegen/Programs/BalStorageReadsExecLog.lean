...
def balStorageReadsInExecLog_prog : Program :=
  [ .ADDI .x2 .x2 (-64 : BitVec 12),
    ...
    .BNE .x12 .x0 (brOff (balStorageReadsInExecLogPc + 400) (balStorageReadsInExecLogPc + 64)),
    .MV .x22 .x11,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (balStorageReadsInExecLogPc + 72)),
    .BNE .x11 .x0 (brOff (balStorageReadsInExecLogPc + 400) (balStorageReadsInExecLogPc + 76)),
    .MV .x11 .x22,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (balStorageReadsInExecLogPc + 84)),
    .BNE .x11 .x0 (brOff (balStorageReadsInExecLogPc + 400) (balStorageReadsInExecLogPc + 88)),
    .MV .x11 .x22,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (balStorageReadsInExecLogPc + 96)),
    .BNE .x11 .x0 (brOff (balStorageReadsInExecLogPc + 400) (balStorageReadsInExecLogPc + 100)),
    .SUB .x10 .x10 .x12,
    .MV .x11 .x12,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_init (balStorageReadsInExecLogPc + 112)),
    .BNE .x12 .x0 (brOff (balStorageReadsInExecLogPc + 400) (balStorageReadsInExecLogPc + 116)),
    .MV .x19 .x10,
    .MV .x20 .x11,
    .BEQ .x19 .x20 (brOff (balStorageReadsInExecLogPc + 392) (balStorageReadsInExecLogPc + 128)),
    .MV .x10 .x19,
    .MV .x11 .x20,
    .JAL .x1 (jalOff GuestAddrs.rlp_walk_next (balStorageReadsInExecLogPc + 140)),
    .BNE .x11 .x0 (brOff (balStorageReadsInExecLogPc + 400) (balStorageReadsInExecLogPc + 144)),
    .MV .x19 .x10,
    .SUB .x6 .x10 .x12,
    .MV .x7 .x12,
    .LI .x5 (32 : Word),
    .BLTU .x5 .x7 (brOff (balStorageReadsInExecLogPc + 400) (balStorageReadsInExecLogPc + 164)),
    .BEQ .x7 .x0 (12 : BitVec 13),
    .LBU .x5 .x6 (0 : BitVec 12),
    .BEQ .x5 .x0 (brOff (balStorageReadsInExecLogPc + 400) (balStorageReadsInExecLogPc + 176)),
    ...
    .JAL .x0 (-24 : BitVec 21),
    .MV .x7 .x18,
    .BEQ .x7 .x0 (brOff (balStorageReadsInExecLogPc + 400) (balStorageReadsInExecLogPc + 252)),
    .MUL .x28 .x7 .x21,
    .ADD .x28 .x9 .x28,
    ...
    .BNE .x29 .x30 (brOff (balStorageReadsInExecLogPc + 376) (balStorageReadsInExecLogPc + 284)),
    .LD .x29 .x28 (8 : BitVec 12),
    .LD .x30 .x8 (8 : BitVec 12),
    .BNE .x29 .x30 (brOff (balStorageReadsInExecLogPc + 376) (balStorageReadsInExecLogPc + 296)),
    .LD .x29 .x28 (16 : BitVec 12),
    .LD .x30 .x8 (16 : BitVec 12),
    .BNE .x29 .x30 (brOff (balStorageReadsInExecLogPc + 376) (balStorageReadsInExecLogPc + 308)),
    ...
    .JAL .x0 (16 : BitVec 21),
    .MV .x29 .x9,
    .BNE .x28 .x29 (brOff (balStorageReadsInExecLogPc + 272) (balStorageReadsInExecLogPc + 380)),
    .JAL .x0 (16 : BitVec 21),
    .JAL .x0 (jalOff (balStorageReadsInExecLogPc + 128) (balStorageReadsInExecLogPc + 388)),
    .LI .x10 (0 : Word),
    .JAL .x0 (8 : BitVec 21),
    .LI .x10 (1 : Word),
