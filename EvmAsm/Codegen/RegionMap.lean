...
def callFrameArenaBase : Nat := 0xad3dd5a0
...
def evmMemoryPoolBase : Nat := 0xb37f65a0
...
theorem evmMemoryPoolRegion_matches_elf :
    evmMemoryPoolRegion.base = 0xb37f65a0
      ∧ evmMemoryPoolRegion.base + evmMemoryPoolRegion.size = 0xb97f65a0 := by decide
