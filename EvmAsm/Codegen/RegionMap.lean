...
-- Grew by a further `0xc` to `0x067498` for #10890: the creation-stage BAL
-- producer reads the running creator nonce rather than hard-coding nonce 1.
def textSizeBytes : Nat := 0x067498
