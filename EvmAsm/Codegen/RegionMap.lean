...
def bssSizeBytes : Nat := 0x1ac6c980
...
def callFrameArenaBase : Nat := 0xad3dd660
...
def evmMemoryPoolBase : Nat := 0xb37f6660
...
theorem evmMemoryPoolRegion_matches_elf :
    evmMemoryPoolRegion.base = 0xb37f6660
      ∧ evmMemoryPoolRegion.base + evmMemoryPoolRegion.size = 0xb97f6660 := by decide
