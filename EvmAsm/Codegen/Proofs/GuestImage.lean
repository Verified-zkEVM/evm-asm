...
theorem guestScratch_sat : ∀ input : SpecRef.Bytes,
  ...
  have t6 : (regionScratch RegionMap.dataRegion).SatWithin
    ...
    satWithin_ramRegion 0xa3000000 0x5370 (by omega) (by omega)
      (by omega) (by omega)
  -- REPIN THESE WHENEVER `RegionMap.bssSizeBytes` CHANGES.  `0x1b77b460` is that
  -- constant spelled as a literal (once, here) and `0xbf77b460` is `0xa4000000`
  ...
  have t7 : (regionScratch RegionMap.bssRegion).SatWithin
      0xa4000000 0xbf77b460 :=
    satWithin_ramRegion 0xa4000000 0x1b77b460 (by omega) (by omega)
      (by omega) (by omega)
  have t7' : (regionScratch RegionMap.bssRegion).SatWithin
      0xa3005370 0xbf77b460 :=
