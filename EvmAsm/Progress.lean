...
def registry : List OpcodeEntry := [
  ...
  entry "ADDMOD" .partly (some "evm_addmod_partial_domain_canonical_existential_regs_owned_stack_tail_spec_within")
