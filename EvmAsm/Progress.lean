...
def registry : List OpcodeEntry := [
  ...
  entry "ADDMOD" .partly (some "evm_addmod_zero_or_no_overflow_named_stack_spec_within")
      ("addmod_correct proven; zero-modulus stack spec done for arbitrary b; " ++
       ...
       "current partial theorem has named stack pre/post assertions"),
...
private noncomputable abbrev _addmod_witness     := @EvmAsm.Evm64.evm_addmod_zero_or_no_overflow_named_stack_spec_within
