...
def registry : List OpcodeEntry := [
  ...
  entry "EXP" .partly (some "evm_exp_headroom_all_regs_owned_leftover_live_stack_spec_within")
...
private noncomputable abbrev _exp_witness         := @EvmAsm.Evm64.evm_exp_headroom_all_regs_owned_leftover_live_stack_spec_within
