...
def registry : List OpcodeEntry := [
  ...
  entry "ADDMOD" .partly (some "evm_addmod_n0_semantic_stack_spec_within")
...
private noncomputable abbrev _addmod_witness     := @EvmAsm.Evm64.evm_addmod_n0_semantic_stack_spec_within
