...
theorem routineCount_eq : routineCount = 13 := by decide

theorem routineProvenCount_eq      : routineCountTier .proven      = 6 := by decide
...
theorem routineSymbols_eq : routineSymbols.length = 7 := by decide
