...
theorem routineCount_eq : routineCount = 88 := by decide

theorem routineProvenCount_eq      : routineCountTier .proven      = 62 := by decide
...
theorem routineSymbols_eq : routineSymbols.length = 69 := by decide
