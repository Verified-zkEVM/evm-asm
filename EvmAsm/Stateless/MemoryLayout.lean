/-
  ...
  0xa3000000 .. 0xbf600000   .data (`-Tdata=0xa3000000`; static tables,
  ...
  0xbf600000 .. 0xbfc80000   .sszscratch NOBITS merkleization scratch
  ```
...
def SSZ_SCRATCH_BASE        : Word := 0xbf600000
def SSZ_SCRATCH_SIZE        : Nat  := 0x00680000  -- 6.5 MiB (0xbf600000..0xbfc80000)
