/-
  ...
  `memIs` atoms for those 7 cells are lifted to `regOwn`/`memOwn`, so each
  digit's PRE matches the previous digit's POST. The remaining input registers
  (`x2/x5/x7/x10/x11`) stay `regIs` (they carry the threaded values, picked at
  composition time).

  Mirrors `divK_fastDigit_post_own_spec_within` (FastN1.lean): peel one owned
  atom at a time via `cpsTripleWithin_of_forall_regIs_to_regOwn` /
  `_memIs_to_memOwn`, reassociating between peels.
...
/-- Generic own-input digit lift: from the full digit lift (universally
    ...
    `memOwn`. -/
theorem divK_fastDigit_own_spec_within_v6
...
-- ============================================================================
-- The three concrete own-input digit lifts (digit2/1/0).
-- ============================================================================

theorem divK_fastDigit2_own_spec_within_v6
  ...
  divK_fastDigit_own_spec_within_v6 sp uHi uLo d base v6Digit2Off 4032 4040 4072
    ...
    (fun v6 v9 retMem dMem dloMem un0Mem scratchMem =>
      divK_fastDigit2_full_spec_within_v6 sp uHi uLo d base v2 v5 v6 v7 v9 v10 v11 qm
        retMem dMem dloMem un0Mem scratchMem halign)

theorem divK_fastDigit1_own_spec_within_v6
    (sp uHi uLo d base : Word) (v2 v5 v7 v10 v11 qm : Word)
  ...
  divK_fastDigit_own_spec_within_v6 sp uHi uLo d base v6Digit1Off 4040 4048 4080
    v2 v5 v7 v10 v11 qm
    (fun v6 v9 retMem dMem dloMem un0Mem scratchMem =>
      divK_fastDigit1_full_spec_within_v6 sp uHi uLo d base v2 v5 v6 v7 v9 v10 v11 qm
        retMem dMem dloMem un0Mem scratchMem halign)

theorem divK_fastDigit0_own_spec_within_v6
    (sp uHi uLo d base : Word) (v2 v5 v7 v10 v11 qm : Word)
  ...
  divK_fastDigit_own_spec_within_v6 sp uHi uLo d base v6Digit0Off 4048 4056 4088
    v2 v5 v7 v10 v11 qm
    (fun v6 v9 retMem dMem dloMem un0Mem scratchMem =>
      divK_fastDigit0_full_spec_within_v6 sp uHi uLo d base v2 v5 v6 v7 v9 v10 v11 qm
        retMem dMem dloMem un0Mem scratchMem halign)
