/-
  EvmAsm.Evm64.DivMod.Compose.V6FastArmTripleMod

  The v6 MOD fast-arm triple: a single `cpsTripleWithin` from the fast-path entry
  `v6ClzOff` to `modV6ExitOff` over `modCodeV6`, whose postcondition is
  `modStackDispatchPostV5 sp a b` — the shape the reused v5 arm produces, so both
  arms converge under `cpsBranchWithin_merge_same_cr`.

  MOD mirror of `Compose/V6FastArmTriple.lean` (DIV): by_cases on the shift
  `(clzResult b0).1`, apply the full MOD fast body (`modK_fastBody_{shift0,shiftNz}_spec_within_v6`,
  429/441 steps), frame the four extra scratch cells + `x1` the body omits, and
  weaken the raw canonical post to `modStackDispatchPostV5` via
  `fast_canonical_to_modDispatchPostV5_{shiftNz,shift0}`, lifting to the uniform
...
/-- **v6 MOD fast-arm triple.** From `v6ClzOff` to `modV6ExitOff` over `modCodeV6`,
    the n=1 fast path reduces `a = ⟨a0,a1,a2,a3⟩` mod `b = ⟨b0,0,0,0⟩` (b0 ≠ 0),
    landing `modStackDispatchPostV5 sp a b`. Covers both shift lanes. -/
theorem modK_fastBody_dispatchPostV5_within_v6
  ...
  · -- shift = 0 lane (429 steps)
    have hbody := modK_fastBody_shift0_spec_within_v6 sp b0 a0 a1 a2 a3 v6Old v7Old v2Old v10
    ...
    exact fast_canonical_to_modDispatchPostV5_shift0 sp a0 a1 a2 a3 b0 b1 b2 b3
      (base + v6Digit0Off + 16)
      (v6chainQ0 (0 : Word) a3 a2 a1 a0 (v6nD b0))
      ((v6chainR0 (0 : Word) a3 a2 a1 a0 (v6nD b0)) >>> (((clzResult b0).1).toNat % 64))
      ...
      ((v6chainR0 (0 : Word) a3 a2 a1 a0 (v6nD b0)) >>> (((clzResult b0).1).toNat % 64))
      (0 : Word) (0 : Word) (0 : Word) (0 : Word) u5 u6 u7 ((clzResult b0).1) (v6nD b0) jMem x1v
      hbnz hb1z hb2z hb3z hclz h (by xperm_hyp hq)
  · -- shift ≠ 0 lane (441 steps)
    have hbody := modK_fastBody_shiftNz_spec_within_v6 sp b0 a0 a1 a2 a3 v6Old v7Old v2Old v10
      v9d v11d qm3 qm2 qm1 qm0 m3992 m3984 retMem dMem dloMem un0Mem scratchMem m40 m48 m56
      u0Old u1Old u2Old u3Old u4Old base hclz halign3 halign2 halign1 halign0
    have hbodyf := cpsTripleWithin_frameR
      (((sp + signExtend12 4016) ↦ₘ u5) ** ((sp + signExtend12 4008) ↦ₘ u6) **
    ...
    rw [show (sp + 0 : Word) = sp from by bv_omega] at hq
    exact fast_canonical_to_modDispatchPostV5_shiftNz sp a0 a1 a2 a3 b0 b1 b2 b3
      (base + v6Digit0Off + 16)
      (v6chainQ0 (v6nU4 a3 b0) (v6nU3 a3 a2 b0) (v6nU2 a2 a1 b0) (v6nU1 a1 a0 b0) (v6nU0 a0 b0) (v6nD b0))
      ((v6chainR0 (v6nU4 a3 b0) (v6nU3 a3 a2 b0) (v6nU2 a2 a1 b0) (v6nU1 a1 a0 b0) (v6nU0 a0 b0) (v6nD b0)) >>> (((clzResult b0).1).toNat % 64))
      (0 : Word) (0 : Word) (0 : Word)
      (v6chainQ0 (v6nU4 a3 b0) (v6nU3 a3 a2 b0) (v6nU2 a2 a1 b0) (v6nU1 a1 a0 b0) (v6nU0 a0 b0) (v6nD b0))
