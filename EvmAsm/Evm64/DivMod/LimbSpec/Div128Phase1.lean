/-
  ...
  quotient halves):
    ...
    * `divK_div128_step1_init_spec` — 3-instruction block (DIVU, MUL,
      SUB) computing `q1 = uHi / d_hi` and `rhat = uHi - q1 * d_hi`.
...
/-- div128 Step 1: q1 = DIVU(uHi, d_hi), rhat = uHi - q1 * d_hi. -/
theorem divK_div128_step1_init_spec (uHi d_hi v5_old v10_old : Word) (base : Word) :
  ...
  intro q1 rhat cr
  have I0 := divu_spec_gen .x10 .x7 .x6 v10_old uHi d_hi base (by nofun)
  have I1 := mul_spec_gen .x5 .x10 .x6 v5_old q1 d_hi (base + 4) (by nofun)
  have I2 := sub_spec_gen_rd_eq_rs1 .x7 .x5 uHi (q1 * d_hi) (base + 8) (by nofun)
  runBlock I0 I1 I2
