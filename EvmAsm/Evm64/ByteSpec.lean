...
abbrev byte_body_jal_code (off : BitVec 12) (jal_off : BitVec 21) (base : Addr) : CodeReq :=
  CodeReq.union (CodeReq.singleton base (.LD .x5 .x12 off))
  (CodeReq.union (CodeReq.singleton (base + 4) (.SRL .x5 .x5 .x6))
  (CodeReq.union (CodeReq.singleton (base + 8) (.ANDI .x5 .x5 255))
   (CodeReq.singleton (base + 12) (.JAL .x0 jal_off))))
...
abbrev byte_store_code (jal_off : BitVec 21) (base : Addr) : CodeReq :=
  ...
  (CodeReq.union (CodeReq.singleton (base + 16) (.SD .x12 .x0 24))
