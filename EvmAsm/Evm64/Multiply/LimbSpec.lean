...
theorem mul_col3_spec (sp : Word) (base : Word)
    ...
    cpsTriple base (base + 20) code
      ((.x12 ↦ᵣ sp) ** (.x5 ↦ᵣ v5) ** (.x6 ↦ᵣ v6) ** (.x10 ↦ᵣ r3_in) **
       (sp ↦ₘ a0) ** ((sp + 56) ↦ₘ b3))
      ((.x12 ↦ᵣ sp) ** (.x5 ↦ᵣ b3) ** (.x6 ↦ᵣ a0 * b3) ** (.x10 ↦ᵣ r3_in + a0 * b3) **
       (sp ↦ₘ a0) ** ((sp + 56) ↦ₘ r3_in + a0 * b3)) :=
  (mul_col3_spec_within sp base a0 b3 r3_in v5 v6).to_cpsTriple
...
theorem mul_col2_spec (sp : Word) (base : Word)
  ...
  (mul_col2_spec_within sp base a0 a1 b2 r2_in r3p v5 v6 v7 v10).to_cpsTriple
...
theorem mul_col1_partA_spec (sp : Word) (base : Word)
  ...
  (mul_col1_partA_spec_within sp base a0 b1 r1_in r2_in v5 v6 v7).to_cpsTriple
...
theorem mul_col1_partB_spec (sp : Word) (base : Word)
  ...
  (mul_col1_partB_spec_within sp base a1 a2 b1 r3p0 v6 v7 carry_r2_1 r2_acc1).to_cpsTriple
...
theorem mul_col1_spec (sp : Word) (base : Word)
  ...
  (mul_col1_spec_within sp base a0 a1 a2 b1 r1_in r2_in r3p0 v5 v6 v7).to_cpsTriple
...
theorem mul_col0_partA_spec (sp : Word) (base : Word)
  ...
  (mul_col0_partA_spec_within sp base a0 a1 b0 v5 v6 v7 v10 v11).to_cpsTriple
...
theorem mul_col0_partB_spec (sp : Word) (base : Word)
  ...
  (mul_col0_partB_spec_within sp base a2 a3 b0 v6 v7 r2_partial).to_cpsTriple
...
theorem mul_col0_spec (sp : Word) (base : Word)
  ...
  (mul_col0_spec_within sp base a0 a1 a2 a3 b0 v5 v6 v7 v10 v11).to_cpsTriple
...
theorem evm_mul_cols01_spec (sp : Word) (base : Word)
  ...
  (evm_mul_cols01_spec_within sp base a0 a1 a2 a3 b0 b1 v5 v6 v7 v10 v11).to_cpsTriple
...
theorem evm_mul_cols23ep_spec (sp : Word) (base : Word)
  ...
  (evm_mul_cols23ep_spec_within sp base a0 a1 b2 b3 r2_in r3p_in v5 v6 v7 v10).to_cpsTriple
...
theorem evm_mul_spec (sp : Word) (base : Word)
  ...
  (evm_mul_spec_within sp base a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11).to_cpsTriple
