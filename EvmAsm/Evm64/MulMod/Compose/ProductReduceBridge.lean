/-
  ...
  window of eight limbs starting at `sp + 152` (each cell 8 bytes lower) with
  ...
  product `a * b`, laid out from `sp + 152` down to `sp + 96`.
-/
...
theorem limbChain_productLimb_eq (sp : Word) (a b : EvmWord) :
    limbChain (sp + signExtend12 (152 : BitVec 12)) (fun i => productLimb a b (7 - i)) 8
      = (((sp + signExtend12 (152 : BitVec 12)) ↦ₘ (EvmWord.mulHigh a b).getLimbN 3) **
         ...
         ((sp + signExtend12 (96 : BitVec 12)) ↦ₘ (a * b).getLimbN 0)) := by
  ...
  have e1 : sp + signExtend12 (152 : BitVec 12) + signExtend12 (0 : BitVec 12)
      = sp + signExtend12 (152 : BitVec 12) := by
    rw [BitVec.add_assoc]; congr 1
  have e2 : sp + signExtend12 (152 : BitVec 12) + signExtend12 (4088 : BitVec 12)
        + signExtend12 (0 : BitVec 12)
      = sp + signExtend12 (144 : BitVec 12) := by
    rw [BitVec.add_assoc, BitVec.add_assoc]; congr 1
  have e3 : sp + signExtend12 (152 : BitVec 12) + signExtend12 (4088 : BitVec 12)
        + signExtend12 (4088 : BitVec 12) + signExtend12 (0 : BitVec 12)
      = sp + signExtend12 (136 : BitVec 12) := by
    rw [BitVec.add_assoc, BitVec.add_assoc, BitVec.add_assoc]; congr 1
  have e4 : sp + signExtend12 (152 : BitVec 12) + signExtend12 (4088 : BitVec 12)
        + signExtend12 (4088 : BitVec 12) + signExtend12 (4088 : BitVec 12)
        + signExtend12 (0 : BitVec 12)
      = sp + signExtend12 (128 : BitVec 12) := by
    rw [BitVec.add_assoc, BitVec.add_assoc, BitVec.add_assoc, BitVec.add_assoc]; congr 1
  have e5 : sp + signExtend12 (152 : BitVec 12) + signExtend12 (4088 : BitVec 12)
        + signExtend12 (4088 : BitVec 12) + signExtend12 (4088 : BitVec 12)
        + signExtend12 (4088 : BitVec 12) + signExtend12 (0 : BitVec 12)
      = sp + signExtend12 (120 : BitVec 12) := by
    rw [BitVec.add_assoc, BitVec.add_assoc, BitVec.add_assoc, BitVec.add_assoc,
      BitVec.add_assoc]; congr 1
  have e6 : sp + signExtend12 (152 : BitVec 12) + signExtend12 (4088 : BitVec 12)
        + signExtend12 (4088 : BitVec 12) + signExtend12 (4088 : BitVec 12)
        + signExtend12 (4088 : BitVec 12) + signExtend12 (4088 : BitVec 12)
        + signExtend12 (0 : BitVec 12)
      = sp + signExtend12 (112 : BitVec 12) := by
    rw [BitVec.add_assoc, BitVec.add_assoc, BitVec.add_assoc, BitVec.add_assoc,
      BitVec.add_assoc, BitVec.add_assoc]; congr 1
  have e7 : sp + signExtend12 (152 : BitVec 12) + signExtend12 (4088 : BitVec 12)
        + signExtend12 (4088 : BitVec 12) + signExtend12 (4088 : BitVec 12)
        + signExtend12 (4088 : BitVec 12) + signExtend12 (4088 : BitVec 12)
        + signExtend12 (4088 : BitVec 12) + signExtend12 (0 : BitVec 12)
      = sp + signExtend12 (104 : BitVec 12) := by
    rw [BitVec.add_assoc, BitVec.add_assoc, BitVec.add_assoc, BitVec.add_assoc,
      BitVec.add_assoc, BitVec.add_assoc, BitVec.add_assoc]; congr 1
  have e8 : sp + signExtend12 (152 : BitVec 12) + signExtend12 (4088 : BitVec 12)
        + signExtend12 (4088 : BitVec 12) + signExtend12 (4088 : BitVec 12)
        + signExtend12 (4088 : BitVec 12) + signExtend12 (4088 : BitVec 12)
        + signExtend12 (4088 : BitVec 12) + signExtend12 (4088 : BitVec 12)
        + signExtend12 (0 : BitVec 12)
      = sp + signExtend12 (96 : BitVec 12) := by
    rw [BitVec.add_assoc, BitVec.add_assoc, BitVec.add_assoc, BitVec.add_assoc,
