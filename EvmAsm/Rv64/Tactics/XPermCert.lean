...
--
-- `Tactics.XPermCert` now lives in the riscv-zkvm dependency, prebuilt.
...
meta import RiscvZkvm.Rv64.Logic.Tactics.XPermCert
...
export RiscvZkvm.Rv64 (Tactics.tacticXperm_cert_ Tactics.tacticXperm_cert_eq)
