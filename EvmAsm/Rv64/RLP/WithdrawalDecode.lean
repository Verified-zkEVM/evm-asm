...
/-- **Fail path: short-list span mismatch** (`0xc0 ≤ prefix < 0xf8`, declared span ≠ input). prologue
    ⨾ walk_init (short-mismatch arm, a2=3) ⨾ status guard (rejects) ⨾ failReturn → capstone failure
    disjunct. Peels x5/x6/x7/x28/x29 for the walk_init call; prefix/span hyps from the dispatch. -/
theorem wd_decode_failSmism
    (base srcBase outPtr raVal sp0 s0Old s1Old s2Old : Word) (srcBytes : List Byte)
    (hbe : base &&& 1 = 0) (hbase : base.toNat + 1444 < 2 ^ 64)
    (hsalign : srcBase.toNat % 8 = 0) (hsrcLen0 : 0 < srcBytes.length)
    (hsrclt : srcBytes.length < 2 ^ 64) (hover0 : srcBase.toNat + 0 < 2 ^ 64)
    ...
    (h_ge : ¬ BitVec.ult ((srcBytes[0]'hsrcLen0).zeroExtend 64) (0xc0 : Word) = true)
    (h_hi : BitVec.ult ((srcBytes[0]'hsrcLen0).zeroExtend 64) (0xf8 : Word) = true)
    (h_smism : (srcBase + BitVec.ofNat 64 0) +
        (((srcBytes[0]'hsrcLen0).zeroExtend 64 - (0xc0 : Word)) + signExtend12 (1 : BitVec 12))
      ≠ (srcBase + BitVec.ofNat 64 0) + BitVec.ofNat 64 srcBytes.length)
    (hdec : decodeWithdrawal srcBytes = none) :
    cpsTripleWithin (6 + (15 + 8)) base (raVal &&& ~~~1) (withdrawal_decode_code base)
      ((.x10 ↦ᵣ srcBase) ** (.x11 ↦ᵣ BitVec.ofNat 64 srcBytes.length) ** (.x12 ↦ᵣ outPtr) **
        (.x1 ↦ᵣ raVal) ** (.x2 ↦ᵣ sp0) ** (.x8 ↦ᵣ s0Old) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) **
        (.x0 ↦ᵣ (0 : Word)) ** wd_scratchOwned ** regOwn .x13 ** regOwn .x14 ** regOwn .x15 **
        wd_frameOwned sp0 **
  ...
  refine cpsTripleWithin_seq_perm_same_cr (fun s hp => hp)
    (wd_decode_failPrologue base srcBase outPtr raVal sp0 s0Old s1Old s2Old srcBytes) ?_
  refine cpsTripleWithin_weaken (fun h hp => by unfold wd_scratchOwned at hp; xperm_hyp hp) (fun _ x => x)
    (cpsTripleWithin_of_forall_regIs_to_regOwn (P := (.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x1 ↦ᵣ raVal) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) ** (.x12 ↦ᵣ outPtr) ** ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 8) ↦ₘ s0Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 16) ↦ₘ s1Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 24) ↦ₘ s2Old) ** regOwn .x6 ** regOwn .x7 ** regOwn .x28 ** regOwn .x29 ** regOwn .x30 ** regOwn .x31 ** regOwn .x13 ** regOwn .x14 ** regOwn .x15 ** (.x10 ↦ᵣ srcBase) ** (.x11 ↦ᵣ BitVec.ofNat 64 srcBytes.length) ** (.x0 ↦ᵣ (0 : Word)) ** bytesRegion srcBase srcBytes ** bytesRegion outPtr (List.replicate 48 (0 : BitVec 8))) (r := .x5) (fun t0Old => ?_))
  refine cpsTripleWithin_weaken (fun h hp => by xperm_hyp hp) (fun _ x => x)
    (cpsTripleWithin_of_forall_regIs_to_regOwn (P := (.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x1 ↦ᵣ raVal) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) ** (.x12 ↦ᵣ outPtr) ** ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 8) ↦ₘ s0Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 16) ↦ₘ s1Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 24) ↦ₘ s2Old) ** (.x5 ↦ᵣ t0Old) ** regOwn .x7 ** regOwn .x28 ** regOwn .x29 ** regOwn .x30 ** regOwn .x31 ** regOwn .x13 ** regOwn .x14 ** regOwn .x15 ** (.x10 ↦ᵣ srcBase) ** (.x11 ↦ᵣ BitVec.ofNat 64 srcBytes.length) ** (.x0 ↦ᵣ (0 : Word)) ** bytesRegion srcBase srcBytes ** bytesRegion outPtr (List.replicate 48 (0 : BitVec 8))) (r := .x6) (fun t1Old => ?_))
  refine cpsTripleWithin_weaken (fun h hp => by xperm_hyp hp) (fun _ x => x)
    (cpsTripleWithin_of_forall_regIs_to_regOwn (P := (.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x1 ↦ᵣ raVal) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) ** (.x12 ↦ᵣ outPtr) ** ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 8) ↦ₘ s0Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 16) ↦ₘ s1Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 24) ↦ₘ s2Old) ** (.x5 ↦ᵣ t0Old) ** (.x6 ↦ᵣ t1Old) ** regOwn .x28 ** regOwn .x29 ** regOwn .x30 ** regOwn .x31 ** regOwn .x13 ** regOwn .x14 ** regOwn .x15 ** (.x10 ↦ᵣ srcBase) ** (.x11 ↦ᵣ BitVec.ofNat 64 srcBytes.length) ** (.x0 ↦ᵣ (0 : Word)) ** bytesRegion srcBase srcBytes ** bytesRegion outPtr (List.replicate 48 (0 : BitVec 8))) (r := .x7) (fun t2Old => ?_))
  refine cpsTripleWithin_weaken (fun h hp => by xperm_hyp hp) (fun _ x => x)
    (cpsTripleWithin_of_forall_regIs_to_regOwn (P := (.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x1 ↦ᵣ raVal) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) ** (.x12 ↦ᵣ outPtr) ** ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 8) ↦ₘ s0Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 16) ↦ₘ s1Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 24) ↦ₘ s2Old) ** (.x5 ↦ᵣ t0Old) ** (.x6 ↦ᵣ t1Old) ** (.x7 ↦ᵣ t2Old) ** regOwn .x29 ** regOwn .x30 ** regOwn .x31 ** regOwn .x13 ** regOwn .x14 ** regOwn .x15 ** (.x10 ↦ᵣ srcBase) ** (.x11 ↦ᵣ BitVec.ofNat 64 srcBytes.length) ** (.x0 ↦ᵣ (0 : Word)) ** bytesRegion srcBase srcBytes ** bytesRegion outPtr (List.replicate 48 (0 : BitVec 8))) (r := .x28) (fun t3Old => ?_))
  refine cpsTripleWithin_weaken (fun h hp => by xperm_hyp hp) (fun _ x => x)
    (cpsTripleWithin_of_forall_regIs_to_regOwn (P := (.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x1 ↦ᵣ raVal) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) ** (.x12 ↦ᵣ outPtr) ** ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 8) ↦ₘ s0Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 16) ↦ₘ s1Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 24) ↦ₘ s2Old) ** (.x5 ↦ᵣ t0Old) ** (.x6 ↦ᵣ t1Old) ** (.x7 ↦ᵣ t2Old) ** (.x28 ↦ᵣ t3Old) ** regOwn .x30 ** regOwn .x31 ** regOwn .x13 ** regOwn .x14 ** regOwn .x15 ** (.x10 ↦ᵣ srcBase) ** (.x11 ↦ᵣ BitVec.ofNat 64 srcBytes.length) ** (.x0 ↦ᵣ (0 : Word)) ** bytesRegion srcBase srcBytes ** bytesRegion outPtr (List.replicate 48 (0 : BitVec 8))) (r := .x29) (fun t4Old => ?_))
  have hcall0 := cpsTripleWithin_extend_code (wd_walkinit_code_sub base)
    (wd_call_walk_init_smism (base + 24) (base + 332) srcBase (BitVec.ofNat 64 srcBytes.length)
      outPtr t0Old t1Old t2Old t3Old t4Old raVal srcBytes 0 (308 : BitVec 21) hoffset halignC
      (wd_decode_disjoint_facts base hbase).1 hsalign hsrcLen0 hover0 hvalid0 hlen h_ge h_hi h_smism)
  rw [show base + 24 + 4 = base + 28 from by bv_omega] at hcall0
  have hcall := cpsTripleWithin_frameR
    ((.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ s1Old) **
      (.x18 ↦ᵣ s2Old) ** ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) **
      ...
      ((sp0 + signExtend12 (-32 : BitVec 12) + 16) ↦ₘ s1Old) **
      ((sp0 + signExtend12 (-32 : BitVec 12) + 24) ↦ₘ s2Old) **
      regOwn .x30 ** regOwn .x31 ** regOwn .x13 ** regOwn .x14 ** regOwn .x15 **
      bytesRegion outPtr (List.replicate 48 (0 : BitVec 8)))
    (by pcFree) hcall0
  exact cpsTripleWithin_weaken
    (fun h hp => by rw [show srcBase + BitVec.ofNat 64 0 = srcBase from by bv_omega]; xperm_hyp hp)
    ...
    (cpsTripleWithin_seq_perm_same_cr
      ...
      (wd_decode_walkInitFailArm base sp0 raVal s0Old s1Old s2Old outPtr outPtr srcBase srcBytes
        (srcBase + BitVec.ofNat 64 0)
        ((srcBase + BitVec.ofNat 64 0) + BitVec.ofNat 64 srcBytes.length) 3 True (by decide) hdec))

/-- **Call block: `rlp_walk_init`, long-header-truncated arm.** Uses the long-truncated leaf
    (`rlp_walk_init_ltrunc_spec_within`, 14 steps): a long-list header (`prefix ≥ 0xf8`) whose
    declared header doesn't fit the input → status `a2 = 4`. The reusable walk_init call for the
    long-truncated fail path (5 scratch registers). -/
theorem wd_call_walk_init_ltrunc
    (callerPC calleeEntry listBase listLen a2Old t0Old t1Old t2Old t3Old t4Old vOld : Word)
    (listBytes : List (BitVec 8)) (listOff : Nat) (offset : BitVec 21)
    (hoffset : callerPC + signExtend21 offset = calleeEntry)
    (halign : (callerPC + 4) &&& ~~~1 = callerPC + 4)
    ...
    cpsTripleWithin (1 + 14) callerPC (callerPC + 4)
      ...
      ((.x10 ↦ᵣ (listBase + BitVec.ofNat 64 listOff)) **
        ...
        regOwn .x5 ** regOwn .x6 ** regOwn .x7 ** regOwn .x28 ** regOwn .x29 **
        (.x0 ↦ᵣ (0 : Word)) ** (.x1 ↦ᵣ (callerPC + 4)) ** bytesRegion listBase listBytes) := by
  have hcallee := rlp_walk_init_ltrunc_spec_within calleeEntry listBase (callerPC + 4) listLen
    a2Old t0Old t1Old t2Old t3Old t4Old listBytes listOff hsalign hoff hover hvalid hlen h_ge h_ge_f8 h_trunc
  exact cpsCallWithin offset hoffset halign (by pcFree) hdisj
    (cpsTripleWithin_weaken (fun h hp => by xperm_hyp hp) (fun h hp => by xperm_hyp hp) hcallee)

/-- **Fail path: long-header truncated** (`prefix ≥ 0xf8`, header doesn't fit). prologue ⨾ walk_init
    (long-truncated arm, a2=4) ⨾ status guard (rejects) ⨾ failReturn → capstone failure disjunct.
    Peels x5/x6/x7/x28/x29 for the walk_init call; prefix/trunc hyps from the dispatch. -/
theorem wd_decode_failLtrunc
    (base srcBase outPtr raVal sp0 s0Old s1Old s2Old : Word) (srcBytes : List Byte)
    (hbe : base &&& 1 = 0) (hbase : base.toNat + 1444 < 2 ^ 64)
    (hsalign : srcBase.toNat % 8 = 0) (hsrcLen0 : 0 < srcBytes.length)
    (hsrclt : srcBytes.length < 2 ^ 64) (hover0 : srcBase.toNat + 0 < 2 ^ 64)
    ...
    (h_trunc : BitVec.ult ((srcBase + BitVec.ofNat 64 0) + BitVec.ofNat 64 srcBytes.length)
      ((srcBase + BitVec.ofNat 64 0) +
  ...
  refine cpsTripleWithin_weaken (fun h hp => by xperm_hyp hp) (fun _ x => x)
    (cpsTripleWithin_of_forall_regIs_to_regOwn (P := (.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x1 ↦ᵣ raVal) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) ** (.x12 ↦ᵣ outPtr) ** ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 8) ↦ₘ s0Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 16) ↦ₘ s1Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 24) ↦ₘ s2Old) ** (.x5 ↦ᵣ t0Old) ** (.x6 ↦ᵣ t1Old) ** (.x7 ↦ᵣ t2Old) ** (.x28 ↦ᵣ t3Old) ** regOwn .x30 ** regOwn .x31 ** regOwn .x13 ** regOwn .x14 ** regOwn .x15 ** (.x10 ↦ᵣ srcBase) ** (.x11 ↦ᵣ BitVec.ofNat 64 srcBytes.length) ** (.x0 ↦ᵣ (0 : Word)) ** bytesRegion srcBase srcBytes ** bytesRegion outPtr (List.replicate 48 (0 : BitVec 8))) (r := .x29) (fun t4Old => ?_))
  have hcall0 := cpsTripleWithin_extend_code (wd_walkinit_code_sub base)
    (wd_call_walk_init_ltrunc (base + 24) (base + 332) srcBase (BitVec.ofNat 64 srcBytes.length)
      outPtr t0Old t1Old t2Old t3Old t4Old raVal srcBytes 0 (308 : BitVec 21) hoffset halignC
      (wd_decode_disjoint_facts base hbase).1 hsalign hsrcLen0 hover0 hvalid0 hlen h_ge h_ge_f8 h_trunc)
  rw [show base + 24 + 4 = base + 28 from by bv_omega] at hcall0
  have hcall := cpsTripleWithin_frameR
    ((.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ s1Old) **
      (.x18 ↦ᵣ s2Old) ** ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) **
  ...
  exact cpsTripleWithin_weaken
    ...
    (cpsTripleWithin_seq_perm_same_cr
      ...
      (wd_decode_walkInitFailArm base sp0 raVal s0Old s1Old s2Old outPtr outPtr srcBase srcBytes
        (srcBase + BitVec.ofNat 64 0)
        ((srcBase + BitVec.ofNat 64 0) + BitVec.ofNat 64 srcBytes.length) 4 True (by decide) hdec))

/-- **Call block: `rlp_walk_init`, long-leading-zero arm.** Uses the long-leading-zero leaf
    (`rlp_walk_init_llz_spec_within`, 17 steps): a long-list header (`prefix ≥ 0xf8`) whose first
    length byte is zero (non-minimal) → status `a2 = 5`. Reusable walk_init call (6 scratch regs). -/
theorem wd_call_walk_init_llz
    (callerPC calleeEntry listBase listLen a2Old t0Old t1Old t2Old t3Old t4Old t5Old vOld : Word)
    (listBytes : List (BitVec 8)) (listOff : Nat) (offset : BitVec 21)
    (hoffset : callerPC + signExtend21 offset = calleeEntry)
    (halign : (callerPC + 4) &&& ~~~1 = callerPC + 4)
    (hdisj : (CodeReq.singleton callerPC (.JAL .x1 offset)).Disjoint
    ...
    cpsTripleWithin (1 + 17) callerPC (callerPC + 4)
      ((CodeReq.singleton callerPC (.JAL .x1 offset)).union (rlp_walk_init_code calleeEntry))
      ((.x1 ↦ᵣ vOld) **
        ((.x10 ↦ᵣ (listBase + BitVec.ofNat 64 listOff)) ** (.x11 ↦ᵣ listLen) ** (.x12 ↦ᵣ a2Old) **
         (.x5 ↦ᵣ t0Old) ** (.x6 ↦ᵣ t1Old) ** (.x7 ↦ᵣ t2Old) ** (.x28 ↦ᵣ t3Old) **
         (.x29 ↦ᵣ t4Old) ** (.x30 ↦ᵣ t5Old) ** (.x0 ↦ᵣ (0 : Word)) ** bytesRegion listBase listBytes))
      ((.x10 ↦ᵣ (listBase + BitVec.ofNat 64 listOff)) **
        (.x11 ↦ᵣ ((listBase + BitVec.ofNat 64 listOff) + listLen)) ** (.x12 ↦ᵣ (5 : Word)) **
        regOwn .x5 ** regOwn .x6 ** regOwn .x7 ** regOwn .x28 ** regOwn .x29 ** regOwn .x30 **
        (.x0 ↦ᵣ (0 : Word)) ** (.x1 ↦ᵣ (callerPC + 4)) ** bytesRegion listBase listBytes) := by
  have hcallee := rlp_walk_init_llz_spec_within calleeEntry listBase (callerPC + 4) listLen
    a2Old t0Old t1Old t2Old t3Old t4Old t5Old listBytes listOff hsalign hoff hover hvalid hlen
    h_ge h_ge_f8 hoff1 hover1 hvalid1 h_fits h_llz
  exact cpsCallWithin offset hoffset halign (by pcFree) hdisj
    (cpsTripleWithin_weaken (fun h hp => by xperm_hyp hp) (fun h hp => by xperm_hyp hp) hcallee)

/-- **Fail path: long-header leading-zero length byte** (`prefix ≥ 0xf8`, first length byte 0).
    prologue ⨾ walk_init (long-leading-zero arm, a2=5) ⨾ status guard (rejects) ⨾ failReturn →
    capstone failure disjunct. Peels x5/x6/x7/x28/x29/x30 for the walk_init call. -/
theorem wd_decode_failLlz
    (base srcBase outPtr raVal sp0 s0Old s1Old s2Old : Word) (srcBytes : List Byte)
    (hbe : base &&& 1 = 0) (hbase : base.toNat + 1444 < 2 ^ 64)
    (hsalign : srcBase.toNat % 8 = 0) (hsrcLen0 : 0 < srcBytes.length)
    (hsrclt : srcBytes.length < 2 ^ 64) (hover0 : srcBase.toNat + 0 < 2 ^ 64)
    ...
    (h_ge : ¬ BitVec.ult ((srcBytes[0]'hsrcLen0).zeroExtend 64) (0xc0 : Word) = true)
    (h_ge_f8 : ¬ BitVec.ult ((srcBytes[0]'hsrcLen0).zeroExtend 64) (0xf8 : Word) = true)
    (hoff1 : 0 + 1 < srcBytes.length) (hover1 : srcBase.toNat + (0 + 1) < 2 ^ 64)
    (hvalid1 : isValidByteAccess (srcBase + BitVec.ofNat 64 (0 + 1)) = true)
    (h_fits : ¬ BitVec.ult ((srcBase + BitVec.ofNat 64 0) + BitVec.ofNat 64 srcBytes.length)
      ((srcBase + BitVec.ofNat 64 0) +
        (((srcBytes[0]'hsrcLen0).zeroExtend 64 - (0xf7 : Word)) + signExtend12 (1 : BitVec 12)))
      = true)
    (h_llz : (srcBytes[0 + 1]'hoff1).zeroExtend 64 = (0 : Word))
    (hdec : decodeWithdrawal srcBytes = none) :
    cpsTripleWithin (6 + (18 + 8)) base (raVal &&& ~~~1) (withdrawal_decode_code base)
      ((.x10 ↦ᵣ srcBase) ** (.x11 ↦ᵣ BitVec.ofNat 64 srcBytes.length) ** (.x12 ↦ᵣ outPtr) **
        (.x1 ↦ᵣ raVal) ** (.x2 ↦ᵣ sp0) ** (.x8 ↦ᵣ s0Old) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) **
        (.x0 ↦ᵣ (0 : Word)) ** wd_scratchOwned ** regOwn .x13 ** regOwn .x14 ** regOwn .x15 **
        wd_frameOwned sp0 **
  ...
  refine cpsTripleWithin_weaken (fun h hp => by xperm_hyp hp) (fun _ x => x)
    (cpsTripleWithin_of_forall_regIs_to_regOwn (P := (.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x1 ↦ᵣ raVal) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) ** (.x12 ↦ᵣ outPtr) ** ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 8) ↦ₘ s0Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 16) ↦ₘ s1Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 24) ↦ₘ s2Old) ** (.x5 ↦ᵣ t0Old) ** (.x6 ↦ᵣ t1Old) ** (.x7 ↦ᵣ t2Old) ** (.x28 ↦ᵣ t3Old) ** regOwn .x30 ** regOwn .x31 ** regOwn .x13 ** regOwn .x14 ** regOwn .x15 ** (.x10 ↦ᵣ srcBase) ** (.x11 ↦ᵣ BitVec.ofNat 64 srcBytes.length) ** (.x0 ↦ᵣ (0 : Word)) ** bytesRegion srcBase srcBytes ** bytesRegion outPtr (List.replicate 48 (0 : BitVec 8))) (r := .x29) (fun t4Old => ?_))
  refine cpsTripleWithin_weaken (fun h hp => by xperm_hyp hp) (fun _ x => x)
    (cpsTripleWithin_of_forall_regIs_to_regOwn (P := (.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x1 ↦ᵣ raVal) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) ** (.x12 ↦ᵣ outPtr) ** ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 8) ↦ₘ s0Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 16) ↦ₘ s1Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 24) ↦ₘ s2Old) ** (.x5 ↦ᵣ t0Old) ** (.x6 ↦ᵣ t1Old) ** (.x7 ↦ᵣ t2Old) ** (.x28 ↦ᵣ t3Old) ** (.x29 ↦ᵣ t4Old) ** regOwn .x31 ** regOwn .x13 ** regOwn .x14 ** regOwn .x15 ** (.x10 ↦ᵣ srcBase) ** (.x11 ↦ᵣ BitVec.ofNat 64 srcBytes.length) ** (.x0 ↦ᵣ (0 : Word)) ** bytesRegion srcBase srcBytes ** bytesRegion outPtr (List.replicate 48 (0 : BitVec 8))) (r := .x30) (fun t5Old => ?_))
  have hcall0 := cpsTripleWithin_extend_code (wd_walkinit_code_sub base)
    (wd_call_walk_init_llz (base + 24) (base + 332) srcBase (BitVec.ofNat 64 srcBytes.length)
      outPtr t0Old t1Old t2Old t3Old t4Old t5Old raVal srcBytes 0 (308 : BitVec 21) hoffset halignC
      (wd_decode_disjoint_facts base hbase).1 hsalign hsrcLen0 hover0 hvalid0 hlen h_ge h_ge_f8
      hoff1 hover1 hvalid1 h_fits h_llz)
  rw [show base + 24 + 4 = base + 28 from by bv_omega] at hcall0
  have hcall := cpsTripleWithin_frameR
    ((.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ s1Old) **
      (.x18 ↦ᵣ s2Old) ** ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) **
  ...
  exact cpsTripleWithin_weaken
    ...
    (cpsTripleWithin_seq_perm_same_cr
      ...
      (wd_decode_walkInitFailArm base sp0 raVal s0Old s1Old s2Old outPtr outPtr srcBase srcBytes
        (srcBase + BitVec.ofNat 64 0)
        ((srcBase + BitVec.ofNat 64 0) + BitVec.ofNat 64 srcBytes.length) 5 True (by decide) hdec))

/-- **Call block: `rlp_walk_init`, long-non-minimal arm.** Uses the long-non-minimal leaf
    (`rlp_walk_init_lmin_spec_within`): a long-list header whose decoded length `< 56` (should have
    been short-encoded) → status `a2 = 6`. The variable spec bound `7·lol+22` (lol = length-of-length
    `∈ [1,8]`) is bumped to the concrete `78`. Reusable walk_init call (all 7 scratch registers). -/
theorem wd_call_walk_init_lmin
    (callerPC calleeEntry listBase listLen a2Old t0Old t1Old t2Old t3Old t4Old t5Old t6Old vOld : Word)
    (listBytes : List (BitVec 8)) (listOff : Nat) (offset : BitVec 21)
    (hoffset : callerPC + signExtend21 offset = calleeEntry)
    (halign : (callerPC + 4) &&& ~~~1 = callerPC + 4)
    ...
    (h_lmin : BitVec.ult (BitVec.ofNat 64 (Nat.fromBytesBE ((listBytes.drop (listOff + 1)).take
      ((listBytes[listOff]'hoff).zeroExtend 64 - (0xf7 : Word)).toNat))) (56 : Word) = true) :
    cpsTripleWithin (1 + 78) callerPC (callerPC + 4)
      ((CodeReq.singleton callerPC (.JAL .x1 offset)).union (rlp_walk_init_code calleeEntry))
      ((.x1 ↦ᵣ vOld) **
        ((.x10 ↦ᵣ (listBase + BitVec.ofNat 64 listOff)) ** (.x11 ↦ᵣ listLen) ** (.x12 ↦ᵣ a2Old) **
         (.x5 ↦ᵣ t0Old) ** (.x6 ↦ᵣ t1Old) ** (.x7 ↦ᵣ t2Old) ** (.x28 ↦ᵣ t3Old) **
      ...
      ((.x10 ↦ᵣ (listBase + BitVec.ofNat 64 listOff)) **
        ...
        regOwn .x31 ** (.x0 ↦ᵣ (0 : Word)) ** (.x1 ↦ᵣ (callerPC + 4)) **
        bytesRegion listBase listBytes) := by
  have hbound : 7 * ((listBytes[listOff]'hoff).zeroExtend 64 - (0xf7 : Word)).toNat + 22 ≤ 78 := by
  ...
  have hcallee := cpsTripleWithin_mono_nSteps hbound
    (rlp_walk_init_lmin_spec_within calleeEntry listBase (callerPC + 4) listLen a2Old
      t0Old t1Old t2Old t3Old t4Old t5Old t6Old listBytes listOff hsalign hoff hover hvalid hlen
      h_ge h_ge_f8 hllen hlover hlvalid hoff1 h_fits h_llz_ne h_lmin)
  exact cpsCallWithin offset hoffset halign (by pcFree) hdisj
    (cpsTripleWithin_weaken (fun h hp => by xperm_hyp hp) (fun h hp => by xperm_hyp hp) hcallee)

/-- **Fail path: long-header non-minimal length** (`prefix ≥ 0xf8`, decoded length < 56). prologue ⨾
    walk_init (long-non-minimal arm, a2=6) ⨾ status guard (rejects) ⨾ failReturn → capstone failure
    disjunct. Peels all 7 scratch registers for the walk_init call. -/
theorem wd_decode_failLmin
    (base srcBase outPtr raVal sp0 s0Old s1Old s2Old : Word) (srcBytes : List Byte)
    (hbe : base &&& 1 = 0) (hbase : base.toNat + 1444 < 2 ^ 64)
    (hsalign : srcBase.toNat % 8 = 0) (hsrcLen0 : 0 < srcBytes.length)
    (hsrclt : srcBytes.length < 2 ^ 64) (hover0 : srcBase.toNat + 0 < 2 ^ 64)
    ...
    (h_ge : ¬ BitVec.ult ((srcBytes[0]'hsrcLen0).zeroExtend 64) (0xc0 : Word) = true)
    (h_ge_f8 : ¬ BitVec.ult ((srcBytes[0]'hsrcLen0).zeroExtend 64) (0xf8 : Word) = true)
    (hllen : 0 + 1 + ((srcBytes[0]'hsrcLen0).zeroExtend 64 - (0xf7 : Word)).toNat ≤ srcBytes.length)
    (hlover : srcBase.toNat + (0 + 1 +
      ((srcBytes[0]'hsrcLen0).zeroExtend 64 - (0xf7 : Word)).toNat) ≤ 2 ^ 64)
    (hlvalid : ∀ k, k < ((srcBytes[0]'hsrcLen0).zeroExtend 64 - (0xf7 : Word)).toNat →
      isValidByteAccess (srcBase + BitVec.ofNat 64 (0 + 1 + k)) = true)
    (hoff1 : 0 + 1 < srcBytes.length)
    (h_fits : ¬ BitVec.ult ((srcBase + BitVec.ofNat 64 0) + BitVec.ofNat 64 srcBytes.length)
      ((srcBase + BitVec.ofNat 64 0) +
        (((srcBytes[0]'hsrcLen0).zeroExtend 64 - (0xf7 : Word)) + signExtend12 (1 : BitVec 12)))
      = true)
    (h_llz_ne : (srcBytes[0 + 1]'hoff1).zeroExtend 64 ≠ (0 : Word))
    (h_lmin : BitVec.ult (BitVec.ofNat 64 (Nat.fromBytesBE ((srcBytes.drop (0 + 1)).take
      ((srcBytes[0]'hsrcLen0).zeroExtend 64 - (0xf7 : Word)).toNat))) (56 : Word) = true)
    (hdec : decodeWithdrawal srcBytes = none) :
    cpsTripleWithin (6 + (79 + 8)) base (raVal &&& ~~~1) (withdrawal_decode_code base)
      ((.x10 ↦ᵣ srcBase) ** (.x11 ↦ᵣ BitVec.ofNat 64 srcBytes.length) ** (.x12 ↦ᵣ outPtr) **
        (.x1 ↦ᵣ raVal) ** (.x2 ↦ᵣ sp0) ** (.x8 ↦ᵣ s0Old) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) **
        (.x0 ↦ᵣ (0 : Word)) ** wd_scratchOwned ** regOwn .x13 ** regOwn .x14 ** regOwn .x15 **
        wd_frameOwned sp0 **
  ...
  refine cpsTripleWithin_weaken (fun h hp => by xperm_hyp hp) (fun _ x => x)
    (cpsTripleWithin_of_forall_regIs_to_regOwn (P := (.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x1 ↦ᵣ raVal) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) ** (.x12 ↦ᵣ outPtr) ** ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 8) ↦ₘ s0Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 16) ↦ₘ s1Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 24) ↦ₘ s2Old) ** (.x5 ↦ᵣ t0Old) ** (.x6 ↦ᵣ t1Old) ** (.x7 ↦ᵣ t2Old) ** (.x28 ↦ᵣ t3Old) ** (.x29 ↦ᵣ t4Old) ** regOwn .x31 ** regOwn .x13 ** regOwn .x14 ** regOwn .x15 ** (.x10 ↦ᵣ srcBase) ** (.x11 ↦ᵣ BitVec.ofNat 64 srcBytes.length) ** (.x0 ↦ᵣ (0 : Word)) ** bytesRegion srcBase srcBytes ** bytesRegion outPtr (List.replicate 48 (0 : BitVec 8))) (r := .x30) (fun t5Old => ?_))
  refine cpsTripleWithin_weaken (fun h hp => by xperm_hyp hp) (fun _ x => x)
    (cpsTripleWithin_of_forall_regIs_to_regOwn (P := (.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x1 ↦ᵣ raVal) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) ** (.x12 ↦ᵣ outPtr) ** ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 8) ↦ₘ s0Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 16) ↦ₘ s1Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 24) ↦ₘ s2Old) ** (.x5 ↦ᵣ t0Old) ** (.x6 ↦ᵣ t1Old) ** (.x7 ↦ᵣ t2Old) ** (.x28 ↦ᵣ t3Old) ** (.x29 ↦ᵣ t4Old) ** (.x30 ↦ᵣ t5Old) ** regOwn .x13 ** regOwn .x14 ** regOwn .x15 ** (.x10 ↦ᵣ srcBase) ** (.x11 ↦ᵣ BitVec.ofNat 64 srcBytes.length) ** (.x0 ↦ᵣ (0 : Word)) ** bytesRegion srcBase srcBytes ** bytesRegion outPtr (List.replicate 48 (0 : BitVec 8))) (r := .x31) (fun t6Old => ?_))
  have hcall0 := cpsTripleWithin_extend_code (wd_walkinit_code_sub base)
    (wd_call_walk_init_lmin (base + 24) (base + 332) srcBase (BitVec.ofNat 64 srcBytes.length)
      outPtr t0Old t1Old t2Old t3Old t4Old t5Old t6Old raVal srcBytes 0 (308 : BitVec 21) hoffset
      halignC (wd_decode_disjoint_facts base hbase).1 hsalign hsrcLen0 hover0 hvalid0 hlen h_ge h_ge_f8
      hllen hlover hlvalid hoff1 h_fits h_llz_ne h_lmin)
  rw [show base + 24 + 4 = base + 28 from by bv_omega] at hcall0
  have hcall := cpsTripleWithin_frameR
    ((.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ s1Old) **
      (.x18 ↦ᵣ s2Old) ** ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) **
...
/-- **Fail path: long-header span mismatch** (`prefix ≥ 0xf8`, decoded length ≥ 56, span ≠ input).
    prologue ⨾ walk_init (long-mismatch arm, a2=7) ⨾ status guard (rejects) ⨾ failReturn → capstone
    failure disjunct. Peels all 7 scratch registers. -/
theorem wd_decode_failLmism
    (base srcBase outPtr raVal sp0 s0Old s1Old s2Old : Word) (srcBytes : List Byte)
    (hbe : base &&& 1 = 0) (hbase : base.toNat + 1444 < 2 ^ 64)
    (hsalign : srcBase.toNat % 8 = 0) (hsrcLen0 : 0 < srcBytes.length)
    (hsrclt : srcBytes.length < 2 ^ 64) (hover0 : srcBase.toNat + 0 < 2 ^ 64)
    ...
    (h_fits : ¬ BitVec.ult ((srcBase + BitVec.ofNat 64 0) + BitVec.ofNat 64 srcBytes.length)
      ...
      = true)
    (h_llz_ne : (srcBytes[0 + 1]'hoff1).zeroExtend 64 ≠ (0 : Word))
    (h_min : ¬ BitVec.ult (BitVec.ofNat 64 (Nat.fromBytesBE ((srcBytes.drop (0 + 1)).take
      ((srcBytes[0]'hsrcLen0).zeroExtend 64 - (0xf7 : Word)).toNat))) (56 : Word) = true)
    (h_lmism : ((srcBase + BitVec.ofNat 64 0) +
        (((srcBytes[0]'hsrcLen0).zeroExtend 64 - (0xf7 : Word)) + signExtend12 (1 : BitVec 12))) +
        BitVec.ofNat 64 (Nat.fromBytesBE ((srcBytes.drop (0 + 1)).take
          ((srcBytes[0]'hsrcLen0).zeroExtend 64 - (0xf7 : Word)).toNat))
      ≠ (srcBase + BitVec.ofNat 64 0) + BitVec.ofNat 64 srcBytes.length)
    (hdec : decodeWithdrawal srcBytes = none) :
    cpsTripleWithin (6 + (81 + 8)) base (raVal &&& ~~~1) (withdrawal_decode_code base)
      ((.x10 ↦ᵣ srcBase) ** (.x11 ↦ᵣ BitVec.ofNat 64 srcBytes.length) ** (.x12 ↦ᵣ outPtr) **
        (.x1 ↦ᵣ raVal) ** (.x2 ↦ᵣ sp0) ** (.x8 ↦ᵣ s0Old) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) **
        (.x0 ↦ᵣ (0 : Word)) ** wd_scratchOwned ** regOwn .x13 ** regOwn .x14 ** regOwn .x15 **
        wd_frameOwned sp0 **
  ...
  refine cpsTripleWithin_weaken (fun h hp => by xperm_hyp hp) (fun _ x => x)
    (cpsTripleWithin_of_forall_regIs_to_regOwn (P := (.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x1 ↦ᵣ raVal) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) ** (.x12 ↦ᵣ outPtr) ** ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 8) ↦ₘ s0Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 16) ↦ₘ s1Old) ** ((sp0 + signExtend12 (-32 : BitVec 12) + 24) ↦ₘ s2Old) ** (.x5 ↦ᵣ t0Old) ** (.x6 ↦ᵣ t1Old) ** (.x7 ↦ᵣ t2Old) ** (.x28 ↦ᵣ t3Old) ** (.x29 ↦ᵣ t4Old) ** (.x30 ↦ᵣ t5Old) ** regOwn .x13 ** regOwn .x14 ** regOwn .x15 ** (.x10 ↦ᵣ srcBase) ** (.x11 ↦ᵣ BitVec.ofNat 64 srcBytes.length) ** (.x0 ↦ᵣ (0 : Word)) ** bytesRegion srcBase srcBytes ** bytesRegion outPtr (List.replicate 48 (0 : BitVec 8))) (r := .x31) (fun t6Old => ?_))
  have hcall0 := cpsTripleWithin_extend_code (wd_walkinit_code_sub base)
    (wd_call_walk_init_lmism (base + 24) (base + 332) srcBase (BitVec.ofNat 64 srcBytes.length)
      outPtr t0Old t1Old t2Old t3Old t4Old t5Old t6Old raVal srcBytes 0 (308 : BitVec 21) hoffset
      halignC (wd_decode_disjoint_facts base hbase).1 hsalign hsrcLen0 hover0 hvalid0 hlen h_ge h_ge_f8
      hllen hlover hlvalid hoff1 h_fits h_llz_ne h_min h_lmism)
  rw [show base + 24 + 4 = base + 28 from by bv_omega] at hcall0
  have hcall := cpsTripleWithin_frameR
    ((.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ s1Old) **
      (.x18 ↦ᵣ s2Old) ** ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) **
...
/-- **Prefix dispatch** for the `decode = none` direction. Case-splits the input exactly as
    `walk_init` does (empty / not-a-list / short-list-fits? / long-header-fits? / leading-zero? /
    non-minimal? / span-match?), routing every malformed case to its proven walk_init fail arm and
    the two *valid-header* cases (short / long success, `a2 = 0`) to the field-processing
    continuations `hShort` / `hLong`. Reduces `hfail` to those two field-reject leaves. -/
theorem wd_decode_failDispatch
    (base srcBase outPtr raVal sp0 s0Old s1Old s2Old : Word) (srcBytes : List Byte)
    (hbe : base &&& 1 = 0) (hbase : base.toNat + 1444 < 2 ^ 64)
    (hsalign : srcBase.toNat % 8 = 0)
    (hsrclt : srcBytes.length < 2 ^ 64) (hnowrap : srcBase.toNat + srcBytes.length < 2 ^ 64)
    (hsvalid : ∀ k, k < srcBytes.length → isValidByteAccess (srcBase + BitVec.ofNat 64 k) = true)
    (hdec : decodeWithdrawal srcBytes = none)
    (hShort : ∀ (hsrcLen0 : 0 < srcBytes.length),
      ¬ BitVec.ult ((srcBytes[0]'hsrcLen0).zeroExtend 64) (0xc0 : Word) = true →
      BitVec.ult ((srcBytes[0]'hsrcLen0).zeroExtend 64) (0xf8 : Word) = true →
      ((srcBase + BitVec.ofNat 64 0) + (((srcBytes[0]'hsrcLen0).zeroExtend 64 - (0xc0 : Word)) + signExtend12 (1 : BitVec 12))) = ((srcBase + BitVec.ofNat 64 0) + BitVec.ofNat 64 srcBytes.length) →
      cpsTripleWithin 2048 base (raVal &&& ~~~1) (withdrawal_decode_code base)
      ((.x10 ↦ᵣ srcBase) ** (.x11 ↦ᵣ BitVec.ofNat 64 srcBytes.length) ** (.x12 ↦ᵣ outPtr) **
        (.x1 ↦ᵣ raVal) ** (.x2 ↦ᵣ sp0) ** (.x8 ↦ᵣ s0Old) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) **
        (.x0 ↦ᵣ (0 : Word)) ** wd_scratchOwned ** regOwn .x13 ** regOwn .x14 ** regOwn .x15 **
      ...
      (((.x1 ↦ᵣ raVal) ** (.x2 ↦ᵣ sp0) ** (.x8 ↦ᵣ s0Old) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) **
       ...
       (fun h =>
         ...
         (((.x10 ↦ᵣ (1 : Word)) ** wd_outOwned outPtr **
            ⌜decodeWithdrawal srcBytes = none⌝) h))))
    (hLong : ∀ (hsrcLen0 : 0 < srcBytes.length)
      (hoff1 : 0 + 1 < srcBytes.length),
      ¬ BitVec.ult ((srcBytes[0]'hsrcLen0).zeroExtend 64) (0xc0 : Word) = true →
      ¬ BitVec.ult ((srcBytes[0]'hsrcLen0).zeroExtend 64) (0xf8 : Word) = true →
      ¬ BitVec.ult ((srcBase + BitVec.ofNat 64 0) + BitVec.ofNat 64 srcBytes.length) ((srcBase + BitVec.ofNat 64 0) + (((srcBytes[0]'hsrcLen0).zeroExtend 64 - (0xf7 : Word)) + signExtend12 (1 : BitVec 12))) = true →
      ((srcBytes[0 + 1]'hoff1).zeroExtend 64 ≠ (0 : Word)) →
      ¬ BitVec.ult (BitVec.ofNat 64 (Nat.fromBytesBE ((srcBytes.drop (0 + 1)).take ((srcBytes[0]'hsrcLen0).zeroExtend 64 - (0xf7 : Word)).toNat))) (56 : Word) = true →
      ((srcBase + BitVec.ofNat 64 0) + (((srcBytes[0]'hsrcLen0).zeroExtend 64 - (0xf7 : Word)) + signExtend12 (1 : BitVec 12))) + BitVec.ofNat 64 (Nat.fromBytesBE ((srcBytes.drop (0 + 1)).take ((srcBytes[0]'hsrcLen0).zeroExtend 64 - (0xf7 : Word)).toNat)) = ((srcBase + BitVec.ofNat 64 0) + BitVec.ofNat 64 srcBytes.length) →
      cpsTripleWithin 2048 base (raVal &&& ~~~1) (withdrawal_decode_code base)
      ((.x10 ↦ᵣ srcBase) ** (.x11 ↦ᵣ BitVec.ofNat 64 srcBytes.length) ** (.x12 ↦ᵣ outPtr) **
        (.x1 ↦ᵣ raVal) ** (.x2 ↦ᵣ sp0) ** (.x8 ↦ᵣ s0Old) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) **
        (.x0 ↦ᵣ (0 : Word)) ** wd_scratchOwned ** regOwn .x13 ** regOwn .x14 ** regOwn .x15 **
      ...
      (((.x1 ↦ᵣ raVal) ** (.x2 ↦ᵣ sp0) ** (.x8 ↦ᵣ s0Old) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) **
       ...
       (fun h =>
         ...
         (((.x10 ↦ᵣ (1 : Word)) ** wd_outOwned outPtr **
            ⌜decodeWithdrawal srcBytes = none⌝) h))) := by
  have hover0 : srcBase.toNat + 0 < 2 ^ 64 := by have := srcBase.isLt; omega
  by_cases hL0 : srcBytes.length = 0
  · exact cpsTripleWithin_mono_nSteps (by norm_num)
      (wd_decode_failEmpty base srcBase outPtr raVal sp0 s0Old s1Old s2Old srcBytes
        hbe hbase hL0 hdec)
  · have hsrcLen0 : 0 < srcBytes.length := Nat.pos_of_ne_zero hL0
    have hvalid0 : isValidByteAccess (srcBase + BitVec.ofNat 64 0) = true := hsvalid 0 hsrcLen0
    by_cases hnl : BitVec.ult ((srcBytes[0]'hsrcLen0).zeroExtend 64) (0xc0 : Word) = true
    · exact cpsTripleWithin_mono_nSteps (by norm_num)
        (wd_decode_failNotlist base srcBase outPtr raVal sp0 s0Old s1Old s2Old srcBytes
          hbe hbase hsalign hsrcLen0 hsrclt hover0 hvalid0 hnl hdec)
    · by_cases hhi : BitVec.ult ((srcBytes[0]'hsrcLen0).zeroExtend 64) (0xf8 : Word) = true
      · -- short list
        by_cases hsp : ((srcBase + BitVec.ofNat 64 0) + (((srcBytes[0]'hsrcLen0).zeroExtend 64 - (0xc0 : Word)) + signExtend12 (1 : BitVec 12))) = ((srcBase + BitVec.ofNat 64 0) + BitVec.ofNat 64 srcBytes.length)
        · exact hShort hsrcLen0 hnl hhi hsp
        · exact cpsTripleWithin_mono_nSteps (by norm_num)
            (wd_decode_failSmism base srcBase outPtr raVal sp0 s0Old s1Old s2Old srcBytes
              hbe hbase hsalign hsrcLen0 hsrclt hover0 hvalid0 hnl hhi hsp hdec)
      · -- long list
        by_cases htr : BitVec.ult ((srcBase + BitVec.ofNat 64 0) + BitVec.ofNat 64 srcBytes.length) ((srcBase + BitVec.ofNat 64 0) + (((srcBytes[0]'hsrcLen0).zeroExtend 64 - (0xf7 : Word)) + signExtend12 (1 : BitVec 12))) = true
        · exact cpsTripleWithin_mono_nSteps (by norm_num)
            (wd_decode_failLtrunc base srcBase outPtr raVal sp0 s0Old s1Old s2Old srcBytes
              hbe hbase hsalign hsrcLen0 hsrclt hover0 hvalid0 hnl hhi htr hdec)
        · obtain ⟨hoff1, hover1, hvalid1, hllen, hlover, hlvalid⟩ :=
            wd_longHeader_access_facts srcBase srcBytes hsrcLen0 hsrclt hnowrap hsvalid hhi htr
          by_cases hlz : (srcBytes[0 + 1]'hoff1).zeroExtend 64 = (0 : Word)
          · exact cpsTripleWithin_mono_nSteps (by norm_num)
              (wd_decode_failLlz base srcBase outPtr raVal sp0 s0Old s1Old s2Old srcBytes
                hbe hbase hsalign hsrcLen0 hsrclt hover0 hvalid0 hnl hhi hoff1 hover1 hvalid1 htr hlz hdec)
          · by_cases hmn : BitVec.ult (BitVec.ofNat 64 (Nat.fromBytesBE ((srcBytes.drop (0 + 1)).take ((srcBytes[0]'hsrcLen0).zeroExtend 64 - (0xf7 : Word)).toNat))) (56 : Word) = true
            · exact cpsTripleWithin_mono_nSteps (by norm_num)
                (wd_decode_failLmin base srcBase outPtr raVal sp0 s0Old s1Old s2Old srcBytes
                  hbe hbase hsalign hsrcLen0 hsrclt hover0 hvalid0 hnl hhi hllen hlover hlvalid hoff1 htr hlz hmn hdec)
            · by_cases hsp2 : ((srcBase + BitVec.ofNat 64 0) + (((srcBytes[0]'hsrcLen0).zeroExtend 64 - (0xf7 : Word)) + signExtend12 (1 : BitVec 12))) + BitVec.ofNat 64 (Nat.fromBytesBE ((srcBytes.drop (0 + 1)).take ((srcBytes[0]'hsrcLen0).zeroExtend 64 - (0xf7 : Word)).toNat)) = ((srcBase + BitVec.ofNat 64 0) + BitVec.ofNat 64 srcBytes.length)
              · exact hLong hsrcLen0 hoff1 hnl hhi htr hlz hmn hsp2
              · exact cpsTripleWithin_mono_nSteps (by norm_num)
...
/-- **Field-0 walk_next reject segment** (base+48 → ret): the `walk_next` call ⨾ the `bnez a1, fail`
    status guard, routing the 5 error-status arms (`a1 ∈ {2,3,4,5,6}`) to the fail endpoint and the
    `rlpWalkNextOk` arm to `hcont` (whose PRE is the guard's success post at base+56). Validates the
    walk_next 6-way-status routing reused by every field. -/
theorem wd_decode_failField0WalkSeg
    (base sp0 raVal s0Old s1Old s2Old outPtr srcBase endPtr vOld a2Old
      t0Old t1Old t2Old t3Old t4Old t5Old t6Old : Word)
    (srcBytes : List Byte) (srcOff Ncont : Nat)
    (halign52 : (base + 52) &&& ~~~1 = base + 52)
    (hdisjW : (CodeReq.singleton (base + 48) (.JAL .x1 (496 : BitVec 21))).Disjoint
      (rlp_walk_next_code (base + 544)))
    (hsalign : srcBase.toNat % 8 = 0) (hoff : srcOff < srcBytes.length)
    ...
    (hll : ¬ BitVec.ult ((srcBytes[srcOff]'hoff).zeroExtend 64) (0xf8 : Word) = true →
        ...
        ∀ k, k < ((srcBytes[srcOff]'hoff).zeroExtend 64 - (0xf7 : Word)).toNat →
          isValidByteAccess (srcBase + BitVec.ofNat 64 (srcOff + 1 + k)) = true)
    (hdec : decodeWithdrawal srcBytes = none)
    (hcont : cpsTripleWithin Ncont (base + 56) (raVal &&& ~~~1) (withdrawal_decode_code base)
      ((fun s => ∃ next len,
        ((regOwn .x5 ** regOwn .x6 ** regOwn .x7 ** regOwn .x28 ** regOwn .x29 ** regOwn .x30 **
          regOwn .x31 ** (.x0 ↦ᵣ (0 : Word)) ** (.x1 ↦ᵣ (base + 52)) ** bytesRegion srcBase srcBytes) ** ((.x10 ↦ᵣ next) ** (.x11 ↦ᵣ (0 : Word)) ** (.x12 ↦ᵣ len) ** ⌜(0 : Word) = (0 : Word)⌝ **
          ⌜rlpItemDecode srcBytes srcOff (srcBase + BitVec.ofNat 64 srcOff) endPtr next len⌝)) s) ** ((.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ (srcBase + BitVec.ofNat 64 srcOff)) **
          (.x18 ↦ᵣ endPtr) **
          ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) **
          ((sp0 + signExtend12 (-32 : BitVec 12) + 8) ↦ₘ s0Old) **
          ((sp0 + signExtend12 (-32 : BitVec 12) + 16) ↦ₘ s1Old) **
          ((sp0 + signExtend12 (-32 : BitVec 12) + 24) ↦ₘ s2Old) **
          regOwn .x13 ** regOwn .x14 ** regOwn .x15 ** wd_outOwned outPtr)) (((.x1 ↦ᵣ raVal) ** (.x2 ↦ᵣ sp0) ** (.x8 ↦ᵣ s0Old) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) **
        (.x0 ↦ᵣ (0 : Word)) ** regOwn .x11 ** regOwn .x12 **
        wd_scratchOwned ** regOwn .x13 ** regOwn .x14 ** regOwn .x15 **
       ...
       (fun h =>
         ...
         (((.x10 ↦ᵣ (1 : Word)) ** wd_outOwned outPtr **
            ⌜decodeWithdrawal srcBytes = none⌝) h)))) :
    cpsTripleWithin ((1 + 87) + (1 + Ncont)) (base + 48) (raVal &&& ~~~1) (withdrawal_decode_code base)
      (((.x1 ↦ᵣ vOld) **
        ((.x10 ↦ᵣ (srcBase + BitVec.ofNat 64 srcOff)) ** (.x11 ↦ᵣ endPtr) ** (.x12 ↦ᵣ a2Old) **
         (.x5 ↦ᵣ t0Old) ** (.x6 ↦ᵣ t1Old) ** (.x7 ↦ᵣ t2Old) ** (.x28 ↦ᵣ t3Old) **
         (.x29 ↦ᵣ t4Old) ** (.x30 ↦ᵣ t5Old) ** (.x31 ↦ᵣ t6Old) ** (.x0 ↦ᵣ (0 : Word)) **
         bytesRegion srcBase srcBytes)) ** ((.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ (srcBase + BitVec.ofNat 64 srcOff)) **
          (.x18 ↦ᵣ endPtr) **
          ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) **
          ((sp0 + signExtend12 (-32 : BitVec 12) + 8) ↦ₘ s0Old) **
          ((sp0 + signExtend12 (-32 : BitVec 12) + 16) ↦ₘ s1Old) **
       ...
       (fun h =>
         ...
         (((.x10 ↦ᵣ (1 : Word)) ** wd_outOwned outPtr **
            ⌜decodeWithdrawal srcBytes = none⌝) h))) := by
  have hcall := cpsTripleWithin_frameR
    ((.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ (srcBase + BitVec.ofNat 64 srcOff)) **
          (.x18 ↦ᵣ endPtr) **
          ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) **
          ((sp0 + signExtend12 (-32 : BitVec 12) + 8) ↦ₘ s0Old) **
          ((sp0 + signExtend12 (-32 : BitVec 12) + 16) ↦ₘ s1Old) **
    ...
    (wd_call_walknext_field0 base srcBase endPtr vOld a2Old t0Old t1Old t2Old t3Old t4Old
      t5Old t6Old srcBytes srcOff halign52 hdisjW hsalign hoff hover hvalid hss hls hll)
  -- reusable reject arm for each error status (a1 = v ≠ 0)
  have rej : ∀ (v : Word) (P : Prop), v ≠ (0 : Word) →
      cpsTripleWithin (1 + Ncont) (base + 52) (raVal &&& ~~~1) (withdrawal_decode_code base)
        (((regOwn .x5 ** regOwn .x6 ** regOwn .x7 ** regOwn .x28 ** regOwn .x29 ** regOwn .x30 **
          regOwn .x31 ** (.x0 ↦ᵣ (0 : Word)) ** (.x1 ↦ᵣ (base + 52)) ** bytesRegion srcBase srcBytes) ** ((.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ (srcBase + BitVec.ofNat 64 srcOff)) **
          (.x18 ↦ᵣ endPtr) **
          ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) **
          ((sp0 + signExtend12 (-32 : BitVec 12) + 8) ↦ₘ s0Old) **
          ((sp0 + signExtend12 (-32 : BitVec 12) + 16) ↦ₘ s1Old) **
          ((sp0 + signExtend12 (-32 : BitVec 12) + 24) ↦ₘ s2Old) **
          regOwn .x13 ** regOwn .x14 ** regOwn .x15 ** wd_outOwned outPtr)) **
          ((.x10 ↦ᵣ (srcBase + BitVec.ofNat 64 srcOff)) ** (.x11 ↦ᵣ v) ** (.x12 ↦ᵣ (0 : Word)) ** ⌜P⌝))
        (((.x1 ↦ᵣ raVal) ** (.x2 ↦ᵣ sp0) ** (.x8 ↦ᵣ s0Old) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) **
        (.x0 ↦ᵣ (0 : Word)) ** regOwn .x11 ** regOwn .x12 **
        wd_scratchOwned ** regOwn .x13 ** regOwn .x14 ** regOwn .x15 **
        wd_frameOwned sp0 ** bytesRegion srcBase srcBytes) **
    ...
    refine cpsTripleWithin_mono_nSteps (by omega)
      (cpsTripleWithin_weaken (fun s hp => ?_) (fun _ x => x)
        (wd_decode_failViaBnez11 base sp0 raVal s0Old s1Old s2Old outPtr srcBase srcBytes
          (base + 52) outPtr (srcBase + BitVec.ofNat 64 srcOff) endPtr (srcBase + BitVec.ofNat 64 srcOff)
          v 13 (252 : BitVec 13) hv (by rw [withdrawal_decode_prog_length]; norm_num) (by decide)
          (by rw [show (4 * 13 : Nat) = 52 from rfl,
                  show signExtend13 (252 : BitVec 13) = (252 : Word) from by decide]; bv_omega)
          hdec))
    unfold wd_scratchOwned
    have hp2 := sepConj_mono_right
      (sepConj_mono (fun _ x => x) (sepConj_mono (fun _ x => x)
        (fun s'' h'' => regIs_implies_regOwn .x12 s'' (((sepConj_pure_right s'').1 h'').1)))) s hp
    xperm_hyp hp2
  -- rlpWalkNextOk continue arm: the success-guard (bnez not taken) then hcont
  have hRlpokC : cpsTripleWithin (1 + Ncont) (base + 52) (raVal &&& ~~~1) (withdrawal_decode_code base)
      (((regOwn .x5 ** regOwn .x6 ** regOwn .x7 ** regOwn .x28 ** regOwn .x29 ** regOwn .x30 **
          regOwn .x31 ** (.x0 ↦ᵣ (0 : Word)) ** (.x1 ↦ᵣ (base + 52)) ** bytesRegion srcBase srcBytes) ** ((.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ (srcBase + BitVec.ofNat 64 srcOff)) **
          (.x18 ↦ᵣ endPtr) **
          ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) **
          ...
          ((sp0 + signExtend12 (-32 : BitVec 12) + 16) ↦ₘ s1Old) **
          ((sp0 + signExtend12 (-32 : BitVec 12) + 24) ↦ₘ s2Old) **
          regOwn .x13 ** regOwn .x14 ** regOwn .x15 ** wd_outOwned outPtr)) ** rlpWalkNextOk (srcBase + BitVec.ofNat 64 srcOff) endPtr srcBytes srcOff)
      (((.x1 ↦ᵣ raVal) ** (.x2 ↦ᵣ sp0) ** (.x8 ↦ᵣ s0Old) ** (.x9 ↦ᵣ s1Old) ** (.x18 ↦ᵣ s2Old) **
        (.x0 ↦ᵣ (0 : Word)) ** regOwn .x11 ** regOwn .x12 **
        wd_scratchOwned ** regOwn .x13 ** regOwn .x14 ** regOwn .x15 **
        wd_frameOwned sp0 ** bytesRegion srcBase srcBytes) **
       (fun h =>
         ...
         (((.x10 ↦ᵣ (1 : Word)) ** wd_outOwned outPtr **
            ⌜decodeWithdrawal srcBytes = none⌝) h))) := by
    have hgs := cpsTripleWithin_frameR ((.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ (srcBase + BitVec.ofNat 64 srcOff)) **
          (.x18 ↦ᵣ endPtr) **
          ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) **
          ((sp0 + signExtend12 (-32 : BitVec 12) + 8) ↦ₘ s0Old) **
          ((sp0 + signExtend12 (-32 : BitVec 12) + 16) ↦ₘ s1Old) **
          ((sp0 + signExtend12 (-32 : BitVec 12) + 24) ↦ₘ s2Old) **
          regOwn .x13 ** regOwn .x14 ** regOwn .x15 ** wd_outOwned outPtr) (by unfold wd_outOwned; pcFree)
      (wd_walknext_guard_success base srcBase (srcBase + BitVec.ofNat 64 srcOff) endPtr (base + 52)
        srcBytes srcOff)
    refine cpsTripleWithin_seq_perm_same_cr (fun s hp => by xperm_hyp hp)
      (cpsTripleWithin_weaken (fun s hp => by xperm_hyp hp) (fun _ x => x) hgs) hcont
  refine cpsTripleWithin_seq_perm_same_cr (fun s hp => hp) hcall ?_
  refine cpsTripleWithin_weaken (fun s hp => ?_) (fun _ x => x)
    (cpsTripleWithin_or_pre hRlpokC (cpsTripleWithin_or_pre (rej 2 (¬ BitVec.ult (srcBase + BitVec.ofNat 64 srcOff) endPtr = true) (by decide))
      (cpsTripleWithin_or_pre (rej 3 (¬ ∃ next len, rlpItemDecode srcBytes srcOff (srcBase + BitVec.ofNat 64 srcOff) endPtr next len) (by decide)) (cpsTripleWithin_or_pre (rej 4 (¬ ∃ next len, rlpItemDecode srcBytes srcOff (srcBase + BitVec.ofNat 64 srcOff) endPtr next len) (by decide))
        (cpsTripleWithin_or_pre (rej 5 (¬ ∃ next len, rlpItemDecode srcBytes srcOff (srcBase + BitVec.ofNat 64 srcOff) endPtr next len) (by decide)) (rej 6 (¬ ∃ next len, rlpItemDecode srcBytes srcOff (srcBase + BitVec.ofNat 64 srcOff) endPtr next len) (by decide)))))))
  have hcomm : (((fun h =>
         rlpWalkNextOk (srcBase + BitVec.ofNat 64 srcOff) endPtr srcBytes srcOff h ∨
         (((.x10 ↦ᵣ (srcBase + BitVec.ofNat 64 srcOff)) ** (.x11 ↦ᵣ (2 : Word)) **
            (.x12 ↦ᵣ (0 : Word)) **
         ...
         (((.x10 ↦ᵣ (srcBase + BitVec.ofNat 64 srcOff)) ** (.x11 ↦ᵣ (6 : Word)) **
            (.x12 ↦ᵣ (0 : Word)) **
            ⌜¬ ∃ next len, rlpItemDecode srcBytes srcOff (srcBase + BitVec.ofNat 64 srcOff)
              endPtr next len⌝) h))) ** ((.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ (srcBase + BitVec.ofNat 64 srcOff)) **
          (.x18 ↦ᵣ endPtr) **
          ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) **
          ((sp0 + signExtend12 (-32 : BitVec 12) + 8) ↦ₘ s0Old) **
          ((sp0 + signExtend12 (-32 : BitVec 12) + 16) ↦ₘ s1Old) **
          ((sp0 + signExtend12 (-32 : BitVec 12) + 24) ↦ₘ s2Old) **
          regOwn .x13 ** regOwn .x14 ** regOwn .x15 ** wd_outOwned outPtr)) = (((.x2 ↦ᵣ (sp0 + signExtend12 (-32 : BitVec 12))) ** (.x8 ↦ᵣ outPtr) ** (.x9 ↦ᵣ (srcBase + BitVec.ofNat 64 srcOff)) **
          (.x18 ↦ᵣ endPtr) **
          ((sp0 + signExtend12 (-32 : BitVec 12)) ↦ₘ raVal) **
          ((sp0 + signExtend12 (-32 : BitVec 12) + 8) ↦ₘ s0Old) **
          ((sp0 + signExtend12 (-32 : BitVec 12) + 16) ↦ₘ s1Old) **
          ((sp0 + signExtend12 (-32 : BitVec 12) + 24) ↦ₘ s2Old) **
          regOwn .x13 ** regOwn .x14 ** regOwn .x15 ** wd_outOwned outPtr) ** ((fun h =>
         rlpWalkNextOk (srcBase + BitVec.ofNat 64 srcOff) endPtr srcBytes srcOff h ∨
         (((.x10 ↦ᵣ (srcBase + BitVec.ofNat 64 srcOff)) ** (.x11 ↦ᵣ (2 : Word)) **
            (.x12 ↦ᵣ (0 : Word)) **
            ⌜¬ BitVec.ult (srcBase + BitVec.ofNat 64 srcOff) endPtr = true⌝) h) ∨
         ...
         (((.x10 ↦ᵣ (srcBase + BitVec.ofNat 64 srcOff)) ** (.x11 ↦ᵣ (6 : Word)) **
            (.x12 ↦ᵣ (0 : Word)) **
            ⌜¬ ∃ next len, rlpItemDecode srcBytes srcOff (srcBase + BitVec.ofNat 64 srcOff)
              endPtr next len⌝) h)))) := sepConj_comm' _ _
  rw [sepConj_assoc', hcomm, ← sepConj_assoc'] at hp
  rcases sepConj_or_elim hp with h | h
  · exact Or.inl h
  · rcases sepConj_or_elim h with h | h
