/-
  ...
  Production proof for the recursive `rlp_items` body.  The proof is kept
  beside the production function; the probe harness remains an independent
  diagnostic copy.
-/
...
private theorem itemsFnV_region_eq (bs : List Byte) (inBase : Word) (d : Nat)
...
private theorem itemsFnV_rw_eq (bs : List Byte) (inBase : Word) (d : Nat)
    (fp : Word) (pStart pEnd : Nat) (v : Word) (rf₀ : RegFile)
    (ws₀ : List (BitVec 8)) (A₀ : Assertion) (beS childS : FnHandleS) :
...
theorem itemsFnV_spec (bs : List Byte) (inBase : Word) (d : Nat) (fp : Word)
  ...
  case rlpitems.iloop.body.pz.t.ifit.e.child.pre =>
    exact child_pre_sp_generic
      ...
      (itemsFnV_region_eq bs inBase d fp pStart pEnd v rf₀ ws₀ A₀ beS childS)
