...
@[irreducible] private def vphlTopArmPre
    (spC parentBase parentLenW childBase childLenW outPtr v21 status v11 v12 offset len : Word)
...
@[irreducible] private def vphlTopComparePrefix
    (spC retPC retHdr parentLenW childLenW outPtr v21 : Word)
    (v11 v12 v13 v14 v15 v16 v17 v29 v30 v31 : Word)
...
@[irreducible] @[irreducible] private def vphlTopComparePrefixOwn
    (spC retPC retHdr parentLenW childLenW outPtr v21 : Word)
    (v11 v12 v13 v14 v15 v16 v17 v29 v30 v31 : Word)
    (cs0 cs1 cs2 cs3 cs4 : Word) (parentBase childBase : Word) : Assertion :=
  ((.x2 ↦ᵣ spC) ** (.x1 ↦ᵣ retPC) **
...
@[irreducible] private def vphlTopCompareStackSaved
...
@[irreducible] private def vphlTopCompareSuffix
...
@[irreducible] private def vphlTopEpiRegsExact
...
@[irreducible] private def vphlTopEpiRegsOwn : Assertion :=
  regOwn .x5 ** regOwn .x6 ** regOwn .x7 **
    regOwn .x15 ** regOwn .x16 ** regOwn .x17 **
    regOwn .x28 ** regOwn .x29 ** regOwn .x30 **
    regOwn .x31 ** regOwn .x13 ** regOwn .x14

@[irreducible] private def vphlTopEpiPreOwn
...
@[irreducible] private def vphlTopEpiPreExact
    (spC retHdr x1Val statusW v11e v12e parentBase parentLenW childBase childLenW outPtr v21 : Word)
    (cs0 cs1 cs2 cs3 cs4 outValW offV lenV : Word)
...
@[irreducible] private def vphlTopEpiPost
...
private theorem vphl_hash_tail_spec
    ...
    cpsTripleWithin 28 (vphlBase + 184) retHdr vphlCode
      (vphlTopHashPost spC (vphlBase + 184) retHdr parentLenW childLenW outPtr v21
        cs0 cs1 cs2 cs3 parentBase childBase parentBytes childBytes
...
private theorem vphl_success_eq32_spec
    (sp0 spC retHdr parentLenW childLenW outPtr v21 : Word)
    (cs0 cs1 cs2 cs3 cs4 : Word)
    (parentBase childBase : Word)
    (parentBytes childBytes claimedOld : List (BitVec 8))
...
private theorem vphl_continuation_spec
