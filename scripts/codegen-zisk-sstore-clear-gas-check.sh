...
# with gas=151050. Amsterdam spec: 21000 intrinsic + 10 x (2 + 3 + 13000) = 151050,
# where each cold clean-changing SSTORE-clear is 3000 cold access + 10000 write = 13000
...
print(f"  status={st} gas_left={gl} log_count={lc} (block_inc={151050-gl})")
...
assert gl==0, f"SSTORE-clear charge drifted: gas_left={gl}, expected 0 (each clear = 13000)"
print("  PASS: all 10 cold SSTORE-clears charged the full 13000 (gas_left=0).")
PY
