"""
Tx-count KAT v3 (limit>>used, coord hypothesis): EIP-7778/8037 sequential REGULAR-gas inclusion gate beyond
...
TX17_GAS_EDGE = 300_000  # limit >> used (~12k self-send); limit > remaining 164000 -> strict > rejects
...
def test_txcount_gate3_edge(
    ...
    """
    txs = _txcount_gate3_scenario(pre, fork, TX17_GAS_EDGE)
