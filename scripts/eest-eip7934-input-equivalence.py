...
Run from the repo root via execution-specs dependencies, for example:
    ...
    uv run --directory execution-specs --quiet python3 \
        ...
        ../gen-out/eest-fixtures/tests-zkevm@v0.6.1/fixtures/fixtures/blockchain_tests/for_amsterdam/osaka/eip7934_block_rlp_limit/max_block_rlp_size/block_at_rlp_size_limit_boundary.json
