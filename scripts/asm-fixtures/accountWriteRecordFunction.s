account_write_record:
  ...
  la t0, tx_account_writes_count; ld t1, 0(t0); lui t3, 0xbf; addiw t3, t3, 1920; slli t3, t3, 12; li t4, 0
.Lawr_scan:
...
.Lawr_next:
  la t0, tx_account_writes_count; ld t1, 0(t0); lui t3, 0xbf; addiw t3, t3, 1920; slli t3, t3, 12; addi t4, t4, 1; j .Lawr_scan
.Lawr_append:
  li t2, 16384; bgeu t1, t2, .Lawr_overflow; mv a5, t1; li a6, 1; jal ra, account_writes_undo_push; bnez a0, .Lawr_overflow
  la t0, tx_account_writes_count; ld t1, 0(t0); lui t3, 0xbf; addiw t3, t3, 1920; slli t3, t3, 12; slli t5, t1, 7; add t5, t3, t5; ld t2, 64(sp); li t6, 20
.Lawr_copy_addr:
