...
- covered by converted `_prog`s: 120584 bytes (34.95%)
...
| `0x80016024` | `0x80018b30` | 11020 | `block_verdict` | UNCONVERTED |
| `0x80018b30` | `0x800198c4` | 3476 | `block_verdict_mtx_oog_materialize` | UNCONVERTED |
| `0x800198c4` | `0x80019ae0` | 540 | `block_verdict_withdrawal_nonstorage_effects` | UNCONVERTED |
| `0x80019dc8` | `0x80019e5c` | 148 | `rlp_field_to_u64_strict` | UNCONVERTED |
| `0x8001a654` | `0x8001a8ac` | 600 | `tx_extract_to_address` | UNCONVERTED |
| `0x8001a8ac` | `0x8001ab24` | 632 | `tx_extract_value` | UNCONVERTED |
| `0x8001ab24` | `0x8001adb8` | 660 | `tx_extract_data_section` | UNCONVERTED |
| `0x8001b3b4` | `0x8001b6d0` | 796 | `account_state_delegation_code_resolve` | UNCONVERTED |
| `0x8001ba98` | `0x8001bd10` | 632 | `stage_runtime_payload` | UNCONVERTED |
| `0x8001bd10` | `0x8001bfb4` | 676 | `stage_creation_runtime_payload` | UNCONVERTED |
| `0x8001bfb4` | `0x8001ca78` | 2756 | `block_verdict_creation_runtime` | UNCONVERTED |
| `0x8001cd8c` | `0x8001cdd4` | 72 | `bytecode_is_self_contained` | UNCONVERTED |
| `0x8001d474` | `0x8001d65c` | 488 | `dtrc_materialize_deferred_delegation` | UNCONVERTED |
| `0x8001d65c` | `0x8001d6b8` | 92 | `dtrc_charge_deferred_delegation` | UNCONVERTED |
| `0x8001d6b8` | `0x8001d784` | 204 | `dispatcher_capture_body_state` | UNCONVERTED |
| `0x8001d784` | `0x8001d858` | 212 | `dispatcher_restore_body_state` | UNCONVERTED |
| `0x8001d858` | `0x8001e7e8` | 3984 | `dispatch_tx_runtime_code` | UNCONVERTED |
| `0x8001f0bc` | `0x8001f1d0` | 276 | `evm_storage_access_seed_key` | UNCONVERTED |
| `0x8001f1d0` | `0x8001f604` | 1076 | `seed_tx_access_list` | UNCONVERTED |
| `0x800202b8` | `0x800202f8` | 64 | `bal_addr_to_exec_log_key` | UNCONVERTED |
| `0x80020558` | `0x800206a0` | 328 | `storage_writes_block_latest_value` | UNCONVERTED |
| `0x800206a0` | `0x800206d0` | 48 | `exec_log_addr_to_bal_canonical` | UNCONVERTED |
| `0x80020c20` | `0x80020db0` | 400 | `destroy_storage` | UNCONVERTED |
| `0x80021fa4` | `0x800220c0` | 284 | `account_agreement_mutation_checkpoint` | UNCONVERTED |
| `0x800220c0` | `0x80022284` | 452 | `account_writes_block_upsert` | UNCONVERTED |
| `0x80022284` | `0x80022514` | 656 | `account_writes_apply_deletes` | UNCONVERTED |
| `0x80022be8` | `0x80022d08` | 288 | `account_writes_undo_push` | UNCONVERTED |
| `0x80023a24` | `0x80023a40` | 28 | `keccak_init` | UNCONVERTED |
| `0x80023a40` | `0x80023ab4` | 116 | `keccak_absorb` | UNCONVERTED |
| `0x80023ab4` | `0x80023b04` | 80 | `keccak_final` | UNCONVERTED |
| `0x80023b04` | `0x80023b30` | 44 | `bal_rlp_scalar_len` | UNCONVERTED |
| `0x80023b30` | `0x80023c10` | 224 | `bal_rlp_emit_scalar` | UNCONVERTED |
| `0x80023c10` | `0x80023c90` | 128 | `bal_rlp_emit_address` | UNCONVERTED |
| `0x80023c90` | `0x80023cc0` | 48 | `bal_rlp_measure_into_throwaway` | UNCONVERTED |
| `0x80023e00` | `0x80023ec4` | 196 | `bal_rlp_emit_list_header` | UNCONVERTED |
| `0x80023ec4` | `0x80023f18` | 84 | `bal_rlp_scalar_rlp_len` | UNCONVERTED |
| `0x80023f18` | `0x80023f48` | 48 | `bal_rlp_list_header_len` | UNCONVERTED |
| `0x80023f48` | `0x80023f88` | 64 | `bal_serializer_addr_matches` | UNCONVERTED |
| `0x80023f88` | `0x80023fc0` | 56 | `bal_serializer_addr_matches_be` | UNCONVERTED |
| `0x80023fc0` | `0x80024000` | 64 | `bal_serializer_slot_eq` | UNCONVERTED |
| `0x80024160` | `0x80024178` | 24 | `bal_serializer_u64_to_field` | UNCONVERTED |
| `0x80025138` | `0x80025334` | 508 | `bal_serializer_rebuild_hash` | UNCONVERTED |
| `0x800253cc` | `0x800254d8` | 268 | `bal_builder_ensure_account` | UNCONVERTED |
| `0x8002553c` | `0x80025704` | 456 | `bal_builder_record_storage_change` | UNCONVERTED |
| `0x80025704` | `0x800259ec` | 744 | `bal_emit_storage_changes` | UNCONVERTED |
| `0x800259ec` | `0x80025ad4` | 232 | `bal_builder_append_balance` | UNCONVERTED |
| `0x80025ad4` | `0x80025bb0` | 220 | `bal_builder_append_nonce` | UNCONVERTED |
| `0x80025bb0` | `0x80025c88` | 216 | `bal_builder_append_code` | UNCONVERTED |
| `0x8002603c` | `0x80026160` | 292 | `read_sets_merge_one` | UNCONVERTED |
| `0x80026160` | `0x80026258` | 248 | `read_sets_incorporate_tx` | UNCONVERTED |
| `0x80026a80` | `0x80026a90` | 16 | `eip8037_tx_state_gas` | UNCONVERTED |
| `0x80026c74` | `0x80026e8c` | 536 | `tx_extract_nonce_and_gas` | UNCONVERTED |
| `0x80026e8c` | `0x80027080` | 500 | `tx_extract_gas_pricing` | UNCONVERTED |
| `0x80027414` | `0x80027a98` | 1668 | `tx_gas_bal_post_verify` | UNCONVERTED |
| `0x800289b4` | `0x80028ed0` | 1308 | `tx_gas_bal_post_verify_runtime` | UNCONVERTED |
| `0x80028f30` | `0x80028fd0` | 160 | `eip7778_remaining_block_gas_check` | UNCONVERTED |
| `0x80029c1c` | `0x8002a410` | 2036 | `eip7702_auth_state_prepare` | UNCONVERTED |
...
| `0x8003067c` | `0x80030818` | 412 | `.runtime_tx_message_entry` | UNCONVERTED |
...
| `0x80031a98` | `0x80031b18` | 128 | `account_state_created_contains` | UNCONVERTED |
...
| `0x8003c93c` | `0x8003c96c` | 48 | `call_frame_forward_gas` | UNCONVERTED |
...
| `0x80043044` | `0x800432cc` | 648 | `h_KECCAK256` | UNCONVERTED |
...
| `0x800537f0` | `0x80053a24` | 564 | `stage_system_call_payload` | UNCONVERTED |
