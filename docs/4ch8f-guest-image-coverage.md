...
not linked** (71 of 464 today — gas helpers etc.
...
- symbols in `.text`: 905 (393 converted, 512 unconverted)
- covered by converted `_prog`s: 102828 bytes (30.01%)
- NOT covered: 239804 bytes (69.99%), 514 ranges
...
| `0x8001cdb8` | `0x8001cebc` | 260 | `stage_runtime_payload_code` | TAIL |
