...
`.text` = [0x80000000, 0x80053e18), 343576 bytes (`RegionMap.textSizeBytes = 0x53e18`)

- symbols in `.text`: 906 (449 converted, 457 unconverted)
- covered by converted `_prog`s: 121600 bytes (35.39%)
- NOT covered: 221976 bytes (64.61%), 458 ranges
...
| `0x8004142c` | `0x80041778` | 844 | `h_MLOAD` | UNCONVERTED |
| `0x80041778` | `0x80041a58` | 736 | `h_MSTORE` | UNCONVERTED |
| `0x80041a58` | `0x80041b78` | 288 | `h_MSTORE8` | UNCONVERTED |
| `0x80041b78` | `0x80041bbc` | 68 | `h_MSIZE` | UNCONVERTED |
| `0x80041bbc` | `0x80041c00` | 68 | `h_GAS` | UNCONVERTED |
| `0x80041c00` | `0x80041c50` | 80 | `h_ADDRESS` | UNCONVERTED |
| `0x80041c50` | `0x80041ca0` | 80 | `h_ORIGIN` | UNCONVERTED |
| `0x80041ca0` | `0x80041cf0` | 80 | `h_CALLER` | UNCONVERTED |
| `0x80041cf0` | `0x80041d40` | 80 | `h_CALLVALUE` | UNCONVERTED |
| `0x80041d40` | `0x80041d90` | 80 | `h_GASPRICE` | UNCONVERTED |
| `0x80041d90` | `0x80041de0` | 80 | `h_COINBASE` | UNCONVERTED |
| `0x80041de0` | `0x80041e30` | 80 | `h_TIMESTAMP` | UNCONVERTED |
| `0x80041e30` | `0x80041e80` | 80 | `h_NUMBER` | UNCONVERTED |
| `0x80041e80` | `0x80041ed0` | 80 | `h_PREVRANDAO` | UNCONVERTED |
| `0x80041ed0` | `0x80041f20` | 80 | `h_GASLIMIT` | UNCONVERTED |
| `0x80041f20` | `0x80041f70` | 80 | `h_CHAINID` | UNCONVERTED |
| `0x80041f70` | `0x80041fc0` | 80 | `h_SELFBALANCE` | UNCONVERTED |
| `0x80041fc0` | `0x80042010` | 80 | `h_BASEFEE` | UNCONVERTED |
| `0x80042010` | `0x80042060` | 80 | `h_SLOTNUM` | UNCONVERTED |
| `0x80042060` | `0x800420b0` | 80 | `h_BLOBBASEFEE` | UNCONVERTED |
| `0x800420b0` | `0x80042148` | 152 | `h_BLOBHASH` | UNCONVERTED |
| `0x80042148` | `0x80042234` | 236 | `h_BLOCKHASH` | UNCONVERTED |
| `0x80042234` | `0x80042278` | 68 | `h_CALLDATASIZE` | UNCONVERTED |
| `0x80042278` | `0x80042494` | 540 | `h_CALLDATALOAD` | UNCONVERTED |
| `0x80042494` | `0x80042664` | 464 | `h_CALLDATACOPY` | UNCONVERTED |
| `0x80042664` | `0x800426a8` | 68 | `h_CODESIZE` | UNCONVERTED |
| `0x800426a8` | `0x80042874` | 460 | `h_CODECOPY` | UNCONVERTED |
| `0x80042874` | `0x8004287c` | 8 | `h_JUMPDEST` | UNCONVERTED |
| `0x8004287c` | `0x8004293c` | 192 | `h_JUMP` | UNCONVERTED |
| `0x8004293c` | `0x80042a30` | 244 | `h_JUMPI` | UNCONVERTED |
| `0x80042a30` | `0x80042a74` | 68 | `h_PC` | UNCONVERTED |
| `0x80042a74` | `0x80042cfc` | 648 | `h_KECCAK256` | UNCONVERTED |
| `0x80042cfc` | `0x80042ff0` | 756 | `h_LOG0` | UNCONVERTED |
| `0x80042ff0` | `0x80043304` | 788 | `h_LOG1` | UNCONVERTED |
| `0x80043304` | `0x80043638` | 820 | `h_LOG2` | UNCONVERTED |
| `0x80043638` | `0x8004398c` | 852 | `h_LOG3` | UNCONVERTED |
| `0x8004398c` | `0x80043d00` | 884 | `h_LOG4` | UNCONVERTED |
| `0x80043d00` | `0x80043fa8` | 680 | `h_BALANCE` | UNCONVERTED |
| `0x80043fa8` | `0x800442b0` | 776 | `h_EXTCODESIZE` | UNCONVERTED |
| `0x800442b0` | `0x8004491c` | 1644 | `h_EXTCODEHASH` | UNCONVERTED |
| `0x8004491c` | `0x80044ec4` | 1448 | `h_EXTCODECOPY` | UNCONVERTED |
| `0x80044ec4` | `0x80045444` | 1408 | `h_SLOAD` | UNCONVERTED |
| `0x80045444` | `0x80045cd0` | 2188 | `h_SSTORE` | UNCONVERTED |
| `0x80045cd0` | `0x80045dbc` | 236 | `h_TLOAD` | UNCONVERTED |
| `0x80045dbc` | `0x80045e8c` | 208 | `h_TSTORE` | UNCONVERTED |
| `0x80045e8c` | `0x8004610c` | 640 | `h_MCOPY` | UNCONVERTED |
| `0x8004610c` | `0x80046aa4` | 2456 | `h_RETURN` | UNCONVERTED |
| `0x80046aa4` | `0x80047088` | 1508 | `h_REVERT` | UNCONVERTED |
| `0x80047088` | `0x800470a4` | 28 | `h_INVALID` | UNCONVERTED |
| `0x800470a4` | `0x800485c8` | 5412 | `h_SELFDESTRUCT` | UNCONVERTED |
| `0x800485c8` | `0x80048614` | 76 | `h_RETURNDATASIZE` | UNCONVERTED |
| `0x80048614` | `0x800487b8` | 420 | `h_RETURNDATACOPY` | UNCONVERTED |
| `0x800487b8` | `0x80049580` | 3528 | `h_CREATE` | UNCONVERTED |
| `0x80049580` | `0x8004b82c` | 8876 | `h_CALL` | UNCONVERTED |
| `0x8004b82c` | `0x8004c9a4` | 4472 | `h_CALLCODE` | UNCONVERTED |
| `0x8004c9a4` | `0x8004d608` | 3172 | `h_DELEGATECALL` | UNCONVERTED |
| `0x8004d608` | `0x8004e410` | 3592 | `h_CREATE2` | UNCONVERTED |
| `0x8004e410` | `0x8004f074` | 3172 | `h_STATICCALL` | UNCONVERTED |
| `0x8004f074` | `0x8004f92c` | 2232 | `h_MULMOD` | UNCONVERTED |
| `0x8004f92c` | `0x80050220` | 2292 | `h_DIV` | UNCONVERTED |
| `0x80050220` | `0x800507bc` | 1436 | `h_MOD` | UNCONVERTED |
| `0x800507bc` | `0x80050e68` | 1708 | `h_SDIV` | UNCONVERTED |
| `0x80050e68` | `0x80050e88` | 32 | `h_SDIV_done` | UNCONVERTED |
| `0x80050e88` | `0x80051534` | 1708 | `h_SMOD` | UNCONVERTED |
| `0x80051534` | `0x80051554` | 32 | `h_SMOD_done` | UNCONVERTED |
| `0x80051554` | `0x80051e84` | 2352 | `h_ADDMOD` | UNCONVERTED |
| `0x80051e84` | `0x800521d0` | 844 | `h_EXP` | UNCONVERTED |
| `0x800521d0` | `0x80052340` | 368 | `h_STOP` | UNCONVERTED |
| `0x80052340` | `0x80052344` | 4 | `h_invalid` | UNCONVERTED |
| `0x80052344` | `0x800523cc` | 136 | `.exit_static_violation` | UNCONVERTED |
| `0x800523cc` | `0x800525c0` | 500 | `.exit_invalid` | UNCONVERTED |
| `0x800525c0` | `0x800525f0` | 48 | `.exit_invalid_top` | UNCONVERTED |
| `0x800525f0` | `0x80052604` | 20 | `.exit_invalid_prep_auth_halt_done` | UNCONVERTED |
| `0x80052604` | `0x80052614` | 16 | `.exit_invalid_hook_done` | UNCONVERTED |
| `0x80052614` | `0x80052644` | 48 | `.exit_invalid_top_no_auth_restore` | UNCONVERTED |
| `0x80052644` | `0x80052838` | 500 | `.exit_invalid_op` | UNCONVERTED |
| `0x80052838` | `0x80052868` | 48 | `.exit_invalid_op_top` | UNCONVERTED |
| `0x80052868` | `0x8005287c` | 20 | `.exit_invalid_op_prep_auth_halt_done` | UNCONVERTED |
| `0x8005287c` | `0x8005288c` | 16 | `.exit_invalid_op_hook_done` | UNCONVERTED |
| `0x8005288c` | `0x800528bc` | 48 | `.exit_invalid_op_top_no_auth_restore` | UNCONVERTED |
| `0x800528bc` | `0x800528e0` | 36 | `.exit_selfdestruct` | UNCONVERTED |
| `0x800528e0` | `0x80052910` | 48 | `.exit_selfdestruct_top` | UNCONVERTED |
| `0x80052910` | `0x80052b04` | 500 | `.exit_outofgas` | UNCONVERTED |
| `0x80052b04` | `0x80052b34` | 48 | `.exit_outofgas_top` | UNCONVERTED |
| `0x80052b34` | `0x80052b48` | 20 | `.exit_outofgas_prep_auth_halt_done` | UNCONVERTED |
| `0x80052b48` | `0x80052b58` | 16 | `.exit_outofgas_hook_done` | UNCONVERTED |
| `0x80052b58` | `0x80052b88` | 48 | `.exit_outofgas_top_no_auth_restore` | UNCONVERTED |
| `0x80052b88` | `0x80052d7c` | 500 | `.exit_stack_underflow` | UNCONVERTED |
| `0x80052d7c` | `0x80052dac` | 48 | `.exit_stack_underflow_top` | UNCONVERTED |
| `0x80052dac` | `0x80052dc0` | 20 | `.exit_stack_underflow_prep_auth_halt_done` | UNCONVERTED |
| `0x80052dc0` | `0x80052dd0` | 16 | `.exit_stack_underflow_hook_done` | UNCONVERTED |
| `0x80052dd0` | `0x80052e00` | 48 | `.exit_stack_underflow_top_no_auth_restore` | UNCONVERTED |
| `0x80052e00` | `0x80052ff4` | 500 | `.exit_stack_overflow` | UNCONVERTED |
| `0x80052ff4` | `0x80053024` | 48 | `.exit_stack_overflow_top` | UNCONVERTED |
| `0x80053024` | `0x80053038` | 20 | `.exit_stack_overflow_prep_auth_halt_done` | UNCONVERTED |
| `0x80053038` | `0x80053048` | 16 | `.exit_stack_overflow_hook_done` | UNCONVERTED |
| `0x80053048` | `0x80053078` | 48 | `.exit_stack_overflow_top_no_auth_restore` | UNCONVERTED |
| `0x80053078` | `0x80053078` | 0 | `.exit_label` | UNCONVERTED |
| `0x80053078` | `0x80053094` | 28 | `.exit_no_epilogue` | UNCONVERTED |
| `0x80053220` | `0x80053454` | 564 | `stage_system_call_payload` | UNCONVERTED |
| `0x80053954` | `0x80053a84` | 304 | `extract_deposit_data` | UNCONVERTED |
| `0x80053a84` | `0x80053ae0` | 92 | `edd_be32_eq` | UNCONVERTED |
| `0x80053ae0` | `0x80053b00` | 32 | `edd_memcpy` | UNCONVERTED |
| `0x80053b00` | `0x80053c3c` | 316 | `materialize_log_records` | UNCONVERTED |
| `0x80053e0c` | `0x80053e18` | 12 | `requests_hash_verify` | TAIL |
