...
> Snapshot: `2026-08-17` @ [`fba56068b`](https://github.com/Verified-zkEVM/evm-asm/commit/fba56068b518fa1adf9540ab088170449b1302a8)
...
By **registry row** (per-form rows retained; total = 115):
...
Distinct guest symbols (deduplicated): **90**
