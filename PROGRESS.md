...
> Snapshot: `2026-06-25` @ [`f6992549d`](https://github.com/Verified-zkEVM/evm-asm/commit/f6992549ded3994ef80278c82d3a6f3a7e36c947)
...
| 🟡 ADDMOD | partial | `evm_addmod_n0_spec_within` | — | addmod_correct proven; zero-modulus stack spec done for arbitrary b |
| ✅ MULMOD | proven | `evm_mulmod_stack_spec_within` | — | total all-n stack spec over evm_mulmod_program_code: evmWordIs a / b / n -> evmWordIs (sp+64) (EvmWord.mulmod a b n); carry-aware reducer (bit-255 capture), no n<=2^255 restriction (PR #9442) |
