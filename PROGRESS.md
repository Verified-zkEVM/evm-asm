...
> Snapshot: `2026-08-04` @ [`bc2b04745`](https://github.com/Verified-zkEVM/evm-asm/commit/bc2b04745b060d57514367dc6fc50976e072e968)
...
| `header` | guest | `check_gas_limit` | `checkGasLimit_ref_spec` | agrees | machine-only | check_gas_limit (SpecRef/SeamShell.lean:200, fork.py) |
| `guest` | guest | `bgv_u32le` | `bgvU32leFlat_spec` | agrees | machine-only | the fixed-width LE reads of deserialize_stateless_input (SpecRef/Guest.lean:29), which reduce to bytesLEtoNat (SpecRef/Crypto.lean:38) |
