...
> Snapshot: `2026-06-07` @ [`98b807280`](https://github.com/Verified-zkEVM/evm-asm/commit/98b8072807fe230cecd4291deb17a77a5204153b)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **878**
- ziskemu round-trip scripts: **616** under `scripts/codegen-*.sh`
