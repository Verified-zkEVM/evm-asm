...
> Snapshot: `2026-06-07` @ [`47c1830f6`](https://github.com/Verified-zkEVM/evm-asm/commit/47c1830f619ca129cd22ba2029ca0f4ff7b1eed9)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **851**
- ziskemu round-trip scripts: **604** under `scripts/codegen-*.sh`
