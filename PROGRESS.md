...
> Snapshot: `2026-06-07` @ [`bc0849a0c`](https://github.com/Verified-zkEVM/evm-asm/commit/bc0849a0c1792c4f7320f88d9fc51c0e44e2f1a2)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **855**
- ziskemu round-trip scripts: **606** under `scripts/codegen-*.sh`
