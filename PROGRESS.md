...
> Snapshot: `2026-06-29` @ [`6c4fccb03`](https://github.com/Verified-zkEVM/evm-asm/commit/6c4fccb03719b69a1bd238fa796168c29817a160)
> Lean toolchain: `leanprover/lean4:v4.30.0-rc1`
> Pinned submodules: `eth-act/zkvm-standards@05d98e4`, `ethereum/execution-specs@a0c1826`
...
| 🟡 EXP | partial | `evm_exp_headroom_stack_spec_within` | — | exp_correct proven; pure executable stack transition names EvmWord.exp; headroom RV64 full-loop composition now reaches a canonical headroom stack theorem with ordinary entry-base alignment, old register/scratch values and the internal scratch base existentially packaged, and the final live stack split at evmSp+32; consumed operand/scratch cells and leftover headroom stack cells are weakened to ownership; leftover frame/scratch registers x0, x2, x9, and x5 are also owned in the leftover frame, with remaining returned resources framed explicitly; public evm_exp_stack_spec_within wrapper still pending |
