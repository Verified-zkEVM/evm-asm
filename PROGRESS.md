...
> Snapshot: `2026-08-20` @ [`61f437b24`](https://github.com/Verified-zkEVM/evm-asm/commit/61f437b24e5e43f0ec0d2f3c4d5a8ec0520aac26)
...
By **registry row** (per-form rows retained; total = 182):
...
Distinct guest symbols (deduplicated): **156**
