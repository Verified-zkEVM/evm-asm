...
> Snapshot: `2026-08-10` @ [`98d8d6b18`](https://github.com/Verified-zkEVM/evm-asm/commit/98d8d6b187468b049e60095d9b653726d6bf9e8c)
...
| ✅ MSTORE | proven | `evm_mstore_stack_spec_within_region` | — | region-backed spec covers every byte offset with an explicit guard; the HandlerSpecs/MemoryFrameSpec lift chain still consumes the raw eight-cell theorem and is tracked separately |
