...
> Snapshot: `2026-08-06` @ [`390655a07`](https://github.com/Verified-zkEVM/evm-asm/commit/390655a07166004cfeaf9c53ee853b017536f442)
...
| `header` | guest | `header_extract_number` | `header_number_of_decode` | stricter ⚠ | ported | the `number` field of `_decode_header` (SpecRef/Stateless.lean:158, stateless.py:244) |
