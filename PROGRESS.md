...
> Snapshot: `2026-08-16` @ [`21f1c52a6`](https://github.com/Verified-zkEVM/evm-asm/commit/21f1c52a6f5b758984724ed337d4863023cd4503)
...
By **registry row** (per-form rows retained; total = 111):
...
Distinct guest symbols (deduplicated): **86**
