...
> Snapshot: `2026-08-11` @ [`e40c6ea90`](https://github.com/Verified-zkEVM/evm-asm/commit/e40c6ea903edc9acb603a27f48aa34bb88e2e0ff)
...
| `guest` | guest | `bgv_u32le` | `bgvU32leFlat_spec` | agrees | ported | the fixed-width LE reads of deserialize_stateless_input (SpecRef/Guest.lean:29), which reduce to bytesLEtoNat (SpecRef/Crypto.lean:38) |
