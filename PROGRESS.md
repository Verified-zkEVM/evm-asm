...
> Snapshot: `2026-07-31` @ [`1614cb701`](https://github.com/Verified-zkEVM/evm-asm/commit/1614cb701069548ad0b2eeba229462c5244cbc6e)
...
| Basis | Count | Meaning |
|---|---|---|
| diff | 0 | backed by `lake exe correspondence-check` |
...
|---|---|---|---|---|
| `rlp_walk_init` | `rlp_walk_init_spec_within` | agrees | bridged | decode_to_sequence entry |
| `rlp_walk_next` | `rlp_walk_next_spec_within` | agrees | bridged | decode_item_length + decode_joined_encodings loop |
| `rlp_content_to_u64` | `rlp_content_to_u64_spec_within` | agrees | inspection | _deserialize_to_uint at U64 |
| `rlp_content_to_u256_be` | `rlp_content_to_u256_be_spec_within` | agrees | machine-only | _deserialize_to_uint at U256 |
| `rlp_item_size` | `rlp_item_size_spec_within` | domain-restricted | bridged | decode_item_length |
| `rlp_item_span` | — | n/a — unproven | — | decode_item_length |
| `rlp_list_count_items` | `rlp_list_count_items_spec_within` | agrees | machine-only | decode_joined_encodings |
| `rlp_list_nth_item` | `rlpListNthItem_spec_within` | agrees | bridged | decode_to_sequence + index |
| `rlp_field_to_u64` | `rlpFieldToU64_spec_within` | agrees | inspection | _deserialize_to_uint at U64 ∘ walk |
| `rlp_field_to_u256_be` | `rlpFieldToU256Be_spec_within` | agrees | inspection | _deserialize_to_uint at U256 ∘ walk |
| `rlp_bytes_encoded_size` | `rlpBytesEncodedSize_spec` | agrees | machine-only | len(encode_bytes(...)) |
| `rlp_list_encoded_size` | `rlpListEncodedSize_spec` | agrees | machine-only | len(encode_sequence(...)) |
| `rlp_encode_uint_be` | — | n/a — unproven | — | encode(Uint) → encode_bytes(to_be_bytes()) — unbounded |
| `rlp_encode_list_prefix` | `rlp_encode_list_prefix_short_pinned_spec_within` | domain-restricted | bridged | header of encode_sequence |
| `rlp_encode_bytes` | — | n/a — unproven | — | encode_bytes |
| `rlp_encode_u64` | — | n/a — unproven | — | encode(U64) |
| `rlp_list_truncate_to_n_fields` | — | no counterpart | inspection |  |
| `rlp_prefix_to_buffer` | — | no counterpart | inspection |  |
