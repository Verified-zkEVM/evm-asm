...
> Snapshot: `2026-06-29` @ [`228cd7e0d`](https://github.com/Verified-zkEVM/evm-asm/commit/228cd7e0d1113c1cbb33a7dd4c560deb7884e736)
...
| 🟡 ADDMOD | partial | `evm_addmod_n0_semantic_stack_spec_within` | — | addmod_correct proven; zero-modulus stack spec done for arbitrary b; no-overflow skeleton composed through legacy MOD no-NOP body proof |
