...
> Snapshot: `2026-06-14` @ [`94972d523`](https://github.com/Verified-zkEVM/evm-asm/commit/94972d5230abcf203baac697dc73515a5680c68d)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **958**
- ziskemu round-trip scripts: **701** under `scripts/codegen-*.sh`
