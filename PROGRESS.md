...
> Snapshot: `2026-08-11` @ [`8c083ea70`](https://github.com/Verified-zkEVM/evm-asm/commit/8c083ea70e9e85e0c9fa1d8f6b1ddbe5502aa9a8)
...
| `mpt` | guest | `hp_decode_nibbles` | `hp_decode_nibbles_spec` | agrees | machine-only | hpDecode / compact_to_nibbles guest mirror (Evm64/MptAssertions.lean; SpecRef compact_to_nibbles is STRICTER on head nibbles — see HpDecodeNibblesSAsm docstring and GH #10528) |
