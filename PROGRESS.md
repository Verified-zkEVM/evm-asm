...
> Snapshot: `2026-07-08` @ [`94f4120be`](https://github.com/Verified-zkEVM/evm-asm/commit/94f4120be788b9808ff1a39b84acded4ed83273b)
...
| ⏳ TLOAD | execSpec | `—` | — | EIP-1153 (Cancun); transient-log scan handler (Codegen Storage.lean) |
| ⏳ TSTORE | execSpec | `—` | — | EIP-1153 (Cancun); transient-log append handler (Codegen Storage.lean) |
