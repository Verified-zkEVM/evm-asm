...
> Snapshot: `2026-08-05` @ [`9b37fb96a`](https://github.com/Verified-zkEVM/evm-asm/commit/9b37fb96ae0dfd9ef0b3e153f50b5e030deb585b)
...
| `header` | guest | `header_extract_number` | `header_number_of_decode` | domain-restricted | ported | the `number` field of `_decode_header` (SpecRef/Stateless.lean:75, stateless.py:244) |
