...
> Snapshot: `2026-06-07` @ [`d40c6cd58`](https://github.com/Verified-zkEVM/evm-asm/commit/d40c6cd5825625ff90f1bca6558943688edd68b8)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **880**
- ziskemu round-trip scripts: **617** under `scripts/codegen-*.sh`
