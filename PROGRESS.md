...
> Snapshot: `2026-06-29` @ [`8d443bfba`](https://github.com/Verified-zkEVM/evm-asm/commit/8d443bfbac705ec246bca1b62e060604b90189ae)
...
| 🟡 EXP | partial | `evm_exp_headroom_clean_visible_stack_spec_within` | — | exp_correct proven; pure executable stack transition names EvmWord.exp; headroom RV64 full-loop composition now reaches a Spec-level clean visible-stack theorem over the ordinary two-operand stack prefix with the loop counter exposed as zero; consumed-base/headroom/leftover frame cleanup is still pending before the public evm_exp_stack_spec_within wrapper |
