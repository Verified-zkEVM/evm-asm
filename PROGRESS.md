...
> Snapshot: `2026-08-14` @ [`64f6fa085`](https://github.com/Verified-zkEVM/evm-asm/commit/64f6fa0859a430bfe4d09ef7e5416b4325316e83)
...
By **registry row** (per-form rows retained; total = 108):
...
Distinct guest symbols (deduplicated): **83**
