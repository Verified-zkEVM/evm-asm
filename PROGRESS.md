...
> Snapshot: `2026-06-29` @ [`4c7ab89b8`](https://github.com/Verified-zkEVM/evm-asm/commit/4c7ab89b8f59e66621c5196f044f159311bac9e8)
...
| 🟡 EXP | partial | `ExpStackExecutionBridge.runExpStack?_semantic_cons` | — | exp_correct proven; pure executable stack transition names EvmWord.exp; RV64 loop-exit post exposes live-stack view; folded/framed final-loop surface plus canonical appended-code entry/loop surfaces, folded headroom entry post, explicit entry bridge frame, entry-to-first-iteration residual bridge, entry-through-loop composition, and folded canonical epilogue surface ready; wrapper pending |
