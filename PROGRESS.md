...
> Snapshot: `2026-08-14` @ [`4fb076c`](https://github.com/Verified-zkEVM/evm-asm/commit/4fb076cb29a16fc56cdce326c13b5f74be994098)
...
By **registry row** (per-form rows retained; total = 105):
...
Distinct guest symbols (deduplicated): **80**
