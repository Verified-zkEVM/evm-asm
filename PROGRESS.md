...
> Snapshot: `2026-08-20` @ [`a1e444ea3`](https://github.com/Verified-zkEVM/evm-asm/commit/a1e444ea3041065f740cb6d2edf32acb2701aa40)
...
By **registry row** (per-form rows retained; total = 180):
...
Distinct guest symbols (deduplicated): **154**
