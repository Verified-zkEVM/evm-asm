...
> Snapshot: `2026-08-04` @ [`e9b254f3d`](https://github.com/Verified-zkEVM/evm-asm/commit/e9b254f3da9645a5e0153e20932f5dcfdaba877a)
...
| bridged | 7 | tied to the shared model, inherits the differential |
...
| `rlp` | guest | `rlp_bytes_encoded_size` | `rlpBytesEncodedSize_spec` | agrees | machine-only | len(encode_bytes(...)) |
| `rlp` | guest | `rlp_list_encoded_size` | `rlpListEncodedSize_spec` | agrees | machine-only | len(encode_sequence(...)) |
