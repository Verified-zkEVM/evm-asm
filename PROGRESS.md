...
> Snapshot: `2026-06-12` @ [`ec5f7c7d1`](https://github.com/Verified-zkEVM/evm-asm/commit/ec5f7c7d1f21b3c6d3e1e0c039dfe9b2236f0856)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **934**
- ziskemu round-trip scripts: **690** under `scripts/codegen-*.sh`
