...
> Snapshot: `2026-06-09` @ [`ec7e9e5a6`](https://github.com/Verified-zkEVM/evm-asm/commit/ec7e9e5a62a015362378236d6b7d176ffa7c9868)
...
- ziskemu round-trip scripts: **656** under `scripts/codegen-*.sh`
