...
> Snapshot: `2026-06-07` @ [`d701d2283`](https://github.com/Verified-zkEVM/evm-asm/commit/d701d2283746dc9a548a1d507e6d211cd189b7ea)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **853**
- ziskemu round-trip scripts: **605** under `scripts/codegen-*.sh`
