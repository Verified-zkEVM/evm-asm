...
> Snapshot: `2026-06-12` @ [`547b1a22d`](https://github.com/Verified-zkEVM/evm-asm/commit/547b1a22dbc7db6856b5f9a3710a31f781b18850)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **926**
- ziskemu round-trip scripts: **688** under `scripts/codegen-*.sh`
