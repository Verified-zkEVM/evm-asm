...
> Snapshot: `2026-08-10` @ [`04de93895`](https://github.com/Verified-zkEVM/evm-asm/commit/04de93895d3805b8d6ae1250d2dc6109f72236e2)
...
| machine-only | 2 | spec restates the rules locally; differential does NOT transfer |
| inspection | 5 | read both sides; no executable backing |
| — | 3 | no verdict to support |
...
| `rlp` | guest | `rlp_item_span` | — | n/a — unproven | — | decode_item_length |
...
| `header` | guest | `header_extract_logs_bloom` | `header_logs_bloom_of_decode` | domain-restricted | ported | the `bloom` field of `_decode_header` (SpecRef/Stateless.lean:158, stateless.py:244) |
| `header` | guest | `header_extract_number` | `header_number_of_decode` | domain-restricted | ported | the `number` field of `_decode_header` (SpecRef/Stateless.lean:158, stateless.py:244) |
...
| `crypto` | guest | `blsg_lt_p` | `blsgLtP_spec_specref` | domain-restricted | ported | Bls12.bytes_to_fq (SpecRef/PrecompilesBls.lean:78), a port of amsterdam/vm/precompiled_contracts/bls12_381/__init__.py:426-454 |
| `crypto` | guest | `bnf_lt_p` | `bnfLtP_spec_specref` | agrees | ported | the `x >= field_modulus` guard of Bn128.bytes_to_g1 (SpecRef/PrecompilesCurve.lean:83), a port of amsterdam/vm/precompiled_contracts/alt_bn128.py:39-82 |
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **1017
0**
