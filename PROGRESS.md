...
> Snapshot: `2026-08-05` @ [`05989deb5`](https://github.com/Verified-zkEVM/evm-asm/commit/05989deb5563696dfa0e65ad2c56d759bb7df9d9)
...
| `header` | guest | `header_extract_number` | `header_number_of_decode` | **SpecRef bug — port defect (#11513)** | ported | the `number` field of `_decode_header` (SpecRef/Stateless.lean:75, stateless.py:244) |
