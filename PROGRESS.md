...
> Snapshot: `2026-08-14` @ [`83546781a`](https://github.com/Verified-zkEVM/evm-asm/commit/83546781a0719514c8b92c4188f2a1ed3214501d)
...
By **registry row** (per-form rows retained; total = 104):
...
Distinct guest symbols (deduplicated): **79**
