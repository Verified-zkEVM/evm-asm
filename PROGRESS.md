...
> Snapshot: `2026-08-16` @ [`c0dac0bce`](https://github.com/Verified-zkEVM/evm-asm/commit/c0dac0bcef2d9cb4f94f12509b32275de32cfcdd)
...
By **registry row** (per-form rows retained; total = 112):
...
Distinct guest symbols (deduplicated): **87**
