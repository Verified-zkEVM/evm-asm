...
> Snapshot: `2026-08-14` @ [`070a9b8c1`](https://github.com/Verified-zkEVM/evm-asm/commit/070a9b8c1bed05a3ce930d9ae6e99a720c0ec899)
...
By **registry row** (per-form rows retained; total = 110):
...
Distinct guest symbols (deduplicated): **85**
