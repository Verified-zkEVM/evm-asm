...
> Snapshot: `2026-06-14` @ [`b7682fd50`](https://github.com/Verified-zkEVM/evm-asm/commit/b7682fd500478a62ecd6518c290c5da9c0e6ecfd)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **961**
- ziskemu round-trip scripts: **705** under `scripts/codegen-*.sh`
