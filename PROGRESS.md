...
> Snapshot: `2026-08-02` @ [`388aaff78`](https://github.com/Verified-zkEVM/evm-asm/commit/388aaff78ce0de6e2cb1c918c308c9501397019d)
...
| bridged | 5 | tied to the shared model, inherits the differential |
...
| `rlp` | guest | `rlp_encode_uint_be` | — | n/a — unproven | — | encode(Uint) → encode_bytes(to_be_bytes()) — unbounded |
...
| `rlp` | guest | `rlp_encode_bytes` | — | n/a — unproven | — | encode_bytes |
...
| `bal` | guest | `bal_sort_storage_writes` | — | n/a — unproven | — |  |
| `bal` | guest | `bal_sort_account_writes` | — | n/a — unproven | — |  |
