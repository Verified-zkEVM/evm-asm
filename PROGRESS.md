...
> Snapshot: `2026-07-18` @ [`35c642301`](https://github.com/Verified-zkEVM/evm-asm/commit/35c6423016e21bd874bba960c1bed0f4250a05fa)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **1015
0**
- ziskemu round-trip scripts: **779** under `scripts/codegen-*.sh`
