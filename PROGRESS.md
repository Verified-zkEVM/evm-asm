...
> Snapshot: `2026-06-29` @ [`a0c73faa0`](https://github.com/Verified-zkEVM/evm-asm/commit/a0c73faa01910b73c7a6898b2c40f89ce9189865)
...
| 🟡 ADDMOD | partial | `evm_addmod_zero_or_no_overflow_word_mod_body_stack3_spec_within` | — | addmod_correct proven; zero-modulus stack spec done for arbitrary b; no-overflow skeleton composed through legacy MOD no-NOP body proof; current partial theorem now accepts the three operands as evmStackIs sp [a,b,N] |
