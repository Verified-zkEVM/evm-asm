...
> Snapshot: `2026-06-29` @ [`a6e933246`](https://github.com/Verified-zkEVM/evm-asm/commit/a6e933246c315ed6a06a17e8ea57ce54512ae473)
...
| 🟡 ADDMOD | partial | `evm_addmod_partial_domain_named_stack_spec_within` | — | addmod_correct proven; zero-modulus stack spec done for arbitrary b; no-overflow skeleton composed through legacy MOD no-NOP body proof; current partial theorem has named domain plus stack pre/post assertions |
