...
> Snapshot: `2026-08-20` @ [`790b76d1c`](https://github.com/Verified-zkEVM/evm-asm/commit/790b76d1cca779bfa72c8a389d7b8fa32cdc2491)
...
By **registry row** (per-form rows retained; total = 183):
...
Distinct guest symbols (deduplicated): **157**
