...
> Snapshot: `2026-06-12` @ [`f420b5c0f`](https://github.com/Verified-zkEVM/evm-asm/commit/f420b5c0fef56d35a7719f47cff9a72372c4e114)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **922**
- ziskemu round-trip scripts: **687** under `scripts/codegen-*.sh`
