...
> Snapshot: `2026-08-11` @ [`bcf51a7a6`](https://github.com/Verified-zkEVM/evm-asm/commit/bcf51a7a6b22cf293e875014d3eae87af4f81c01)
...
| `rlp` | guest | `rlp_list_nth_item` | `rlpListNthItem_spec_within` | agrees | bridged | decode_to_sequence + index |
...
| `rlp` | guest | `rlp_bytes_encoded_size` | `rlpBytesEncodedSize_encode_spec` | agrees | bridged | len(encode_bytes(...)) |
| `rlp` | guest | `rlp_list_encoded_size` | `rlpListEncodedSize_encode_spec` | agrees | bridged | len(encode_sequence(...)) |
| `rlp` | guest | `rlp_encode_uint_be` | `reub_spec_within` | domain-restricted | bridged | encode(Uint) → encode_bytes(to_be_bytes()) — unbounded |
| `rlp` | guest | `rlp_encode_list_prefix` | `rlp_encode_list_prefix_short_pinned_spec_within` | domain-restricted | bridged | header of encode_sequence |
| `rlp` | guest | `rlp_encode_bytes` | `reb_spec_within` | agrees | bridged | encode_bytes |
| `rlp` | guest | `rlp_encode_u64` | — | n/a — unproven | — | encode(U64) |
