...
> Snapshot: `2026-07-15` @ [`a4feccd1d`](https://github.com/Verified-zkEVM/evm-asm/commit/a4feccd1dc73cfcb7f669f73aea81cd96a9b01e0)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **1006
0**
- ziskemu round-trip scripts: **762** under `scripts/codegen-*.sh`
