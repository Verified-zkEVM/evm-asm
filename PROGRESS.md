...
> Snapshot: `2026-08-04` @ [`e1d526092`](https://github.com/Verified-zkEVM/evm-asm/commit/e1d52609265a23e2fb5fd3059ecdec54886b5ce6)
...
| bridged | 9 | tied to the shared model, inherits the differential |
...
| `rlp` | guest | `rlp_content_to_u256_be` | `rlp_content_to_u256_be_spec_within` | agrees | machine-only | _deserialize_to_uint at U256 |
