...
> Snapshot: `2026-06-29` @ [`8fc9d6820`](https://github.com/Verified-zkEVM/evm-asm/commit/8fc9d682078a8c8a2b822f9b4a06a51f8a314478)
...
| 🟡 ADDMOD | partial | `evm_addmod_zero_or_no_overflow_named_stack_spec_within` | — | addmod_correct proven; zero-modulus stack spec done for arbitrary b; no-overflow skeleton composed through legacy MOD no-NOP body proof; current partial theorem has named stack pre/post assertions |
