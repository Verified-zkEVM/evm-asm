...
> Snapshot: `2026-06-07` @ [`3f3317c5a`](https://github.com/Verified-zkEVM/evm-asm/commit/3f3317c5a94ad1bd95f74cceb6ce0e16368b1949)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **889**
- ziskemu round-trip scripts: **619** under `scripts/codegen-*.sh`
