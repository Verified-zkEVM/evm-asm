...
> Snapshot: `2026-06-09` @ [`658faaf73`](https://github.com/Verified-zkEVM/evm-asm/commit/658faaf7355b5b866417115b878635274627756d)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **921**
- ziskemu round-trip scripts: **647** under `scripts/codegen-*.sh`
